**Source:** https://www.cpp.edu/polysec/scholarship.shtml
...
New in 2024: the Department of Computer Science has started a Cyber Security minor and two Cyber Security Digital Badges which will be available starting Fall 2024. To receive more information about the Cyber Security program please submit the: [Information Request Form](https://forms.gle/HbmpRufv2G7mg27a8)

An overview of sample cyber curriculum can be found here for reference only.

[Undergraduate Curriculum (PDF)](docs/cyber-security-bs.pdf)

[Graduate Curriculum (PDF)](docs/cyber-security-ms.pdf)

## Scholarship For Service (SFS) Program

![CPP SFS banner](img/official-sfs-banner.png)

Cal Poly Pomona (CPP), an NSA/DHS Center of Academic Excellence in Information Assurance/Cyber Defense Education since 2005, has received a 5-yr (2015-2023) grant from the National Science Foundation CyberCorps Scholarships for Service (SFS) program to train students who choose the professional specialty of cyber security and prepare them to succeed in challenging careers in government agencies to enhance the security of critical national information infrastructure.

The scholars undergo rigorous academic training in cyber security with hands-on experience through undergraduate research, Collegiate Cyber Defense Competition, National Cyber League, and industry certification. The scholars also receive training in communication and leadership skill development by

participating in extra-curricular activities such as GenCyber program.

If you will be graduating within 1-2 years who is interested in the field of cyber security at CPP and love to serve and protect your country, this scholarship is for you! Visit the [application-process link](https://www.cpp.edu/sfs/application-process.shtml) to know about the next step.
