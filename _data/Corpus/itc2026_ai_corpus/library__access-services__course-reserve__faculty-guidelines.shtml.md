**Source:** https://www.cpp.edu/library/access-services/course-reserve/faculty-guidelines.shtml
...
Before requesting that materials be placed on reserve, faculty should determine whether or not permission to copy the materials needs to be obtained. Cal Poly Pomona Library's guidelines for reserves are based on the principle that the fair use provisions of the Copyright Act of 1976, Section 107 permit the making copies of copyrighted material for the classroom:
...
Copyright permission must be sought after by faculty through the [Copyright Clearance Center](https://www.copyright.com) or write a letter to the publisher: [Sample Draft Letter to Publisher](sample-letter.shtml).

Reserve may include copyright materials at the request of an instructor for **one** semester only.

Materials that will be placed in reserve without obtaining copyright permission include any combination on the following list:
...
* Student papers ([with written authorization](studentpapercopyrightpermissionform.doc))
...
Material may be placed on reserve by submitting a [Reserve Request Form (PDF)](faculty-request-form-12-2021.pdf) and should accompany all material.
...
* via the web for [Library-owned materials](reserve-request-form.shtml).
