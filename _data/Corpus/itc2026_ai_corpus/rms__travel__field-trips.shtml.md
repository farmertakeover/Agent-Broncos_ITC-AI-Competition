**Source:** https://www.cpp.edu/rms/travel/field-trips.shtml
...
EXAMPLE OF WHAT'S ***NOT*** A FIELD TRIP
...
### Planning the Field Trip and Creating Your Field-Trip Checklist
...
## Field Trips Involving Travel Outside the United States
...
## Insurance for Field Trips Involving Travel Outside of the United States
...
## CSU Release of Liability, Promise Not to Sue, Assumption of Risk and Agreement to Pay Claims Form

All field trip participants, with the exception of employees in the course and scope of their employment, must sign a Release of Liability.  Departments that sponsor activities that involve off-campus field trips are responsible for preparing [Release of Liability](../forms/release-of-liability-2022.pdf) and making certain that all participants sign and submit one before being allowed to participate in the activity. If an itinerary has been developed, it can be referenced and attached to the Release of Liability.

## Where to Meet and Transportation

FIELD TRIPS WITH INDIVIDUAL STUDENT AND FACULTY TRAVEL
...
FIELD TRIPS WITH CHARTERED TRAVEL SERVICES
...
## Review Codes of Conduct with Field Trip Participants
...
* Advise participants of the consequences of non-compliance and take appropriate action when aware that participants are in violation.  Visit the [Cal Poly Pomona Student Conduct & Integrity website](https://www.cpp.edu/studentconduct/index.shtml) for details regarding Student Conduct Code and Procedures.

## CSU Executive Orders (Policies) and Forms

### CSU Executive Orders:

* [CSU Executive Order 1062 (Field Trip Policy & Procedures)](https://calstate.policystat.com/policy/6591007/latest) (PDF)
* [CSU Executive Order 998 (Study Abroad Programs)](https://www.cpp.edu/rms/docs/EO-998.pdf) (PDF)
* [CSU Executive Order 1041 (Student Travel)](https://calstate.policystat.com/policy/13647263/latest) (PDF)
* [CSU Executive Order 1083 (Volunteers)](http://www.calstate.edu/eo/eo-1083-rev-7-21-17.html%20) (PDF)

### Forms/Paperwork:

* [Student Travel Release Notice](https://www.cpp.edu/rms/docs/stud_travel_release_notice.pdf) (PDF)
* [Release of Liability](../forms/release-of-liability-2022.pdf) (PDF)
* [Academic Field Trip Participant List (Emergency Contact Information)](../forms/academic-field-trip-participant-list.pdf) (PDF)
...
[Release of Liability](../forms/release-of-liability-2022.pdf) Please review the statement carefully before signing it.

### Student Conduct Code

Students participating in academic field trips are expected to conform to the same standards of behavior as published in the [Cal Poly Pomona Student Conduct Code](http://www.cpp.edu/~studentconduct/student-conduct-code.shtml). Any violation of the Student Conduct Code or local, state, or federal laws may result in disciplinary action or sanctions by the University.
...
If a field trip involves travel outside of the United States, check with Risk Management, extension 4846, regarding required Foreign Travel Insurance. This insurance is mandated by [CSU Executive Order 1041](http://www.calstate.edu/eo/EO-1041.html) and a cost is assessed for faculty and students.
