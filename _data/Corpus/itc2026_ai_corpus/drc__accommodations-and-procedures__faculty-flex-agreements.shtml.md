**Source:** http://www.cpp.edu/drc/accommodations-and-procedures/faculty-flex-agreements.shtml
...
# Faculty Info for Flex Agreements

## What are Flexible Agreements?

Flexible Agreements are the agreements initiate by a DRC student approved for either or both Modified Attendance and Extended Deadlines. These accommodations do not go into effect until the student and instructor have discussed, agreed upon a specific plan and the student has submitted the agreement through myDRC. It is the student’s responsibility to initiate this process.
...
## How to Complete Flexible Agreements on myDRC

The student will initiate a flexible agreement through their myDRC account. Once submitted, the instructor will receive an email notification asking them to review the request. Read our step-by-step instructions on [How to Complete Flexible Agreements](https://sway.cloud.microsoft/ZyxariyPcx3Z0rj2?ref=Link) on the myDRC portal.

If there is no response to a student's initiate agreement on the myDRC portal, the students proposed agreement is in effect after email attempts to the instructor to review the agreement.

## DRC Consultations

When in doubt, request a consultation with the DRC to determine if the flexible agreement would result in fundamental alterations to the course design. Instructors should never deny a student’s eligible accommodation. Be prepared to provide a rationale about how the flexible agreement is either not educationally feasible or how adjustments would result in changes to essential components of the course.
