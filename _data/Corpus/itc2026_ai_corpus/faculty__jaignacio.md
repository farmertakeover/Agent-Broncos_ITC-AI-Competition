**Source:** http://www.cpp.edu/faculty/jaignacio
...
Tony is a licensed landscape architect practicing in the Central Valley and Southern California. He works with diverse communities focusing on collaborative partnerships that bring positive benefits to each project. Tony actively integrates his environmental background with landscape architecture and planning, promoting a better understanding of the interplay between our physical, cultural, and economic environments. His holistic approach creates spaces that are not only functional, but also fosters a sense of community and connection to the environment. Tony holds a BS in Marine Science from the University of San Diego, a MSES and MPA from Indiana University, and a MLA from Cal Poly Pomona.
