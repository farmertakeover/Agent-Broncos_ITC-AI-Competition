**Source:** http://www.cpp.edu/fpm/design-construction.shtml
...
Major Capital Outlay projects are defined as projects, building construction, improvements and renovations greater than [$1,103,000](https://www.calstate.edu/csu-system/doing-business-with-the-csu/capital-planning-design-construction/operations-center/Documents/guidelines/Commissioning-Guidelines-28-Nov-2018-rev2.pdf). Deferred maintenance projects are exempt. (See the [California State University procedures for capital projects (PDF)](https://www.calstate.edu/csu-system/doing-business-with-the-csu/capital-planning-design-construction/operations-center/Documents/guidelines/Commissioning-Guidelines-28-Nov-2018-rev2.pdf))
...
**Construction Management Priorities**
...
Need help with a project? Fill out a [Project Request Form](fpm-documents/project-intake-form.pdf) online and submit it to fmcustomer@cpp.edu
...
These projects are limited to those projects that correct minor deficiencies, provide new or improved facilities, add access or provide equipment, or require work to meet ADA compliance. Minor capital outlay projects are those with an estimated or actual cost of less than $1,103,000.
...
The [Project Request Form (PDF)](fpm-documents/project-intake-form.pdf) is used to initiate campus capital projects. This includes projects funded by the campus, donors, grants, and auxiliary organizations. To initiate a project, complete the Project Request Form and send it via email to fmcustomer@cpp.edu.
...
* On the FP&M website ([www.cpp.edu/fpm](http://www.cpp.edu/fpm)), click on the Services menu bar, select Services, select Service Requests. Fill out the [Service Request Form](https://cpp.webtma.com/?tkn=tLs22bS2La4M-q075b6JJkofELEtiOzzacinjNQdbceGVb_5uZo1OdGY06Kd2FbNKlYBawZHSimc2k5C0dgD8aP6rQtqHjdozYs7IzLaplvC-LD-G_ah1CzBkMZJeAGPbk3le4FfPg3FuHsukvMuwhi2v_1A1zYhZe1SUD6KgWTt7fw4BeR3dunXZbHUBCLGW2KuzBxGROjFWSHEKZCbf-r-HSgW38Jjam-EZPQ7_MLh0_Kux9OZcu1Wi7D9nyqUQD0lhSQXTrXHK_-X3arA0w) online and submit.
* Call (909) 869-3030
* Submit a request to fmcustomer@cpp.edu
