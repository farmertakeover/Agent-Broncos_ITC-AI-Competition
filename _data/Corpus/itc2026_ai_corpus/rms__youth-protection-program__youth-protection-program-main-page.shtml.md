**Source:** https://www.cpp.edu/rms/youth-protection-program/youth-protection-program-main-page.shtml
...
![Children's tour of the CPP Rainforest with docent displaying an Iguana](../img/discovery-camp-iguana2.jpg)
...
In alignment with the [CSU Managing Risk in Youth Programs Resource Guide (PDF)](csumanagingriskinyouthprogramsresourceguide.pdf), Cal Poly Pomona's Youth Protection Program (YPP) establishes campus-wide policies and protocols to ensure the health, safety, and welfare of minors when they are participating in University-affiliated programs.
...
All Youth Programs must adhere to the requirements set forth in the [CSU Managing Risk in Youth Programs Resource Guide](csumanagingriskinyouthprogramsresourceguide.pdf) and the [CPP Youth Protection Program Operations Detail.](youthprotectionprogram.pdf)

**Youth Program Sponsors**

* University departments/colleges, auxiliaries, and third-party organizations who want to sponsor a youth program must adhere to the [Program Sponsor Requirements](program-sponsors.shtml).

**Youth Program Personnel**

* Individuals wishing to volunteer or work at a youth program must adhere to the [Program Personnel Requirements](program-personnel.shtml).

## Youth Program Requirements

[Program Sponsor Requirements](program-sponsors.shtml)

[Program Personnel (Staff & Volunteer) Requirements](program-personnel.shtml)

## Policies & Procedures

[CSU Managing Risk in Youth Programs Resource Guide](csumanagingriskinyouthprogramsresourceguide.pdf)

[CPP Youth Protection Program Operations Detail](youthprotectionprogram.pdf)
