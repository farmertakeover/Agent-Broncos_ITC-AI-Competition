**Source:** http://www.cpp.edu/financial-aid/credentials/current/aid-programs.shtml
...
Our [Scholarships page](../../scholarships/index.shtml) is your resource for information on a variety of Cal Poly Pomona, CSU Systemwide,  and outside scholarship opportunities.
...
The largest federal grant program, the Federal Pell Grant is designed to assist students from low-income families. These grants are awarded to eligible credential students who have not yet exhausted their Pell Grant Lifetime Eligibility. The Pell grant varies based on financial need, as determined by your FAFSA application; **for 20****25 – 2026 the maximum Pell Grant will be  $7,395.**
...
As you add and drop units, your Pell Grant will increase or decrease based upon your enrollment intensity - which is a percentage value based on the number of credits you are enrolled in during a term. The final amount of Pell Grant that you will receive in any semester will be based upon your official enrollment as measured at **the Grant Recalculation Date** (the day after the end of the Add Period)

Review our [**Understanding Enrollment Requirements**](../../resources/understanding-enrollment-requirements.shtml) page for details on how your Pell Grant is impacted by the number of units you are enrolled in (your enrollment intensity).
...
[Federal Student Grant Programs Factsheet (PDF)](https://studentaid.gov/understand-aid/types/grants)
...
The TEACH grant is not included in the initial financial aid package, but can be offered retroactively to eligible students during the award year.
...
* Complete the *Credential - TEACH Grant Request (2025-26)* available online at [cpp.studentforms.com](https://cpp.studentforms.com)
...
* After our Grant Recalculation Date (the end of the Add Period), TEACH grant will be reviewed, adjusted and disbursed based on the student's enrollment in program eligible units.
...
State Grants are available for California residents only – or those who meet the [AB540 eligibility criteria](https://www.csac.ca.gov/post/california-nonresident-tuition-exemption); eligibility for these grants is determined by the California Student Aid Commission (CSAC).
...
Grants are released according to the number of units you are enrolled in each semester. At the Grant Recalculation Date (the day after the end of the Add Period), financial aid grants are adjusted for enrollment that is less than full time.
...
* Be a California Resident or have an [approved AB540 status](https://www.cpp.edu/admissions/other-resources/residency.shtml) with Cal Poly Pomona
...
If you meet the above criteria, submit the [G-44 form](https://www.csac.ca.gov/post/request-cal-grant-teaching-credential-program-benefits) to the California Student Aid Commission as soon as you have completed your Aid Application.
...
Final enrollment for a semester is measured at our **Grant Recalculation Date** (after the last day of the Add Period). During the Recalculation Date, Financial Aid grants are revised for students enrolled less than full-time to match eligibility based on the actual number of unitsin which students are officially enrolled**.** The student's enrollment and grant is then locked.

### **Cal Grant Award Information**

Award information is available online at [WebGrants for Students](https://mygrantinfo.csac.ca.gov/logon.asp). To set up your account (if you haven't already done so), log in and click on "Cal Grants."
...
1. Create your account on CSAC's site [WebGrants for Students](https://mygrantinfo.csac.ca.gov/logon.asp) and make sure **Cal Poly Pomona** is listed as your school of attendance.
2. Check your [WebGrants for Students](https://mygrantinfo.csac.ca.gov/logon.asp) account to see if your award is on hold. There should be instructions regarding how to release the hold.
...
The**Golden State Teacher Grant (GSTG) Program**awards students currently enrolled in a professional preparation program approved by the Commission on Teacher Credentialing (CTC) and working towards earning their preliminary teaching credential.
...
* Submit a [Golden State Teacher Grant Program Application](https://gstg.csac.ca.gov/).
* Submit a Free Application for Federal Student Aid ([FAFSA® Application  Federal Student Aid](https://studentaid.gov/h/apply-for-aid/fafsa)) or CA Dream Act Application ([CA Dream Act Application](https://dream.csac.ca.gov/landing)).
...
In addition to the above eligibility criteria, 2024-25 and 2025-26 GSTG applicants have varying additional eligibility restrictions, maximum award amounts, awarding prioritizations, funding restrictions, and service obligations:

|  |  |  |  |
| --- | --- | --- | --- |
|  | **Cohort 1** | **Cohort 2****(2024-25 only)** | **Cohort 3** |
| **Description** | GSTG recipients paid less than the maximum award in 2020-21, 2021-22, 2022-23, or 2023-24 who continue to meet program eligibility criteria. | New 2024-25 applicants who submitted their GSTG application on or prior to 6/30/2024. | New 2024-25 and 2025-26 applicants who submit their GSTG application after 7/1/2024 **and** new 2024-25 applicants moved from Cohort 2 due to awarding prioritization and funding restrictions. |
| **Additional Eligibility Restrictions** | None. | None. | Intern credential programs do not qualify for GSTG participation. |
| **Maximum Award** | $20,000 | $20,000 | $10,000 |
...
**There is a service requirement tied to receiving GSTG funds.**The commitment is documented in the [Cohort 1 and 2 Service Agreement (SA)](https://www.csac.ca.gov/sites/default/files/2024-08/cohorts_1_and_2_gstg_service_agreement_sample_august_2024.pdf) and [Cohort 3 Service Agreement](https://www.csac.ca.gov/sites/default/files/2024-08/cohort_3_gstg_service_agreement_sample_august_2024.pdf). No funds are paid until the SA is accepted by the participant.
...
[2025-26 GSTG Priority Schools List](https://www.csac.ca.gov/sites/default/files/2025-04/2025-26_gstg_priority_schools_list.xlsx)

[2024-25 GSTG Priority Schools List](https://www.csac.ca.gov/sites/default/files/file-attachments/2024-25_gstg_priority_schools_list.xlsx)

[2025-26 GSTG CSPP List](https://www.csac.ca.gov/sites/default/files/2025-04/2025-26-GSTG-CSPP-List.xlsx)

[2024-25 GSTG CSPP List](https://www.csac.ca.gov/sites/default/files/file-attachments/2024-25_gstg_cspp_list.xlsx)
...
**STEP 1**: Submit a Free Application for Federal Student Aid ([FAFSA | Federal Student Aid](https://studentaid.gov/h/apply-for-aid/fafsa)) or CA Dream Act Application ([CADAA](https://dream.csac.ca.gov/landing)).

**STEP 2**: Submit a [Golden State Teacher Grant (GSTG) Application](https://gstg.csac.ca.gov/).
...
[GSTG Frequently Asked Questions FAQ](https://www.csac.ca.gov/sites/default/files/2025-07/GSTG_Frequently_Asked_Questions_July2025.pdf)

### Cal Poly Pomona Grants

**C****al Poly Pomona****Grants are available to FAFSA or DREAM Applicants.**

***Priority filing deadline for Cal Poly Pomona Grants for 2025-2026 is April 2, 2025!***

Cal Poly Pomona Grants are available for California residents only – or those who meet the [AB540 eligibility criteria](https://www.csac.ca.gov/post/california-nonresident-tuition-exemption).  By filing the FAFSA or Dream Application by the priority filing deadline, eligible students may be considered for a Cal Poly Pomona Grant.

Grants currently available from Cal Poly Pomona include:

## **State University Grant (SUG):**

**The State University Grant is available only for your initial credential.** SUG awards are available only to California residents (or eligible AB540 students) working on their initial credentials, who filed their FAFSA or Dream Application.  Eligibility is determined by the FAFSA or DREAM Application – including meeting the Priority Filing deadline.

The State University Grant (SUG) is a state grant awarded by Cal Poly Pomona to California residents who have an eligible Student Aid Index (SAI). **For 20****25 – 2026 the eligible SAI for Credential Students is set at -1,500.**

Since funds are limited, you must have submitted your financial aid application by the priority deadline in order to be considered for SUG.
...
| --- | --- | --- |
| **Senior or Teacher Credential Student (60+units)** | **$5,500**   If qualified, up to $5,500 may be in subsidized loans | **$12,500**   If qualified, up to $5,500 may be in subsidized loans |
| **Aggregate (or Lifetime) Borrowing Limit for Credential Students** (includes amounts borrowed as Undergraduates) | **$31,000**   If qualified, $23,000 may be in subsidized loans | **$57,500**   If qualified, up to $23,000 may be in subsidized loans |

For Credential Students who are considered to be Dependent Students for financial aid purposes, Federal Loans are also available for parents to cover the student’s remaining education costs.  [**PLUS** (Parent Loans for Undergraduate Students)](https://studentaid.gov/understand-aid/types/loans/plus/parent)  are Federal Direct Loans in which the parent of a dependent student is the applicant/borrower.

### **Impact of Enrollment on Direct Loans:**

In general, Direct Loans are not pro-rated based on enrollment.  However, you must be enrolled at least half-time (6 units) in coursework required for your credential program in order to be eligible to receive funds from the loans.  if you are not enrolled in at least 6 units of coursework required by the State of California for your credential program, you will not be eligible for your loan funds – and your loan will be canceled for the semester.

*All staff members of the Office of Financial Aid*   *and Scholarships*   *at Cal*   *Poly Pomona*   *adhere to*   [*The California State University Student Lending – Code of Conduct (PDF)*](https://www.calstate.edu/apply/paying-for-college/financial-aid/Documents/CSU_CodeofConduct_StudentLending.pdf)   *, which restricts activity that may lead to conflicts of interest in the area of student lending*
...
3. Your parent must log in with *their* [Federal Student Aid ID (FSA ID)](https://studentaid.gov/) - *not yours*
...
Review our [Parent PLUS Loan Instructions Guide (PDF)](../../forms/parent_plus_borrower_instructions.pdf) for step-by-step instructions (including screen captures).
...
If the Parent PLUS Loan is denied due to credit history, the U.S. Department of Education will send the parent information about appealing the credit decision or using an endorser/cosigner.  Review our [Parent PLUS Instructions Guide (PDF)](../../forms/parent_plus_borrower_instructions.pdf) for more information on the steps involved if the parent is credit denied.  The Federal Student Aid [website for parent borrowers with adverse credit history](https://studentaid.gov/understand-aid/types/loans/plus/parent#adverse-credit) provides additional guidance.

If the parent does not pursue these options, the student may be eligible to add up to an additional $5,000 to their Unsubsidized Loan for the aid year for a junior or senior.

*All staff members of the Office of Financial Aid at Cal**Poly Pomona**adhere to*[*The California State University Student Lending – Code of Conduct (PDF)*](https://www.calstate.edu/apply/paying-for-college/financial-aid/Documents/CSU_CodeofConduct_StudentLending.pdf)*, which restricts activity that may lead to conflicts of interest in the area of student lending*
...
* [Federal Student Loan Forgiveness Program for Teachers](https://studentaid.gov/manage-loans/forgiveness-cancellation/teacher): A loan forgiveness program offered by the federal government and administered by the Department of Education.
* [Loan Forgiveness for Public Service Employees](https://studentaid.gov/manage-loans/forgiveness-cancellation/public-service): A loan forgiveness program offered by the federal government and administered by the Department of Education.
...
* Your lender should provide you with a copy of the required **Private Education Loan Self-Certification Form**.
  ...
  + If you receive financial aid, this information can be found on your Financial Aid Summary in your [MyCPP Student Center](https://my.cpp.edu/).  Otherwise, refer to the [Costs page](../../undergraduate/newly-admitted/costs.shtml) on our website.
* Send your completed **self-certification form** to your lender. Your loan cannot be disbursed until your lender receives it.

*All staff members of the Office of Financial Aid & Scholarships at Cal Poly Pomona adhere to*[*The California State University Student Lending – Code of Conduct (PDF)*](https://www.calstate.edu/apply/paying-for-college/financial-aid/Documents/CSU_CodeofConduct_StudentLending.pdf)*, which restricts activity that may lead to conflicts of interest in the area of student lending**.*
...
For more information, contact your local [County Veterans Service Office](https://www.calvet.ca.gov/VetServices/Pages/CVSO-Locations.aspx). You can also contact Samuel Kim, the VA Certifying Official for Cal Poly Pomona.
