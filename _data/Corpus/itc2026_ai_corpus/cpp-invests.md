**Source:** https://www.cpp.edu/cpp-invests
...
![](img/banners/icorps-topbanner-v3-02-01.png)

1. [CPP](https://www.cpp.edu)
2. [CPP INVESTS](index.shtml)
3. CPP INVESTS

# CPP INVESTS

![](https://www.cpp.edu/learndiscovery/img/hatchery/teams/team-fj.jpg)
...
### Faculty and Staff Summer Conference

|  |
| --- |
| **Date:**May 28 - 30, 2025  **Time:** Wednesday - 08:30-4:00pm | Thursday - 08:30-4:00pm | Friday - 08:30 AM - 1:00 PM  **Format:**In Person, CBA Building  **Topic:**TBA |

[Register](https://www.cpp.edu/ai-summer-conference/future-of-work.shtml "Register. ")

### First Year Experience (FYE) Learning Experience (LC)

|  |
| --- |
| **Date:**Fall 2024 - Thursdays: 9/12, 9/26, 10/10, 10/24, 11/7, 11/21, 12/5  **Time:** Thursdays - 11:45-1:00pm  **Format:**In Person, Building 4, 2nd Floor, Room 314  **Overview:**This Learning Community is for STEM staff and faculty (tenure track faculty and adjunct faculty) who teach or may be interested in teaching a First Year experience (FYE) class. |
...
|  |
| --- |
| **Date:**Year-round  **Time:** Varies  **Format:**Online via Zoom/In Person  **Overview:**Micro-Internships are a great way for students and recent graduates to gain professional experience and get a taste of the real-world tasks and projects you'll be working on as a new hire or intern. |
...
Micro-Internships are a form of brief and compensated professional assignments, similar to those given to new hires or interns, that allow students and recent graduates to gain valuable experience and demonstrate their skills. These internships are typically short-term, lasting between 5-40 hours and completed in one week to one month.

###### How they can help you

Micro-Internships are an excellent opportunity when you're starting your career, giving you the chance to gain real-world experience and build your professional skillset. Explore different career paths, work on exciting projects, and showcase your abilities to potential employers, all while building your portfolio and network. It's a great way to gain a competitive edge as you begin your journey.

[Apply Now](https://info.parkerdewey.com/cpp)

Close

### Project Learning Assistant (PLA)

|  |
| --- |
| **Date:**Train in the Spring, Work in the Fall  **Time:** Varies  **Format:** Online via Zoom/In Person  **Overview:**CPP INVESTS is currently recruiting sophomore and junior STEM students who want to give back to the educational community by becoming Project Learning Assistants (PLAs). PLAs serve as student mentors and assist faculty in project based learning in the First Year Experience (FYE) courses. |
...
As a Project Learning Assistant, you will develop leadership skills, manage group dynamics, and learn research skills in Spring to work under a faculty member in Fall. Sophomores, Juniors, and continuing Seniors students are welcomed and will be trained in the Spring term. Students will receive a $200 stipend for training. In Fall, students will have the opportunity to be hired and be paid hourly!
...
[Apply Now](https://forms.office.com/pages/responsepage.aspx?id=HqZLFuw5XU-J_6ofAKUhtDfkuGkzINdOhslxlfkezbJUMEFGNjhEUFAzSzNCN1g2SlZZOFNGMzRDTC4u)
...
|  |
| --- |
| **Date:**Fall 2024 and Spring 2025 (TBA)  **Time:** Varies  **Format:** Online via Zoom/In Person  **Overview:**The training institute is designed to equip educators with the knowledge and skills to teach in an equitable way that aligns with Cal Poly Pomona's mission to deliver an inclusive polytechnic education to all students and close equity gaps |

Register

### Professional Development (PD) for USC Equity-Minded Teaching Institute
...
| --- | --- | --- |
| Active learning, equity-minded classroom observation, & peer coaching workshop |  | Required in person |
...
| October Zoom group check in |  | Recommended.  Via Zoom. |
| December wrap-up and assessment |  | Required in person |
...
| **Activity** | **Date/time** | **Requirement** |
| --- | --- | --- |
| Active learning, equity-minded classroom observation, & peer coaching workshop 2.0 |  | Required in person |
...
| March Zoom group check in |  | Recommended |
| May wrap-up and assessment |  | Required in person |
...
### CUREs Learning Community (LC)

|  |
| --- |
| **Date:**2024-2025: once a month  **Time:** TBA  **Format:**In Person  **Overview:**Embed CUREs in second year STEM gateway courses. |
...
[Meet the Project Team](about-us/meet-team.shtml "Meet the Project Team. ")

![](img/icons/document.png)

[Project Summary](documents/invests-project-summary-fnl.pdf "Project Summary. ")
...
* [Year 1 Outcome Report](documents/invests-year-1-outcome.pdf)
* [Year 2 Outcome Report](documents/invests-year-2-outcome.pdf)
* [Year 3 Outcome Report](documents/invests-year-3-outcome.pdf)
