**Source:** https://www.cpp.edu/health/health-services/travel-immunizations.shtml
...
* All immunizations at Health Services are scheduled by appointment, and you will be asked to remain for 20 minutes afterwards to ensure no reaction.
* Please call 909-869-4000 for your appointment unless instructed otherwise (appointments CANNOT be made online).
* Choose from the drop down menu on the left for more details.

Available Immunizations

*[Call for current pricing; Prices are subjected to change without notice]*

* Hepatitis A Vaccine (Adult) - 2 doses  - $43.00 per dose
* Hepatitis B Vaccine (Adult) - 3 doses - $52.00 per dose
* Menactra - 1 doses - $135.00 per dose
* Mumps-Measles-Rubella Vaccine (MMR) - $86.00 per dose
* PPD/Tb Skin Test (requires 2 appts.) - **No Charge**
* Tdap (Tetanus, Diptheria/Pertusis) - **No Charge**
* Td (Tetanus/Diptheria) - **No Charge**
* Typhoid (Oral) - $94.00 per dose
