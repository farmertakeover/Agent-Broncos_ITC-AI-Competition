**Source:** https://www.cpp.edu/fpm/pdc/master-plan/events.shtml
...
*Purpose:  This meeting provides the public an opportunity to learn about the CPP Master Plan Update Draft Environmental Impact Report (EIR) and options to comment on the document.*

---

[NOA Notice (PDF)](cpp-mp-eir-noa-05072025.pdf)
...
CPP Master Plan Update EIR Scoping Meeting

*Purpose:  This meeting provides information about the project,**EIR process, and how to comment on the EIR scope.*

---

[NOP Notice (PDF)](../docs/cpp-mp-nop_acc.pdf)
