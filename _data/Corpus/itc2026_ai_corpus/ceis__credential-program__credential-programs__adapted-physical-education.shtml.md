**Source:** http://www.cpp.edu/ceis/credential-program/credential-programs/adapted-physical-education.shtml
...
**[Click here for information if you are a non-single subject PE credential student or teacher (PDF)](../docs/semester-ape-aa-non-credential-sspe.pdf)**

**[Click here for information if you are a single subject PE credential student or teacher (PDF)](../docs/semester-ape-aa-credential-sspe.pdf)**

The program is offered by the: College of Education and Integrative Studies, Education Department and College of Science, Kinesiology and Health Promotion Department.
...
| \*KIN 4310AS Student with Disabilities Field Experiences  ***\*KIN 4310AS must be taken two times. Co-requisites: KIN 4330S and KIN 4340*** | 1 (2x) | Fall/Spring |
...
| \*KIN 4360 Clinical Practice in Adapted Physical Education  ***\*Not needed if completing single subject PE credential concurrently*** | 3 | Spring |
| KIN 4370 Adapted Physical Education Candidate Assessment | 1 | Spring |
...
Email: lkillick@cpp.edu.edu

**Information about the Cal Poly Pomona Motor Development Clinic can be found here**:  [Motor Development Clinic](https://www.cpp.edu/~sci/motor-development-clinic/)

**Information about the SEEDS scholarship can be found here:**  [SEEDS Scholarship](https://www.cpp.edu/~ceis/seeds/index.shtml)
