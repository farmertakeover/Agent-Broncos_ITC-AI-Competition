**Source:** https://www.cpp.edu/brand/about-the-campaign.shtml
...
* A refreshed [website](http://www.cpp.edu/) geared to prospective students that makes enrollment and degree program information more visible and accessible
...
[Watch the Forum](https://streaming.cpp.edu/media/1_qj39ay8p%20)

![The University Libary Become by Doing](img/library-become-by-doing-sneak-peek.gif)
...
### When did the campaign and new branding launch?
...
![The Logo Family. CPP logo, seal and athletics logo.](img/logo-family.jpg)

### Will we still use “Learn by Doing”? Does “Become by Doing” replace it?

We will use both. We’ll continue to use “learn by doing” to describe the CPP Polytechnic Experience that we offer our students. However, because the phrase is used by other schools, we’re using “[Become by Doing](https://www.cpp.edu/aboutcpp/become-by-doing.shtml)” as the slogan for the campaign. This is unique to us and illustrates the outcomes that our students attain when they “learn by doing.”

### Did you engage the campus community in the rebranding decisions?
...
### What agency did this rebranding work?

The university contracted with [160over90](https://www.160over90.com/), a global creative agency with deep experience in marketing and branding for higher education (including San Diego State University and UCLA) and consumer products. 160over90 is not the same agency that was used in 2018.

### Why did we need to hire an agency to help us with a campaign?
...
### How do we know rebranding will turn out better than the last time we did it?
...
### How much will this cost? How is CPP paying for this? How does the cost compare to others?
...
![Investment: Budgeted an Spent (Philanthropic Sources over 3 years).](img/investment-budgeted-and-spent.jpg)

### How does this initiative interact with the look and feel of our colleges, programs and more?
...
### Does the look and feel of colleges, programs and more have to align with the university’s?

Yes. We want to look cohesive so that students recognize our great colleges and programs as part of one university.

### Will campus communicators have any freedom to create assets for their colleges or programs?

Yes, as long as they fit within our new branding and follow the new [brand guidelines](authenticated/cpp-brand-guidelines.pdf). Strategic Communications is providing communicators with tools and training to help with this process.

### The logo or mark we use for our program is well established and we like it. Can we keep using it?

The campaign includes a new structure for branding all units of the campus. Using this structure, our campus logos and marks will fit together as a “family” and further strengthen recognition of the CPP brand. The new [brand guidelines](authenticated/cpp-brand-guidelines.pdf) lay out the structure for colleges, programs, events, etc. In limited cases where the current logo is firmly established and beloved, we will consider the benefits of retaining it.

### What questions were asked at the community forums?

Between the two community forums, we had nearly 200 attendees and over 50 questions. You can read all the questions and answers in [this PDF](authenticated/community-forums-qa.pdf).
