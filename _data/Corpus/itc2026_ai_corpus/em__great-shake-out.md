**Source:** https://www.cpp.edu/em/great-shake-out
...
![When an Earthquake Strikes](../files/whenanearthquakestrikes-poster-2025.jpg)
...
![Drawing of a family discussing their emergency plan at a dining table](https://www.earthquakecountry.org/library/step2wideicon.png)

![Drawing of two people securing a bookshelf and water heater to prevent them from falling in an earthquake](https://www.earthquakecountry.org/library/step1wideicon.png)

![Drawing of a parent and child organizing disaster supplies in a backpack and a larger container](https://www.earthquakecountry.org/library/step3wideicon.png)

## During the Earthquake

* DROP, LOCK, COVER, and HOLD ON when the earth shakes.

![Drawing of a family protecting themselves during an earthquake, under a table and in a wheelchair](https://www.earthquakecountry.org/library/step5wideicon.png)
...
![Drawing of people after a quake cleaning up debris, helping the injured, and moving to high ground in case of tsunami.](https://www.earthquakecountry.org/library/step6wideicon.png)
...
* Faculty and staff should ensure their information is updated in the Emergency Notification System by logging into the [Safety Alert website](https://www.cpp.edu/em/emergency-communication/safety-alert-system.shtml) or call the IT Help Desk at (909) 869-6776.
