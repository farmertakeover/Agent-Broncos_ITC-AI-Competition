**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/call-to-action-cards.shtml
...
# Call To Action Module Tutorial

## Instructions

In this Module it is required to have at least one Call to Action Card, The max number of allowable

You can find images available for download and usage at the page.

[Call-to-Action Images](call-to-action-images.shtml)

***Page View***

![](../img/call-to-action-cards-shtml.jpg)

 This entire section is optional, but if you choose to use it, you will need:
...
![call to action cards](../img/call-to-action-cards.jpg)
