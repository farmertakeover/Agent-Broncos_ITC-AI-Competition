**Source:** https://www.cpp.edu/international/students/u-s-employment/stem-opt.shtml
...
2. Completed an appropriate degree in one of the [DHS-approved STEM fields](https://studyinthestates.dhs.gov/stem-opt-hub/additional-resources/eligible-cip-codes-for-the-stem-opt-extension)
3. Be employed in a **paying job,**minimally 20 hours per week, by an employer who is registered with the [E-Verify](https://www.e-verify.gov/) employment verification system.
...
### 1. Verify Your Major is STEM OPT Eligible

The major code on your I-20 must be listed on the Department of Homeland Security’s [STEM Designated Degree Program List](https://studyinthestates.dhs.gov/eligible-cip-codes-for-the-stem-opt-extension) at the time of application.

### 2. Fill Out Form I-983

* Download [Form I-983](https://www.ice.gov/sites/default/files/documents/Document/2016/i983.pdf) and [instruction](https://www.ice.gov/doclib/sevis/pdf/i983Instructions.pdf).
...
|  |  |
| --- | --- |
| **Student Last Name** | **Assigned Advisor** |
| Ending with Letters A-L | Lisa Nguyen, lisalnguyen@cpp.edu |
| Ending with Letters M-Z | Junko Takada, jtakada@cpp.edu |
...
### 3. Request STEM OPT I-20

* **Before you request for the STEM OPT I-20, you must check on your current I-20 and see if the CIP code on the first page of your I-20 is in the [eligible STEM major list](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.ice.gov%2Fsevis%2Fschools%23dhs-stem-designated-degree-program-list-and-cip-code-nomination-process&data=05%7C02%7Cmbotello%40cpp.edu%7Ce909155b4bdb4db3e96708dc78e92a36%7C164ba61e39ec4f5d89ffaa1f00a521b4%7C0%7C0%7C638518190051044442%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C0%7C%7C%7C&sdata=%2F58QG4vMr%2B8d%2BLO%2BjLtC6UCnT04fXtMnk%2FuHcTIZqAQ%3D&reserved=0 "Original URL: https://www.ice.gov/sevis/schools#dhs-stem-designated-degree-program-list-and-cip-code-nomination-process  Click to follow link.") for STEM OPT extension or not. Please note that it is your responsibility to verify this information, not the DSO’s responsibility. Not every STEM discipline major is in the eligible list.**
* Log into the new [international student portal](https://www.cpp.edu/international/students/isso-forms/index.shtml). To request STEM OPT. If you have difficulty, please email international@cpp.edu
...
### 4. Fill Out Form I-765, Application for Employment Authorization
...
[**Here**](../img/guidance-for-online-filing-i-765-stem-opt.pdf) is the guideline on online filing of I-765 for the STEM OPT Extension application.
...
* Agrees to follow the [terms of STEM OPT](https://studyinthestates.dhs.gov/employers-stem-opt-reporting-requirements) and complete the employer-specific sections of the [I-983 Training Plan](https://studyinthestates.dhs.gov/form-i-983-overview)
...
#### All reporting must be completed via **[STEM OPT REPORTING](https://cpp-isss.terradotta.com/_portal/)**. Email submission will not satisfy the reporting requirements.

### OPT Cap-Gap Extension

The Cap-Gap Extension is an automatic extension of F-1 status and work authorization past the EAD End Date, for students transitioning to an H-1B work visa. Please visit the [OPT Cap-Gap Extension page](opt-cap-gap-extension.shtml) for additional information.

## Validating SEVIS Information (every 6 months)
...
SEVP Portal users will [receive a reminder](https://studyinthestates.dhs.gov/sevis-help-hub/student-records/fm-student-employment/sevis-and-the-sevp-portal/portal-email-notices) via email 30 days before any validation report is due. Please note that **STEM OPT students must report a change in this information, including any loss of employment, within 10 days of the change.**

[**Report Now**](https://sevp.ice.gov/opt/)

## Annual Self-Evaluations (12 months and 24 months)
...
SEVP Portal users will [receive a reminder](https://studyinthestates.dhs.gov/sevis-help-hub/student-records/fm-student-employment/sevis-and-the-sevp-portal/portal-email-notices) via email 30 days before their self-evaluation is due. For more information about the annual self-evaluation, please visit the [Students and the Form I-983 page](https://studyinthestates.dhs.gov/stem-opt-hub/for-students/students-and-the-form-i-983).
...
If a STEM OPT student believes that their STEM OPT employer is not complying with the terms and conditions of the 24-month STEM OPT extension regulations, the [Form I-983 instructions](https://www.ice.gov/doclib/sevis/pdf/i983Instructions.pdf), and the completed [Form I-983](https://www.ice.gov/doclib/sevis/pdf/i983.pdf) on file with their DSO, the student may:

* Contact the Student and Exchange Visitor Program at the U.S. Immigration and Customs Enforcement (ICE) by following the instructions found on [ICE.gov](https://www.ice.gov/sevis/contact).
* Report violations through this Homeland Security Investigations [tip submission form](https://www.ice.gov/webform/ice-tip-form).
...
If you change employers, fill out [Form I-983](https://studyinthestates.dhs.gov/stem-opt-hub/additional-resources/form-i-983-overview) (list the information of the new employer) and [report the change](https://sevp.ice.gov/opt/) to the ISSO. Employment changes must be reported **within 10 days**.
