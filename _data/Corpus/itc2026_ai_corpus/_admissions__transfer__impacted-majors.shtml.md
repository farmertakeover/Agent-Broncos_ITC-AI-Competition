**Source:** https://www.cpp.edu/~admissions/transfer/impacted-majors.shtml
...
![CPP Students](../img/cppstudents2)

## Program Impaction

"Program Impaction" occurs when more students apply to a major than the program can accommodate. Cal Poly Pomona currently has 19 impacted programs at the transfer level. Applicants to these majors are held to higher admission standards based on available space.

![Local Area Preference](../img/students-mural.jpg)

## Local Area Preference

Transfer applicants to impacted majors receive "Local Preference" if most of their transferable units or an Associate Degree for Transfer (ADT) were earned at a local community college. Cal Poly Pomona also gives this preference to all veterans and offers additional consideration to Chaffey College and Rio Hondo College students. Visit the Local Preference page for details.

[Local Area Preference](https://www.cpp.edu/admissions/transfer/local-area.shtml%20)
...
| --- | --- | --- |
| Animal Health Science\* Animal Science (General)\* | General Chemistry I & Lab | CHM 1210/L |
|  | Basic Bio & Lab | BIO 1150/L or BIO 1210/L |
|  | Statistics | STA 1200 |
| Animal Science (Pre Vet)\* | General Chemistry I & Lab | CHM 1210/L |
|  | Foundations of Bio/Lab | BIO 1210/L |
|  | Statistics | STA 1200 |

\*Beginning Fall 2026:

Priority Consideration - Applicants with a 3.0 GPA and completion of all supplemental courses receive priority consideration.

Traditional Consideration -  If space remains available (after "Priority Consideration"), all CSU-eligible applicants are considered, regardless of whether they have completed all supplemental courses. However, GPA and completion of additional supplemental courses will be taken into account during this process to further prioritize applicants.
...
\*Beginning Fall 2026, programs will have both required and recommended coursework.
...
| General Chemistry I & Lab | CHM 1210/L |
| General Chemistry II & Lab | CHM 1220/L |
| Kinesiology  (General option only) | Basic Biology & Lab or Foundations of Biology & Lab | BIO 1150/L or BIO 1210/L |
| Statistics | STA 1200 |
...
Visit [assist.org](https://assist.org/) or [Transfer Evaluation Services](https://www.cpp.edu/registrar/evaluation-transfer-credit/articulation-agreements.shtml) (TES) for course articulations.
