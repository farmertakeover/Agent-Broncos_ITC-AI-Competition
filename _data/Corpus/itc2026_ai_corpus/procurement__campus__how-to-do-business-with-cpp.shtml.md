**Source:** http://www.cpp.edu/procurement/campus/how-to-do-business-with-cpp.shtml
...
* [Vendor Data Form (STD.204 form) (PDF)](https://www.cpp.edu/fas/university-accounting-services/docs/Accounts%20Payable/vendordatarecordoct2019.pdf)
* [Vendor Profile Form (PDF)](docs/vendor_data_profile_digital-signature.pdf)
...
* [Voluntary Statistical Data Sheet (PDF)](docs/voluntarystatdatacpp.fillable.pdf)

***Note: All vendors doing business with the State of California are required to complete a Vendor Data Record (std. 204 Form), prior to payment. This information is utilized for 1099 reporting and for withholding on payment to******nonresident vendors. Timely completion on this form will ensure payments will be process****e****d without delay.***
