**Source:** https://www.cpp.edu/drc/faculty-resources/faculty-communication-access.shtml
...
* DRC Staff may need access to your Canvas Course to facilitate these services. DRC may work directly with Center for the Advancement of Faculty Excellence (CAFE) to add staff or ask the instructor for assistance. More details can be found on our [DRC Staff Role on Canvas](https://www.cpp.edu/drc/faculty-resources/drc-role-canvas.shtml) webapge.
...
* Keeping the[Zoom application updated](https://support.zoom.us/hc/en-us/articles/201362233-Upgrading-Zoom-to-the-latest-version) to the most-recent release
* Ensuring the student receiving accommodations is placed in the same breakout rooms as their captioners or interpreters
* Enabling [Zoom multi-pinning](https://support.zoom.us/hc/en-us/articles/201362743-Pinning-participants-videos) feature for classes with sign language interpreting
* Adding DRC staff as [Zoom co-hosts](https://support.zoom.us/hc/en-us/articles/206330935-Enabling-and-adding-a-co-host) upon request. This will allow the service providers to assist with setting-up multi-pinning or seeing which breakout rooms the DRC student is in so that they can continue to serve the student.

Please contact the DHH coordinators drcdhh@cpp.edu with any questions about facilitating in-class accommodations.
...
All videos created in or uploaded to [CPP Streaming/Kaltura](https://streaming.cpp.edu/), CPP’s recommended video streaming service, will have auto-generated captions added to the content. Faculty have the ability to [review and edit the auto-generated captions for accuracy](https://streaming.cpp.edu/media/0_ts4cv5vl), and are encouraged to do so for all of their instructional media.
...
1. Upload content to [CPP Streaming/Kaltura](https://streaming.cpp.edu/), If you're unsure how to do this, please refer to [CAFE’s Kaltura quick start guide](https://www.cpp.edu/cafe/teaching-and-learning/quickstart-tutorials.shtml).
...
Instructors should review captions in videos created by others. If the captions are missing or inaccurate, instructors may [submit a request to MediaVision](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=ce5441846fcdce0025ce9e4eae3ee4db) to have captions added. Instructors who received a Faculty Notification Letter that a student in their class has requested Deaf & Hard of Hearing Accommodations and requires professional captions, should be sure to check the box that a DRC student enrolled in the class requires captions. Once captions have been added, instructors will be provided with new links to the content to use for the class.
...
### Add DRC Staff to Canvas Course
...
1. Log into [CPP Canvas](https://canvas.cpp.edu)
2. Open your course
...
More information about the manual enrollment process in Canvas can be found here on [Canvas' Instructor Guide.](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-add-users-to-a-course/ta-p/1119)

### Tips for Working with Interpreters

Check-out some quick [Tips for Working with Interpreters](https://sway.cloud.microsoft/SYrFQoGs33yenJ6w?ref=Link)

### Zoom Multi-pinning Settings
...
[American Sign Language (ASL) Interpreting Request for a Campus Event](https://cascade.accessiblelearning.com/CPP/CustomRequest.aspx)
...
### Americans with Disabilities Act (ADA) and CSU Executive Orders
...
### When will I know that a captioner or interpreter has been assigned to my class?

Students can request accommodations at any time, once a student is approved the professor will be notified.

### Where will the Realtime Captioner(s) or Interpreter(s) sit?
...
### What are the service providers responsibilities in the classroom?

The service providers will caption/interpret lectures and class discussions. Communication with the Deaf or Hard of Hearing (DHH) student will also be facilitated. It is the captioners responsibility to caption everything you say.

### What is the best way to help the service providers assigned to my class?

Sharing handouts, power point presentations, and access to Canvas will provide a good preview of the lecture.

### How do I talk to a deaf or hard of hearing student?
...
### How can I help the student receive the most benefit from my lecture?

Sharing handouts and power point presentations will provide a good preview of the lecture.

### If I show a video or DVD in class, does it need to be captioned?
...
### How do I request captioning for media used in my class?
...
Contact IT & IP eHelp for captioning requests [Service Catalog - eHelp.](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=ce5441846fcdce0025ce9e4eae3ee4db)
