**Source:** http://www.cpp.edu/sci/kinesiology-health-promotion/about-the-department/mission-vision-and-values.shtml
...
![KHP is the place to be](../img/khp-banner-image.jpg)

## **The KHP Strategic Objective**

***Investigate ways to advance the art and******science of health and human movement***

KHP has added definitions that represent cornerstone behaviors we embrace to shape the culture we desire. These principles guide our internal conduct and external relationships to ensure we stay true to our strategic objective and provide a critical foundation for developing the goals and strategies that follow in this plan.

***CURIOSITY***
We encourage and model an open-minded and holistic approach to life-long learning and wellness. ***INTEGRITY***
We exhibit soundness of character and an unwavering moral compass. ***COLLABORATION***
We combine our strengths in affirming, proactive and creative ways.

***INCLUSIVITY***
We foster diversity appreciation and equity for all individuals and maintain an adaptable curriculum. ***INNOVATION***
We take risks with creative, outside the box thinking and planning to maximize our resources to best serve our students and community.

## **A Framework for the Future: The Department of Kinesiology and Health Promotion**
...
#### **FOCUS AREA:** DEFINE THE MISSION AND IDENTITY OF KHP

**Goal #1 -**KHP appreciates the diverse ways each sub-discipline advances the art and science of health and human movement.

#### **FOCUS AREA:** REVISE THE CULTURE TO BE MORE SUPPORTIVE AND INCLUSIVE

**Goal #2 -**KHP is a welcoming and supportive environment for students, faculty and staff.
**Goal #3 -**KHP fosters a culture of professional respect, cohesion and inclusivity.

#### **FOCUS AREA:** DESIGN AND COMMUNICATE OUR CUTTING-EDGE CURRICULUM

**Goal #4 -**KHP is a destination department for innovators, educators and scientists in health and human movement.

#### **FOCUS AREA:** PRIORITIZE STUDENT SUCCESS FOR NOW AND FOR THEIR FUTURE

**Goal #5 -**KHP provides educational experiences to build leaders in health and human movement.
