**Source:** https://www.cpp.edu/health/my-health-portal.shtml
...
We use a secure, online portal to your health record entitled [My Health Portal (opens in new window)](https://myhealthportal.cpp.edu/home.aspx "My Health Portal"). This web portal allows you, as a patient to:
...
[Access My Health Portal](https://myhealthportal.cpp.edu/home.aspx)

## FAQ's

### Is my sensitive health information secure via the internet?

This system will encrypt your information and send it securely without Google or any other search engine being able to decipher it. Rest assured, we are adhering to the highest quality standards of security available.

### Why do I need to fill out a health history form or consent to treat first?
...
### I accidentally hit 'submit' for my health history before I was finished — what can I do?
...
### How can I send a secure message to a specific provider or staff member?
...
### How will I know if I received a response to my secure message?
...
*"You have a new message from your Student Health Services. To access your messages, please go to the Student Health Services website, @ www.cpp.edu/~healthcounseling, log-in to My Bronco Health Manager, and your Inbox for messages.*

*(Please do not reply to this message)"*

Go to your [My Health Portal (opens in new window)](https://myhealthportal.cpp.edu/home.aspx "My Health Portal"), log in, and then click on "Messages" on the green menu bar. You will see an Inbox of any messages.

### How can I schedule an appointment online?

Our online appointment scheduling system is configured to only show a range of available appointments up to 16 hours in advance. Go to [My Health Portal (opens in new window)](https://myhealthportal.cpp.edu/home.aspx "My Health Portal") and select "Make an appointment." If you wish to schedule a future appointment beyond 16 hours in advance, you will need to call 909-869-4000.

### Will I be able to view all of my upcoming appointments?
