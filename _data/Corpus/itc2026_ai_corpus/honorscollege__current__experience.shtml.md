**Source:** http://www.cpp.edu/honorscollege/current/experience.shtml
...
## KHC Honors Symposium, Research Scholarly and Creative Activities Conference

![Crowd of people talking near research posters](../img/rsca2025.jpeg)

![Group of people talking at a table with stuff on it](../img/khcstudentpresentingrsca.jpeg)

![A group of students standing in front of a research poster](../img/grouprscaposter.jpeg)
...
The KHC is committed to supporting students by guiding them through their ELE project, ensuring they stay on track and complete it with confidence. The timelines below are recommended timelines for students to complete their projects. They are ideal but can be modified to adjust to your specific graduation goals. Work with the KHC Director or KHC Advisor to develop your own plan of completion, ensuring you stay on track and meet all necessary requirements.

[Video Presentation (YouTube)](https://youtu.be/6XELLPA9wKA%20 "opens a new window")

![Three students standing in front of a research poster with graphs and text](../img/rsca-3.jpg)

## ELE Timelines

Use these timelines as a guideline to help complete your Engaged Learning Experience Project.

### Freshman/Sophomore Entry Students

First Year: Build relationships with faculty, explore research opportunities, and get involved early.

Second Year: Continue faculty engagement, participate in research or internships, and identify a mentor.

Third Year: Start brainstorming project ideas, submit the Honors Capstone Contract Form, and prepare for CPU4990H.

Fourth Year: Register for CPU4990H, conduct research, finalize and present the project, and celebrate at convocation.

### Transfer Students

First Semester: Start building relationships with faculty, explore research opportunities, and understand project requirements.

Second Semester: Find a mentor, brainstorm capstone ideas, and prepare to submit the Honors Capstone Contract Form.

Third Semester: Register for CPU4990H, work on the project with mentor guidance, and create a draft of the final presentation.

Fourth Semester: Finalize the project, complete and print the poster, present at the KHC Research Symposium, and celebrate at convocation.

## Engaged Learning Experience Proposal Form

Use this form to propose an experience/project for approval by the KHC director. This form requires input from the faculty mentoring the research experience. This form is due the *semester prior* to conducting the research. Once this proposal is approved, students will enroll in CPU 4990H during the Add/Drop Period for the semester of the research/project. CPU 4990H applies toward the minimum [honors course](../honors_classes.shtml) graduation requirement. CPU 4990H does not qualify for KHC Priority Registration.

* [Honors Engaged Learning Experience (ELE) Proposal Form PDF](../documents/Accessible/eleform.pdf)
  + The completed form is due in the semester *before* the start of the project:
    - Fall semester projects: Submit the form by the end of the spring semester (May)
    - Spring semester projects: Submit the form by the end of the fall semester (December)

## Past Convocation Materials

[Photos of 2025 Research Presentations](https://photos.app.goo.gl/mJ3LqhMoZEFHvMRK6)

[2025 KHC Convocation Program](https://www.canva.com/design/DAGg5_yyE2w/nu3w4tBYiq4PM7S0myc-DA/view?utm_content=DAGg5_yyE2w&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hd8dc07ab45)

[Photos of 2025 KHC Convocation](https://photos.app.goo.gl/64ApxeHuU8X3w8S76)

## Frequently Asked Questions For Students

### What is the honors engaged learning experience?

All KHC students must have a learning experience that is faculty mentored, senior-level complexity, and independent. Students will produce a poster or other medium to present at CPP’s [RSCA](https://www.cpp.edu/cppsrc/index.shtml) event held every March. Alternatively, students can present projects at [CARS](https://www.cpp.edu/our-cpp/events-workshops/cars/index.shtml) held every August, or any approved external conference. The project can be from any major discipline, so long as it is within the student's academic interests.

Students may apply projects from their major (senior project), faculty labs, research programs (McNair, etc),  and/or internships to earn KHC learning experience credit. Students must request ([using the project proposal form](https://www.cpp.edu/honorscollege/documents/eleform.pdf)) and receive approval from the KHC director the *semester before starting the project.*

The research proposal/idea does not need to be original. Students must conduct data collection, analysis, and conclusion.

### When do I conduct the honors engaged learning experience?

The project can be done any semester except students’ final spring semester. Since the project must be presented around the 7th week of spring semester, students must conduct the project in the fall semester before. Students graduating in a fall semester can do the project that same fall semester and present in the following spring.

## Frequently Asked Questions for Faculty Mentors

### What are my responsiblities as a Mentor?
...
### How much work is necessary for it to qualify as an eligible project?
