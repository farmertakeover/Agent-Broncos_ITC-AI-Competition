**Source:** http://www.cpp.edu/env/landscape-architecture/degrees-admissions
...
* a four-year [Bachelor of Science of Landscape Architecture (BSLA)](bachelors.shtml), and
* a three-year   [Master of Landscape Architecture (MLA) with General Standing and Advanced Standing Tracks](masters.shtml).
...
We offer several study abroad options for both BSLA and MLA students. Popular minors for BSLA students include Geographic Information Systems (GIS) (28 units) and Regenerative Studies (RS) (24 units). See the   [University Catalog](https://catalog.cpp.edu/ "University Catalog (opens in new window)")  for a full list of the 83 minors offered at Cal Poly Pomona.
