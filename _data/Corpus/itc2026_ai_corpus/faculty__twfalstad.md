**Source:** http://www.cpp.edu/faculty/twfalstad
...
![Travis W. Falstad](twfalstad.jpg)
...
Previously, Falstad served as Executive Producer for the winning entry in the SIRIUS program sponsored by the U.S. Intelligence Advanced Research Projects Activity (IARPA). The goal of the program was to help intelligence analysts identify and mitigate cognitive bias in their decision making. The game was effective at decreasing cognitive bias when compared with the control (a video in this case). With Creative Technologies Incorporated, he managed development for an Oculus-based flight simulator to help train fighter pilots. Falstad subsequently led an innovation workshop with Boeing to introduce gamification elements (progression, social competition and reward system) into future pilot training programs.

He currently mentors for USC’s Greif Center for Entrepreneurial Studies and teach at Cal Poly Pomona's John T. Lyle Center for Regenerative Studies.
