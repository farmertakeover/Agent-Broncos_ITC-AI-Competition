**Source:** https://www.cpp.edu/cpge/professional-development/construction/spida-calc-pole-loading-certificate.shtml
...
***Class is on Saturday, beginning February 28, 2026, and ending on March 28, 2026. (These meetings will be virtual via ZOOM)***

[Registration Info](https://cpge.cpp.edu/search/publicCourseSearchDetails.do?method=load&courseId=1022977)
...
Upon completion of this course, the student will have the basic skills necessary to:
...
A certificate of completion will be awarded to all those who successfully complete the class.

### Instructor(s)

**Stephen Kerman** has been a SPIDA and Pole Loading subject matter expert and trainer for 14 years, and has over 24 years working in many Planning-related positions. He’s been a planner, training specialist, technical specialist, and supervisor, and also holds an MBA with a concentration in information systems.

## This course is sponsored by SPIDA Software
