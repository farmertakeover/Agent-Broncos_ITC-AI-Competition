**Source:** https://www.cpp.edu/cafe/faculty-recognition/grant-projects-repository/spice/classroom-modernization
...
[Classroom Modernization](index.shtml)

[Instructional Innovation](../instructional-innovation/index.shtml)
...
Establishing this lab will allow us to increase the professionalization of our students and to promote the value of liberal arts education at our polytechnic institution. Our lab materials will be available virtually to enhance online learning while simultaneously providing a physical place for students to engage in hands-on applications.
...
## Introducing three smart materials experiments for quasi-static structural deformation control, vibration energy harvesting with structural vibration suppression, and ground vibration test actuation to the aerospace curriculum.
...
## State of the art optical extensometer for testing of materials
...
## Augmenting the computer-integrated manufacturing laboratory with traffic-light and industrial motor control devices
...
## Advancement of additive manufacturing capability through installation of fiber composite 3D printer
...
## Enhancing the IME Automation Lab with PLC-controlled mini-production lines
...
## Improving laboratory design tools to aid in virtual modeling, simulation and development of a smart power grid system and to protect the power grid against any cyber attacks
...
## Modernization of a curve tracers using source meter units (SMU)
...
## Safe remote access to dedicated computing nodes in CPP data-center
...
## Civil engineering construction materials modernization- aggregates testing
...
## Upgrade of four hemical engineering laboratory experiments
...
## Enhancing remote and virtual instruction by renewing service and support for MNOVA Data Processing Suite
...
## ECE Operating Systems Lab Modernization
...
## BitScope Low-power virtual cluster for IoT applications and Security on-Chip
...
**Proposal Abstract:**This proposal requests funding to purchase equipment that can enhance product quality testing and sustainability of diverse materials including woven, knit, non-woven, and foam materials to enhance student learning about textiles for footwear and apparel. This will support the new AMM footwear minor, existing textile courses that are part of the core curriculum, and in the Textiles option that began in Fall 2018. Student experience with the proposed equipment (air permeability tester, foam testing equipment, and microfiber pollution materials) will diversify their knowledge of textiles and standardized testing. This can prepare students for product quality and sustainability positions in industry and/or for graduate studies.

Close

**2022**

## Acquisition of Brookfield viscometers to enhance multiple laboratory courses in the NFS department
...
**Proposal Abstract:**For the past six years, our digital radiology machine has been limping along.  We have been patching our radiology machine in a desperate attempt to keep it going, replacing parts as needed for years. However, this summer, the radiology unit finally went into its final death throes.

Close

**2021**

## Improving Apparel Computer Aided Design (CAD) Computing Resources for Better Student Learning Outcomes
...
## System for Studying Animal Behavior Remotely
...
## Equipment resources (raised bed sewing machines) for Footwear Design and Merchandising minor program
...
## Enhancing Social Research through NodeXL, a Data Mining and Network Visualization Software
...
## Bio 1220L: compound microscopes
...
## COSMED quark CPET metabolic testing system for hands on learning of khp students
...
## Purchase of equipment and software for upper division biological science laboratory courses
...
## Online Interactive Workbook for CS3650-Computer Architecture
