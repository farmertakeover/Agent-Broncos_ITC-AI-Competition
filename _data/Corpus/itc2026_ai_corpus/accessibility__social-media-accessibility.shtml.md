**Source:** https://www.cpp.edu/accessibility/social-media-accessibility.shtml
...
See [Cal Poly Pomona's Commitment to Web Accessibility](https://www.cpp.edu/accessibility/web/index.shtml) and additional resources at the [WebAIM Website](https://webaim.org/)
...
* Checking if text within an image follows [Contrast and Color Accessibility Requirements](https://webaim.org/articles/contrast/)
...
![Billy Bronco poses with his hands by his hips in front of the Bronco Statue](img/billy_bronco_image_desc_ex-min.png)
...
* Text on the screen must follow [Contrast and Color Accessibility Requirements](https://webaim.org/articles/contrast/)
...
Ensure that infographics meet [Contrast and Color Accessibility Requirements](https://webaim.org/articles/contrast/). Include alt text if the infographic conveys information.
...
* See more at [X Accessibility Information](https://help.x.com/en/resources/accessibility)
...
* See more at Facebook: [Creating Accessible Content](https://www.facebook.com/government-nonprofits/blog/creating-accessible-content) and [Facebook Accessibility portal](https://www.facebook.com/help/accessibility)
...
* See more at [Advancing Accessibility on Instagram](https://about.instagram.com/blog/tips-and-tricks/advancing-accessibility-on-instagram) and [Accessibility | Instagram Help Center](https://help.instagram.com/308605337351503)
...
* See more at [LinkedIn Accessibility](https://www.linkedin.com/accessibility) and [Creating Accessible Content on LinkedIn](https://www.linkedin.com/pulse/creating-accessible-content-linkedin-shaun-conner/)
