**Source:** http://www.cpp.edu/class/history/graduate-program.shtml
...
![MA Students at 2025 banquet](img/25-ma-banquet.jpeg)

## Why CPP?

Our History Master's (MA) program offers you individualized attention from expert faculty, small classes and the support of your incoming cohort of fellow students. It is primarily designed for current and prospective secondary school teachers but other alums have pursued further graduate study! Use the links below to explore what a CPP History MA entails!

## Program Details

[### Admissions

We admit an annual incoming cohort of MA students each Fall, with an application deadline in April. We also now offer a dual teaching credential/MA Program for those applicants who want to simultaneously pursue a single-subject teaching credential (social studies) here at CPP along with their MA!](#modal-0 "Admissions")

### Admissions

×

**Fall 2026 Admission Guidelines**
...
* The applicant must submit an application at calstate.edu/apply by April 1, 2026.
* The statement of purpose included in the online application should address the applicant's reasons for pursuing a graduate degree and should add address his or her post-baccalaureate work experience and plans for the future.
* The applicant must request THREE confidential letters of recommendation from professors and/or supervisors (K-12 teachers may submit letters from the applicant's principal and two colleagues). Letters of recommendation are required even if the applicant was an undergraduate history major at Cal Poly Pomona.
* The letters of recommendation should be submitted by April 1, 2026. Recommenders will be asked to submit their letters electronically via Calstate Apply.
* Fall 2026 applicants: If you have any questions or would like more information about the program, please e-mail Dr. David DeVore (ddevore@cpp.edu)

***MA + Credential Program***

* Qualifications (undergraduate degree, GPA) remain the same. Prospective students should apply to the Cal Poly Pomona Credential Program (via Cal State Apply) and then submit their MA-specific materials (statement of purpose, official transcript, and a list of three recommenders) to Dr. David DeVore (ddevore@cpp.edu). They should arrange for their recommenders to send letters directly to Dr. DeVore.

Close

[### The Program

Here are the details about our MA degree requirements (courses, exams, etc.)](#modal-1 "Degree Requirements")
...
* 14-19 semester units of the following required 5000 and 6000 level core courses:
...
* A minimum of 6 semester units of elective graduate courses in history, such as:
...
* A maximum of 11 semester units of undergraduate 3000 and 4000 level courses in history, social sciences or humanities.
* Total: at least 31 semester units of course work.
...
Consult these guidelines about registration, time to degree, etc.!](#modal-2 "General Guidelines")
...
Find the course road map designed for your cohort here!](#modal-3 "Road Maps")

### Road Maps

×

Click the link below for the detailed road maps for our graduate program, specific to each entering cohort!

* + [Graduate Program Road Map Cohort 13 (Entering Fall 2025) (Word document)](docs/macohort13roadmap.docx "Cohort 13")
  + [Graduate Program Road Map Cohort 12 (Entering Fall 2024) (Word document)](docs/macohort12roadmap.docx "Cohort 12")
  + [Graduate Program Road Map Cohort 11 (Entering Fall 2023) (Word document)](docs/macohort11roadmap.docx "Cohort 11")

Close

[### Graduate Courses

Detailed descriptions of our MA courses can be found here!](#modal-4 "Course Descriptions")
