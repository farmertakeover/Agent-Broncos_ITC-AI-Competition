**Source:** http://www.cpp.edu/admissions/freshmen/lote-requirement.shtml
...
[View our Freshmen Requirements](requirements.shtml)
...
To see what courses from your high school are approved, please visit the [UCOP A-G Course List](https://hs-articulation.ucop.edu/agcourselist).

## Alternative Methods to Meeting Requirement "E"

### Advanced Placement (AP) Exams

AP Exams are administered by CollegeBoard. Visit the [CollegeBoard AP website](https://ap.collegeboard.org/) for more information.
...
![how to enter ap exams on application](../img/ap-exam)
...
SAT Exams are administered by CollegeBoard. Visit the [CollegeBoard SAT website](https://collegereadiness.collegeboard.org/sat) for more information.
...
![how to enter sat exam on application](../img/sat-exam)
...
![how to enter formal school on application](../img/formal-schooling)
...
![how to enter esl grade on application](../img/esl-grade)
