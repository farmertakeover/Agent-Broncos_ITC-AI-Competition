**Source:** https://www.cpp.edu/cpge/professional-development/student-resources/campus-parking.shtml
...
There are various **[foundation dining options](https://www.cppdining.com/)** available at Cal Poly Pomona.
...
Parking permits are required at all times on our main campus. Visit the [Parking and Transportation Services](https://www.cpp.edu/~parking/) website for more information.

Additional campus maps can be found below:

- An **[interactive map](https://www.cpp.edu/maps/)** of the campus that includes building numbers, parking and transit information, and dining locations.

![image of CTTI building where professional development classes are held. Image shows a map of the buildings located on the corner of  Innovation Way and Temple Ave. Image shows three buildings ( building 220A, building 220B, and building 220C)](../img/ctti-site-map.jpg)
