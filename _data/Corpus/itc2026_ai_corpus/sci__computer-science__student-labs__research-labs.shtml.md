**Source:** https://www.cpp.edu/sci/computer-science/student-labs/research-labs.shtml
...
The Cyber Adaptive Learning Systems Laboratory (CALSys Lab) supports Dr. Marin's research on proactive cyber-threat intelligence; the effective combination of machine learning, social network analysis, and cybersecurity to predict emerging cyber-threats. Research activities focus on continuously mining and classifying malicious hacker data from the darkweb, and use this information to identify key-hackers, extract hacker network topology, uncover hacker communities based on expertise, predict software vulnerability exploitation, detect 0-day exploits, anticipate malicious viral cascades, and other intelligent data-driven tasks that directly contribute to a less reactive and a more proactive cyber-defense. Please, visit the [CALSys Lab website](https://www.cpp.edu/calsys/index.shtml "https://www.cpp.edu/calsys/index.shtml") or contact Dr. Marin for more information.

> ## AI&ML-X Lab – Artificial Intelligence and Machine Learning for the Real World

The AI&MLX Lab supports Dr. Kosaraju's  interdisciplinary research in advancing generative AI, trustworthy machine learning, and data driven solutions for healthcare, agriculture, and life sciences. The lab focuses on building interpretable and impactful AI systems that support real world decision making and scientific discovery. Current student projects are in the areas of precision agriculture, bioinformatics, drug discovery, and medical imaging, gaining hands on experience with cutting edge tools, collaborative research, and publication opportunities. Through mentorship, research training, and industry partnerships, the lab prepares students to become leaders in AI and data science innovation. Please contact Dr. Kosaraju for more information

## IMMERSYNC Lab

The Immersive Synchronization Laboratory (IMMERSYNC Lab) supports **Dr. Jamshidi’s** interdisciplinary research at the intersection of **game development,** **game music, music therapy, virtual reality (VR), mixed reality (MR), and extended reality (XR)**. The lab investigates how immersive technologies combined with AI and interactive design can enhance learning, therapeutic experiences, and creative expression.

Current research focuses on designing and evaluating VR-based music learning systems, adaptive music therapy platforms, immersive game environments, and real-time audio-visual synchronization tools. Projects span from enabling collaborative rehearsal in XR spaces to building interactive simulations for education and well-being. The lab also explores how generative AI can empower students to become music creators, game developers, and digital storytellers using tools like EarSketch and custom VR/AR platforms.

Through hands-on development and experimental studies, IMMERSYNC Lab aims to advance human-centered, emotionally engaging, and inclusive applications of immersive technologies.

Please visit the IMMERSYNC Lab website or contact **Dr. Jamshidi** for more information.
