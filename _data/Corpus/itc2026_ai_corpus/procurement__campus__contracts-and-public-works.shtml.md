**Source:** http://www.cpp.edu/procurement/campus/contracts-and-public-works.shtml
...
The **Contract Authorization Matrix** is an essential internal control tool that outlines the appropriate signatory approvals required for various types of contracts entered into by Cal Poly Pomona. Developed in alignment with CSU policy, this matrix ensures that contracts are reviewed and approved by the correct campus officials based on contract classification and level of authority.

**Purpose**

The matrix is designed to support the integrity, efficiency, and compliance of our Contracts Operations. It helps safeguard the university against unauthorized commitments, conflicts of interest, and fiduciary missteps by clearly identifying who is authorized to approve specific types of agreements.

**How It Works**

* **Contract Classifications:** Contracts are grouped by type (e.g., Retreat Facility Agreements, Auxiliary Agreements, Local Agency Agreements, NDAs, etc.).
* **Approval Levels:** Each contract type is assigned a required signatory level such as a Department Dean, Associate Vice President, or Divisional Vice President.
* **Required Reviews:** The matrix also identifies when additional campus reviews are necessary from areas such as Risk Management, Budget and Planning, Academic Programs, or Environmental Health and Safety.
* **CRF Verification:** All Contract Request Forms (CRFs) submitted to Procurement are verified against the matrix to ensure that the appropriate approval has been obtained before a contract is processed.

**Why It Matters**

Following the Contract Authorization Matrix:

* Ensures compliance with CSU delegation of authority policies
* Prevents delays caused by incorrect or unauthorized approvals
* Protects departments and approvers from conflicts of interest or unauthorized financial commitments
* Promotes consistency and accountability across all contracting activities

Departments are responsible for confirming the required approval level before submitting a CRF. Forms without the correct signature will be returned for correction.

For assistance or questions about the matrix or contract approvals, please contact the **Contracts & Procurement Office** at procurement@cpp.edu.

[**Contract Authorization Matrix (PDF)**](docs/contract-authorization-matrix.pdf)
...
[https://www.dgs.ca.gov/PD/Services/Page-Content/Procurement-Division-Services-List-Folder/Certify-or-Re-apply-as-Small-Business-](https://www.dgs.ca.gov/PD/Services/Page-Content/Procurement-Division-Services-List-Folder/Certify-or-Re-apply-as-Small-Business-Disabled-Veteran-Business-Enterprise)[Disabled-Veteran-Business-Enterprise](https://www.dgs.ca.gov/PD/Services/Page-Content/Procurement-Division-Services-List-Folder/Certify-or-Re-apply-as-Small-Business-Disabled-Veteran-Business-Enterprise).  ​
...
[https://www2.calstate.edu/csu-system/doing-business-with-the-csu/contract-services-and-procurement/Pages/vendor-](https://www2.calstate.edu/csu-system/doing-business-with-the-csu/contract-services-and-procurement/Pages/vendor-resources.aspx)[resources.aspx](https://www2.calstate.edu/csu-system/doing-business-with-the-csu/contract-services-and-procurement/Pages/vendor-resources.aspx)

## Contact Us

**Location:**Building 75
**Hours of Operation:** Monday-Friday, 8AM-5PM
**Email:**procurement@cpp.edu**Mailing Address:**
3801 W. Temple Ave
Pomona, CA 91768
