**Source:** http://www.cpp.edu/env/landscape-architecture/academic-student-resources/advising-forms.shtml
...
![](../img/advising-forms.jpg)

**General Advising Links:**

Most necessary academic forms can be found on the  [**Registrar's**](https://www.cpp.edu/registrar/index.shtml "Registrar's (opens in new window)") form page; questions about processes and forms should be directed to the student's cohort level advisor or the graduate coordinator.

* [https://www.cpp.edu/registrar/forms/index.shtml](https://www.cpp.edu/registrar/forms/index.shtml "https://www.cpp.edu/registrar/forms/index.shtml (opens in new window)")

**Financial Aid**  questions should be directed to the  **[Office of Financial Aid.](https://www.cpp.edu/financial-aid/index.shtml "Office of Financial Aid.  (opens in new window)")**

Students in need of assistance can reach out to:

* **[Disability Resource Center](https://www.cpp.edu/drc/index.shtml "Disability Resource Center (opens in new window)")**
* **[Student Health, Counseling and Wellness Center](https://www.cpp.edu/health/ "Student Health, Counseling and Wellness Center (opens in new window)")**

For GE-specific questions please contact **ENV Student Success Advising Retention and Graduation Specialist:**

* **Michelle Martinez** (mjmartinez@cpp.edu)
* Students are encouraged to meet with Michelle for any general academic advising.
* See other advising services and resources on official ENV Student Success Advising Center page at <https://www.cpp.edu/env/student-success-advising-center/index.shtml>

***Specific BSLA and MLA documents and advising information can be found on the tabs on this page.***

### ENV/LA Safety Policies
...
4. Do not dump waste concrete mix or rinsate from containers in the dirt or planters.  Use only approved waste collection containers.
...
* [University Catalog Landscape Architecture Department Description](https://catalog.cpp.edu/preview_entity.php?catoid=36&ent_oid=3666&returnto=2907 "University Catalog Landscape Architecture Department Description (opens in new window)")
* [Master of Landscape Architecture Catalog Description](https://catalog.cpp.edu/preview_program.php?catoid=36&poid=9495&returnto=2907 "Master of Landscape Architecture Catalog Description (opens in new window)")
* [Bachelor of Science in Landscape Architecture Catalog](https://catalog.cpp.edu/preview_program.php?catoid=36&poid=9494&returnto=2907 "Bachelor of Science in Landscape Architecture Catalog (opens in new window)")
* [Bachelor of Science in Landscape Architecture Curriculum Sheets](https://www.cpp.edu/~academic-programs/academic-advising/tools/sheets-roadmaps/2018-2019/index.shtml "Bachelor of Science in Landscape Architecture Curriculum Sheets (opens in new window)")
* [Landscape Architecture Minor](https://catalog.cpp.edu/preview_program.php?catoid=36&poid=11940&returnto=2907 "Landscape Architecture Minor (opens in new window)")
...
### MLA Curriculum Roadmaps

[MLA Curriculum Roadmap - General Standing Track](https://www.cpp.edu/env/landscape-architecture/degrees-admissions/2025-26-mla-curriculum-roadmap-gst.pdf)

[MLA Curriculum Roadmap - Advanced Standing Track](https://www.cpp.edu/env/landscape-architecture/degrees-admissions/2025-26-mla-curriculum-roadma-ast.pdf)

[Pre-Approved Elective List for MLA Students (Pre-Approved\_Electives\_MLA\_Semester.pdf)](../degrees-admissions/pre-approved-electives-mla-semester.pdf "Pre-Approved Elective List for MLA Students (Pre-Approved_Electives_MLA_Semester.pdf) (opens in new window)")
...
Below through the link to   [Advising forms from CPP Graduate Studies](https://www.cpp.edu/gradstudies/current-students/forms.shtml), you can find the following forms and their respective user guides:
...
Through the [University Strategic Enterprise Risk Management](https://www.cpp.edu/rms/about-risk-management/risk-forms.shtml), you can find the field trip forms. Additional forms are listed below.

+ [University Course Auditing Form](https://www.cpp.edu/registrar/forms/course-auditing-form-2020.pdf "University Course Auditing Form (opens in new window)")
...
* **First Year**Rennie Tang (lrktang@cpp.edu)
* **Second Year**Lorena Garcia (lorenag1@cpp.edu)
* **Third Year**Keiji Uesugi (kuesugi@cpp.edu)
* **Fourth Year**
  Claire Latané (calatane@cpp.edu)

**ENV Retention and Graduation Specialist (Student Success Advising Center)**

* **Michelle Martinez** (mjmartinez@cpp.edu). Students are encouraged to meet with Michelle for any general academic advising.

### BSLA Curriculum and Road Map 2020-24 Academic Year
...
[BSLA Curriculum Sheet 2020-24 (2020-24 BSLA\_Curriculum Roadmap.pdf)](https://cpp-env-static.s3-us-west-2.amazonaws.com/prod/s3fs-public/attached_files/2020-21%20BSLA_Curriculum%20Roadmap.pdf "BSLA Curriculum Sheet 2020-21 (2020-21 BSLA_Curriculum Roadmap.pdf) (opens in new window)")
