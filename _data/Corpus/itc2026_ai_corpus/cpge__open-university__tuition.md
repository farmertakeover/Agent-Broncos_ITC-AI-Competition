**Source:** https://www.cpp.edu/cpge/open-university/tuition
...
* [Tuition](index.shtml)
* Term Tuition | Open University at Cal Poly Pomona
* [...](../index.shtml)

## Open University Term Tuition

Fees are determined by the number and type of units in which you are enrolled. Students taking classes through Open University must either pay the full amount they owe online through BroncoDirect or enroll in a payment plan in order to be enrolled in their classes.

Important Dates

| **Course Level** | **Fees** |
| --- | --- |
| Undergraduate  (1000 – 4999 Level)  **Maximum transferable units: 24** | $340.00/Unit |
| Graduate (5000 Level and Above)  **Maximum transferable units: 9** | $365/Unit |

Important Dates

| **Miscellaneous Items** | **Fees** |
| --- | --- |
| Payment Plan Administrative Fee | $25.00 (Non-Refundable) |
| Late Payment on Open University Payment Plan | $25.00 (Per Late Payment, Non-Refundable) |
| Lab and Miscellaneous Course Fees | Posted to the student’s account after tuition is paid. The amount due varies based on the class. Students are responsible for checking their accounts and paying off their balances. |
| Instant Access Program Fees | Open University students are automatically charged for the Instant Access program upon enrollment in one or more courses. This fee covers textbooks & course materials. Please visit the Instant Access website for additional information and instructions on opting out of the program.  **[Bronco Bookstore - Instant Access Complete](https://www.broncobookstore.com/instant-access-complete.asp)**  **\*Please note that students must opt out of the program by the given deadline each term or they are responsible for paying the fee. Failure to pay the fee will result in a financial hold and the inability to enroll in future terms and obtain transcripts.** |
...
**See[payment instructions](https://www.cpp.edu/cpge/open-university/tuition/payment-instructions.shtml "payment instructions") on how to make a payment**
