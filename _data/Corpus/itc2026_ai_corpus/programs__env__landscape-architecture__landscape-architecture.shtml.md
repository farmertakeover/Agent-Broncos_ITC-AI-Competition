**Source:** https://www.cpp.edu/programs/env/landscape-architecture/landscape-architecture.shtml
...
## Bachelor of Science – BSLA | Undergraduate

![Landscape architecture students with their design models](../img/la-bsla-main.jpg)

## Quicklinks

[Department Page](https://www.cpp.edu/env/landscape-architecture/index.shtml)
[International Programs](https://www.cpp.edu/env/landscape-architecture/academic-student-resources/international-programs.shtml)
[Scholarships](https://www.cpp.edu/env/landscape-architecture/academic-student-resources/scholarships.shtml)
[About the Profession](https://www.cpp.edu/env/landscape-architecture/about/about-the-profession.shtml)
[Contact Us](https://www.cpp.edu/env/landscape-architecture/contact/index.shtml)
...
[Learn More](https://www.cpp.edu/env/landscape-architecture/about/about-the-profession.shtml)
[Get Involved](https://www.cpp.edu/env/landscape-architecture/about/asla-socal-asla.shtml)
...
Design spaces that are beautiful, functional and in harmony with the natural environment. Prepare site plans, develop models, select materials and work alongside project design teams.

### Landscape Scientist

Care for the environment with your expertise in botany and geology through conservation efforts within soil analysis, reclamation techniques and habitat surveys.

### Landscaping Account Manager

Meet with clients, work within budget limits and keep track of a company’s clientele needs.

### Landscape Planner

Search for locations, analyze them and construct a report based on findings to understand the suitability of a site for future projects.
...
[See Course Catalog](https://catalog.cpp.edu/preview_program.php?catoid=68&poid=18622 )
[Visit Advising](https://www.cpp.edu/env/landscape-architecture/academic-student-resources/advising-forms.shtml)
[CPPLA Overview](https://www.cpp.edu/env/landscape-architecture/degrees-admissions/bachelors.shtml)

![BSLA graduates pose in front of Building 7](../img/la-grads-bldg7.jpg)
...
[See More Scholarships](https://www.cpp.edu/env/landscape-architecture/academic-student-resources/scholarships.shtml%20%20%20%20%20%20)

![Three landscape architecture students in front of a design wall](../img/la-firm-day.jpg)
...
[Read More](https://www.cpp.edu/news/content/2024/08/qa-alumna-pamela-galera-discusses-her-journey-in-landscape-architecture/index.shtml%20%20%20%20%20%20)
...
[Architecture](https://www.cpp.edu/programs/env/architecture/architecture.shtml)
