**Source:** http://www.cpp.edu/academic-resources/budget-and-finance/computer-purchasing-guide.shtml
...
# Computer Purchasing Guide - For Offices in Central Academic Affairs

For Central Academic Affairs offices, computer purchases for new staff and necessary replacement computers will be managed by Academic Resources from a central budget. Academic Resources initiates the purchasing process for computers that are 5 or more years old. Requests outside the refresh cycle are processed on a flow basis for new employees or broken equipment. Please note that as the end of the fiscal-year approaches, the budget may be exhausted.

To submit a request to replace a computer or purchase a computer for a new hire, please submit the request here: [Computer Request Form](https://forms.office.com/Pages/ResponsePage.aspx?id=HqZLFuw5XU-J_6ofAKUhtAMhEUc10MRDge3EKZinyn9UNkc4TkZIREpWWUtZRUpQQU1aTlE3Nk9XNC4u)
...
**Useful link**: <https://www.cpp.edu/it/purchasing-process-management/index.shtml>

For positions that become vacant, we ask that you turn in their laptop to Academic Resources.

* Please do not return the device to IT.
* To arrange a return, please complete [this form](https://forms.office.com/r/62PNAxqPt4).  We will make sure the device gets cleared and reimaged.
