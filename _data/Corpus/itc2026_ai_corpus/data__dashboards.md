**Source:** http://www.cpp.edu/data/dashboards
...
Dashboard data is current and reflects production data as of midnight of the previous day. Off-campus access requires connecting to the university's VPN.

[#### Tableau Dashboard](https://analytics.cpp.edu "opens a new window")

[#### Accessing Tableau Off-Campus

Tableau is only available when you are connected to CPP Global Protect VPN. View our eHelp article for information on connecting from an off-campus network.](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=c40f854e6fe8e600e020f35d5d3ee4d5 "opens a new window")

[#### Tableau Dashboard Navigation Guide

The Dashboard Navigation Guide is an introduction to our most popular dashboards. It helps you find specific topics, provides a description, and details on how the dashboard can be used, how often the dashboard is updated, and who to contact for questions. Additionally, this guide highlights any new or recently enhanced dashboards.](https://analytics.cpp.edu/#/site/production/workbooks/1269/views "opens a new window")

[#### 1st Year Student Outcomes (PDF)

This flyer contains links to access dashboards that provide insights into first year student experiences and outcomes.](/data/authenticated/documents/irpa_promo_flyer.pdf)

[#### Video Tutorials

Academic Resources (AR) has created video tutorials and handouts for the Tableau Dashboards.](/academic-resources/tableau.shtml "opens a new window")

## ATI Compliance Statement

We are committed to accessibility and strive to provide information that is easy to navigate and fully accessible. Please [contact us](../about.shtml) with any questions or suggestions.

## Frequently Asked Questions

### How do I gain access to Tableau?

All faculty and staff are automatically granted access to the [CPP Tableau dashboard](https://analytics.cpp.edu/) website. Most Tableau dashboard permissions are based on an employee’s role. However, some dashboards require additional approvals for access. HEERA managers, or their delegates, can complete the [Tableau Dashboard Access Request](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=a4237f972bb426d0d0ebf5dfc391bfa1) form should specific dashboard access be needed.

### How do I access Tableau from off-campus?

Tableau and Data Warehouse are available on-campus, or off-campus with a valid VPN (Virtual Private Network) connection. For information on setting up a VPN connection please reference the [eHelp VPN article.](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=c40f854e6fe8e600e020f35d5d3ee4d5)

### If you see an error when logging in

If you see the following error when logging in to Tableau, close all browser windows and then try again.

![Tableau error message: Tableau Unable to Sign In Invalid username or password Try again](../img/tableau-error.jpg)

### Who can I contact for more information?

For more information, please email: irpa@cpp.edu

For a specific contact person, please see our [staff directory](https://www.cpp.edu/data/about.shtml).
