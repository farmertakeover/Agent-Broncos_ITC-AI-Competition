...
* [Home](/tree/index.shtml)
* About Us

  + [Who We Are](/tree/about-us/values.shtml)
  + [Meet the Staff](/tree/about-us/meet-the-staff.shtml)
  + [Cultural Graduations](/tree/cultural-grad.shtml)
...
![A student participates in an event](img/canto-henna-event.jpg)

# Centers for T.R.E.E.

![Cultural Center Building](img/cultural-centers.jpg)

## About Us

The Centers for Transformation, Retention, Equity and Empowerment (T.R.E.E.) warmly welcome any person, regardless of how they identify. These spaces are designed to inspire exploration, learning, connection, and collaboration, with a core dedication to fostering student success.

Grounded in a profound appreciation for diversity in all its forms, the Centers for T.R.E.E. remain unwavering in their commitment to cultivating a respectful, inclusive, and empowering environment where every individual has the resources and support needed to flourish and thrive.

## Our Centers

[![APISC Inside](img/tree_updated1.png)

### Asian and Pacific Islander Student Center](https://www.cpp.edu/tree/apisc/index.shtml%20 "opens a new window")

[![BRC Outside](img/tree_updated2.png)

### Black Resource Center](https://www.cpp.edu/tree/brc/index.shtml%20 "opens a new window")

[![CECCHE inside](img/tree_updated3.png)

### Cesar E. Chavez Center for Higher Education](https://www.cpp.edu/tree/cecche/index.shtml%20 "opens a new window")

[![NASC Beading Event](img/tree_updated4.png)

### Native American Student Center](https://www.cpp.edu/tree/nasc/index.shtml%20 "opens a new window")

[![Pride Center interior](img/tree_updated5.png)

### Pride Center](https://www.cpp.edu/tree/pride/index.shtml%20 "opens a new window")

[![WRC Inside](img/tree_updated6.png)

### Womxn's Resource Center](https://www.cpp.edu/tree/wrc/index.shtml%20 "opens a new window")
