**Source:** https://www.cpp.edu/~admissions/freshmen/requirements.shtml
...
![CPP Student](../img/cpp-student)

## Freshmen Requirements

### CPP Eligibility

Freshmen must first meet the minimum California State University eligibility requirements listed below to be considered for admission. In addition, Cal Poly Pomona uses a Multifactor Admissions (MFA) process to evaluate applicants. All admission requirements must be completed by high school graduation.

[California State University Eligibility](https://www.calstate.edu/apply/freshman/getting_into_the_csu/Pages/admission-requirements.aspx%20)
...
For A-G requirement details, visit[University of California - Admissions](https://admission.universityofcalifornia.edu/) and to see if your particular high school course meets an A-G requirement, visit [A-G Course List](https://hs-articulation.ucop.edu/agcourselist).
...
[MFA Model](https://www.cpp.edu/admissions/freshmen/freshmen-student-profile.shtml)

### SAT/ACT Test Scores

The [California State University (CSU)](https://www.calstate.edu/apply/Pages/undergraduate-admissions-and-standardized-tests.aspx) has eliminated the use of SAT/ACT test scores when making undergraduate admission decisions. Applicants may still submit test scores, however, they will NOT be used for admission purposes. If admitted, scores may be used for first year course placement in English and Math upon enrollment.
...
[Find out more about program impaction](impacted-majors.shtml)

[Find out more about local preference](local-area.shtml)
...
All local applicants will receive additional consideration during the admission process. For further information please visit our local student [page](https://www.cpp.edu/admissions/freshmen/local-area.shtml).
