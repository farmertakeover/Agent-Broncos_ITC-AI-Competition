**Source:** http://www.cpp.edu/studentsuccess/guides/a-z.shtml
...
# A-Z Glossary of Academic Terms and Definitions

## A

**Academic Standing:**  Your academic standing is determined by your GPAs. Review the [Academic Standing webpage](https://www.cpp.edu/studentsuccess/oss/academic-advising/university-policy-information/academic-standing.shtml) for more specific information. You can find your GPA and academic standing in the Current Academic Summary section of your Degree Progress Report.

**Add/Drop Period:** A period that occurs after the General Registration Period that allows you to adjust your class schedule before classes begin and during the first few weeks of class. During Add/Drop, you can also drop courses from your schedule without receiving a W on your transcript. Find specific Add/Drop dates for a term on the [Student Success Central Academic Calendar](https://www.cpp.edu/~studentsuccess/calendar/index.shtml).
...
**Blue Book:**  An exam booklet with a blue cover and about 20 lined pages. They come in a small and a large size, so ask your professor which size you need for your test. You can purchase blue books in the [Bronco Bookstore](https://www.broncobookstore.com/).
...
**Bronco ID Number:** Your Bronco ID number is the 9-digit number you're assigned when you apply to the university. You can find this number in your admissions communication, Degree Progress Report and Unofficial Transcripts. Make sure to include this number in your email or have it handy whenever you are communicating with an official CPP department.

## C

**CA Dream Act Application:**  This is the financial aid application for students who are Dream Act eligible. For more information, visit the [Financial Aid & Scholarships website](https://www.cpp.edu/financial-aid/undergraduate/current/how-to-apply-for-aid-dream.shtml).
...
**College:** Cal Poly Pomona organizes its degree programs by colleges. There are [eight colleges at Cal Poly Pomona](https://www.cpp.edu/~academics/colleges-departments/index.shtml): Huntley College of Agriculture, College of Business Administration, College of Education & Integrative Studies, College of Engineering, College of Environmental Design, Collins College of Hospitality Management, College of Letters, Arts, & Social Science, and College of Science.

**Commencement:** The [ceremonies in May](https://www.cpp.edu/~commencement/) celebrating students who have completed all of their graduation requirements.

**Corequisite:** If you are required to register for two classes in the same term, the classes are considered corequisites. Corequisites can be found in the Class Detail page for a course in the BroncoDirect Class Search or in the [University Catalog](https://catalog.cpp.edu/content.php?catoid=57&navoid=4399).  Some examples of corequiste courses include CHM 1210 and CHM 1210L or ARC 1022 and ARC 1022A.

**Course Attribute:** A search criteria option in the Class Search under Additional Search Criteria. This allows you to limit your search to only include classes from a certain GE area, fully online courses, course level and more.
...
**Credit/No Credit (CR/NC):** Some courses offer Credit/No Credit grading, as indicated by in the University Catalog by the Grading Basis. These classes are graded as either “CR” for credit or “NC” for no credit instead of receiving a letter grade and therefore only count as units completed and are not included in your GPA.

**Curriculum:** The coursework you are required to complete in order to earn your degree.

**Curriculum Sheet:**  Your curriculum is the coursework you are required to complete to earn your degree. The curriculum sheet is an official document that lists your coursework. You can find your curriculum sheet [on the curriculum sheet directory](https://www.cpp.edu/academic-programs/academic-advising/tools/sheet-roadmaps/index.shtml), but make sure that you select the year you started school at Cal Poly Pomona or the year in which you switched majors to your current major.
...
**Degree Progress Report (DPR):** A tool in your Student Center that indicates which requirements for your degree that you’ve satisfied and which requirements you have left to complete. Your DPR can also tell you your overall, core and CPP GPAs, the number of units you’ve taken and still need, your academic standing and more. For information on how to view your DPR, check out [this video](https://www.youtube.com/watch?v=F70rzOaM3yI).

**Department:** The academic departments within a college are responsible for the students in their majors, and offer courses. For example, the chemistry and biochemistry majors are within the Department of Chemistry and Biochemistry. The department offers CHM courses. For a list of academic departments, [visit here](https://www.cpp.edu/~studentsuccess/directories/departments-az.shtml).
...
**Error Message:** A message that you receive when you are registering if you are unsuccessful in registering for a course. You could receive an enrollment error message for a number of reasons. Refer to [Step 3: Registering for Courses](registration/register.shtml) in the Registration Guide for information on how to troubleshoot your enrollment errors.

## F

**FAFSA:** The Free Application for Federal Student Aid. It is the application you fill out to apply for financial aid every year. For more information go to the [Financial Aid & Scholarships website](https://www.cpp.edu/~financial-aid/how-tos/index.shtml#fafsa).

**First-generation:** A student is first-generation if neither parent/guardian has completed a U.S. bachelor's degree. These students are still considered first-generation even if a sibling or other family member has already completed a four-year college degree. For more information, visit the [I Am First website](https://www.cpp.edu/~studentsuccess/oss/i-am-first/index.shtml).

**Full-Time Student:** A student enrolled in 12 units during a semester. Being a full-time student is required for several grants to disburse fully. Waitlisted units do not count towards your total enrolled units. For more information about how your enrolled units will affect your financial aid, visit the [Financial Aid & Scholarships website](https://www.cpp.edu/financial-aid/resources/understanding-enrollment-requirements.shtml).

**Freshman:** A student who has completed 0 – 29 semester units.

## G

**General Education (GE):**  The General Education Program is designed to help you succeed and learn essential skills and knowledge in a variety of disciplines. Review the [General Education Guide](ge.shtml) for more information.

**General Registration Period:** The period in which all students can register for classes in an upcoming term. You can find upcoming registration periods on the [Student Success Central Academic Calendar](https://www.cpp.edu/~studentsuccess/calendar/index.shtml). Check your Student Center for your registration window.
...
* **Major GPA:** Calculated using only the courses listed under “Major Required Core” in your curriculum sheet.
...
**Graduation:**  Refers to the term in which you have officially and successfully completed all of your graduation requirements. You [must apply](https://www.cpp.edu/registrar//graduation/applying-for-graduation.shtml) for the term in which you plan to graduate through your Student Center in BroncoDirect.  Once grades are posted, your record will be evaluated and if all requirements are met, your degree will be awarded.

## H

**Hold:** Holds, or sometimes referred to as service indicators, appear in the upper right-hand side of your Student Center and may impact your ability to register. Some holds are informational and do not impact your ability to register. Refer to [Step 1: Planning Your Courses](registration/plan.shtml) in the Registration Guide for information on how to check for registration holds in BroncoDirect.
...
**Instant Access Program:** A program offered by the Bronco Bookstore that automatically provides students access to digital course material for participating courses at a highly discounted price. Students must opt-out of the Instant Access Program by Add/Drop if they do not want these digital materials. More info can be found on the [Bronco Bookstore website](https://www.broncobookstore.com/instant-access.asp).

## J

**Junior:**  A student who has completed 60 – 89 semester units.

## L

**Leave of Absence:** If students need to take more than one semester off, they will need to apply for a leave of absence. Contact the [Bronco Advising Center](https://www.cpp.edu/studentsuccess/bronco-advising-center/index.shtml) for more information.

## M

**Major:** Your major is a specific academic area that you choose to study. There are nearly 100 majors at Cal Poly Pomona.

**Minor:** A secondary academic area that you choose to study. There are over 80 minors at Cal Poly Pomona.

**Mode of Instruction:**  Classes can be offered in a variety of instructional modes. You can search by mode of instruction in the Class Search or find it in the Class Details page for a class in your search results. Review the [Instruction Modes guide](instruction-modes.shtml) for more information.
...
**Orientation:** A program designed to give you a comprehensive experience where you will learn about academic requirements, academic success strategies, campus involvement, volunteer opportunities, and register for your first-semester classes. For more information, visit the [New Student Programs & Family Engagement website](https://www.cpp.edu/orientation/index.shtml).

## P

**Part-Time Student:** A student enrolled in less than 12 units during a semester.

**Permission Number:** Permission numbers, also commonly called add codes, are one-use codes that allow you to enroll in a course that is full, requires consent or requires requisites (pre- or corequisites). For more information about permission numbers, refer to [Step 3: Registering for Courses](registration/register.shtml) in the Registration Guide.

**Petition:** A form you fill out in order to request an exception to academic policy. You can find the list of academic petitions on the [Registrar’s Office website](https://www.cpp.edu/registrar/forms/forms.shtml).
...
**Priority Registration Period:** If you have priority registration privileges, you can register earlier than most of the student population. Priority Registration happens before General Registration. You may have priority registration if you are a part of the 2 or 4-Year California Promise Program, a veteran or member of the military, or part of another campus program that grants priority registration privileges.

## R

**Registration Window:**  A specific day and time that you are able to register for classes in an upcoming term. It is also sometimes called your enrollment appointment, registration appointment, enrollment date or enrollment time. You can find your registration window in your Student Center in the Enrollment Dates box on the right-hand side. It is assigned based on the number of units you have successfully completed, including units completed at Cal Poly Pomona, transfer credits, and AP and IB credits. Your window will typically show up on your account a few days before registration begins.

**Requisite:** A requirement for a class. Requisites are either prerequisites or corequisites.

## S

**Scantron:** A multiple-choice test answer sheet. They come in multiple sizes, so ask your professor which size you need for your test. Shorter scantrons are sometimes called quiz strips. You can purchase scantrons in the [Bronco Bookstore](https://www.broncobookstore.com/).

**Senior:** A student who has completed 90+ semester units.

**Sophomore:** A student who has completed 30 – 59 semester units.

**Stopping Out**: Students may "stop-out" or not register for courses for one semester without having to notify the Registrar's Office.

**Subject:** In the Class Search, you can choose a subject as one of your search criteria. The subject refers to the [academic department](https://www.cpp.edu/~studentsuccess/directories/departments-az.shtml) offering the course, such as math or biology. You can find the subject for a course by looking at the letters that precede the course number, like BIO in BIO 1110.
...
**Synthesis Course:**  Upper division General Education courses that you must complete at CPP. These include GE Areas B5, C3, and D4.
...
**Term:** The time in which classes are in session. For instance, the Fall 2023 semester is a term.
...
**Transcript:**  Your transcript is an official record of the courses you’ve taken at an institution. It includes dates of enrollment, the courses you’ve taken, the grades you received for those courses, the units you earned, and your overall GPA. It may also include some general information about your transfer and test credit. You can view an unofficial version of your Cal Poly Pomona transcript in your BroncoDirect Student Center, and [order an official version](https://www.cpp.edu/registrar//transcripts/index.shtml) from the National Student Clearinghouse.  **Transfer Credit Report (TCR):** A tool in your Student Center that shows you the courses you've transferred from community colleges or other institutions and how they translate to CPP classes. Your TCR also shows your AP, CLEP, or IB test scores.

## U

**Unit:** Sometimes called credit hours, these refer to the number of hours of student work per week including in-class time and homework time. Typically, in semesters, a one unit lecture course is considered to be one hour of lecture class time and two hours of homework per week. Most degrees at Cal Poly Pomona require completing 120 units. We recommend that you plan for 30 semester units across an academic year to stay on track to graduate in four (for freshmen) or two (for transfer students) years. Visit the [Take 30 website](https://www.cpp.edu/~studentsuccess/take30/index.shtml) to learn more about the benefits. The number of units you’ve completed can be found in your Degree Progress Report and [determines your class standing](registration-page.shtml).

**Unit Enrollment Limit:** The number of units you are allowed to register for each term, including waitlist units. You can find the unit enrollment limit on the [homepage of the Registration Guide](registration-page.shtml).

**Unrestricted Electives:** If you have unrestricted electives as part of your degree requirements, you can take any courses you qualify for to satisfy the requirement. Many students use unrestricted electives to earn a minor.

## W

**Waitlist:** A list of students who are waiting to get into a course that is full. For more information about the waitlist, go to [Step 3: Registering for Courses](registration/register.shtml) in the Registration Guide.

**Waitlisted Course:** A class that no longer has available seats but has space on the waitlist. You can get on the waitlist for a waitlisted course if you meet all the requirements and have waitlist units available. Waitlisted courses are indicated in the Class Search by a yellow triangle. You can find the waitlist unit limit on the [homepage of the Registration Guide](registration-page.shtml).

**Waitlist Position:** When you put yourself on a course waitlist, you get in a virtual line to be enrolled in the course. As students drop the class and leave open seats, the line moves up and so does your waitlist position. When space is available, you will automatically be enrolled in the course and notified by email unless you are already registered in a different section of the same course. For more information about being on the waitlist, visit [Step 3: Registering for Courses](registration/register.shtml) in the Registration guide.

**Waitlist Units:** Waitlist units are a part of your total unit enrollment limit. These units allow you to waitlist for classes that have no available seats. You can find the waitlist unit limit on the [homepage of the Registration Guide](registration-page.shtml).

**Withdrawal:** A withdrawal is when you drop a class after the Add/Drop Period ends. Instead of the course disappearing from your transcript, it will be indicated by a W. Look at [Step 4: Starting the Term](registration/start.shtml) in the Registration Guide for more information about withdrawals.
