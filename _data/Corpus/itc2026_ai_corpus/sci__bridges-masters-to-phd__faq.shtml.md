**Source:** https://www.cpp.edu/sci/bridges-masters-to-phd/faq.shtml
...
The purpose of the B2D program is to increase the number of CPP MS students accepted into biomedical-related PhD programs.
...
Please see [Applicant Eligibility and Requirements](program_overview/applicant_requirements.shtml "Applicant Eligibility and Requirements").
...
Students accepted into the CPP B2D Program are expected to commit two academic years, and two 10-week (full-time) summer internships. See [B2D Calendar of Activities](program_overview/b2d_calendar_of_activities.shtml "B2D Calendar of Activities").
