**Source:** http://www.cpp.edu/env/urp/news-events/dale-prize-pages/2009.shtml
...
Challenges associated with resource constraints and climate change require planners to critically evaluate their assumptions about the future of California's communities and regions. Some see a transformation toward a mixed-use, urban model where location advantages are paramount, while others contend that outlying areas will adapt and prosper. So much is changing, however, that unprecedented new forms may emerge. What does the resource-constrained future hold for California's communities and regions, and how can planners proactively shape that future?
