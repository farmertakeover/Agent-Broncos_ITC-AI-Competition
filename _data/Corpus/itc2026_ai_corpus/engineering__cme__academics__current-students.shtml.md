**Source:** https://www.cpp.edu/engineering/cme/academics/current-students.shtml
...
* [Home](/engineering/cme/index.shtml)
* About Us

  [Mission, Vision, Objectives and Outcomes](/engineering/cme/about-us/outcomes.shtml)
  [Faculty and Staff](/engineering/cme/about-us/faculty.shtml)
  [Open Faculty Positions](https://www.cpp.edu/jobs/index.shtml)
* Academics

  [Prospective Students](/engineering/cme/academics/prospective-students.shtml)
  [Undergraduate Program](/engineering/cme/academics/undergrad-program.shtml)
  [Graduate Program](/engineering/cme/academics/graduate-program.shtml)
  [Current Students](/engineering/cme/academics/current-students.shtml)
* Alumni and Friends

  [Alumni Spotlight](/engineering/cme/alumni-and-friends/index.shtml)
  [News](/engineering/cme/alumni-and-friends/news.shtml)

# Current Students

![A professor teaching a student in a lab.](/engineering/cme/academics/img-academics/puthoff-swanson.jpg)

See below for a list of key resources to graduate on time and answers to frequently asked questions.

## Course Descriptions

* Please visit the [university catalog](https://catalog.cpp.edu/content.php?catoid=61&navoid=4884) for the current list of current courses.

## Student Resources:

* [Curriculum sheets/roadmaps by college](https://www.cpp.edu/academic-programs/academic-advising/tools/sheets-roadmaps/index.shtml)
* Prerequisite Flowsheets: [2017-18](../documents/flowchart-chemical-engineering-2017-2018.pdf), [2019-20](../documents/flowchart-chemical-engineering-2019-2020.pdf), [2020-21](../documents/flowchart-chemical-engineering-2020-2021.pdf), [2021-22](../documents/flowchart-chemical-engineering-2021-2022.pdf), [2022-23](../documents/flowchart-chemical-engineering-2022-2023.pdf)
* [Engineering Advising Center](https://www.cpp.edu/engineering/advising/index.shtml)
* [Materials Minor](https://catalog.cpp.edu/preview_program.php?catoid=61&poid=15842&returnto=4884)
* [University Catalog](https://catalog.cpp.edu/content.php?catoid=61&navoid=4884)
...
* [Office of Undergraduate Research at CPP](https://www.cpp.edu/our-cpp/index.shtml)
* [McNair Scholars Program](https://www.cpp.edu/mcnair/)

## Scholarship Opportunities

* [Up-to-date scholarship opportunities for College of Engineering students](http://www.cpp.edu/~engineering/honors/coe-scholarship.shtml)

## Minor in Materials Engineering

Students may log into the [BroncoDirect Student Center](https://my.cpp.edu/uPortal/p/broncodirect.ctf1/max/render.uP) to submit a request to add/drop/change a minor, select minor course electives outside of those already approved, or request minor course substitutions. Please review the [Steps to Declaring a Minor](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml) before submitting the request.

Instructions:

After you log into BroncoDirect, click on **Student Center** on the top, then click on the drop-down menu under **Academics**.  You may also click on **Academics** on the left side panel and you’ll see **Change of Minor** on the right side. Don’t click on **Academics** before you click on **Student Center**, or you will not be able to find the **Change of Minor**.

DO NOT fill in the courses to add the minor. All you need to do on the form is to select the Materials minor from the list and fill out the justification (write your major and expected graduation semester here).

Here is the link to the minor requirements from the catalog:  [Materials Minor](https://catalog.cpp.edu/preview_program.php?catoid=61&poid=15842&returnto=4884)

---

## Chemical Engineering Undergraduate Project

The EGR 4810/4820/4830 and CHE 4631 classes are the project classes that you need to take after you have completed all your 2000-level classes in CHE and MTE. They were previously known as the "senior project classes."
...
You should have **completed and passed** all the **2000-level classes for CHE and MTE** by the end of Spring semester and have gotten a **C- or better in CHE 2021** to be eligible to take the project classes, beginning in Fall semester. Those students who are not eligible by this time will need to take the classes the following year. You may not start the project classes in Spring, only in Fall.
...
## How to Sign Up and Complete Undergraduate Project Classes
...
* Faculty advisor should request the department office to create Undergraduate Project Classes. If you met the prerequisite requirements, you should receive permission numbers from your advisor to enroll.
...
Freshmen entering the program are assigned to an advisor in the [Engineering Advising Center](https://www.cpp.edu/engineering/advising/index.shtml). In the sophomore year, they will be assigned an advisor in the CME department who typically monitors their progress until they graduate. During the first week of the Fall semester, a list of students and their advisors are posted in the display case outside the Department Office. Advisors' office hours are posted outside each advisor‘s office and outside the department office along with their room number, phone number and email address. If your advisor‘s office hours conflict with your class schedule, please either call or email them to set up an appointment at another time.
...
If you have questions on which GE classes to take, refer to your [curriculum sheet](https://www.cpp.edu/academic-programs/academic-advising/tools/sheets-roadmaps/index.shtml) or the [university catalog](https://catalog.cpp.edu/) for your curriculum year where courses are listed under General Education.

### Forms

Many forms you need (general academic petition, grad check, petition to drop, transcript requests etc.,) are available for you online to print out. Visit the [university forms and services](https://www.cpp.edu/registrar/forms/forms.shtml) web page to familiarize yourself with the forms available.

For grad check info, go [here](https://www.cpp.edu/registrar/graduation/how-to-apply-for-graduation-online-via-broncodirect-003_updated-sept-2020.pdf).
