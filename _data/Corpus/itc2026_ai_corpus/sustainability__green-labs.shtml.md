**Source:** https://www.cpp.edu/sustainability/green-labs.shtml
...
![](img/green-lab-photo.jpg)

## Committed to Green Lab Certification Program

The Bronco Green Labs program was developed to evaluate and promote sustainable behavior and efficiency within campus laboratories. The program provides resources and guidance in areas of water conservation, waster reduction, sustainable purchasing, and energy efficiency.

To participate, please contact us at sustainability@cpp.edu.

## Certified Labs

### Stieber Lab

[Learn More about Stieber Lab](https://www.cpp.edu/~sestieber/)

### John Lab

[Learn More about John Lab](https://alexjohn18.wixsite.com/mysite)

## Quick Information

### Program Overview

The Bronco Green Labs program overview shares the overall process of lab certification. View the [Bronco Green Labs Overview.](bronco-green-lab-overview.pdf)

### Freezer Log Signage

This [freezer log](pdfs/lab-freezer.pdf) can be used to track cleaning.

### Lab Recycle & Trash Bin Signage

These signs can be placed on your lab bins to ensure the proper contents are placed inside.  View the [recycling bin signage.](pdfs/lab-recycle.pdf)  View the [trash bin signage](pdfs/lab-trash1.pdf).

### Shut the Sash Signage

This [Shut the Sash flyer](pdfs/green-labs-sash.pdf) can be used as a friendly reminder within your lab.

### Webcast: How to Green Your Lab

This [webcast](https://www.youtube.com/watch?v=ih7Ag1kJ2cs&t=3s) produced by Nature Careers helps train researchers green their labs.
