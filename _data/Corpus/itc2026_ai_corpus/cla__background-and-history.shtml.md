**Source:** https://www.cpp.edu/cla/background-and-history.shtml
...
![CLA under construction in 1991](img/1991-cla-construction-1.gif)

CLA Tower and Registrar Building Demolition

* [Home](/cla/index.shtml)
* [Background and History](/cla/background-and-history.shtml)
* [Timeline](/cla/timeline.shtml)
* [Frequently Asked Questions](/cla/faqs.shtml)
...
However, the building sits atop an earthquake fault and numerous structural issues have plagued the tower. The building has construction flaws, mechanical system problems and is not energy efficient.

After the Student Services Building opened, the CLA Tower and Registration building were vacated in 2019.

The decision to move forward with the demolition project was the result of multiple seismic, structural and feasibility studies, which were initially completed in April 2019. The university also determined that maintaining an empty building long-term would be a financial burden, requiring utilities, an operating fire suppression system, security, custodial services, and other campus resources.

Once the demolition is complete, Cal Poly Pomona will no longer have any buildings on the highest priority list for seismic safety maintained by the California State University Chancellor’s Office.
