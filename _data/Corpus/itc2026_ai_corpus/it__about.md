**Source:** https://www.cpp.edu/it/about
...
**Our mission is to provide technology solutions and business process leadership through collective expertise,** collaboration with other divisions, and continuous learning to advance the University's mission, enhance the student experience, and support student success.

IT's vision is to be an innovative technology leader within higher education by providing essential services and emerging technologies that simplify and improve access to knowledge and learning; increase student success; and prepare the leaders of tomorrow with skills necessary for the future.

![](../img/about-page-banner.png)

## About the CIO

![John McGuthry](../img/john-mcguthry.jpg)**John McGuthry, Vice President and Chief Information Officer** oversees the Division of Information Technology. The division includes six units: The Office of the Vice President; Information Technology; IT Security & Compliance; Process & Project Management; Institutional Research, Planning & Analytics; Learning & Research Technologies.
...
**![students looking at a laptop screen](../img/about-page-mid-banner.jpg)**

## IT Master Plan

### Values

**Operational Excellence** – We strive for operational excellence through recruitment and retention of technology staff committed to the success of students and the university.
...
**Respect** – We encourage a work environment built on professionalism and respect to better serve students, faculty, and staff.
...
**PRIORITIZE SOLUTIONS TO SUPPORT THE UNIVERSITY COMMUNITY**
...
* Establish and maintain a 3-year technology portfolio for solutions that is heavily guided with input from the University Community.
  + IT&IP will establish a new technology request process and enhance the existing technology request process.
  ...
  + Final schedules for major solutions will be guided by the cabinet and must consider cost and resources when scheduled.
...
**ADVANCE A CULTURE OF PROFESSIONAL EXCELLENCE**
...
* Improve on the processes and organizational effectiveness of the Division
  + Routinely assess the division against NIST/ISO best practices.
  + Conduct regular assessments and improvements for all technology policies and procedures
...
**INVEST IN INNOVATIVE TECHNOLOGY PLATFORMS AND CAPABILITIES**
...
* Expand data storage, data analysis, and data visualization platforms in order to generate actionable insights to improve student support services and organizational practices
  ...
  + Enhance the division's abilities to provide predictive analytics for key initiatives
...
* Partner with Academic Affairs with Strategic Technologies.
  + Identify and invest in technologies that benefit the operational environment and learning environment.
...
[Advanced Computing](../advanced-computing/index.shtml) supports faculty and student achievement through technology by integrating modern technologies into our campus resources. We offer support from the initial grant proposal to the final stages of research projects and technology requests.

### Institutional Research, Planning and Analytics

Reporting to the AVP, Learning & Research Technologies, [Institutional Research, Planning and Analytics](/data) (IRPA)serves the university by providing leadership and support for strategic planning, business intelligence, data visualization and analytics.

### IT Operations

Information Technology Operations is responsible for delivering and supporting our secure, reliable technology infrastructure in support of CPP's academic mission. IT Operations collaborates with the campus community to provide critical services and applications. We maintain the university's telecommunications, cloud, on-site data centers, networking infrastructure, and the strategic use of multimedia resources. The [Client Services](../client-services/index.shtml) department provides support for campus computing devices for students, faculty, and staff, including classroom and lab technologies.

### IT Security & Compliance

* [Information Security](https://www.cpp.edu/it/security.shtml) –  Works in collaboration with the campus community to protect the integrity of campus information technology infrastructure to mitigate risks and losses associated with security threats, while supporting access to technology.  Provides risk, threat, alert, vulnerability and alert monitoring, investigation, and advisory services for the University’s computing and information assets allowing for improvement to preventative, detective and corrective controls.  Collaborates with faculty and students to support teaching, learning and research related to IT cybersecurity.
* Information Compliance – An information technology compliance program to improve efficiency and effectiveness of the internal controls and assessment processes, monitor regulations for new or changed requirements, and coordinate with internal and external auditors to ensure compliance. Assists senior management in identifying IT related control gaps and associated remediation plans, and that policies and procedures are updated in a timely manner. Maintains core IT risk processes according to industry standards/frameworks (e.g. ISO27001-2, COBIT, ITIL, NIST, etc.).  Compliance requirements include, but are not limited to:  FERPA, HIPAA, PCI DSS, Section 508, GLBA, Red Flag Rule, GDPR.
...
[The Process & Project Management Office](/it/ppmo/index.shtml) (PPMO) seeks to promote best practices in business process management and project management across the university to advance the university's mission.
...
## Projects, Governance and Reporting

[Card 1 of 5

### Organizational Chart

The division is composed of six departments.](org-chart.shtml)
[Card 2 of 5

### Technology Governance

Learn about University Technology Governance at CPP.](../governance.shtml)
[Card 3 of 5

### Policies and Procedures

View the policies maintained by IT&IP and the University.](../policies-procedures-guidelines/index.shtml)
[Card 4 of 5

### Incident Reports

Information Technology incident reports for current and previous academic years.](../reports/index.shtml)
[Card 5 of 5

### Communications

View an archive of email notifications and social media posts.](../communications/index.shtml)
