**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/media-clip.shtml
...
# Media Clip Instructions Tutorial

## Instructions

***Page View***

![Video Clip Option Demo](../img/video-clip-option.png)
...
![Video Clip Option Cascade View](../img/clipcascade.png)

## Responsive vs Non-Responsive

### Responsive Example

This is how the video embed will display with the Responsive property ticked.

![](img/responsive-example.png)

### Non-Responsive Example

This is how the video embed will display with the Responsive property unticked.

![](img/nonresponsive-example.png)
