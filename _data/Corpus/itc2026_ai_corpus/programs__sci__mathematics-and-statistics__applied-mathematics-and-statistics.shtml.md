**Source:** https://www.cpp.edu/programs/sci/mathematics-and-statistics/applied-mathematics-and-statistics.shtml
...
![Professor and students solve equations on a transparent board. ](../../img/sci-math-applied-mathematics.jpg)
...
Extend your knowledge and impact as you study mathematical, statistical, computational and modeling methods to solve real-world issues across industries like engineering, finance, health and technology.
With the applied mathematics / statistics program emphasis, you will find extensive opportunities to make a difference in others’ lives.
...
Develop mathematical and statistical models based on real-world data, design experiments and find solutions to applied problems. Work directly with industrial software and apply mathematical reasoning to fields including engineering, physics and biology. Put theory into practice and graduate ready to take on careers across multiple industries.
...
Gather and interpret data, then prepare them in easy-to-understand formats to help businesses and organizations make better informed decisions.
...
The Applied Mathematics / Statistics option provides you with broad and flexible coursework to prepare for employment in countless industries or graduate study in applied mathematics or statistics.

For the most up-to-date information on courses for this program, visit the course catalog or contact an advisor.

[See Course Catalog](https://catalog.cpp.edu/preview_program.php?catoid=68&poid=18698)
[Visit Advising](https://www.cpp.edu)

## Related Programs

[Secondary Teacher Preparation / Pure Mathematics](https://www.cpp.edu/programs/sci/mathematics-and-statistics/secondary-teacher-preparation-pure-mathematics.shtml)
