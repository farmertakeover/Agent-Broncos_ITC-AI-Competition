**Source:** https://www.cpp.edu/graphics/copyright-guidelines.shtml
...
## When does the work receive protection under copyright law?
...
## How do I obtain permission from an author or publisher to utilize their work?

* You can contact the author/publisher directly to request permission or conduct a renewal search yourself to determine if the work has passed into the public domain. The renewal records for the works published from 1950 to the present are available online at <http://lcweb.loc.gov/copyright>.
* The U.S. Copyright Office will research renewal information for individuals upon request for an hourly fee (call the Reference & Bibliography Section at (202)707-6850).
* The University Bookstore offers a comprehensive copyright clearing service that can be accessed through the University Library via the link [here for faculty guidelines](https://www.cpp.edu/library/access-services/course-reserve/faculty-guidelines.shtml "Access Services - Faculty Guidelines")
...
* All work published in the United States before 1923 are in the public domain.
...
## Are there other legal instances to reproduce protected copyright works

...that do not require requesting permission from the author or publisher?

Notwithstanding the provisions of sections 106 and 106A , the fair use of a copyrighted work, including such use by reproduction in copies or phonorecords or by any other means specified by that section, for purposes such as criticism, comment, news reporting, teaching (including multiple copies for classroom use), scholarship, or research, is not an infringement of copyright.

In determining whether the use made of a work in any particular case is fair use, please refer to the [Fundamentals of Copyright and Fair Use Guidelines](https://www.calstate.edu/csu-system/administration/general-counsel/Documents/CopyrightManual.pdf) developed by the Office of General Counsel, The California State University, dated December 2012, and posted on their web site.

Interactive Fair Use Factors Checklist, [F-3798](docs/f3798_fair_use_checklist.pdf).
