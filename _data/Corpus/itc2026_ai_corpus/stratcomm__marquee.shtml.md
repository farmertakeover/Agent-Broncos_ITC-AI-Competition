**Source:** http://www.cpp.edu/stratcomm/marquee.shtml
...
[Submit Marquee Request](https://wkf.ms/3Hf3i11)

## Electronic Marquees - Answers
...
To submit a marquee request, fill out the [online form](https://wkf.ms/3Hf3i11). We ask that the request is made at least two weeks before the desired run dates. You will receive an email confirming your submission, but it is not a guarantee that the message will be posted.

Because of the volume of requests, we aren’t able to send additional confirmation emails about the message approval or scheduling. However, faculty and staff are welcome to contact us about individual requests. Call the Department of Strategic Communications at (909) 869-3342 or email stratcomm@cpp.edu.
