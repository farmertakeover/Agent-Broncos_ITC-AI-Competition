**Source:** https://www.cpp.edu/sci/physics-astronomy/academic-programs/astronomy-minor.shtml
...
[CURRICULUM MAP FOR THE ASTRONOMY MINOR](https://docs.google.com/spreadsheets/d/1RB99Yg33Wm_vk1cOwoVlpSgp0sXZyZnFTS_HD_iP_cE/edit#gid=1016273829)
...
The [Astronomy Minor consists of 41 total units](https://catalog.cpp.edu/preview_program.php?catoid=36&poid=9603&hl=%22astronomy+minor%22&returnto=search "Astronomy Minor"), including the 25 units in the courses listed below that go beyond freshman physics and prerequisite calculus courses that are taken by most science and engineering majors.
...
An introduction to astrophysical data collection and analysis from both ground-based and space-based telescopes. Concepts, techniques, skills and resources needed to plan, obtain, reduce, and interpret astronomical observations across the electromagnetic spectrum. Emphasis on computer programming and data visualization software.
...
For more information on signing up for the Astronomy minor, contact Professor Coral Wheeler. You can also get additional information on the [Physics minor page](physics-minor.shtml "Physics Minor").
