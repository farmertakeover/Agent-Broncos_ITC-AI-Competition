**Source:** https://www.cpp.edu/fas/delegation-of-authority.shtml
...
* [Home](/fas/index.shtml)
* Policies, Procedures & Resources

  [Policies, Procedures & Resources](/fas/protected/policies.shtml)
  [Financial Transparency](/fas/protected/budget-presentations.shtml)
* [Financial Statements](/fas/financials.shtml)
* [Contact Us](https://www.cpp.edu/fas/protected/contact-us.shtml)
* [About Us](/fas/about-us.shtml)
* [Feedback](/fas/feedback.shtml)
* [Delegation of Authority](/fas/delegation-of-authority.shtml)

# Delegation of Fiscal Authority (DOA)

![SSB Old Stables](img/22ssb-old-stables.gif)

**Overview**

The Chancellor’s Office (CO) formed the Financial Business Rules Committee (FBRC) to identify a baseline delegation of authority structure for the CSU. This committee was composed of campus and CO representatives who were charged with developing this standard for approval of financial transactions. Further information about this collaborative effort is available on the [CSYou Delegation of Authority webpage](https://csyou.calstate.edu/Divisions-Orgs/bus-fin/Financial-Services/Pages/csu-delegation-of-authority-standard.aspx).
...
* [CSU Delegation Standards](https://csyou.calstate.edu/Divisions-Orgs/bus-fin/Financial-Services/Pages/csu-delegation-of-authority-standard.aspx)
...
| 2 | Individuals with oversight of divisions | Provost, Vice President | Approval - CSUBUY (goods/services) Approval - Concur Travel Request and Expense Approval - Hospitality | CSUBUY, Concur, Hospitality - Up to $5,000,000 |
| 3 | Individuals with oversight of divisions | Provost, Vice President | Approval - CSUBUY (goods/services) Approval - Concur Travel Request and Expense Approval - Hospitality | CSUBUY, Concur, Hospitality - Up to $500,000 |
| 4 | Individuals with oversight of College/Unit  &  Individuals with delegated authority to spend from and manage approved budgets | Deans, Associate/Assistant Vice President (AVP), Vice Provost, Athletic Director, Management Personnel Plan (\*MPP Admin III)  &  Academic Equivalent, Department Chairs, Directors (\*MPP Admin II) | Approval - CSUBUY (goods/services) Approval - Concur Travel Request and Expense Approval - Hospitality | CSUBUY, Concur, Hospitality - Up to $100,000 |
| 5 | Individuals who process, monitor, and initiate expenditure transactions on behalf of a higher authority | Associate Deans | Approval - CSUBUY (goods/services) Approval - Concur Travel Request and Expense Approval - Hospitality | CSUBUY, Concur, Hospitality - Up to $5,000 |
...
[**Delegation of Authority Request Form (PDF)**](docs/cpp-delegation-of-fiscal-authority-request-form_2025.pdf)

[**Delegation of Authority (DOA) Request Smartsheet**](https://app.smartsheet.com/b/form/2505d5d34c3f4fc0bd81c4a51b1c60fb)

Check the status of past submissions [HERE](https://app.smartsheet.com/dynamicview/views/44bd006d-f6a4-4fea-aba9-2256d77434e6).

## FAQ

**Q: Why are we implementing a new Delegation of Fiscal Authority?**

*A: A new Delegation of Fiscal Authority is being implemented to align with the FBRC’s CSU Delegation of Authority Standard in preparation for Procure-to-Pay.*

**Q: I previously signed a Signature Authorization Form but I never signed a DOA Form. Do I still have signature authority?**

*A: No, the Signature Authorization Forms are now obsolete. In order to be an authorized signor/approver one must have an approved DOA Form on file.*

**Q: Do I still need to obtain other approval signatures within my college/unit?**

*A: While Financial Services only requires the appropriate level of signature within the Delegation of Fiscal Authority, your college/unit may have other internal procedures you must follow. Please refer to your college/unit policies and procedures.*

**Q: How do I establish a temporary DOA?**

*A: A temporary DOA must remain within the existing DOA structure. The fiscal approver must be someone already in the structure and may be at the same or a lower level. Managers or individuals outside the structure cannot be delegated as a temporary DOA. To make the delegation valid, a DOA form must be completed, submitted, and properly filed.*
