**Source:** http://www.cpp.edu/~class/science-technology-society
...
![STS Science, Technology, and Society; College of Letters, Arts, and Social Sciences](img/sts_landing_page_small_image-15x7.jpg)

# Science, Technology, and Society

![Parker Graffham presenting on his senior thesis](img/sts_landing_page_large_image.jpg)

## New technologies and the future

Do you have strong views about how new technologies can significantly help or seriously harm our future? Are you interested in getting involved with managing technology's influence on society? Science, Technology, and Society is an interdisciplinary field which examines science and technology in relation to society.
...
Best Undergrad Teaching (West)

U.S. News and World Report, 2023

![circuit board](img/dalle-call-to-action-card3.jpg)

## New Option!

### AI Ethics and Society

The AI Ethics and Society Option of Science, Technology, and Society is starting in Fall 2025. This Option prepares you to address problems AI raises--societal problems that cannot be addressed by technology alone.

[Learn more about the new option](https://www.cpp.edu/class/science-technology-society/about-page.shtml#ai-ethics  "opens a new window")
...
## An Example STS Problem

### Gene Editing

An example problem for STS: gene editing technology called CRISPR/Cas9 is a powerful and relatively easy to use new tool for modifying plant or animal genes. Now that we have this powerful tool, what limits should governments place on its use to modify human beings? Should heritable genetic changes in humans be banned? What if some governments don't ban this so that their societies gain leadership in developing the technology? Addressing this question requires not only technical background, but also grounding in ethics, policy, and culture.

[Learn more about STS](https://www.cpp.edu/class/science-technology-society/about-page.shtml%20 "opens a new window")

![Gene editing icon](img/enhanced_gene_editing_icon.png)
...
![](img/cpp-bitmap-horses.jpg)](student-resources/contact-info.shtml "opens a new window")

[Get involved! AI student club

![](img/cpp-bitmap-stables.jpg)](clubs/ai-ethics-club.shtml "opens a new window")

[Get involved! STS student club

![](img/cpp_bitmap_nature_500x381.jpg)](clubs/sts-club.shtml "opens a new window")
