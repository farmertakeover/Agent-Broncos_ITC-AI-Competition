**Source:** https://www.cpp.edu/admin-affairs/org-effectiveness/project-management.shtml
...
![](pictures/pmfgvy.jpg)**The OE Team's Project Management service goals include:**

* Creating strategic alignment between all stakeholders involved in any given initiative.
* Providing the leadership needed to take an idea from conception through development and on to final delivery.
* Designing clear, focused objectives and goals, and achieving buy-in from all relevant stakeholders.
* Developing a realistic resource plan that can achieve achieving the project’s objectives on time, under budget, and within scope.
* Ensuring that the final delivery meets the expectations of the organization and/or the client.
...
**[Project Charter Template (PDF)](pictures/project-charter-template.pdf)**

**[Microsoft Project Planning Sheet](https://livecsupomona.sharepoint.com/%3Au%3A/s/oes/ERVOqNgNJfJJtc3GLW5a70cBEAP4UGMrsZ4uQ5eZx1Hdbg?e=VGET7g)**

* **The Project Planning Sheet contains a project outline, Gantt Chart, and timeline. The sheet opens in Microsoft Projects which can be downloaded from the app store with an end-user license.**

![](pictures/projectsub.png)

## Project Submission

**If you are interested in implementing a project in your area, click on the link below and submit a request. The OE team will review the submission and contact you for an interview to assess the project.**
