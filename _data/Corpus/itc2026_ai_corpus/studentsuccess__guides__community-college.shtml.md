**Source:** http://www.cpp.edu/studentsuccess/guides/community-college.shtml
...
Taking courses at a community college is an option for meeting your [30 units for the academic year](https://www.cpp.edu/studentsuccess/take30/index.shtml) or getting ahead on your lower-division requirements. Read below for the general steps to take in transferring supplemental transfer credit to CPP.

*This guide has been adapted from how-to materials written by the [College of Letters, Arts, and Social Sciences Student Success Center team](https://www.cpp.edu/class/student-success-center/index.shtml).*

## Step 1: Find A Community College

Use the [California Community Colleges' Find a College Tool](https://www.cccco.edu/Students/Find-a-College) to see a map. CPP students often take classes at Mt. Sac, Citrus College and Chaffey College.
...
You can use [Assist.org](https://assist.org/) to look up the articulation agreement between the California Community Colleges and CPP. The simplest way to search is to pick your college and CPP, and then view by major, department or subject prefix.
...
**If you are taking the course as a prerequisite to a CPP course the following term,** you should contact [the department offering the CPP course](https://www.cpp.edu/studentsuccess/directories/departments-az.shtml) to avoid being dropped for not meeting prerequisites.
...
[Visit the Financial Aid & Scholarships website](https://www.cpp.edu/financial-aid/other-programs/cross-enrollment.shtml) for more detailed information, including eligibility requirements and additional steps. If you use this option, you will also need to submit the [Application for Cross Enrollment](https://www.cpp.edu/registrar/forms/forms.shtml) to the Registrar's Office.

### How do I know which course(s) I can take?
...
### Can I retake a course at a CC that I did not pass at CPP for Grade Forgiveness?
