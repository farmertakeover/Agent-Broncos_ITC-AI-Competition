**Source:** https://www.cpp.edu/student-accounting/student-account-help/sacs-faqs.shtml
...
### Why do I have a BFH hold on my account?
...
### I can't pay all of my tuition right now. What can I do?

Installment Payment Plan (IPP):

* Available for the portion of tuition not covered by financial aid.
* [How to sign up for the Installment Payment Plan](https://www.cpp.edu/student-accounting/payment-options/paymentplan.shtml "How to sign up for the Installment Payment Plan")

### How do I sign up for the Installment or Monthly Payment Plan?

* Visit [TouchNet](https://secure.touchnet.net/C20365_tsa/web/caslogin.jsp "TouchNet Payment Plan provider")to enroll in a payment plan.

### How do I enroll in Direct Deposit for financial aid or refunds?
...
* Link: [Direct Deposit information](../payment-options/direct-deposit-for-student-refunds.shtml "Direct Deposit information")

### How do I get a refund if I drop classes or withdraw?

Refunds are issued based on your withdrawal date and the refund schedule for that term. View the full policy on our [Refund policy](../refund-and-holds/refund-policy.shtml "Refund policy") page.

### What is a third-party sponsorship?

This is when an external organization pays your fees on your behalf. This can include employers, embassies, military branches, or government agencies. Learn more on our [Third-Party Payment](../payment-options/third_party_billing.shtml "Third-Party Payment information") page.

### Where do I view my account balance and activity?

You can log in via the [MyCPP student portal](https://my.cpp.edu/ "MyCPP student portal"), which offers a user-friendly dashboard and single sign-on access to BroncoDirect. Your account is organized into several sections to help track charges, payments, and financial aid. Visit the [Understanding Your Student Account](understanding_your_student_account.shtml "Understanding Your Student Account") page for more details.

### Where can I find important dates like fee deadlines or registration periods?

All key term deadlines are available on the [Dates & Deadlines](../dates-and-deadlines/dates-and-deadlines.shtml "Dates & Deadlines") page.

### What are campus fees?
...
### Are campus fees the same as auxiliary fees?
...
You can check your due dates by logging in to your **[BroncoDirect](https://my.cpp.edu/ "BroncoDirect") Student Center**:
...
[Installment Payment Plan (IPP) Instructions](https://www.cpp.edu/student-accounting/payment-options/paymentplan.shtml)

[Direct Deposit Setup](../payment-options/direct-deposit-for-student-refunds.shtml)

[Dates & Deadlines](../dates-and-deadlines/dates-and-deadlines.shtml)

[Understanding Your Student Account](understanding_your_student_account.shtml)
