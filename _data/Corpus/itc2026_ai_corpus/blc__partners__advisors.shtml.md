**Source:** http://www.cpp.edu/blc/partners/advisors.shtml
...
All advisors must be working at Cal Poly Pomona the entire academic year and must be one of the following below:
...
## Subscribe to our Advisor Newsletter

If you are an aspiring advisor, or want to just be in the loop of our communications, change your subscription preferences below.

[Subscribe to BLC Faculty/Staff Newsletters](https://engage.cpp.edu/register/BLCFacStaffNewsletter)

## Advisor Email Archive

### June 6, 2025 - Club & Organization Announcement

Dear Club & Organization Advisors,

We’re currently midway through the club and organization registration process, and we’ve now reached the crucial phase of verifying that all registration requirements have been completed. This is where we need your help.

If you have not yet completed the **[Advisor Session](https://csu.sumtotal.host/rcore/c/dash/Learning_Assigned/initial)** within CPP Learning (csu.sumtotal.host), please do so as soon as possible. Incomplete advisor requirements will delay the approval process for your club or organization, which can impact access to important resources such as:
...
If you encounter any issues accessing or completing the Advisor Session, please do not hesitate to reach out to me directly—I am happy to help.

Thank you for your continued support and commitment to our student organizations!

### May 14, 2025 - 2025-26 Club & Organization Advisor Announcement

Hello and welcome, Advisor! I hope this week is going well. But, before it comes to an end, I ask that you read through the following:

* You've been named an Advisor for a student club, organization, or council, for the 2025-26 academic year.

* Registration is an annual process and must be completed by everyone in a required position each year.

* Clubs & Organizations have submitted their Proposals, identifying the incoming 2025-26 President, Treasurer, Scheduler, Advisor, and Authorized Signer.

  + An Authorized Signer is now required to serve as a third "student" signer; this is important, for example, on those occasions where the President or Treasurer seek reimbursement and cannot sign for their own reimbursement. Because two student signatures are always required, an additional student signature, an authorized signer, is necessary.
* If you haven't already, during May 10-16, you will receive an email providing access to the Advisor Session, in CPPLearning (SUMTOTAL). **You must complete this session in order for your club to meet all registration requirements.** If you happen to advise more than one club, you're only required to complete the session once for 2025-26.

* Additional resources can be found on the BLC [Website](https://www.cpp.edu/blc "https://www.cpp.edu/blc"), and also included in the Advisor Session.
...
### Advisor Guidance (from the Club/Org Handbook)
...
* Partnering with the student organization to plan and be present for safe and productive events. Please be sure to stay up to date with the campus event guidelines. ([CSU Time, Place and Manner Policy and CPP Addendum (cpp.edu)](https://www.cpp.edu/free-speech/policies.shtml))
...
* Become familiar with the [Student Code of Conduct (cpp.edu)](https://www.cpp.edu/studentconduct/policies/code.shtml), the [Student Conduct Process (cpp.edu)](https://www.cpp.edu/studentconduct/policies/conduct-process.shtml) and other institutional guidelines that establish expectations for student behavior and activities.
...
### What paperwork do Advisors normally do?

Advisors perform several important functions. Here are the most common tasks, and the links on how to accomplish them.

* [25Live Tasks](https://25live.collegenet.com/pro/cpp#!/home/search/task/list/Outstanding)
...
* [Accept your myBAR invitations (cpp.edu)](https://mybar.cpp.edu/invitations)
...
* OnBase Approval Queues
  ...
  + You must use a laptop or desktop computer and be on-campus or connected to the campus VPN to access these queues.
  + [ASI Disbursement Request (cpp.edu)](https://polydoc.cpp.edu/AppNet/Workflow/WFLogin.aspx?LifeCycleID=159&QueueID=717)
  + [ASI Purchase Orders (cpp.edu)](https://polydoc.cpp.edu/AppNet/Workflow/WFLogin.aspx?LifeCycleID=173&QueueID=719)
* Yearly Budget Deadlines
  + The funding cycle for returning clubs/orgs occurs from February - May each year.
  + For more information go to the [ASI Club Services Finance Support Website (cpp.edu).](https://asi.cpp.edu/services/club-services/finance-support/)

### Policies

Advisors must understand all the policies governing clubs and organizations at Cal Poly Pomona.

* [Administration of Student Organization Funds Policy ICSUAM 03141 (policystat.com)](https://calstate.policystat.com/policy/15008510/latest)
* [Campus Reporting of Fiscal Improprieties, Executive Order 1104 (policystat.com)](https://calstate.policystat.com/policy/13576706/latest)
* [Student Travel Policy, Executive Order 1041 (policystat.com)](https://calstate.policystat.com/policy/6590083/latest/)
* [Student Activities Policy, Executive Order 1068 (policystat.com)](https://calstate.policystat.com/policy/10170470/latest/)
* [Free Speech @ CPP](https://www.cpp.edu/free-speech)
  + CSU Interim Time, Place and Manner Policy
  + CPP Addendum to the CSU Time, Place and Manner Policy
* [Student Conduct Code (cpp.edu)](https://www.cpp.edu/studentconduct/policies/code.shtml "Cal Poly Pomona Student Conduct Code")
* [Student Conduct Process (cpp.edu)](https://www.cpp.edu/studentconduct/policies/conduct-process.shtml "Cal Poly Pomona Student Conduct Code")

### Who can I talk to if I have an issue or need to consult?

If you have any questions or want to consult on an issue related to your club or organization, please contact the Bronco Leadership Center at leadership@cpp.edu or (909) 869-2841.

## Important Links

[### Access CPP Learning (mobile)](https://www.cpp.edu/blc/docs/leadership-toolkit-mobile.docx)

[### Club and Org Email Archive

We archive all messages sent to club and org leadership on this page. If you are not receiving these messages, please email us at leadership@cpp.edu.](https://www.cpp.edu/blc/student-leaders/club-org-toolkit.shtml#emailarchive)

### Access the Advisor Session

If you need access to the advisor session please contact the Bronco Leadership Center at leadership@cpp.edu. We have to add you manually so you receive proper credit for completing the advisor session.

[### Club and Org Handbook

The handbook captures the rules, policies, and expectations for clubs and organization operations.](../student-leaders/club-org-handbook.shtml)

[### Student Conduct Process

If your organization becomes involved in the student conduct process, you can view information about it.](https://www.cpp.edu/studentconduct/office-process/org-process.shtml)
