**Source:** https://www.cpp.edu/msti/awards-and-programs/msti-scholar.shtml
...
The Math and Science Teacher Initiative's (MSTI) objective is to support talented Science and Mathematics majors who might not have considered the teaching profession. Each MSTI Scholar can receive up to $10,000 in awards ($2,500 per semester).  MSTI Scholars will be selected based on academic achievement and demonstrated commitment and experiences related to STEM teaching.  MSTI Scholar Awards are available to those seeking a single subject credential in Life Sciences, Chemistry, Geosciences, Mathematics, Physics and Foundational Level General Science and Math. Awards will be allocated on a competitive basis.

[MSTI Scholar Award PowerPoint](../docs/mstischolaraward)

![during MSTI seminar](../img/msti_seminar)

## Deadlines to receive funding:

**Fall Semester 2026:**  May 4, 2026

**Spring Semester 2027**:  November 13, 2026

## MSTI Requirements

Expand/Collapse All MSTI Requirements
...
### Minimum Requirements for Credential Candidates
...
### Unit Requirements for Credential Candidates
...
[MSTI Online Application](https://polyform.cpp.edu/Loginformproc/UnityForm.aspx?d1=AXuVxHurJop0H7%2bQZKCSRsG9TDU5YCLW0vZsyEv7z%2bTQhXPINOO2DFD4T8fNnjd3XjNKxBM7SSyl3dQEIZ7Jz3ePzxipwE%2fccgWvq5uZWc%2fUmPuzyUxc7rqJVfTr54jlvTg%2brcRrWjQStx7ol6INb1%2fpWfgDogJMe9TWmBj3xOovEBypZW8oxatxml1XeggRzrDEQhlQ%2fk8Z4y0xFOOEuwDatvPoFFCQt%2fViRDWMHu39Tmg%2fxsZ%2fxSgW8IJJh973aA%3d%3d)

![during MSTI seminar with students listening and taking notes](../docs/mstiseminar.jpg)

## MSTI Scholar Award Obligations

MSTI Scholars are required to obtain their teaching credential at Cal Poly Pomona, attend monthly seminars, meet with the single subject advisor, and teach in a public school district within California for every year of MSTI Scholar Award support. Undergraduate MSTI Scholars must maintain a minimum grade point average (GPA) of 3.0 with a preference given to those who have no lower than 3.0 in their major. Post baccalaureate MSTI Scholars must maintain a minimum GPA of 3.3 in credential coursework.

![two females during MSTI seminar](mstiseminar2.jpg)
