**Source:** https://www.cpp.edu/sci/biological-sciences/graduate-studies/gradprog/thesis-defense.shtml
...
**View this one page [Suggestions/Guidelines for the Thesis Defense](../../docs/gradprog/guidelines_for_thesis_defense.pdf) for additional discussion of some of the topics and expectations that may be part of your thesis defense.**
...
The last day to defend varies from semester to semester. The date is usually around finals week but varies. Be sure to review the [Thesis/Project Guidelines](https://www.cpp.edu/gradstudies/steps-towards-completing-your-thesis-or-project.shtml) provided by the [University Office of Graduate Studies](https://www.cpp.edu/gradstudies/index.shtml). The [Thesis/Project Guidelines](https://www.cpp.edu/gradstudies/steps-towards-completing-your-thesis-or-project.shtml) page has deadlines and much additional critical information. It is not a good idea to wait until the very end of the semester. Allow time for changes to be made to the thesis. You may have to allow for some additional discussion with your committee. If changes are necessary, and there's no time to do them, it may delay your graduation into the next semester. Defending at least two weeks prior to the deadline is a good plan.
...
## Publicizing the Thesis Defense
...
Send an email to the [Graduate Coordinator](https://www.cpp.edu/sci/biological-sciences/graduate-studies/contact.shtml) that includes the following:
...
Information on the forms that must be submitted after the defense can be found [here](../../forms/thesis-defense-forms-2021.pdf).
