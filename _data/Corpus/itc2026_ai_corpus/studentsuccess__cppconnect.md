**Source:** http://www.cpp.edu/studentsuccess/cppconnect
...
## CPP's Appointment Scheduling Tool

## Log In

[CPP Connect for Students](https://cpp.campus.eab.com/)

Note: Fall 2026 admits will gain access to CPP Connect in August 2026.

## Mobile Apps

[Download the Mobile App for iOS](https://apps.apple.com/us/app/navigate-student/id950433229)

[Download the Mobile App for Android](https://play.google.com/store/apps/details?id=com.eab.se&hl=en_US)

## Accessibility Features in CPP Connect

CPP Connect now has additional accessibility adjustments, including Enhanced Accessibility Mode, a content reader, a content timer and settings to adjust font size and spacing. Click on the accessibility icon on any individual page to turn on these features for that page. If you have questions about these settings or need alternative access to information in CPP Connect, email cppconnect@cpp.edu, call 909-869-4600 or visit the Bronco Advising Center at the Student Services Building, first floor, blue counter.

## Resources

[### Student Guide (PDF)](https://www.cpp.edu/studentsuccess/documents/cpp-connect-student-guide.pdf "opens a new window")

[### Degree Planning Questions

Contact Your Advisor](../directories/advising-directory.shtml "opens a new window")

### Technical/Other Questions

Email cppconnect@cpp.edu
