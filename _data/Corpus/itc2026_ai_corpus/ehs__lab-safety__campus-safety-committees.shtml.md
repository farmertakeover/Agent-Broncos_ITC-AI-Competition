**Source:** http://www.cpp.edu/ehs/lab-safety/campus-safety-committees.shtml
...
![group of individuals in a meeting](../img/campus-safety-committee.jpg)
...
* Review all internal safety inspection reports conducted by management, or external reviews conducted by regulatory bodies, and offer suggestions and recommendations relative to the reports' findings and conclusions.
...
**Functions**
Implement chemical procurement procedures.
Implementation of a centralized chemical inventory database.
Implementation of an online waste tracking system.
Review incidents involving hazardous materials and provide corrective action recommendations.

**Schedule**
The committee currently meets at least once per semester. To propose agenda items in advance of the next meeting, please email ehs@cpp.edu.
