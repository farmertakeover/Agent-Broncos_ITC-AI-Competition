**Source:** https://www.cpp.edu/accessibility/powerpoint.shtml
...
## Why is PowerPoint accessibility important?

PowerPoint accessibility is essential for ensuring that all individuals, including those with visual, auditory, cognitive, or motor impairments, can access and understand presentation content. Accessible presentations remove barriers to learning and promote inclusivity and equal participation. They also help organizations comply with legal accessibility requirements and demonstrate a commitment to diversity and equity. Making presentations accessible benefits everyone by improving clarity, usability, and overall effectiveness.

![Two students walking under the breezeway between the student services buildings.](img/2022-ssb-breezeway.jpg)

## Resources

[CAFE's PowerPoint Accessibility Guide](https://www.cpp.edu/cafe/teaching-and-learning/accessibility-tutorials/microsoft-powerpoint.shtml)

[Microsoft Guide to PowerPoint Accessibility](https://support.microsoft.com/en-us/office/make-your-powerpoint-presentations-accessible-to-people-with-disabilities-6f7772b2-2f33-4bd2-8ca7-dae3b2b3ef25)

[WebAIM PowerPoint Accessibility](https://webaim.org/techniques/powerpoint/)

[Section 508 PowerPoint Videos](https://www.section508.gov/create/presentations/)
