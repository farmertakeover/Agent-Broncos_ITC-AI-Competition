**Source:** https://www.cpp.edu/provostsawards/about-the-awards/service.shtml
...
* Personal statement about service activities (two (2) pages, double spaced, 12-point font, 1-inch margins).
* A *curriculum vitae* on the [approved form (.docx)](../documents/cv-form-for-service.docx); no other version of the CV will be considered.
* Relevant materials that provide evidence of the nominee’s excellence in service.
* Three letters from colleagues who can provide evidence of the nominee’s excellence in service. These must be on letterhead and signed or they will not be considered. Click the link for the [Letter of Support Form (.docx)](../documents/provosts-awards-letter-of-support.docx).
* Up to three letters from current or former students who can provide evidence of the nominee’s excellence in service. These letters do not need to be on letterhead, but must be signed and include Bronco ID number, or they will not be considered.
