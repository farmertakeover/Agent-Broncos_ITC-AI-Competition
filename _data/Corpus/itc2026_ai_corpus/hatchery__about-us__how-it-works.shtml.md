**Source:** https://www.cpp.edu/hatchery/about-us/how-it-works.shtml
...
![](../img/banners/how-it-works-topbanner.png)

# How It Works

![Key Program Requirements](../img/banners/program-requirements.png)
...
If you are interested in applying, please check out [How to Join the Hatchery](https://www.cpp.edu/hatchery/join.shtml).

![](../img/misc/phase1-infographic.png)

View Phase I

###

![Hatchery Phase 1 Infographic](../img/misc/phase1-infographic.png)

Close

![](../img/misc/phase2-infographic.png)

View Phase II

###

![Hatchery Phase 2 Infographic](../img/misc/phase2-infographic.png)

Close

![](../img/misc/phase3-infographic.png)

View Phase III

###

![Hatchery Phase 3 Infographic](../img/misc/phase3-infographic.png)

Close

![Monthly Meetings](../img/banners/monthly-meetings-header.png)

During the Hatchery process, students will be attending monthly meetings. Monthly meetings are an essential component of Projects Hatchery and are designed to:

![](../img/misc/hatchery-icon-info.png)

Provide students with helpful information such as faculty-led presentations, tips on project work, or skill building activities.

![](../img/misc/hatchery-icon-community.png)

Foster a community of likeminded scholars that can network and share opportunities.

![](../img/misc/hatchery-icon-progress.png)

Allow teams to present on their project progress to advance to the next phase.
