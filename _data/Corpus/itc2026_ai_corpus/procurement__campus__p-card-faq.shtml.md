**Source:** http://www.cpp.edu/procurement/campus/p-card-faq.shtml
...
## Why is my PCard transaction declined?

Please note that PCard purchases can be declined due to various reasons (see below):

* [Prohibited purchase](docs/prohibited-purchases-with-a-procurement-card.pdf)(PDF)
* MCC Code blocked
* Purchase items over monthly/single limit
* Vendor is not within the United States

## How do I register/activate my PCard?

Refer to attached [US BANK Access Online Cardholder Training](docs/procard/access-online-training-guide-r.8--3.2021.pdf) (PDF), page 3, 4 – 8.

\*A new temporary password may need to be created by the PCard Administrator, Janice Lam.

## What is my current monthly and single purchase limit?

Refer to attached [US BANK Access Online Cardholder Training (PDF)](docs/procard/access-online-training-guide-r.8--3.2021.pdf), page 13 under Authorization Limits.

## Can I use PCard for software purchase?

Software purchases may be approved for PCard and are evaluated on a case-by-case basis.

\*If approved please note that an [ATI/IT Review](https://www.cpp.edu/accessibility/procurement/index.shtml) must be completed and submitted to procurement with a requisition for purchase via [Smartsheet](https://app.smartsheet.com/b/home?lgt=wf&lrt=s&EQBCT=7a4d769706fe4266bef814fe8d2cac52).

## Can I use my PCard to order food for faculty/staff training or meeting?
...
## How do I reallocate expense?

Refer to page 20 – 22 of the [US BANK Access Online Cardholder Training (PDF)](docs/procard/access-online-training-guide-r.8--3.2021.pdf), or follow these steps in the [US BANK Access Online web-base training](https://www.access.usbank.com/cpsApp1/AxolPreAuthServlet?requestCmdId=login):
...
## What steps should I take to reimburse the university/state if I mistakenly charged personal items to my PCard?
...
## How do I get access to the CSUBUY Marketplace?

To create an automatic account, log in, log out, and then log back in.

## Who do I contact if I am experiencing issues with Amazon/Staples on CSUBUY.

Contact Janice Lam directly at jlamnguyen@cpp.edu

## Can I use the PCard to book hotel accommodations for professor candidates?
...
## Can my PCard be used for student events, field trips, or student de-stress activities (e.g., lunch/activities)?
...
## How do I reconcile expenses for late invoices from previous months?
