**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/templates-instructions/program-page-instruction.shtml
...
# Program Page Instruction

## Introduction

To start creating content for your website, go to the top left corner next to the site menu, and click on the Add Content button. Next, click on the Entity folder button and choose the Program Page template.

![program page addcontent](../img/program-page-addcontent.png)

This checklist breaks down each element of the new CPP web template for the [Program Page](https://www-test.cpp.edu/green-and-gold/mockups/program-page.shtml). Use this as an interactive guide to collect all the content you will need for your page and you will be set up for success during the content entry process in Cascade. If you are using this template and are not a college, you will need to adjust your page accordingly and may find some guidelines do not apply to you. It may be helpful to have both the template, and this checklist open simultaneously. If you require assistance understanding what template to use, please submit a [ticket](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=80cc3358db951c50e00f785e0f961996&sysparm_category=d571b2f26f84820025ce9e4eae3ee482).
...
* [Hero Programs](../module-instructions/hero-program.shtml)
* [Quicklinks](../module-instructions/link-list.shtml)
* [About](../module-instructions/about.shtml)
* [Call to Action Buttons](../module-instructions/call-to-action-cards.shtml)
* [Carousel (Career Outcome)](../module-instructions/carousel-cards.shtml)
* [Carousel (Optional)](../module-instructions/carousel-standard.shtml)
* [Course Information](../module-instructions/course-information.shtml)
* [Standard Text/Image (Optional)](../module-instructions/text-image.shtml)
* [Featurette (Optional)](../module-instructions/featurette.shtml)
* [Accordion (Optional)](../module-instructions/accordions-faq.shtml)
