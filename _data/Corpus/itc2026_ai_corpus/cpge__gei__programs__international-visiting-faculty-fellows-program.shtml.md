**Source:** https://www.cpp.edu/cpge/gei/programs/international-visiting-faculty-fellows-program.shtml
...
![student reaching to globe](../img/21.9-ivff-program.jpg)
...
* [J2 dependent's information form (PDF)](../docs/j2-dependent-form.pdf) and their passport copy (only if your spouse and/or child need to travel with you as your J2 dependents)

Once you have your application documents ready, please click the button of "Apply Now" to submit an online application.

If you prefer using an application form to apply, please download it [from here (PDF)](../docs/j1-application.pdf). Once you complete the application form, please email it to Mr. Arthur Wang (haichaowang@cpp.edu).

## Apply Now

Before you click the "Apply Now" button, please make sure you have all the application documents listed above.

[Apply Now](https://cpge.cpp.edu//portal/applications/applicationProfile.do?method=loadApplicationIndex&applicationProfileId=1724442 "Apply Now. ")
