**Source:** https://www.cpp.edu/our-cpp/events-workshops/cars/2020/presentations/presenter-directory.shtml
...
The [Symposium Schedule](../schedule.shtml) provides an overview of the agenda for the day. If you are looking for a specific session schedule, use the [Session Schedule](session-directory.shtml).
...
[Skip Sorting by Letter and go to results](#directory-list)

* All
* {{letter}}

## {{ presenter.T1NameLast }}, {{ presenter.T1NameFirst }}

### {{ presenter.ProjectTitle }}

**Session {{ presenter.Sessionno }}: {{ presenter.SessionName }}**
