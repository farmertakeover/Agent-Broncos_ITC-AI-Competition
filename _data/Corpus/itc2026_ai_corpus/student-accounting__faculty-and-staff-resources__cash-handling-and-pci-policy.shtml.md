**Source:** https://www.cpp.edu/student-accounting/faculty-and-staff-resources/cash-handling-and-pci-policy.shtml
...
The purpose of this document is to establish a campus protocol and procedural guidelines for the handling of cash and cash equivalents and an appropriate segregation of duties in accordance with the University and ICSUAM Policies 6000. [University Main Cashiering: Cashiering Handling Procedure (PDF)](../forms-and-policies/csu-pomona-cash-handling-2025.pdf "University Main Cashiering: Cashiering Handling Procedure")

### Cash Handling Policy References

* ICSUAM 6100 – [Centralized Management of Cash and Investments](https://calstate.policystat.com/policy/16324507/latest/ "Centralized Management of Cash and Investments")
* ICSUAM 6200 - [Campus Administration of Systemwide Cash Management](https://calstate.policystat.com/policy/15451137/latest/ "Campus Administration of Systemwide Cash Management")
* ICSUAM 6201 - [Sensitive Positions and Cash Handling](https://calstate.policystat.com/policy/17973887/latest/ "Sensitive Positions and Cash Handling")
* ICSUAM 6202 – [Segregation of Cash Handling Duties](https://calstate.policystat.com/policy/17640481/latest/ "Segregation of Cash Handling Duties")
* ICSUAM 6330 – [Security of Cash and Cash Equivalents](https://calstate.policystat.com/policy/16402118/latest/ " Security of Cash and Cash Equivalents")
* ICSUAM 6340 – [Credit/Debit Card Payments](https://calstate.policystat.com/policy/16402118/latest/ "Credit/Debit Card Payments")

### Cash Handling Training

**Training & Certification**: Annual mandatory training modules for staff involved in payment collection or processing to ensure awareness of responsibilities and security practices. [CPP Learning Link o Payment Card Industry Data Security Standard (PCI DSS).](https://CSU.sumtotal.host/core/pillarRedirect?relyingParty=LM&lang=en-us&domain=42&url=app/management/LMS_ActDetails.aspx%3FActivityId%3D43465%26UserMode%3D0 "CPP Learning Link o Payment Card Industry Data Security Standard (PCI DSS).")
