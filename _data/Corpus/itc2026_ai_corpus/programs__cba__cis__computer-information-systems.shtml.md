**Source:** https://www.cpp.edu/programs/cba/cis/computer-information-systems.shtml
...
![Dean Krishnamirthy in cyber lab with students](../img/cis-home-24.jpg)

## Quicklinks

[Home](https://www.cpp.edu/cba)
[CIS Department](https://www.cpp.edu/cba/computer-information-systems/index.shtml)
[Faculty](https://www.cpp.edu/cba/computer-information-systems/faculty/index.shtml)
[Current Students](https://www.cpp.edu/cba/computer-information-systems/current-students/index.shtml)
...
Whether it’s building business applications, strengthening cybersecurity and computer forensics, or harnessing the power of business intelligence, our students gain hands-on experience that prepares them to lead.
Through our signature “learn-by-doing” approach, our department has a proud history of driving innovation in information systems education. Employers consistently praise our graduates for their ability to “hit the ground running,” their “can-do attitude,” and their leadership and teamwork skills. Join us at CIS and get ready to shape the future of technology and business!
...
A Computer Forensics Examiner investigates digital devices to collect, preserve, and analyze evidence related to cybercrimes or data breaches.

### Mobile App Developer

A Mobile App Developer designs, creates, and maintains applications for mobile devices, ensuring functionality, performance, and user experience.

### Software Engineer

A Software Engineer designs, develops, tests, and maintains software applications and systems to solve problems and meet user needs.

### Business Analyst

A Business Analyst analyzes business processes, identifies opportunities for improvement, and provides data-driven recommendations to enhance efficiency and achieve organizational goals.

### Information Auditor

An Information Auditor evaluates and audits an organization's information systems, ensuring data accuracy, security, compliance, and effective use of technology.

### Database Administrator

A Database Administrator (DBA) manages and maintains databases, ensuring their security, performance, and availability for efficient data storage and retrieval.

### Security Specialist

A Security Specialist protects an organization's information systems and networks from cyber threats by implementing security measures, monitoring for vulnerabilities, and responding to incidents.

### DevOps Engineer

A DevOps Engineer bridges development and operations teams by automating processes, managing infrastructure, and ensuring efficient software delivery and system reliability.

### Information Systems Manager

An Information Systems Manager oversees an organization's IT infrastructure, ensuring the efficient operation, security, and alignment of technology with business goals.
...
[See Course Catalog](https://catalog.cpp.edu/preview_entity.php?catoid=65&ent_oid=5445&returnto=5342)
[Visit Advising](https://www.cpp.edu/outreach/index.shtml)
[Schedule a Tour](https://engage.cpp.edu/portal/campustour)

![Geoffrey Okamoto](../img/g-okamoto-testimonial-pic-copy.jpg)
