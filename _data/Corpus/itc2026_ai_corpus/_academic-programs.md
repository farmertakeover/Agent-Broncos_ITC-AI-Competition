**Source:** https://www.cpp.edu/~academic-programs
...
![Student studying](img/studying-for-finals.jpg)

# Office of Academic Programs

![Student group](img/frontpage1.jpg)
...
The office of Academic Programs role is to support faculty in developing programs that are intentionally designed, driven by student learning, and committed to student success. By supporting departments’ course and curriculum design, administering academic policies, and engaging in robust program review and assessment, the Office maintains both the University’s Catalog and WSCUC accreditation.

![professor in front of a class](img/classroom1.jpg)

## Faculty Resources

[![](img/sangho-working-rubric-scoring.png)

### Assessment and Program Review

Professional Development Opportunities, Resources, Policies](https://www.cpp.edu/assessment/index.shtml "opens a new window")

[![](img/books1.jpg)

### Curriculum Development

Guides and Templates](curriculum.shtml "opens a new window")

[![](img/schedule.png)

### Scheduling Resources

Timelines and Procedures](scheduling.shtml "opens a new window")

[![](img/18advising-bac-hoang.jpg)

### Advising Resources

Curriculum Sheets and Roadmaps](academic-advising/tools/sheets-roadmaps/index.shtml "opens a new window")

![Notebook](img/horgan-lauren-notebook.jpg)

## Take command of your coursework!

### General Education Updates

Beginning in Fall 2025, incoming students will help the CSU usher in a new GE program. Find a list of GE courses that meet each area requirement either at the link below or in the University Catalog. For GE course design, check out the Curriculum Development page.

[General Education Program Page](ge.shtml)

![Presenter in front of a screen](img/ai2.jpg)

## Generative AI in the Classroom

### Emerging Technologies

Emerging technologies like Generative AI (gAI) are transforming education, offering new ways to engage students, enhance learning experiences, and develop future-ready skills. The Generative AI Course Integration Grant, funded by the Kellogg Legacy Endowment, supports tenured and tenure-track faculty in integrating AI into new or existing courses.
Through this grant, faculty can receive $2,000...

[Learn More about CPP's Emerging Technologies Initiative](emerging-tech/emerging-technologies-initiative.shtml)

## University Accreditation

CPP is accredited by the WASC Senior College and University Commission (WSCUC). Additionally, many of CPP's programs are evaluated by external accreditors. Notable highlights include:

## Rankings

### 10 Years

#### Reaffirmation of University's WSCUC Accreditation
...
#### CAAHEP-accredited Exercise Science Bachelor's Program in CA

![](https://www.cpp.edu/common//green-and-gold/assets/images/vertical-line-circle.svg)

## Learn More About CPP's Programs

[University Catalog

![](img/24first-day-dewald.jpg)](https://catalog.cpp.edu/index.php?catoid=2 "opens a new window")

[Academic Programs List

![](img/grc-ribbon.jpg)](https://www.cpp.edu/programs/index.shtml "opens a new window")
