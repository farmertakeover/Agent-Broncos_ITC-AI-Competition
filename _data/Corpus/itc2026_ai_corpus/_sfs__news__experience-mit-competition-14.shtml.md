**Source:** https://www.cpp.edu/~sfs/news/experience-mit-competition-14.shtml
...
![MIT Competition Participants](../img/news/experience-mit-competition-14.jpg)

While most Cal Poly Pomona students began this school year getting back into the swing of things — buying books, adding or dropping classes and perusing syllabi — four of them were preparing for something else entirely. They were getting ready to hack MIT.
...
For more information on the event, which is scheduled for January, visit the [hackpoly Facebook page](https://www.facebook.com/Hackpoly). Visit the [Major League Hacking website](http://mlh.io/standings/) to see the entire list of rankings.

*(Photo: Copyright 2013 Kevin Yiming Chen/hackMIT)*

[Original Article on *PolyCentric*](http://polycentric.cpp.edu/2013/10/team_hacks_mit_competition/)
