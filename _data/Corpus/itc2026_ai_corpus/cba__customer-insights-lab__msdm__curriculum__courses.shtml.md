**Source:** https://www.cpp.edu/cba/customer-insights-lab/msdm/curriculum/courses.shtml
...
## DWV100: Data Wrangling and Visualization

The certificate consists of topics such as introduction to R, R data structure, data input and output, data manipulation with Tidyverse, R programming, and data visualization. Students without programming experience are strongly recommended to take the course offered as a professional certificate program through the College of Professional and Global Education. [Certificate](https://www.cpp.edu/cba/customer-insights-lab/curriculum/certificate/dwv/index.shtml). No academic credit is granted for this professional certificate.
