**Source:** http://www.cpp.edu/engineering/ece/about_us/labs.shtml
...
* [Home](/engineering/ece/index.shtml)
* [About Us](#item-1)

+ [Faculty & Staff](/engineering/ece/about_us/faculty.shtml)
+ [Facilities & Labs](/engineering/ece/about_us/labs.shtml)
+ [Department Business](/engineering/ece/about_us/dept.shtml)
+ [Alumni & Friends](/engineering/ece/about_us/alumni.shtml)

* [Prospective Students](/engineering/ece/prospective-students.shtml)
* [Undergraduate Programs](#item-2)

+ [Electrical Engineering](/engineering/ece/undergrad_programs/bsee.shtml)
+ [Computer Engineering](/engineering/ece/undergrad_programs/bsce.shtml)

* [Graduate Program](#item-3)

+ [Admission Criteria](/engineering/ece/graduate_program/admission.shtml)
+ [Faculty Advisors](/engineering/ece/graduate_program/faculty.shtml)
+ [Prerequisites](/engineering/ece/graduate_program/prerequisites.shtml)
+ [Recently Admitted Students](/engineering/ece/graduate_program/recently_admitted_students.shtml)

* [Student Resources](#item-4)

+ [Current Students](/engineering/ece/student_resources/current-students.shtml)
+ [Semester Conversion Guide](/engineering/ece/student_resources/semester-conversion.shtml)
+ [Downloadable & Forms](/engineering/ece/student_resources/forms.shtml)
+ [Student Activities](/engineering/ece/student_resources/clubs.shtml)

* [Contact Us](/engineering/ece/contact.shtml)

# Facilities & Labs

## ECE Labs

### 9-101 Illumination Laboratory
...
### 9-102 Advanced Imaging Laboratory
...
### 9-147 Basic Circuits Laboratory
...
* Teledyne LeCroyÂ Wavesurfer 3074 750MHz Digital Oscilloscope
...
### 9-409 Open Computer Laboratory
...
### 9-431 Operating Systems Laboratory
...
### 9-435 Microcontroller Laboratory
...
### 9-503 Signal Processing Laboratory
...
**[Laboratory Data Sheet](../documents/data-sheet-503.pdf)**

![503 Lab](../img/503-1.jpg)
...
### 9-507 Digital Systems and Networks Laboratory
...
### 9-523 Communications Laboratory
...
![Communications Lab](../img/523-1.jpg)

### 9-523a Prototype Laboratory
...
### 9-529 RF/Microwave & Electromagnetic
...
### 9-533 Student Project Laboratory
...
### COMPUTING LABORATORY - Room 9-409

Room 9-409 is a general-purpose computing Laboratory with 43 PC's and a LCD Projector. This Laboratory focuses on the use of student versions of basic engineering programs like PSPICE, MATLAB, Mathcad, Visual Studio, MS Office, and so on. This lab is available during all university hours except for class times and after hours by authorized bronco card access.

### COMPUTING LABORATORY - Room 9-205

Room 9-205 is a classroom and general-purpose computing Laboratory with 30 PC's and a LCD Projector. This Laboratory focuses on the use of student versions of basic engineering programs like PSPICE, MATLAB, Mathcad, Visual Studio, MS Office and so on. This lab is available during all university hours except for class times and after hours by authorized bronco card access.

### GENERAL PURPOSE LABORATORIES - Rooms 9-431, 9-435 and 9-147

Rooms 9-431, 9-435 and 9-147 are general purpose laboratories supported by Keysight DSOX2022A oscilloscopes, multimeters, power supplies and signal generators. These Laboratories are used for measuring the time and frequency response of linear circuits, for designing linear active circuits, and for the building and testing of basic logic circuits including the programming and interfacing of microcontrollers. Rooms 9-431 and 9-435 have 28 Keysight 200MHz oscilloscopes.

### SIGNAL PROCESSING LABORATORY - Room 9-503

Room 9-503 is used for experimenting & simulating of continuous and discrete-time signals as well as systems using Digital Signal Processing (DSP) boards with simulation software packages, and related Laboratory hardware.

### DIGITAL SYSTEMS and NETWORKS LABORATORY - Room 9-507

Room 9-507 is used to implement microcontroller-based applications and microprocessor-based system design Laboratories. The students design and implement PIC18F-based applications using both assembly and C. Typical projects include digital voltmeter and DC motor control. The students also design, develop, and build hardware and assembly language programs for Pentium-based applications from chip level.

### COMMUNICATION LABORATORY - Room 9-523

Room 9-523 is the Communications Laboratory. This Laboratory currently supports a total of five undergraduate, technology and graduate courses in the areas of analog communications, digital communications, radio frequency (RF) design, and digital signal processing (DSP). This Laboratory is used to study and implement the basic theory of the design and analysis of communications systems; and to learn the operation of laboratory instruments used in modern communications systems. It is also used to support the other communication Laboratories. Each bench includes standard Laboratory equipment and instrumentation for RF communication.

### MICROWAVE LABORATORY - Room 9-529

Room 9-529 is the Radio-Frequency Laboratory. It currently supports a total of eight undergraduate, technology and graduate courses in the areas of RF, microwave, applied electromagnetics and antenna theory. It provides hands-on experience in measurement techniques at RF/microwave frequencies ranging from 10 MHz to 18 GHz. It is used to conduct experiments on impedance matching, RF circuits, antennas, and S-parameter measurements using Network Analyzers. It is also used on other RF related courses.

### ILLUMINATION LABORATORY - Room 9-101

Room 9-101 is a special purpose Laboratory used for illumination engineering. It has specialized equipment such as integrating spheres, EMC pre-compliance software and hardware, environmental chambers, spectrum analyzers, CAD system, PSPICE and IEEE 488 controlled power supplies and voltmeters. Typical experiments consist of measuring lamp characteristics such as luminous efficacy, chromaticity and fixture efficiency.

## Laboratory Rules

### ECE Department Lab Rules
...
Ammeter shunt switches give additional protection for ammeters. They act as short circuits in parallel (across) with the ammeter, and are opened when a reading is taken. When the ammeter shunt switch is properly used and a wiring error has been made, dangerous current will flow through the shunt and bypass the meter. Be sure the meter is connected so that itÃ• full-scale reading is more than the voltage or current youÃ•e measuring.
...
8. It is best to turn an ohmmeter off after you have completed your measurements. This will insure against the battery being run down if the leads are accidentally shorted together. On most VOM's and DMM's, the ohmmeter section can be de-energized by switching to a "volts" position. It is best to leave the range switch on the highest position if there is no Ã’ffÃ“position.
...
[Free Parts List (PDF)](../documents/componentlist.pdf)
