**Source:** http://www.cpp.edu/financial-aid/resources/understanding-unit-maximums.shtml
...
A student is eligible to receive financial aid for a **maximum** number of overall attempted units for their primary program of study.  This **attempted unit maximum** is based on the published length of the program; at Cal Poly Pomona, all students must complete their program **within 150% of the published length of the program**.  This is measured as part of our [Satisfactory Academic Progress Standards for Financial Aid Applicants](https://cpp.cascadecms.com/entity/open.act?type=page&id=98273f4dac1e0049375003f1a0dc786a&confId=020b75608647f71f74b7f89fbfafc67f).

In addition to the attempted unit maximum, the [**State University Grant**](https://cpp.cascadecms.com/entity/open.act?type=page&id=98288966ac1e0049375003f192266dfe&confId=020b75608647f71f74b7f89fbfafc67f) has an **earned unit maximum** - based on the published length of a student's primary program of study.
...
***Caution:** Students may lose eligibility for certain grants or loans before these unit maximums are reached.  Be sure to review [Understanding Aid Program Limits](https://cpp.cascadecms.com/render/page.act?id=83717a9a0a00005e477f2a0c2a2ad33c&confId=adfb88350a00005e477f2a0c65db8f31) for details on the limits associated with each program.*

## Undergraduate Unit Maximums
...
**Please Note**: [SUG Unit Maximum](understanding-state-university-grant-eligibility.shtml) is based upon **earned units** while the [Satisfactory Academic Progress (SAP) Standards for the Receipt of Financial Aid](https://cpp.cascadecms.com/entity/open.act?type=page&id=98273f4dac1e0049375003f1a0dc786a&confId=020b75608647f71f74b7f89fbfafc67f) is based upon attempted units.
...
* [**Understanding State University Grant Eligibility**](understanding-state-university-grant-eligibility.shtml)
* [**Understanding SAP**](understanding-sap.shtml)
...
| Program | Published Length | Earned Unit Maximum (SUG Eligibility) | Attempted Unit Maximum (SAP - Overall Aid Eligibility) |
| --- | --- | --- | --- |
| Architecture, B. Arch | 150 Units | 187.50 Units | 225 Units |
...
## Teaching Credential Unit Maximums
...
## Graduate Degree Unit Maximums by College
...
* The **International Apparel Management, M.S.** program and the **Dietetics, M.S.** program are both administered through the [College of Professional and Global Education](https://www.cpp.edu/cpge/degree-programs/index.shtml). These programs are considered **self-supporting programs**, meaning the programs operate entirely on student fees; Cal Poly Pomona does not receive any state aid in support of them.
...
The following **graduate programs** in the College of Business Administration are administered through the [College of Professional and Global Education](https://www.cpp.edu/cpge/degree-programs/index.shtml). These programs are considered **self-supporting programs**, meaning the programs operate entirely on student fees. Cal Poly Pomona does not receive any state aid in support of these programs; they are therefore not eligible for the State University Grant.  They are, however, eligible for Federal Direct Student Loans.
...
The following **graduate programs** in the College of Engineering are administered through the [College of Professional and Global Education](https://www.cpp.edu/cpge/degree-programs/index.shtml). These programs are considered **self-supporting programs**, meaning the programs operate entirely on student fees. Cal Poly Pomona does not receive any state aid in support of these programs; they are therefore not eligible for the State University Grant.  They are, however, eligible for Federal Direct Student Loans.
...
**Please Note**: The Hospitality Management, M.S. program is administered through the [College of Professional and Global Education](https://www.cpp.edu/cpge/degree-programs/index.shtml). This program is considered a **self-supporting program**, meaning the program operates entirely on student fees. Cal Poly Pomona does not receive any state aid in support of this program; it is therefore not eligible for the State University Grant.
