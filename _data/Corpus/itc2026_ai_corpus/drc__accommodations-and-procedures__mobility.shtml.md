**Source:** http://www.cpp.edu/drc/accommodations-and-procedures/mobility.shtml
...
The Mobility Assistance Cart (MAC) provides intra-campus cart service for eligible students, faculty, and staff with mobility difficulties operated by Parking and Transportation Services

**Students:**DRC will determine eligibility for students with permanent or temporary mobility limitations. Students can apply for services through the [DRC application process.](https://www.cpp.edu/~drc/accommodations-and-procedures/drc-registration.shtml) If you are already a DRC student, please submit an [Additional Accommodation Request](https://cascade.accessiblelearning.com/CPP/dashboard/AdditionalDocumentation.aspx) on myDRC.

**Faculty and Staff:** Contact the University's ADA Coordinator at 909.869.4095 or adacoordinator@cpp.edu to determine eligibility for services. Once eligibility is confirmed, DRC will email further instructions.
...
[### How-To Mobility Assistance](https://sway.office.com/VZ6oHYqD7RzM8nbK?loc=swsp "opens a new window")

[### CPP Bronco Express Shuttle](https://www.cpp.edu/transportation/commuting-to-campus/bronco-shuttle.shtml "opens a new window")
