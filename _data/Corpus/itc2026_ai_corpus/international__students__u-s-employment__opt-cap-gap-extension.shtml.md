**Source:** https://www.cpp.edu/international/students/u-s-employment/opt-cap-gap-extension.shtml
...
![student opt h1b](../img/opt-girl-form.jpg)

![checklist](../img/560.check-list.jpg)
...
1. [Upload](../isso-forms/upload-document.shtml) copies of the following documents (PDFs only):
   ...
   * [eShipGlobal](https://study.eshipglobal.com/) payment confirmation email with the order number included
...
* A new [eShipGlobal](https://study.eshipglobal.com/) order confirmation

The ISSO processes completed Cap-Gap I-20 Requests within **ten business days** from submission.

### What do I do if my OPT expires and my Cap-Gap Extension request is still pending with the ISSO?
...
Per [USCIS](https://www.uscis.gov/working-united-states/temporary-workers/h-1b-specialty-occupations-and-fashion-models/extension-post-completion-optional-practical-training-opt-and-f-1-status-eligible-students-under-h-1b-cap-gap-regulations#capgap), “if an H-1B petition filed for an F-1 student with a cap-gap extension is denied, rejected, revoked, or withdrawn, the student will have the standard 60-day grace period (from the date of the notification of the denial, rejection, revocation, or withdrawal of the petition) to depart the United States.
...
Yes – if you meet all [STEM OPT eligibility requirements](https://www.cpp.edu/international/students/u-s-employment/stem-opt.shtml). USCIS must receive the STEM OPT Extension application before the cap-gap extension period is terminated (by September 30 or by the notice of rejection, denial, or revocation of the H-1B petition).
...
Per [USCIS](https://www.uscis.gov/working-united-states/temporary-workers/h-1b-specialty-occupations-and-fashion-models/extension-post-completion-optional-practical-training-opt-and-f-1-status-eligible-students-under-h-1b-cap-gap-regulations#capgap), “An F-1 student may generally travel abroad and seek readmission to the United States in F-1 status during a cap-gap period if:
