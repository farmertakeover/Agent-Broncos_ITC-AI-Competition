**Source:** http://www.cpp.edu/data/course-evaluations.shtml
...
* [IT Home](/it)
* [IRPA Home](/data/index.shtml)
* [About IRPA](/data/about.shtml)
* [CPP Facts](/data/cpp-facts.shtml)
* [Tableau Resources](/data/dashboards/index.shtml)
* [Student Achievement](/data/student-achievement.shtml)
* [Course Evaluations](/data/course-evaluations.shtml)
* [Related Links](/data/related-links.shtml)
...
IRPA adheres to the policies and course evaluation content that has been approved by the University and the Academic Senate. For more information regarding the policies that guide course evaluations please refer to [CPP Academic Manual, Policy No 1329](https://www.cpp.edu/academic-manual/1300-1399-academic-personnel-policies/1325-1349/1329-student-evals.pdf)

## Fall 2025 Course Evaluations

The course evaluation period for the Fall 2025 term is **November 16 through December 5** for students. Evaluations can be accessed directly within the [Blue](https://cpp.bluera.com/cpp) system, through email invitations sent directly to your CPP email or Canvas. Please contact evaluations@cpp.edu if you experience any technical issues accessing evaluations.

## Resources

[Explorance Blue Navigation Guide (PDF)](/data/authenticated/documents/course-evals/blue-navigation-guide.pdf)

[Course Evaluation Timeline (PDF)](/data/authenticated/documents/course-evals/course-evaluation-timeline-v2.pdf)

## Frequently Asked Questions from Students

### Where can I access my evaluations?

Evaluations can be accessed through the email invitation sent by CPP Course Evaluations. You can also access your evaluations through your Canvas course under the 'Course Evaluations' link in the left hand navigation menu or by logging into our evaluation software, [Blue](https://cpp.bluera.com/cpp). For more information, click on the following link to view the [Blue Student Guide (PDF)](authenticated/documents/course-evals/accessing-evaluations-students.pdf).

### Will instructors know that I completed an evaluation and how I responded?
...
### Why should I complete my course evaluation?
...
### Am I required to complete course evaluations?

No, however students are highly encouraged to complete them as results can better CPP courses.

### What types of questions can I expect or be asked?
...
### Can I provide written feedback?

Yes, at the end of each course evaluation form, there are two comment questions in which you are able to provide written feedback. If these two comment questions do not address your concerns or if you want to provide additional feedback, you may do so by submitting a letter to the department chair. Letters should be sent from your Cal Poly Pomona email address, and they can be sent at any time. A directory with names and email addresses can be found at [Office of Faculty Affairs website.](https://www.cpp.edu/faculty-affairs/about-us/dept-chairs-deans-dir.shtml).
...
### Can I re-take my online course evaluation?
...
### Why can't I see my course listed on Blue?
...
All course evaluations that are open for responses can be accessed at any time directly through the [Blue](https://cpp.bluera.com/cpp/) system.

## Frequently Asked Questions from Faculty

### Can I change my evaluation dates to the last week of instruction?

Due to the update and revision of Policy 1329, evaluations must fall within week 13 and week 14 of the semester. We are unable to extend or open course evaluations past week 14 of the semester.

### Can I designate specific dates for my course to be evaluated?

In Blue, faculty have the option to customize their course evaluation start and end dates. Modified evaluation date(s) MUST fall within the default two-week period (week 13 through week 14). Modifications occur within a one week window approximately two weeks before the general course evaluation period. After this window closes, you will NOT be able to modify the dates again. See the [Blue Navigation Guide (PDF)](authenticated/documents/course-evals/blue-navigation-guide.pdf) for instructions on how to modify evaluation dates and additional considerations.

### How can I view my response rates?

You can view your response rates by logging into our evaluation software, [Blue](https://cpp.bluera.com/cpp). Instructions on how to best utilize features in Blue can be found in the Blue Navigation Guide (PDF).

### How do I ensure high response rates for my online course evaluations?
...
The [Blue Navigation Guide (PDF)](authenticated/documents/course-evals/blue-navigation-guide.pdf) details how to generate QR codes, a unique link to your evaluation, and re-send invitation emails to students to help increase response rates.

### Why might some students not be included in evaluating my course?

The course evaluation system captures data at census; therefore, students who enroll afterwards will not be eligible to evaluate the course. If students are enrolled in a course section through Open University, the section will not be eligible to evaluated. These courses will not be displayed in Blue for students under these conditions.
...
### What if my course is team-taught?
...
If this is applicable to you and you would like your evaluations to be sent out during the last two weeks of your instructional period, please provide three weeks of advanced notice by emailing evaluations@cpp.edu.

### Who can I contact about obtaining a copy of my results for a previous semester?

Since CPP switched to the [Blue](https://cpp.bluera.com/cpp) evaluation system beginning Spring 2022, Blue contains reports from Spring 2022 and onwards. For historical copies of course evaluation reports prior to Spring 2022, please contact your college administrator as they are the official custodians of these records. Each term, they place these records in your PAF. Should they not have all the reports you have anticipated, please email evaluations@cpp.edu with your request. Include in the email, the term, subject, and catalog numbers needed.

## Frequently Asked Questions from Staff

### What is the general course evaluation process?

Please see our [Course Evaluation Timeline Resource (PDF)](authenticated/documents/course-evals/course-evaluation-timeline-v2.pdf).

### When are course evaluations administered?

They are administered anywhere between the start of week 13 and the end of week 14 of the semester per [Policy 1329 (PDF)](https://www.cpp.edu/academic-manual/1300-1399-academic-personnel-policies/1325-1349/1329-student-evals.pdf).

### When do I request early course evaluations?

Early course evaluations need to be requested 3 weeks before their expected launch date.

Relevant information from University [Policy 1329 (PDF)](https://www.cpp.edu/academic-manual/1300-1399-academic-personnel-policies/1325-1349/1329-student-evals.pdf):

All student evaluations shall be administered between the start of the 13th week and the end of the 14th week of the academic semester. There are two exceptions: One, when multiple instructors teach a class, the evaluation for each individual instructor shall take place during the last two weeks of the instructional period of each individual instructor...

### What is the process for updating our evaluation question forms?

Departments are encouraged to contact CPP’s CAFE ([Center for the Advancement of Faculty Excellence](https://www.cpp.edu/cafe/index.shtml)) for resources and consultation when developing evaluation instruments. Once updated evaluation instruments are adopted by the department they must communicate these changes by sharing a copy of the template to all instructors, Faculty Affairs, and Institutional Research, Planning, and Analytics (evaluations@cpp.edu) no later than 14 days after the first day of instruction.
...
### How do I notify IRPA which courses should be evaluated?

After census has passed, typically week 8 of the semester, your department will receive a course list for approval. If there are any changes to the course list after approval has been submitted, please notify IRPA as soon as possible at evaluations@cpp.edu.
