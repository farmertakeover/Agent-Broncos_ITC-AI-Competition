**Source:** https://www.cpp.edu/mediavision/about.shtml
...
MediaVision is part of the [IT division](https://www.cpp.edu/it/) at Cal Poly Pomona and is committed to providing the campus community with high-quality video and audio services. We create branded media for the university, assist in instructional course content, A/V design in instructional space & beyond, and provide video and audio support to elevate campus events.

Our team of creative and technical staff works closely with departments across the campus to help find solutions and empower your efforts.

We also manage Cal Poly Pomona’s Zoom account and the official video server of the campus - [streaming.cpp.edu](https://streaming.cpp.edu/) (Kaltura).

[Our team](staff.shtml) is service-oriented and eager to hear how we can use video and audio to elevate CPP and your role in our students’ success.

[Let us know how we can help you today!](request-a-service.shtml)
