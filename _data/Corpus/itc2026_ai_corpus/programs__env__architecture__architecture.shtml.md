**Source:** https://www.cpp.edu/programs/env/architecture/architecture.shtml
...
## Bachelor of Architecture – B.Arch. | Undergraduate

![Architecture student presents in studio](../img/arc-main.jpg)

## Quicklinks

[Department Page](https://www.cpp.edu/env/architecture/index.shtml)
[Costs & Technology](https://www.cpp.edu/env/architecture/program-degrees-admissions/computer-requirements.shtml)
[Studio Culture](https://www.cpp.edu/env/architecture/resources/studio-culture.shtml)
[Contact Us](https://www.cpp.edu/env/architecture/about/contact.shtml)
...
Top 100 Undergraduate Architecture Program Graduating the Highest Number of Latinx Students
...
In the architecture program, you’ll take designs from initial sketches to structural models. You will balance aesthetic concepts with structural considerations and design details with economic choices. Studio courses will provide collaborative environments with project-focused instruction, while lectures introduce topics that impact architectural design. Our integrative, learn by doing approach, internship experiences and strong industry connections will develop you into a lateral, creative thinker and prepare you for careers in various sectors, allowing you to make a difference in the built environment.

[Apply](http://cpp.edu/apply)
[Contact Us](https://www.cpp.edu/env/architecture/about/contact.shtml)
[ARC In Motion](https://www.cpp.edu/env/architecture/news-events/arc-in-motion.shtml)
...
Preserve and conserve buildings, structures and monuments with cultural and historic significance.

### Urban Planner

Create public and community spaces, helping to develop land and make the most accessible and safe use of open land.

### Computer Aided Design Detailer

Use technology to make execution in the physical world smoother, easier and safer by creating blueprints and illustrations to predict and test for obstacles.

### Interior Designer

Using knowledge of architectural design, help structure the interior placement of furniture, lighting, artwork and more to evoke the appropriate emotion and sensation in a safe, accessible way.

## Courses

The architecture program consists of a five-year curriculum focused on the design laboratory. The studio sequence consists of four segments: a three-year basic core, three-semester topic studios and a two-semester long culminating senior project. Lecture classes in Architecture Theory and History, Human Behavior, Professional Practice, Programming, Sustainability, Building Technology, Structures, Codes and Digital Media are closely coordinated with the studio sequence, and students are expected to demonstrate their knowledge of these areas in their design projects.

For the most up-to-date information on courses for this program, visit the course catalog or contact an advisor.

[See Course Catalog](https://catalog.cpp.edu/preview_program.php?catoid=68&poid=18617 )
[Visit Advising](https://www.cpp.edu/env/student-success-advising-center/)
[Internships](https://www.cpp.edu/env/architecture/program-degrees-admissions/internship-requirement.shtml)
[Required Tech](https://www.cpp.edu/env/architecture/program-degrees-admissions/computer-requirements.shtml)

![Architecture student working on her model](../img/arc-accred.jpg)
...
[See More Scholarships](https://www.cpp.edu/env/architecture/resources/scholarships.shtml%20%20%20%20%20%20)

![Luis Lazaro works on his  model during his 1st Year Architecture studio](../img/arc-pitassi.jpg)

![Architecture Professor Irma Ramirez ](../img/arc-irma-ramirez.jpg)

## Featured Faculty

> Irma Ramirez focuses on community-based design, design-build, interdisciplinary practice and service learning. She collaborates with CPP's Habitat 21 Sustainable Settlements Project and founded the ENV China Program in Beijing.

Irma Ramirez
Professor, Architecture

[Faculty Profile](https://www.cpp.edu/faculty/ieramirez/index.shtml%20%20%20%20%20%20)

## Related Programs

[Art History, B.A.](https://www.cpp.edu/programs/env/art/art-history.shtml)

[Landscape Architecture, B.S.](https://www.cpp.edu/programs/env/landscape-architecture/landscape-architecture.shtml)

[Visual Communication Design, B.F.A](https://www.cpp.edu/programs/env/art/visual-communication-design.shtml)

[Urban and Regional Planning, B.S. - Urban Design](https://www.cpp.edu/programs/env/urp/urban-design.shtml)
