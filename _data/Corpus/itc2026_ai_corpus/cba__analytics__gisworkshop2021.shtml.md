**Source:** https://www.cpp.edu/cba/analytics/gisworkshop2021.shtml
...
If you would like to participate in the hands-on learning activities and earn the certificate of completion, please register in advance. Pre-registration is required to ensure that we create ArcGIS online accounts for you to complete the hands-on learning activities. Each session will build on the previous one, so please plan on **attending both sessions**.

The Dashboards Session on Oct 6 will feature a presentation by **Jian Lange, Principal Product Manager (Spatial Analysis), ESRI.**

**Register via email** to the Singelyn Center for Innovative Analytics with the **Subject “Registration request for GIS workshops”** and using your cpp email.
