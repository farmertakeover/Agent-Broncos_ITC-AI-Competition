**Source:** http://www.cpp.edu/fpm/customer-service.shtml
...
* Website: [www.cpp.edu/fpm](http://www.cpp.edu/fpm). Click on the Services menu bar, select Services, select Service Requests. Fill out the [Service Request Form](https://cpp.webtma.com/?tkn=tLs22bS2La4M-q075b6JJkofELEtiOzzacinjNQdbceGVb_5uZo1OdGY06Kd2FbNKlYBawZHSimc2k5C0dgD8aP6rQtqHjdozYs7IzLaplvC-LD-G_ah1CzBkMZJeAGPbk3le4FfPg3FuHsukvMuwhi2v_1A1zYhZe1SUD6KgWTt7fw4BeR3dunXZbHUBCLGW2KuzBxGROjFWSHEKZCbf-r-HSgW38Jjam-EZPQ7_MLh0_Kux9OZcu1Wi7D9nyqUQD0lhSQXTrXHK_-X3arA0w) online and submit. Please refer to these instructions to help navigate how to input an FP&M Service Request.
* Phone: (909) 869-3030
* Email: Submit request to fmcustomer@cpp.edu
...
For a status update on any service request, call the Customer Service Center at Ext. 3030 or submit an inquiry to fmcustomer@cpp.edu.
...
**Facilities Funded Services (Non-Billable) vs. Recharge Services (Billable)**
...
Contact the Customer Service Center at Ext. 3030 with questions regarding non-billable and billable work.

## FAQs

Common questions received by the Customer Service Desk

### What is the procedure for requesting services from FP&M?

Email a request or inquiry to fmcustomer@cpp.edu.

Call Ext. 3030 and a representative will assist.

Fill out a Service Request Form and submit it via fax (Ext. 4363) or email it to fmcustomer@cpp.edu.

### Where is FP&M located?

The department is situated in Building 81, located off Eucalyptus Lane and Citrus Lane. ([Directions to FP&M PDF](fpm-documents/directions-to-fpm.pdf)).
...
### Does the Custodial staff dispose of empty toner cartridges and batteries? Where can they be left?
...
### Can I borrow a tool or equipment from FP&M?

No, the department does not loan out items. Please submit a work request to fmcustomer@cpp.edu or by calling the Facilities Service Center at Ext. 3030.

### How do I request floor plans?

Fill out a [Document Request Form (PDF)](https://www.cpp.edu/fpm/fpm-documents/document-resource-center-request-form-accessible.pdf) and submit it to fpmdrc@cpp.edu.

### What is the turnaround time for key requests?
...
Please complete the [Key Request Form (PDF)](fpm-documents/key-request.pdf) and submit to fmkeydesk@cpp.edu or fax to (909) 869-4363.

For details on key requests, see [Key Policy Issuance (PDF)](fpm-documents/campus-key-policy-issuance-control.pdf).

### Where is the Aratani Japanese Garden located and when is it open?

The Japanese Garden is open Monday through Friday from 8 a.m. to 5 p.m. A one-day parking pass is $8 and can be purchased from a ticket kiosk Lot F10 or Lot C. ([Directions to the garden PDF](fpm-documents/directions-to-gardens.pdf))
