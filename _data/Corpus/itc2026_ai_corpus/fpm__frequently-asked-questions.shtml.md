**Source:** http://www.cpp.edu/fpm/frequently-asked-questions.shtml
...
## FP&M Has the Answers

A roundup of the most common questions directed at FP&M, ranging from the frequency of restroom cleanings to key requests to the kinds of filters used in HVAC units.

## Customer Service

Commonly asked questions received by the Customer Service Desk.

### What is the procedure for requesting services from FP&M?

There are a few ways to request services: Email your request or inquiry to fmcustomer@cpp.edu. Call Ext. 3030 and a representative will assist you over the phone. Fill out a [Service Request Form](fpm-documents/service-request-form.pdf) and submit the form via fax (Ext. 4363) or scan and email the form to fmcustomer@cpp.edu.

### Who oversees various areas within FP&M?

Administrators, directors and managers are listed on the FP&M Contact List.

### Where is FP&M located?

Building 81 is on Citrus Lane off Eucalyptus Lane. ([PDF map and directions](fpm-documents/directions-to-fpm.pdf))

### Who is responsible for unlocking buildings and classrooms?
...
### How often is my office cleaned by the Custodial Staff?
...
### Does Custodial Services dispose of empty toner cartridges and batteries? Where can they be left?
...
### Can I borrow a ladder or tools from FP&M?
...
### How do I request floor plans?

Fill out a [Document Request Form (PDF)](fpm-documents/document-resource-center-request-form-accessible.pdf) and submit it to fpmdrc@cpp.edu.

### What is the turnaround time for a key request?

A key request is processed within 24 hours. However, the request can take up to a week for a key to be cut by the locksmith if the key is not part of department inventory. FP&M policy states, “The Key Shop will make every effort to respond to all key requests within 72 hours of receipt of a completed original Key Request Form.” Please complete the [Key Request Form (PDF)](fpm-documents/key-request-accessible.pdf) and submit the form to fmkeydesk@cpp.edu or fax to (909) 869-4363. For up-to-date information, see the [Key Policy Issuance (PDF)](fpm-documents/campus-key-policy-issuance-control.pdf).

### Where is the Aratani Japanese Garden and when is it open?

The garden is open Monday through Friday from 8 a.m. to 5 p.m. and is located adjacent to the CLA Building. Parking in campus lots is $8 a day. Parking passes can be purchased from ticket kiosks in Lot F10 and Lot C. ([PDF map and directions](fpm-documents/directions-to-gardens.pdf))

## Custodial Cleaning

Frequency of cleaning and other services performed by Custodial Services.

### An extensive cleaning is needed in my work area. Which department should I contact?
...
### Are restrooms cleaned on a regular basis?

Cleaning schedules in restrooms have returned to pre-pandemic levels. If you find a restroom in need of cleaning, contact Facilities Customer Service at fmcustomer@cpp.edu or call Ext. 3030.

## Deferred Maintenance

FP&M has an ongoing deferred maintenance program to maintain and upgrade the campus infrastructure.
...
Proactive maintenance is a [preventive maintenance strategy](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.emaint.com%2Fwhat-is-a-cmms%2Fpreventive-maintenance%2F&data=04%7C01%7Cgcfong%40cpp.edu%7C4c67c951752443afa65e08d9f663050e%7C164ba61e39ec4f5d89ffaa1f00a521b4%7C0%7C0%7C637811727482904525%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000&sdata=oqcSTwNlL6zxcyD%2BcXf2dwdfI5WDZb5xNf%2FtvaSr7xw%3D&reserved=0) that works to correct the root causes of failure and avoid breakdowns caused by underlying equipment or building system conditions. It is based on an analysis that uses real-time and historical data about an asset to spot trends that might lead to failure. It spots changes and makes inferences about the failure of an asset.

### What is preventive maintenance?

Preventive maintenance is a routine or schedule for periodically inspecting equipment with the goal of identifying small problems and fixing them before major ones develop. The main goal behind preventive maintenance is for the equipment to make it from one planned service to the next without any failures.
...
The HVAC Shop maintains the systems in campus buildings.

### How do I know that my building HVAC system is working properly?

All building HVAC systems on campus are monitored by FP&M within the campus building management system. Alarms are sent to Facilities Personnel if monitor points are out of established parameters (running, temp, filter flow, etc.).

### What kind of air filters are used in campus systems?
...
### Do the HVAC systems use 100% outside air?

We attempt to use outside air whenever possible but outside air (up to 100%) is supplied based on varying factors like building duct pressure, flow and temperature needs.

### What types of cleaning supplies and equipment are used on campus?

The campus uses several types based on the space being cleaned. Examples: Electrostatic foggers, KAIVAC no-touch cleaning systems for bathrooms, manual spray bottles and surface disinfectant wipes.
