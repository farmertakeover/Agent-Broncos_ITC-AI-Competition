**Source:** https://www.cpp.edu/accessibility/universal-design.shtml
...
* [U.S. Department of Labor on Universal Design Principles](https://www.dol.gov/agencies/odep/program-areas/employment-supports/universal-design?lang=en)
* [Universal Design for Learning Guidelines – Center for Applied Special Technology (CAST)](https://udlguidelines.cast.org/)

![A blind student using a computer through a braille display. ](img/girl-using-braille-display.jpeg)

## Discover the Impact of UDL and Accessibility

Universal Design for Learning benefits everyone—but it’s especially vital for people with disabilities as it enables accessible practices. Learn more about how inclusive design empowers users with diverse needs to engage fully, independently, and equitably with digital content, technology, and learning environments.

[Impact of Accessibility](impact-accessibility.shtml)
