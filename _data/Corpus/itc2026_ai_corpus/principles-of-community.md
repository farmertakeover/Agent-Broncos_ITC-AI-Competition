**Source:** https://www.cpp.edu/principles-of-community
...
![Rose Garden](img/rose-garden-aerial02.jpg)
...
![horses running](img/cpp_bitmap_horses_both_300dpi-3.jpg)

### Cultivate Belonging

We actively create an inclusive culture where everyone feels valued, welcomed and empowered to contribute.

![Old Stables](img/cpp_bitmap_stables_both_300dpi-1.jpg)
...
Cal Poly Pomona’s Principles of Community are a shared commitment to fostering a positive, inclusive, and respectful campus environment. These guiding values set expectations for behavior, encourage open dialogue, and provide a framework for navigating conflicts fairly and constructively. To shape these principles, we invited the Bronco community to share their perspectives in Fall 2023. More than 2,600 students, faculty, and staff contributed their voices, helping define the core values that strengthen our campus culture.

Learn more about the Principles of Community, their development, and their impact by visiting the [EODA/Human Resource Operations website](https://www.cpp.edu/eoda-hr/about/principles-of-community1.shtml).
