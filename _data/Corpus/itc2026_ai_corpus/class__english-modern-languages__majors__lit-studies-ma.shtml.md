**Source:** http://www.cpp.edu/class/english-modern-languages/majors/lit-studies-ma.shtml
...
# EML Master Degrees: English – Literary Studies
...
All students pursuing the M.A. in the Literary Studies option are introduced to the practices, challenges, and rewards of conducting original investigations in English 5010: Graduate Literary Research. You will then take a collection of courses in British, American, and world literatures, as well as across genres. This work will prepare you well for the capstone project: either the comprehensive master's exam or the master's thesis. The capstone project allows you to demonstrate advanced understanding of the role literature plays in human history and culture, and the skills necessary to conduct research, communicate, and analyze these texts.

This degree prepares students for a number of career paths. Whether you choose to continue your education in a Ph.D. program, pursue or enhance a teaching career in high school or community college classrooms, or move in to industries like marketing, editing, law, and so on, you will be well prepared for high-level intellectual work.

For required coursework, see the [University Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19679&returnto=6721).

## Options for the Literary Studies Culminating Experience

Students can choose between the Comprehensive Examination and M.A. Thesis for their culminating experience.

### Comprehensive Examination

Students MUST ENROLL in ENG 6970 in order to take the Comprehensive Exam. However, enrolling in ENG 6970 requires department authorization. One to two weeks [prior to registration](https://www.cpp.edu/registrar/registration/registration-schedule.shtml), email Connie Cuellar. Let her know your intention to take the exam and provide her with your option, directed electives or second option, and your Bronco ID. Failure to do this means you will be unable to register for ENG 6970, and thus unable to fulfill your culminating experience, or graduate.

The Comprehensive Exam in Literature is administered during weeks 6 through 10 of the Fall and Spring semesters. The examination consists of three take-home essays where students respond to essay prompts using textual evidence and research. One essay is drawn from a “Common Read” text that is announced the year prior to the exam. Exams are evaluated by multiple faculty members using a grading rubric. Students only examine in their primary option.

#### Reading List

Students are expected to be familiar with all the texts on the syllabi. In addition, students are asked to read a Common Read. Every year, faculty members decide on a single text that has not been taught in any course. Students are expected to transfer their knowledge gained in the classroom to an unfamiliar text.

 \*\*\* For 2024-25, the Common Read text was Shirley Ann Williams’ *Dessa Rose*\*\*\*

\*\*\* For 2025-26, the Common Read text is Wang Xiaobo’s*The Golden Age* (Yan Yan’s translation) \*\*\*

\*\*\* For 2026-27, the Common Read text is Geoffrey Chaucer’s*House of Fame* (Simon Webb’s Modern English Verse translation only, Langley Press) \*\*\*

#### Literary Studies Examination

Students examining in Literary Studies will turn in a total of three take-home essays. Each essay will be a minimum of 3,125 words (10+ pages). The essay prompts will be distributed on Monday of week 6 and all essays will be due 5 weeks later, on Monday of week 11.
...
* [**The grading rubric**](../docs/ma-lit-comp-exam-rubric-2020.pdf) (PDF). These are the measures that will be used to assess your exam. Know what you’ll be tested on. The grading rubric is based on the program's and option's student learning outcomes.
...
Students may choose to write a thesis: a directed, in-depth research project. For more information, see the [thesis](../docs/masters-thesis-guidelines-24-25.doc)[guidelines](../docs/masters-thesis-guidelines-24-25.doc) (DOC). Then, speak with an advisor before completing the [petition](../docs/ma-thesis-petition.doc) (DOC).
