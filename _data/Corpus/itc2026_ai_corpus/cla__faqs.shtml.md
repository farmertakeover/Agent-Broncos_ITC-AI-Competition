**Source:** https://www.cpp.edu/cla/faqs.shtml
...
![A rainbow over the CLA tower](img/18cla-and-rainbow2.gif)
...
Building codes prohibit construction on land that sits atop any earthquake fault line. Taking down the buildings eliminate one of the highest priorities on the [CSU Chancellor’s Office seismic safety list](https://www.calstate.edu/impact-of-the-csu/government/Advocacy-and-State-Relations/legislativereports1/California%20State%20University%20Deferred%20Maintenance%20and%20Seismic%20Safety%20%20Plan%20Report.pdf).
...
Visit the [Timeline page](timeline.shtml) for more information.
...
The Public Health Testing Site for COVID-19 will temporarily be relocated during a portion of the project. The temporary location will be shared with the campus via email and the [Safer Return website](https://www.cpp.edu/safer-return/index.shtml).
