**Source:** http://www.cpp.edu/sci/chemistry-biochemistry/research/senior-project.shtml
...
To begin your senior project, you will need to meet with a faculty member to discuss and agree upon a senior research project. Once you have found a mentor, complete the [Enrollment form](../docs/supervisory-forms.pdf) and submit it to the Chemistry Department office. You may enroll during registration and during the add/drop period.
...
* Work with your advisor to complete your [Senior Project Proposal](../docs/senior-project-proposal-form.pdf). Submit to the Senior Project Coordinator before 5 pm on the Friday of Week 8.
...
To continue your senior project, complete the [Enrollment Form](../docs/supervisory-forms.pdf) and submit it to the Chemistry Department office. You may enroll in CHM 4620 during registration and during the add/drop period.
...
* Complete all three requirements of the senior project by 5 pm of the Friday of Finals Week.
  + 2 printed, bound, and signed copies of your thesis ([template here](../docs/senior-project-template.docx)) *Note: due to COVID-19, this requirement is currently a signed PDF copy submitted via Canvas*
  + Signed [lab clearance form](../docs/senior_project_clearance_form.pdf); required of all students regardless of project type
  + PDF of lab key return receipt
* You may also find these documents useful:
  + [Notes to senior project authors](../docs/senior-project-notes-to-authors.pdf) - a reference guide for writing your thesis
  + [ACS citation style guide](../docs/acs-quick-style-guide.pdf) - a resource for properly formatting the citations in your thesis
...
* To enroll in CHM 4610 & CHM 4620, all students must submit a completed [Enrollment Form](../docs/supervisory-forms.pdf) to the Department office.
