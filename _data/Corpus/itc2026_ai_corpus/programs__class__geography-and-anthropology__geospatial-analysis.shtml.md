**Source:** https://www.cpp.edu/programs/class/geography-and-anthropology/geospatial-analysis.shtml
...
![student looking at a presentation](../img/24gis-day-posters.jpg)
...
[Careers in Geography](https://www.cpp.edu/class/geography-anthropology/student-resources/careers-in-the-field.shtml)
...
Manage and interpret geographic data to help institutions better understand our environment through the Geospatial Analysis option.
You will learn and develop technical skills, including Geographic Information Systems (GIS) and Remote Sensing software. Graduate prepared for a future dedicated to land-use management, local government and environmental protection.
...
[Geography Careers](https://www.cpp.edu/class/geography-anthropology/student-resources/careers-in-the-field.shtml)
...
Manage and analyze geographic information systems (GIS) to create maps, analyze spatial data, and solve complex geographical problems. Collect and manage spatial data, create digital maps, perform spatial analysis, maintain GIS databases, and provide technical support for projects using specialized software like ArcGIS.

Card 2 of 3

### Remote Sensing Specialist

Analyze and interpret data collected from satellites, aircraft, unmanned aerial systems and other remote sensors to study Earth's surface features, natural resources and environmental conditions. Process and analyze satellite imagery, conduct image classification, develop algorithms for data extraction, create detailed maps, monitor environmental changes and integrate remote sensing data with other spatial information systems to support decision-making in fields like agriculture, forestry, urban planning and environmental monitoring.

Card 3 of 3

### Emergency Management Planner

Develop and coordinate comprehensive plans to prepare for, respond to and recover from disasters, public health emergencies and other crisis situations to protect communities and minimize impact. Create emergency response protocols, conduct risk assessments, coordinate with multiple agencies, organize emergency drills, manage resources and ensure compliance with regulations while continuously updating plans based on lessons learned from actual emergencies.
...
[See Course Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19688)
[Visit Advising](https://www.cpp.edu/class/geography-anthropology/student-resources/advising.shtml)

![Kelly Huh](../img/kellyhuhjuneau.png)
...
[Geography – Environmental Studies](https://www.cpp.edu/programs/class/geography-and-anthropology/environmental-studies.shtml)

[Anthropology](https://www.cpp.edu/programs/class/geography-and-anthropology/anthropology.shtml)

[Sociology](https://www.cpp.edu/programs/class/sociology/general.shtml)
...
[Anthropology Minor](https://catalog.cpp.edu/preview_program.php?catoid=4&poid=933)

[Science, Technology and Society](https://www.cpp.edu/programs/class/philosophy/science-technology-society.shtml)
