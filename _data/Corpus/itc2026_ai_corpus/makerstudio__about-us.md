**Source:** https://www.cpp.edu/makerstudio/about-us
...
The Maker Studio was created for *all* students, regardless of major. Some of the technology that we have in the studio like 3D printers and sewing machines are available elsewhere, but you must be enrolled in a class or a major of the college to access them. We are located on the second floor of the library, where all students can easily use it and create innovative and creative projects. All the machines and technology we have is free to use, but students are required to pass safety training. We provide limited support for materials; to see what we have and what you can use, stop by during our operating hours or get involved as an ambassador.
