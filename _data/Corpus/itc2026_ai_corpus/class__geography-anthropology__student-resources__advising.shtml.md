**Source:** http://www.cpp.edu/class/geography-anthropology/student-resources/advising.shtml
...
Every Geography and Anthropology student has a tenure-track faculty advisor assigned in their major viewable on their BroncoDirect page. For help with academic plans, class selections, or petitions, schedule an appointment via **CPP Connect.**

For career and graduate school guidance, consult any department faculty member in your discipline, whose contact information is on the **Faculty & Staff page.**

When requesting **a letter of recommendation**, contact professors familiar with you from your significant coursework (e.g., term projects, presentations).  Rach out via email or by appointment, explaining the purpose of the recommendation and why you've chosen them and allow them ample time to consider your request.

## Student Success Center in CLASS

[![Jessica Rojas-Avellaneda](../img/25advisor-rojas-avellaneda2.jpg)

### Jessica Rojas-Avellaneda

CLASS Student Success Center Advisor Jessica Rojas-Avellaneda javellaneda@cpp.edu](#modal-0 "Jessica Rojas-Avellaneda")
...
[### CPP Connect](https://www.cpp.edu/studentsuccess/cppconnect/index.shtml "opens a new window")

[### Petitions and E-Forms](https://www.cpp.edu/registrar/forms/forms.shtml "opens a new window")

[### Faculty Office Hours](../faculty-staff/faculty-office-hours.shtml)
