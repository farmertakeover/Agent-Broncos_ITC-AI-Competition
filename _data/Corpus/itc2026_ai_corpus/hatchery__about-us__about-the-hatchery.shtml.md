**Source:** https://www.cpp.edu/hatchery/about-us/about-the-hatchery.shtml
...
![](../img/banners/about-us-topbanner.png)

# About The Hatchery

![](../img/misc/about-us-slide.gif)
...
For more information on how our program works, check our our [How It Works](how-it-works.shtml) page!

![Projects Hatchery Orientation](../img/banners/orientation-video.png)

![Key Program Components](../img/banners/program-requirements.png)

![](../img/misc/hatchery-icon-flexibility.png)
...
![](../img/misc/hatchery-icon-comprehensiveness.png)
...
![](../img/misc/hatchery-funding-icon.png)

## Funding

Students can be funded up to $5,000 for projects with teams of 3 or more OR up to $3,000 for projects with teams of 2 or less. Funding may also depend on the project scope.
