**Source:** https://www.cpp.edu/nagpra/native-pipeline/applications.shtml
...
**DEADLINE HAS BEEN EXTENDED TO JUNE 30, 2025.**

Each year, the NATIVE Pipeline offers Native students scholarships to help with the cost of housing, tuition and books.

For students interested in our NATIVE Pipeline program, fill out the [online application](https://tinyurl.com/napipeline) or download the [application](../docs/2025-cal-poly-pomona-native-pipeline-application.docx) and email it to Dr. Sandy Kewanhaptewa-Dixon (Hopi) at sldixon@cpp.edu**.**
