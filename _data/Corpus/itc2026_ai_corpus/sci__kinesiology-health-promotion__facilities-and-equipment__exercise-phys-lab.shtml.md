**Source:** http://www.cpp.edu/sci/kinesiology-health-promotion/facilities-and-equipment/exercise-phys-lab.shtml
...
![](../img/khp-banner-image.jpg)

## Exercise Science Laboratory

The **Exercise Science Lab**is housed in 43-107. This lab is primarily utilized for instruction in exercise science courses, such as Exercise Physiology and Exercise Testing and Prescription. The lab is equipped with two ParvoMedics metabolic testing systems, treadmill and Monark LC7 cycle ergometers, two Monark Peak Bikes with computer integration, 12-lead ECG testing system, Biodex isokinetic dynamometer, BodPod Body Composition analyzer, and equipment for basic health and exercise testing and screening.
