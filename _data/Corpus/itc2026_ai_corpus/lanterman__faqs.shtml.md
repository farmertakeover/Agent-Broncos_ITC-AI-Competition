**Source:** http://www.cpp.edu/lanterman/faqs.shtml
...
### What does Cal Poly Pomona plan to do the Lanterman site?

The vision for the Lanterman property is that it becomes a live, learn, work, play destination that will support the university’s educational mission and values that will also be of significant benefit to the surrounding communities. The public will have significant opportunity to weigh in on development that ultimately takes place on the Lanterman site.

### What is the current status of the Lanterman property?
...
### What happened to the first master developer, Five Point Holdings, LLC?

Five Point decided to withdraw from the project due to significant leadership changes in the company.

### How much does it cost Cal Poly Pomona to maintain the Lanterman property?
...
### Why has the university spent money on hiring consultants relating to the future of the Lanterman project?
...
### Has the university considered selling the property and using the funds to support current campus needs?
...
### What is the condition of the buildings left over from he old Lanterman Development Center? Will they be torn down?
...
### What kinds of uses will the university consider for the future of the Lanterman site?
...
### Will development of the Lanterman site worsen the existing parking and traffic around the main campus?
...
### Will there be a shuttle connection between the main campus and the Lanterman site? Will it be necessary for people to drive their cars back and forth between the main campus and the Lanterman site? What about the traffic? Will there be enough parking?
...
### Why can't the university just use the property to build needed academic buildings?
...
### Who do I contact if I have questions about Lanterman?

Please contact lantermanproject@cpp.edu.
