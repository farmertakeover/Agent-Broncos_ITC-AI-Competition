**Source:** http://www.cpp.edu/blc/students/fsl.shtml
...
![FSL leaders at the Kellogg Arena](../img/fsl.jpg)

## Active Chapters

Scroll down to see a full list of active chapters at Cal Poly Pomona. Click on their individual links to see their organization page.

## IFC

### InterFraternity Council

* [Phi Kappa Tau](https://mybar.cpp.edu/organization/phikappatau)
* [Pi Kappa Alpha](https://mybar.cpp.edu/organization/pikappaalpha)
* [Pi Kappa Phi](https://mybar.cpp.edu/organization/pikapp)
* [Sigma Chi](https://mybar.cpp.edu/organization/sigmachi)
* [Sigma Nu](https://mybar.cpp.edu/organization/sigmanu)
* [Sigma Phi Epsilon](https://mybar.cpp.edu/organization/sigep)
* [Sigma Alpha Epsilon](https://mybar.cpp.edu/organization/sigmaalphaepsilon)
* [Tau Kappa Epsilon](https://mybar.cpp.edu/organization/taukappaepsilon)

## MGC

### Multicultural Greek Council

* [Alpha Phi Gamma](https://mybar.cpp.edu/organization/alphaphigamma)
* [Alpha Pi Sigma](https://mybar.cpp.edu/organization/alphapisigma)
* [Gamma Zeta Alpha](https://mybar.cpp.edu/organization/gammazetaalpha)
* [Lambda Theta Alpha](https://mybar.cpp.edu/organization/lambdathetaalpha)
* [Lambda Theta Phi](https://mybar.cpp.edu/organization/lambdathetaphi)
* [Phi Lambda Rho](https://mybar.cpp.edu/organization/plr)
* [Sigma Delta Alpha](https://mybar.cpp.edu/organization/sigmadeltaalphalambdachapter)
* [Sigma Lambda Beta](https://mybar.cpp.edu/organization/sigmalambdabeta)
* [Sigma Lambda Gamma](https://mybar.cpp.edu/organization/sigmalambdagamma)

## NPC

### National Panhellenic Conference

* [Alpha Xi Delta](https://mybar.cpp.edu/organization/alphaxidelta)
* [Chi Omega](https://mybar.cpp.edu/organization/chiomega)
* [Kappa Delta](https://mybar.cpp.edu/organization/kappadelta)
* [Sigma Kappa](https://mybar.cpp.edu/organization/sigmakappa)
* [Zeta Tau Alpha](https://mybar.cpp.edu/organization/zetataualpha)

## NPHC

### National Pan-Hellenic Council

* [Alpha Phi Alpha](https://mybar.cpp.edu/organization/alphaphialpha)
* [Delta Sigma Theta](https://mybar.cpp.edu/organization/deltasigmatheta)
* [Sigma Gamma Rho Sorority, Inc.](https://mybar.cpp.edu/organization/sigmagammarho)

## Principles of Success

1. ### Philanthropy and Service

   One of the most gratifying aspects of the Fraternity & Sorority experience is the sense of pride that comes with involvement in philanthropic activities. These activities create a sense of contribution and satisfaction that ultimately foster unity among all members. As a community, each year members raise thousands of dollars for St. Jude Children’s Research Hospital in support of finding cures for children with cancer. In addition, each fraternity and sorority hosts their own philanthropy according to founding principles associated with the organization. When you visit with the chapter members during the recruitment process, be sure to ask about their philanthropy programs.
   Service is one of the founding principles of all fraternities and sororities. No matter what your service interests may be, you will find opportunities to participate in both "hands-on" service and fundraising as part of the Cal Poly Pomona fraternity and sorority community.
...
[Access CPP's SFTAR Reports](fsl-sftar.shtml)
