**Source:** http://www.cpp.edu/env/landscape-architecture/degrees-admissions/masters.shtml
...
We invite you to take the next step by signing up for one of our **upcoming [Information Sessions](https://forms.office.com/r/BfTfhzhe9B)**, currently arranged on Saturday, October 4th, where you’ll meet faculty, explore the curriculum, and get answers to your questions about the application process. We look forward to welcoming you to our community!

Email mla@cpp.edu for access to the recording of the information session if you miss the Zoom meeting.

![MLA Information Session](information_session.jpg)
...
**Study Abroad Programs:** MLA students are welcome to participate in the fall Italy Study Abroad Program (15-units), our our new summer Paris Study Abroad Program (6-unit), or one of the electives featuring international travel over Spring Break. See [International Programs page.](https://www.cpp.edu/env/landscape-architecture/academic-student-resources/international-programs.shtml)

**MLA Culminating Master Project:** The last year of study in the MLA program is a year-long collaborative Master’s Project Studio (formerly known as the ‘606 Studio’) that works with a public agency, non-profit community/environmental organization, and/or local communities providing funded or *pro bono analysis, planning,* design, and other technical support and services. See [MLA Culminating Master Project Tab](#Culminating_Experience) for additional information.

### STEM Status

Landscape Architecture is a STEM Discipline. The U.S. Department of Homeland Security has [designated landscape architecture a STEM discipline](https://www.asla.org/NewsReleaseDetails.aspx?id=63963 "designated landscape architecture a STEM discipline"). The designation recognizes the high degree of science, technology, engineering and mathematics course work required in landscape architecture collegiate programs. For more information about Landscape Architecture's STEM Status, please refer to the [ASLA](https://www.asla.org/ContentDetail.aspx?id=57146 ) webpage.

### Program Rankings

In 2025, Cal Poly Pomona was ranked [the #2 best public college in the west by US News](https://www.cpp.edu/aboutcpp/why-cpp/well-ranked.shtml)! More significantly to the CPP community and our mission, is that we are consistently at the top of the [Social Mobility Index](https://www.cpp.edu/aboutcpp/why-cpp/well-ranked.shtml#:~:text=In%20addition%2C%20Cal%20Poly%20Pomona,(SMI)%20has%20been%20published.). **The Wall Street Journal**ranked Cal Poly Pomona at No. 21 on its “[2025 Best Colleges in America](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.wsj.com%2Frankings%2Fcollege-rankings%2Fbest-colleges-2025%3Fmod%3Dcollegerankings2025_rankings&data=05%7C02%7Csbgonzaga%40cpp.edu%7Cc3a95de3684a4bd8d86d08dcd12c7567%7C164ba61e39ec4f5d89ffaa1f00a521b4%7C0%7C0%7C638615236077309121%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C0%7C%7C%7C&sdata=n2StyeWj6mPU5JV8AperUgwhpMcf5icNXIy9t10aUwc%3D&reserved=0)” listing after analyzing 500 universities. CPP was also recognized as No. 7 Top Public University.

The Master of Landscape Architect (MLA) program was ranked 14th most-admired Landscape Architecture School nationwide in the [2019-2020 Design Intelligence Rankings,](https://www.di-rankings.com/most-admired-schools-landscape-architecture/) ranked in the [most hired from landscape architecture schools](https://www.di-rankings.com/most-hired-from-schools-landscape-architecture/) two years in a row. Among Design Intelligence's [12 Key Focus areas](https://www.di-rankings.com/twelve-focus-areas-landscape-architecture/), CPP’s MLA program is ranked 10th in Design Technologies, 9th in Engineering Fundamentals, 6th in Healthy Built Environments, and 7th in Sustainable Built Environments/Adaptive Design/Resilient Design.

Beyond rankings, our tuition, as part of the CSU system, remains among the most affordable for accredited MLA programs nationwide. For detailed information on tuition and fees, please visit the university’s official website [tuition information](https://www.cpp.edu/student-accounting/tuition-fees/index.shtml).

### MLA Fall Admission

Applications to the MLA program for the following Fall opens on October 1st each year, and there is a two-step process submitting both the A) [CSU Apply Application](https://www.calstate.edu/apply) by February 15th, and B) MLA Supplemental Application by March 1st. The MLA program currently admit students to its both**General Standing Track (72-unit/3-year)** and **Advanced Standing (48-unit/2-year) Tracks**. The program also offers unique learning experience such as study abroad in Europe and Asia, and its reputable [MLA culminating master project experience](../academic-student-resources/mla_culminating_experience.shtml) with the [LEAD Studio](../academic-student-resources/mla_lead_studio.shtml), formerly known as the 606 studio.

For more information about the program, please refer to content navigation list, e.g., mission, curricula, etc. to the right. For more information about the admission process and requirements, please go to [Admission](masters_admission.shtml).

We invite you to learn more about our program, faculty, curriculum, campus, and the admission process by downloading the detailed [MLA Program Guide for Prospective Students](https://www.cpp.edu/env/landscape-architecture/degrees-admissions/mla_program_guide_2025_2026.pdf) and our [program information pamphlet](https://www.cpp.edu/env/landscape-architecture/degrees-admissions/information_package_f2025.pdf)in a summary format.

Every year in Fall, we will host the MLA information session. Please sign up [here](https://forms.office.com/r/BfTfhzhe9B).

Email mla@cpp.edu to request a link to the recording of the previous information session.

### MLA Space and Facilities
...
You are also encouraged to fill out the [**Department Record of Application for Graduate Admission**](https://forms.office.com/r/esvjZ37dL9) to establish your connection with us to receive critical updates about the MLA program.
