**Source:** http://www.cpp.edu/research/sponsored-program/proposal-information.shtml
...
Anastasia Rutherford, Director, ORSP; Tariq Marji, Sr. Director Business Services/OES, CPP Foundation
...
| Applicant Institution Type | * Nonprofit with 501c3 status (other than Institution of Higher Education) * Hispanic Serving Institution (HSI) * Asian American, Native American, Pacific Islander Serving Institution (AANAPISI) |
| Applicant Address | 3801 W. Temple Avenue, Pomona, CA 91768-2557 |
| Authorized Organizational Representatives (AOR) | Anastasia Rutherford, Director, ORSP  Tariq Marji, Sr. Director Business Services/OES, CPP Foundation |
| Animal Welfare Assurance # | D16-00223 (A3344-01) (through 12/31/2027) |
| Congressional District | CA-039 |
| Cage Code | 2F321 |
| DUNS # | 028929438 |
| NAICS Code | 71110 |
| UEI # | JMGMMM7BMBT6 |
| SAM registration | [Active through 4/29/2026](http://www.sam.gov/) |
| Federal Tax Entity Identification # (EIN) | 95-2417645 |
| USDA ASAP Recipient Identification # | A3824P1 |
| Human Subjects Assurance Number (FWA or Federalwide Assurance) | FWA00001759 (through 07/22/2026) |
| Office of Postsecondary Education ID number (OPEID) | 110529 |

### Demographic and other data about CPP

Please visit [Tableau](https://www.cpp.edu/data/dashboards/index.shtml) for a set of dashboards with institutional data.

* Here are data for the Fall 2023 student population: [Fall 2023 Student Population Demographics (PDF)](docs/fall-2023-enrollment-summary.pdf)

### Deans and Department Chairs

Visit the list of [Deans and Department Chairs](https://www.cpp.edu/faculty-affairs/about-us/dept-chairs-deans-dir.shtml)
...
* WTU should be in whole numbers, typically in multiples of 3
* Fringe benefits are at the faculty member's actual rate and are incremented 3% per year for grant budgets
...
* May not exceed 125% total workload (3.75 WTU)
* Fringe benefits are at 13%
* Permission for overload from Dean and Chair required

**Off-Contract Salary (Summer and Winter)**

* At actual salary rate
* Fringe benefits are at 13%
* Typically, 10 weeks max allowable for summer salary (CPP policy).  Some sponsors limit summer salary as well (NSF = 2 months).
...
* please visit the [Foundation page](https://foundation.cpp.edu/es/compensation-classification.aspx) for staff compensation
...
****2026 Cal Poly Pomona Foundation, Inc.****

* [STUDENT ASSISTANT SALARY SCHEDULE (PDF)](docs/student-assistant-salary-schedule-2026.pdf)

****Minimum wage:****

* Effective Jan. 1, 2026: $16.90 per hour
...
### Other rates published by the sponsor
...
[Federally negotiated Indirect Cost Rate Agreement (PDF)](docs/idc-rate-agreement-9-4-2025.pdf) 9.4.2025
