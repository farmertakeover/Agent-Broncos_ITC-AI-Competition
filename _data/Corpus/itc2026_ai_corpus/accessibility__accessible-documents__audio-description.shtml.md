**Source:** https://www.cpp.edu/accessibility/accessible-documents/audio-description.shtml
...
* [What is Audio Description?](https://www.acb.org/audio-description-project) – An informative page about audio description from an initiative of the American Council of the Blind called the Audio Description Project.  They contracted the Audio Descriptions Associates, LLC to work in tandem. source: American Council of the Blind.

* [The 21st Century Communications and Video accessibility Act, What Audio Visual Content Providers Need to Know (PDF)](../documents/deque_cvaa_whitepaper__audio_descript-1.pd.pdf) - This paper provides an overview of the 21st Century Communications and Video Accessibility Act (CVAA), a discussion of compliance, and a breakdown of what the act requires providers of audiovisual content to do. source: Deque Systems.

* [Effective Practices for Description of Science Content within Digital Talking Books](http://ncamftp.wgbh.org/ncam-old-site/experience_learn/educational_media/stemdx.html) – A document about audio description and how to do it. source: National Center for Accessible Media (NCAM).

* [Guideline G: Math](http://ncamftp.wgbh.org/ncam-old-site/invent_build/web_multimedia/accessible-digital-media-guide/guideline-g-math.html) – A section in a document on how to make math accessible including making an audio description of it. source: National Center for Accessible Media (NCAM).

* [The Visual Made Verbal](https://adp.acb.org/articles/TheVisualMadeVerbal.html) – A book offering the first overview of audio description. source: Dog Ear Publishing.

* [How to Describe Complex Images for Accessibility](https://www.youtube.com/watch?v=oSdz6KZpLjs) – Video of Bryan Gould of the WGBH National Center for Accessible Media gives a demonstration on how to audio describe. source: YouTube.

* [Resources](http://ncamftp.wgbh.org/ncam-old-site/invent_build/analog/dtv-access-a-resource-site-for.html) – NCAM’s resources for describing STEM images, DTB Standards, and National Instructional Materials Access Center (NIMAS) links.

### Examples:

* [Samples of Audio Description](https://adp.acb.org/samples.html) – Samples from the Audio Description Project initiative. source: American Council of the Blind.

* [Described and Captioned Media Program YouTube channel](https://www.youtube.com/user/dcmpnad/videos) – A YouTube channel that provides examples on how to make educational videos accessible with audio description. source: YouTube.
  + [Modern Materials And The Solid State: Crystals, Polymers, And Alloys (Accessible Preview)](https://www.youtube.com/watch?v=l2LqaVP7UqY) source: YouTube.
  + [The Metallic World: Electrochemistry And Coordination Compounds (Accessible Preview)](https://www.youtube.com/watch?v=5X866VKPp9w) source: YouTube.

* [Red blood cell production](https://medlineplus.gov/ency/anatomyvideos/000104.htm) – From the U.S. National Library of Medicine comes an educational video with audio description. source: U.S. National Library of Medicine.

### Related Articles:

* [Audio Description Services](http://www.bridgemultimedia.com/audiodescription/index.php) – Bridge Multimedia’s introduction into its audio description services. source: Bridge Multimedia.

* + [Audio Description for Education-Based Media](http://www.bridgemultimedia.com/audiodescription/overview_media_ed.php) – A list provided of several organizations funded by the U.S. Department of Education to promote and produce audio description.

* [People who are sight impaired needn't be culturally disadvantaged.](http://www.audiodescribe.com/) – This page describes audio description and programs for its promotion. source: The Audio Descriptions Associates, LLC.

* [Building New Paths To Accessibility](http://diagramcenter.org/) – The DIAGRAM Center is an initiative that promotes and provides services to create accessible educational material. source: Benetech.
