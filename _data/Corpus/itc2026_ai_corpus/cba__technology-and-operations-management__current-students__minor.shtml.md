**Source:** http://www.cpp.edu/cba/technology-and-operations-management/current-students/minor.shtml
...
Students can review the minor options and courses required to complete a minor on the [CBA Catalog](https://catalog.cpp.edu/index.php).
...
There are some cases of completed courses from other departments may fulfill the minor course requirements. In those cases, you will need to check with the TOM department and fill out the following form:   [Minor Course Substitution Request Form - (PDF)](https://www.cpp.edu/registrar/forms/change-of-minor-in-broncodirect-bpg-for-students_june-2023.pdf "https://www.cpp.edu/registrar/forms/minor-course-substitution-request_4_22_20213.pdf ").
...
For instructions regarding the Minor Request process, visit the [Student Success Central's Minor Coordinators](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml) page.

If you have questions, please contact the Department Coordinator and include the following information in your email:
...
\*Please use the [CBA Catalog](https://catalog.cpp.edu/content.php?catoid=65&navoid=5342) for the most up-to-date information on minor course requirements.
