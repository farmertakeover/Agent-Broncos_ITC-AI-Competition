**Source:** https://www.cpp.edu/~cba/customer-insights-lab/cpp-insights-club
...
![image of eboard members and the two advisors](../img/team_image3.2.jpg)

![Four Eboard members tabling at the event](../img/2019clubfair3.2.jpg)

![CBA on a bright and sunny day](../img/bbrl-slide3.2.jpg)

[Previous](#CPPCarousel)
[Next](#CPPCarousel)

If you are considering being involved with our club on the next level, we strongly encourage you to come to our networking, skill-building, social, and fundraising events! Follow us on our social media to receive our announcements and check out events calendar for more information.

---

## Benefits of Membership

1. Participating in market research/analytics helps develop critical thinking skills
2. Helps improve strategic decision making
3. Learn insights/data analytics, which is one of the fastest-growing fields in business jobs.
4. Make lifelong friends
5. Networking opportunities
6. Being involved in research shows employers that you are a critical thinker and intelligent.
7. Research/analytics can be applied and is used in many fields of business

## Contact for Analytics and Marketing Insights Club

Directory Listing for Contact for Analytics and Marketing Insights Club

| Name | Title | Email |
| --- | --- | --- |
| Gene Deng | Vice President | ami@cpp.edu |
