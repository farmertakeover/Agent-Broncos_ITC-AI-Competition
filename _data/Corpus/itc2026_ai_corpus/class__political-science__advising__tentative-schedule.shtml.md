**Source:** http://www.cpp.edu/class/political-science/advising/tentative-schedule.shtml
...
## Plan Ahead with the Tentative Four-Year Course Schedule

The Political Science Department publishes a tentative four-year schedule of classes. **This schedule is subject to change**. For the latest updates to the course schedule, consult the [Schedule of Classes](https://schedule.cpp.edu).

[Download the tentative schedule (PDF).](https://www.cpp.edu/class/political-science/docs/tentativeschedule/25-26.pdf)
