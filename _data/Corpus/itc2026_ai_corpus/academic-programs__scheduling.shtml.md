**Source:** http://www.cpp.edu/academic-programs/scheduling.shtml
...
The materials below are provided by the Office of Academic Planning to help departments build accurate, transparent, and equitable schedules.

[![calendar clipart](img/cpp_calendar_clipart.png)

### Academic Calendar

The University's official Academic Calendar.](academic-calendar/index.shtml)

[![Scheduling Guide cover](documents/scheduleguide.png)

### Schedule Building Guide

This guide is designed to support departments as they build their schedules.](https://www.cpp.edu/academic-programs/protected/scheduling/25-26_scheduling_guide_111425.pdf%20)

[![Academic Planning Logo](documents/academicplanninglogo.jpeg)

### Schedule-Building Timelines](#modal-0 "Schedule-Building Timelines")

### Schedule-Building Timelines

×

* [Winter 2026 (PDF)](protected/scheduling/winter-2026-class-schedule-building-timeline_v1.pdf)
* [Spring 2026 (PDF)](protected/scheduling/spring-2026-class-schedule-building-timeline_v2.pdf)
* [Summer 2026 (PDF)](protected/scheduling/summer-2026-class-schedule-building-timeline.pdf)
* [Fall 2026 (PDF)](protected/scheduling/fall-2026-class-schedule-building-timeline.pdf)

*Dates subject to change.*

Close

[![DeLorean Clock](documents/backtothefuture.png)

### Time Module Deviations](#modal-1 "Time Module Deviations")

### Time Module Deviations

×

Standard time modules ensure that students can build a course schedule of major and university requirements. Deviations from these modules thus require significant justification, as they can seriously impact student success. To request a time module deviation, please fill out the form found here

[Time Module Deviation Form](protected/scheduling/time-module-deviation-form-revised-06.13.20231.pdf)

Submit this form to the AVP of Academic Planning, Keith Forward (kmforward@cpp).
...
## CourseMatch Submissions

CourseMatch is a CSU Chancellor's Office program that aims to provide students across the system with greater access to essential GE courses. CourseMatch courses must be fully online, GE-approved, maintain low DFW rates, and be staffed by trained faculty. Departments receive additional funding for CourseMatch student enrollment.

[Submit Your Course](coursematch.shtml)

![Cyber Security Team](img/24cyber-team3.jpg)

## Contact Us

Email scheduling@cpp.edu for help.
