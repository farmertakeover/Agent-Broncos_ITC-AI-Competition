**Source:** http://www.cpp.edu/cafe/teaching-and-learning/accessibility-statements.shtml
...
| Application | Accessibility Statements |
| --- | --- |
| Adobe Creative Cloud, Adobe Express | [Accessibility conformance reports for Adobe solutions](https://www.adobe.com/accessibility/compliance.html) |
| Audacity | [Audacity Accessibility Information](https://manual.audacityteam.org/man/accessibility.html) |
| Camtasia | [Camtasia VPAT (pdf)](https://assets.techsmith.com/docs/techsmith-camtasia-vpat.pdf) |
| Cascade | [Cascade VPAT (pdf)](../documents/teaching-learning/cascade-vpat.pdf) |
| GradeScope | [Gradescope VPAT](https://www.turnitin.com/about/accessibility) |
| iClicker | [iClicker Accessibility Statement & VPATs](https://www.iclicker.com/accessibility) |
| Kaltura | [Kaltura Accessibility Statement](https://corp.kaltura.com/products/video-accessibility/) [Kaltura VPAT (pdf)](https://corp.kaltura.com/wp-content/uploads/2018/09/Kaltura-Official-VPAT-September-2018.pdf) |
| Labster | [Labster Accessibility](https://www.labster.com/accessibility/) [Labster EEAAP (docx)](../documents/lms-integrations/labster-eeaap.docx) |
| MATLAB | [Accessibility Statement](https://www.mathworks.com/support/accessibility.html) [Keyboard Shortcuts](https://www.mathworks.com/help/matlab/matlab_env/keyboard-shortcuts.html#responsive_offcanvas) |
| Microsoft Office | [Microsoft Office Accessibility Statement](https://www.microsoft.com/en-us/trustcenter/compliance/accessibility) |
| Microsoft Sway | [Microsoft Sway Accessibility Information](https://support.office.com/en-us/article/accessibility-features-in-sway-536c615e-14fc-4689-b816-c79442748a73) |
| Snagit | [Snagit VPAT (pdf)](https://assets.techsmith.com/docs/techsmith-snagit-vpat.pdf) |
| Turnitin | [Turnitin Accessibility Statement & VPATs](https://www.turnitin.com/about/accessibility) |
| YouTube | [Google Accessibility Information](http://www.google.com/accessibility/initiatives-research.html) |
| Zoom | [Zoom Accessibility Statement](https://zoom.us/accessibility) |
