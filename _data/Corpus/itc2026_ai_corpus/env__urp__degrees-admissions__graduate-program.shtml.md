**Source:** http://www.cpp.edu/env/urp/degrees-admissions/graduate-program.shtml
...
![Student Desc crit](../img/student-desc-crit.jpg)

*Student desk crit with Distinguished Alumnus Earl Gales Jr. ('72, urban and regional planning).*

## Overview

The Masters Program in Urban and Regional Planning at Cal Poly was established in 1972 and is fully accredited by the American Planning Association. It is the only accredited program in Southern California offering most of its classes in the evening hours. The program can be completed in two years if taken on a full time basis, or in up to seven years on a part-time schedule. The quality of the program has been recognized by national accreditation teams, in awards by professional organizations, and by employer demand for our students. In 2006, Planetizen rated the program in the top 25 nationally, 6th in the nation for zoning administration. Planetizen also rated the program as the most diverse in the nation. The Graduate Coordinator is Dr. So-Ra Baek sbaek@cpp.edu.
...
* [Measures of Student Achievement - Master of Urban and Regional Planning (pdf)](../docs/pab_publicinfo_2025_murp.pdf)
* [Program and Student Learning Outcomes - Master of Urban and Regional Planning (MURP\_PLO\_SLO.pdf)](../docs/murp-plo-slo.pdf "Program and Student Learning Outcomes - Master of Urban and Regional Planning (MURP_PLO_SLO.pdf) (opens in new window)")

## Admissions

The Department accepts applications for **Fall** semester only.

To be considered for admissions, you are required to submit your application materials through the university’s online application platform. Please pay close attention to the procedures and deadlines. For specific information, application instructions, and requirements please refer to the Masters Admissions page: [Apply as a Graduate Student](https://www.cpp.edu/admissions/graduate/apply.shtml).

### *Application Deadline for Fall 2026 is February 15, 2026.*

##### *\*\*For those who have missed the deadline and are still interested in applying to the program, please reach out to the Graduate Coordinator*

Submit your application through the university’s online application form found on the [Office of Admissions](https://www.cpp.edu/admissions/graduate/masters-app-checklist.shtml) webpage along with any supporting material, which includes:

* **Unofficial transcripts**from all institutions of higher education that you have attended.
* **Three letters of recommendation** from individuals who can address your scholarly and/or professional abilities and can comment on your potential for success in graduate study. Recommenders should upload their letters through the Cal State Apply platform on letterhead, .pdf or doc. file.
* **Statement of Purpose** in which you indicate your reasons for seeking a Master of Urban and Regional Planning degree and discuss your interest and career goals. The statement should be 600-900 words and typed.
* **Unofficial test scores** (GRE and/or TOEFL). Please see below for specific requirements.
* **CV**

The department has established the following minimum requirements to prospective students.

* **GPA:** Minimum grade point average (GPA) score is 3.0. The University determines your GPA by evaluating all college course work.
* **GRE:** Applicants with an undergraduate grade point average between 2.5 and 3.0 will be considered for admission on the basis of scores on the Graduate Record Exam (GRE). Applicants with an undergraduate grade point average of 3.0 or better are not required to take the GRE. We require a combined score of 280 and no less than 135 on either the verbal or the quantitative sections.
* **TOEFL:** Applicants who received their undergraduate degree from an institution where English is not the main form of instruction must submit the results of the TOEFL examination. The required minimum score on this examination is 237 (computer-based), 580 (paper-based), or 92-­93 (Internet-­based).

**International Applicants**

Known for its outstanding academic programs, Cal Poly Pomona offers excellent education for international students who wish to pursue a degree in the United States. The Graduate Program accepts non-resident and foreign students. Current and future International Students in Cal Poly academic programs must contact the International Center for information regarding visas, guidelines for maintaining academic progress, and procedures for internships and post graduation work. For additional information on Incoming International Students and requirements, please refer to: [Apply as an International Student](https://www.cpp.edu/admissions/international/apply.shtml).

**Contact**

For inquiries regarding admissions to the Master of Urban and Regional Planning degree program, please contact:
...
1. ***Mastery of urban and regional planning knowledge***
   ...
   1. Demonstrate knowledge of the evolution of substantive and procedural planning theory, emphasizing behaviors and structures to bring about sound planning and the purpose and meaning of planning, emphasizing the philosophical underpinnings of that understanding, an ability to discern and critique paradigms, and an ability to theorize about planning.
   2. Demonstrate knowledge of the role of planning in public, private, and non-profit settings and methods of collaboration and entrepreneurship across sectors appropriate to management-level planning.
   3. Demonstrate an ability to argue positions regarding planning laws, constitutional rights, legal procedures, and the intergovernmental framework for planning and organizational administration.
   4. Explain the historical, current, and likely future influences shaping cities and regions, including design, land use, environmental, social, economic, financial, legal, institutional, and social justice dimensions, while understanding these influences in a global context. Show an ability to apply a multi-paradigmatic approach to these influences.
   5. Demonstrate expert knowledge of at least one subfield of planning, such as community development, environmental policy, transportation policy, or land use and design.
2. ***Demonstrated communication and dialogic skills***

   1. Make well researched, logically crafted, and adequately warranted presentation, analysis or argument in written, oral and graphic forms, suitable for graduate research and advanced professional reports.
   2. Discuss clearly planning concepts, research activity, and policy proposals at a level appropriate to mid-level professional planning.
   ...
   4. Effectively design and carry out visioning, facilitation, and negotiation in planning settings, emphasizing empowerment and broadening of the voices in planning.
   5. Demonstrate leadership and collaboration skills for organizing team work, community motivation, and decision-making, based on an understanding of organization and community culture.
3. ***Demonstrated skills and creativity in research, analysis, and problem solving***

   1. Demonstrate competence and creativity in graduate-level data collection, including secondary sources such as library, internet, and government data sources, and primary sources such as field research, surveys, and interviews.
   2. Uncover and mine relevant data, literature or policy, use case studies, and develop research designs appropriate for graduate research and/or advanced studies.
   3. Apply quantitative, qualitative, mixed-method, and spatial analysis tools suitable for carrying out graduate research; interpret research methodologies from the literature.
   4. Apply models for ex ante and ex post policy analysis for sophisticated, multi-dimension problems.
4. ***Demonstrated skills and creativity in design, plan, and policy making***

   1. Assess the application of alternative design, plan and policy making processes to a problem context, emphasizing change making and organizational capacity. Innovate in designing new planning processes.
   ...
   3. Develop implementation strategies to carry out physical designs, and/or economic and social policies, including designing ex post evaluations.
   4. Develop a logical hierarchy of ends and means in plan texts; write clear policy and regulatory language that meets legal standards for logic and clarity.
   5. Evaluate designs, development plans, and associated implementing tools once implemented.
   6. Demonstrate entrepreneurship in implementing plans, policies and regulations, including project management, through in-class experiences.
5. ***Reflective capacity in ethical and normative reasoning***

   1. Reflect on, articulate and justify with graduate-level reasoning positions on concepts such as the public interest(s), governance processes and participation, sustainability and environmental quality, economic growth and efficiency, and diversity and social justice.
   2. Demonstrate analytic capability and judgment in considering professional ethics as they apply to typical public, private, and non-profit planning situations that commonly occur at the management level. Articulate and coherent approach to politics and power.
   3. Manifest self-knowledge, experiences, and reflective ability concerning learning styles, roles in interdisciplinary teams, and cultural awareness. Have a game plan to carry reflection through one’s professional career.
...
Choose a minimum of 13 units with approval of advisor from courses listed below:
