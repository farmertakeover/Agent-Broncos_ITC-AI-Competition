**Source:** https://www.cpp.edu/accessibility/videos.shtml
...
This [YouTube Video about Coffee](https://youtu.be/7SYnAJg1Cig) demonstrates how captions are used to convey information. The captions in the video can be turned on and off.
...
* [Success Criterion 1.2.1 Audio-only and Video-only (Prerecorded)](https://www.w3.org/WAI/WCAG21/quickref/#audio-only-and-video-only-prerecorded)
...
* [Mozilla Firefox: Adding captions and subtitles to HTML5 video](https://developer.mozilla.org/en-US/Apps/Fundamentals/Audio_and_video_delivery/Adding_captions_and_subtitles_to_HTML5_video)
* [Accredited Language Services: Subtitles and Captions](https://www.accreditedlanguage.com/2016/08/18/subtitles-and-captions-whats-the-difference/)
* [Described and Captioned Media Program: Captioning Types, Methods, and Styles](https://www.dcmp.org/caai/nadh38.pdf)
