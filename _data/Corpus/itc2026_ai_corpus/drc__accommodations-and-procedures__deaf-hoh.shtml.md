**Source:** http://www.cpp.edu/drc/accommodations-and-procedures/deaf-hoh.shtml
...
### Student Request for DHH Services for campus events
...
### Campus Community Interpreting Request Form

If you are faculty or staff on campus, and need to request Interpreting or Captioning for course or campus events (one-time events, special events etc.), please submit our [Interpreting Request Form](https://cascade.accessiblelearning.com/CPP/CustomRequest.aspx).

### Request an Appointment with a DHH Coordinator
...
Review the full details about DRC [Policy and Procedures for Deaf and Hard of Hearing Services](https://www-test.cpp.edu/drc/accommodations-and-procedures/policies-and-procedures-links.shtml).
