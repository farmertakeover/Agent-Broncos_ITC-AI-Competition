**Source:** http://www.cpp.edu/faculty/jkorah
...
![John Korah](jkorah-profile2.jpg)
...
[Building 8, 15](https://www.cpp.edu/maps/?id=1130#!m/276186)

## Office hours

M | 1:00 PM - 3:00 PM (ZOOM)
W | 1:15 PM - 03:15 PM (ZOOM AND IN PERSON)

* [About Me](index.shtml)
* [Research](interior-page.shtml)
* [Publications](publication.shtml)
* [Teaching](teaching.shtml)
* [Current Students](current_students.shtml)

## About Me

John Korah is an Assistant Professor with the Department of Computer Science at Cal Poly Pomona.

##### **Education**

* Ph.D. in Computer Science - Virginia Tech
* M.S. in Electrical Engg - Virginia Tech
* B.E. in Electronics and Instrumentation Engineering - Government College of Technology Coimbatore, India

##### **Research Areas**

Parallel & distributed algorithm design, high performance computing, large and dynamic network analysis, computational social systems, cybersecurity parallel/distributed information retrieval, modeling & simulation

##### **Research Topics**

* **High Performance Computing:** Large and dynamic social network analysis using anytime anywhere algorithms
* **Health Policy Modeling:**Modeling complex human decision making in cross-border disease spread and information desimination of health care guidelines
* **Big Data Analytics:**Parallel/Distributed processing frameworks for time and resource bound information retrieval applications in large and dynamic search spaces
* **Cyber Security:**Insider threat modeling in cyber systems utilizing computational behavioral modeling and machine learning techniques for threat detection
* **Computational Social Systems:**Modeling complex real world scenarios such as political instability, and social resilience
* **Performance Modeling & Analysis:**Network load and performance modeling in network centric systems

## Announcements

 Students interested in doing Senior Projects and Masters Projects/Thesis may email me.
