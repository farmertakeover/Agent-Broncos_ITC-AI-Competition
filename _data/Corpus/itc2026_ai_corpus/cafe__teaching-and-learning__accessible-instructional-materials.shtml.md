**Source:** http://www.cpp.edu/cafe/teaching-and-learning/accessible-instructional-materials.shtml
...
Accessible instructional materials allow us to foster growth and cultivate belonging, two of CPP’s Principles of Community. The resources below offer practical guidance to help faculty create and provide accessible instructional materials.

Additionally, CAFE will be offering [workshops and trainings](../programs-and-events/upcoming-programs.shtml) on accessibility in early December 2025 and early Spring 2026. CAFE will also offer limited student assistant hours this academic year to support faculty as they work to make instructional materials accessible.

Two new accessibility tools are available in Canvas. More information about [UDOIT and TIdyUP](#udoit) is below.

View our Accessibility Checklist to help ensure that your materials are accessible.

[View Accessibility Checklist](accessibility-tutorials/accessibility-checklist.shtml)
...
[Request Accessibility Consultation](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=355426dd6f3c43007996073aea3ee401)
...
[Learn more about UDOIT](https://cidilabs.instructure.com/courses/6621/pages/introduction-to-udoit) [Learn more about TidyUp](https://cidilabs.instructure.com/courses/2854)
...
[Learn more about CHAI](../faculty-recognition/chai.shtml)
...
[![Microsoft Word icon](../img/accessibility/word.png)

Microsoft Word](/cafe/teaching-and-learning/accessibility-tutorials/microsoft-word.shtml)

[![Microsoft Powerpoint icon](../img/accessibility/powerpoint.png)

Microsoft Powerpoint](/cafe/teaching-and-learning/accessibility-tutorials/microsoft-powerpoint.shtml)

[![Adobe PDF icon](../img/accessibility/pdf.png)

Adobe PDF](/cafe/teaching-and-learning/accessibility-tutorials/adobe-pdf.shtml)

[![HTML icon](../img/accessibility/html.png)

Websites](/cafe/teaching-and-learning/accessibility-tutorials/websites.shtml)

![](../img/general/divider.png)

## Information and Resources

* Federal law requires electronic and information technology, and digital materials be accessible for users with disabilities. This includes campus websites, third party applications, as well as digital instructional materials. Beginning April 24, 2026, amendments to the Americans with Disabilities Act (ADA) Title II regulations require adherence to [WCAG 2.1, Level AA](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1) technical standards.
* [Top Tips for Making Your Materials Accessible](accessibility-tutorials/top-tips.shtml)
* [Learning Technologies Accessibility Statements](accessibility-statements.shtml)
* [Disability Resource Center (DRC)](https://www.cpp.edu/drc/)
* [Accessibility Technology Initiative (ATI)](https://www.cpp.edu/accessibility/)
