**Source:** https://www.cpp.edu/ramp/program-materials/syllabus.shtml
...
## READING, ADVISING, & MENTORING PROGRAM TRIO Student Support Services Sample Syllabus for CPU 1050A
...
| --- | --- |
| **A** | * **24 Tutorial Sessions**(weekly sessions two times per week beginning week 2)  * **Financial Aid / Literacy or Academic Success Workshop**([see list and regsiter on RAMP Events page](https://www.cpp.edu/ramp/events/index.shtml))  * **On-Campus Play or Event AND Journal**(to be arranged with RAMP advisor; see a staff member for a play voucher)  * **Peer Mentoring Session**(offered around weeks 9-12; see a staff member to schedule a session)  * **Professional Spotlight**(offered around week 7, 8, or 9; register on the RAMP events page)  * **Post-test**(completed in tutorial session during last week of tutoring)  * **Active Reading Project** (see description on Active Reading Journals handout) |
| **B** | Same as above but without the Active Reading Project |
...
***Peer Mentoring Workshop*:**You will meet with a RAMP Peer Mentor to develop campus awareness and skills critical to being a successful student. See your advisor to schedule a peer mentoring session.
...
***Active Reading Project*****:**The active reading project entails one of the following two options:
...
**If you have questions at any time, email ramp@cpp.edu**
