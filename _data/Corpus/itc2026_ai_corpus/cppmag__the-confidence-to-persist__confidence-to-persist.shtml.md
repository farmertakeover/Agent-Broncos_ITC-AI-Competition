**Source:** https://www.cpp.edu/cppmag/the-confidence-to-persist/confidence-to-persist.shtml
...
![Illustration of students in a classroom with the Story Titled The Confidence to Persist](../img/20fall-cppmag-hero-confidence-to-persist.jpg)
...
**Chris Yanez** showed up to his high school’s orientation for [**Upward Bound**](https://www.cpp.edu/pre-college/ub-classic/classic.shtml) in a football uniform caked with dirt and reeking of his sweat.

![Chris Yaenz](../img/chris-yanez.jpg)He hadn’t planned to attend at all. But when his mom found his invitation to the meeting poking out of his backpack, Yanez was forced to go “as is.”
...
Some programs, such as Upward Bound and the [**Educational Opportunity Program**](https://www.cpp.edu/ssep/eop/index.shtml) (EOP), date back to the Civil Rights movement of the 1960s and ’70s while others were created in recent years in response to the ever-changing needs of students.
...
There is a 4 to 5 percent equity gap in student achievement for low-income students and a 10 percent gap for underrepresented minorities. That gap needs to be zero, says **Terri Gomez**, associate provost for [student success](https://www.cpp.edu/studentsuccess/), equity and innovation.
...
![Laptop Distribution during COVID-19](../img/laptop-distribution-alonso2-2.jpg)
...
Guzman Scott’s office oversees EOP, which serves 2,700 students throughout the year. Some are in [**Renaissance Scholars**,](https://www.cpp.edu/ssep/renaissance-scholars/) a year-round program for former foster youth. EOP Transition Programs such as [**Summer Bridge**](https://www.cpp.edu/ssep/summer-bridge/index.shtml) and [**Transfer Bridge**](https://www.cpp.edu/ssep/transfer-bridge/index.shtml) help incoming freshmen and transfers. EOP Tutorial Services and the Veterans Resource Center provide tutoring, mentoring and a physical space for students to connect. In the last couple of years, a new pilot program connected 24 academic coaches with about 400 first-generation, underrepresented freshmen in the [College of Letters, Arts, and Social Sciences](https://www.cpp.edu/class/).
...
![Collage of 4 photos featuring upward bound students.](../img/upward-bound-4-up.jpg)
...
For Quintero, executive director of Cal Poly Pomona’s [**TRIO Pre-College Programs**](https://www.cpp.edu/drc/arches/index.shtml), the message resonated: Education is the key to socioeconomic mobility.
...
The bulk of equity programs on campus, including [**I AM FIRST**](https://www.cpp.edu/studentsuccess/oss/i-am-first/index.shtml) (first-generation students), [**Project SUCCESS**](https://www.cpp.edu/projectsuccess/index.shtml) (men of color), **[Bronco Scholars](https://www.cpp.edu/studentsuccess/oss/early-start/bronco-scholars/index.shtml)** (first-year students needing additional math support) and [**PolyTransfer**](https://www.cpp.edu/polytransfer/index.shtml) (transfer students), are designed to support students as they work toward earning their degrees.

For example, the [**Disability Resource Center**](https://www.cpp.edu/drc/index.shtml) (DRC) and its [**ARCHES**](https://www.cpp.edu/drc/arches/index.shtml) program that provides academic advising, peer tutoring and mentoring, help ensure that students with disabilities receive equal access. Students get help with how to meet deadlines, study more efficiently and take better notes, says DRC Director **Tracee Passeggi**.
...
Last year, the couple contributed an additional $50,000 to expand the [**President’s Scholars program**](https://www.cpp.edu/president/honoring-exellence/presidents-scholars.shtml), which now designates one of the 26 scholarships for a student with a disability. (Turn to page 13 for more on the Strand family’s memorial fund.)
...
![During an Upward Bound summer session in 2018, Professor Steve Alas speaks to high school students about opportunities for underrepresented minorities in science.](../img/upward-bound-alas1.jpg)
...
[![Paul An](../img/an,-paul5.jpg)

### United with Differences

Recent grad shines light on students with disabilities.](https://www.cpp.edu/cppmag/the-confidence-to-persist/united-with-differences.shtml)

[![The Strands hold a photo of their son. ](../img/strand3.jpg)

### Overcoming Obstacles

The Strands honor son's life through memorial fund.](https://www.cpp.edu/cppmag/the-confidence-to-persist/overcoming-obstacles.shtml)

[![Jose Gomez](../img/gomez,-jose-dist-alum7.jpg)

### Bridging the Gap

Recalling his own challenges, alumnus helps students in need.](https://www.cpp.edu/cppmag/the-confidence-to-persist/bridging-the-gap.shtml)

[![Anne Cawley teaches a class online](../img/cawley,-ann3.jpg)

### Solving for Equity

Math professor works to ensure all students make the grade.](https://www.cpp.edu/cppmag/the-confidence-to-persist/solving-for-equity.shtml)

[![Reggie Robles](../img/robles,-reggie5.jpg)

### Leadership from the Ground Up

Alumnus, now staff member, models the power of leadership and advocacy.](https://www.cpp.edu/cppmag/the-confidence-to-persist/leadership-from-the-ground-up.shtml)

[![Makeda Bostio speaking with a student at a table.](../img/renaissance-scholar-2015-3.jpg)

### Against All Odds

Renaissance Scholars helps steer foster youth to success.](https://www.cpp.edu/cppmag/the-confidence-to-persist/against-the-odds.shtml)

![Thumbnail of Confidence to Persist Story](../img/20fall-cppmag-presidents-message.jpg)
[Download PDF](https://www.cpp.edu/cppmag/pdf/20fall-cpp-mag-confidence-to-persist.pdf)
