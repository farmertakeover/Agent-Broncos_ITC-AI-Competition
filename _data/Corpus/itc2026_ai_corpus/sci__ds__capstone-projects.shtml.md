**Source:** https://www.cpp.edu/sci/ds/capstone-projects.shtml
...
Daeyoung Hwang (Advisor: Dr. Ben Steichen), Generating A Multilingual Information Retrieval Data Set Through Crowdsourcing, Fall 2021

Roy Amador (Advisor: Dr. Tingting Chen), Malware Visualization and Analysis through Supervised Machine Learning, Fall 2021

Shura Boz and Yongxin Zhong (Advisor: Dr. Tingting Chen), Pneumonia Identifier, Spring 2022

Abigail Choi (Advisor: Dr. John Korah), Cyber Anomaly Detection Using Support Vector Machines, Spring 2022

Eugene Mondkar (Advisor: Dr. Amar Raheja), Hyperspectral Data Processing (expected completion in Spring 2022)

Kevin Pham (Advisor: Dr. John Korah), Modeling the Impact of Disease Epidemic Interventions using Agent-based Models, Spring 2022

Babak Shajari (Advisor: Dr. Marcus Eger), Digital Twin for a UAV, Spring 2022

Sean Ta (Advisor: Dr. Lan Yang), Analyzing posts from r/wallstreetbets (expected completion in Fall 2022)

Saul Barajas (Advisor: Dr. John Korah), Implementing and Comparing Different Parallel SURF Algorithms (expected completion ?)
