**Source:** http://www.cpp.edu/sci/mathematics-statistics/calculus-placement.shtml
...
First-time freshmen who are in [**Math Category 2**](https://www.cpp.edu/studentsuccess/new-students/category-placement.shtml "link to understanding category placement") in specific majors need to take the ALEKS PPL assessment.

Majors that Need to Take ALEKS

### Majors that Need to Take the ALEKS
...
* Nutrition, Nutrition Science and Nutrition and Health options
* Physics
* Undeclared students interested in a major above

Close

### Step 2: Make Your ALEKS Account

Using your CPP email address and password, sign up for the **[Calculus Placement, Cal Poly Pomona, AY 25-26](https://secure.aleks.com/shiblogon/sso?sso_account=ab873f3&enroll_class_code=UXFR4-U4FYG)**at the ALEKS website. This link should take you directly to the ALEKS AY 25-26 cohort. Be ready with pencil, scratch paper, and time for a 1-hour practice assessment when you first log in. The first practice assessment does not count for your placement - it is for practice only.
...
You will need a **photo ID** and your **Bronconame** and **Bronco password** to access the ALEKS PPL proctored assessment.
...
### How can I be exempt from taking the proctored ALEKS assessment?
...
* **AP Precalculus or AP Calculus AB and/or BC exam scores of 3s or higher.** You can make sure to indicate Cal Poly Pomona on your AP score report. If you have a passing score and it is not on your Transfer Credit Report, join the **[Bronco Advising Center’s virtual queue](https://www.cpp.edu/bac "link to the BAC's virtual queue")** for assistance. You will need to know your College Board login information. CPP will receive 2024 scores in July.

* **IB Mathematics HL exam score of 4 or higher.** You can request IB transcripts through **[IB Transcript Request](https://www.ibo.org/programmes/diploma-programme/assessment-and-exams/getting-results/ "link to IB transcript request")**. If you have a passing score and it is not on your Transfer Credit Report, join the **[Bronco Advising Center’s virtual queue](https://www.cpp.edu/bac "link to the BAC's virtual queue")** for assistance.

* **Official transcripts for College Algebra (as the prerequisite for MAT 1200) or College Algebra and Trigonometry (as the prerequisites for MAT 1140 or MAT 1300) from an accredited college with grades of C or higher.** Refer to your college’s registrar or records webpage for more instructions on ordering official transcripts. Visit Admissions’ **[Admitted Freshmen checklist](https://www.cpp.edu/admissions/freshmen/admitted.shtml "link to the admitted freshman checklist")** for more information on submitting transcripts.
...
### What if I am waiting on AP Calculus scores or dual enrollment grades?
...
### What happens if I take both the ALEKS and an AP exam?
...
### What should I do if I am not able to come to campus for an in-person proctored assessment?
...
If none of the testing dates work for you because of extenuating circumstances, contact **testingservices@cpp.edu**.

### What will happen if I do not take the recommended proctored ALEKS assessment for my major?
...
### ALEKS Scores Course Placement

**[ALEKS Placement Scores AY 2025-26 (PDF)](docs/math-placement/aleks_placement_scores_24-25.pdf)**

### Eligibility and Scores/Course Placement Questions

[Bronco Advising Center](https://www.cpp.edu/studentsuccess/bronco-advising-center/index.shtml "Bronco Advising Center. ")

### Proctored Assessment Questions

[Testing Services](https://www.cpp.edu/testing-services/index.shtml "Testing Services. ")

### ALEKS PPL Website Troubleshooting

Email Mathematics & Statistics Department
