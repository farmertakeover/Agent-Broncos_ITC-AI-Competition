**Source:** https://www.cpp.edu/student-accounting/payment-options/third_party_billing.shtml
...
### General Submission Instructions (All Sponsors)

* Authorizations **must be submitted in writing** (mail, email) and **must arrive prior to** registration or payment due date, or the student risks disenrollment.
...
* Company must have an established **contractual agreement** with the university on file or prior arrangement with Student Accounting & Cashiering Services.
* Student must **send an authorization** on company letterhead, signed by an authorized representative for each term.

### Federal Government

* **Signed letter** must be on official US Government letterhead.

### International Sponsors (Foreign Embassy)
...
### Vocational Rehabilitation / Veterans Affairs

* Requires a **signed authorization** from the appropriate sponsoring agency, such as the **Veterans Administration**.
...
| **Requirement** | **Details** |
| --- | --- |
| Student Information | Full name and Bronco ID |
| Term and Year | Example: Spring 2026 |
| Covered Charges | List of covered fees (e.g., tuition, housing, meals) |
| Billing Address | For invoicing the sponsor |
| Authorized Contact Information | Sponsor’s representative name and phone Number /email |
| Signature | Must be signed by an authorized representative/official |
| No Conditions Allowed | Cannot be contingent on grades or course completion |
...
You can find census dates on the [Dates & Deadlines page](../dates-and-deadlines/dates-and-deadlines.shtml "Dates and Deadlines page").

* Invoices are sent after the census date.
* Payment is due within 30 days.
* Late or unpaid invoices result in charges reverting to the student’s account.
* A financial hold may be placed on the student’s account for non-payment.

Payment Method: Checks. Payable to Cal Poly Pomona. Include a copy of the invoice. For ACH, if you are interested in ACH billing, please contact Student Accounting and Cashiering Services directly at SACS3rd@cpp.edu
...
**Mailing Address and Location**California State Polytechnic University, Pomona
...
[Payment Plan page](cpp-payment-plans.shtml)

[Financial Aid Office](https://www.cpp.edu/financial-aid/)

[Understanding Your Student Account](../student-account-help/understanding_your_student_account.shtml)
