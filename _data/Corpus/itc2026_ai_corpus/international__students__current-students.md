**Source:** https://www.cpp.edu/international/students/current-students
...
* **I-94 Arrival and Departure Record**
  ...
  + You might need a printout of your electronic I-94 information to apply for various benefits such as a California State ID card or a Social Security Number. You can obtain a printout of your I-94 record at [CBP.gov/I94](https://i94.cbp.dhs.gov/I94/#/home).
...
* **Program Extension**
  + If you are unable to complete your course of study before the completion date noted in item 5 on your I-20, **you must request an extended I-20 before your current I-20 expires**. For more information and instructions, see [Extending I-20 or DS-2019](../isso-forms/i20-ds2019-extension.shtml).

* **Changing School**
  + You must register full-time at CPP, since we issued your I-20 and oversee your SEVIS record. If you decide to transfer to another school, **contact the ISSO prior to completing your final semester at CPP**. For information about transferring your SEVIS record to the new school, visit [School Transfer](../isso-forms/transfer-out.shtml).

* **Change of Education Level**
  + If you will complete your current program of study and plan to continue at CPP in another program (for example, change from a Bachelor's degree program to a Master's degree program), your [I-20 must be updated](../new-students/request-i-20.shtml).
...
* **Name Change**
  ...
  + Note that SEVIS is a separate database from the CPP database. For instructions on changing your name in the CPP database, visit: <https://www.cpp.edu/registrar//student-record/update-personal-information.shtml>.
...
See the “[Reduced Course Load](../isso-forms/rcl.shtml)” for information.
...
Visit [Travel](travel.shtml) for more information.
...
Any change of address must be reported to Department of Homeland Security (DHS) within **10 days**. Update your local address through your [MyCPP](https://my.cpp.edu/) account, and DHS will automatically be notified of the change. If you are on OPT, update your address in [SEVP portal](https://sevp.ice.gov/opt/).
...
Review [Completion of Academic Program](completion-of-academic-program.shtml) for more information.
