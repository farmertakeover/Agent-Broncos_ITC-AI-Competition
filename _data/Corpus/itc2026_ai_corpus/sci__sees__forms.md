**Source:** http://www.cpp.edu/sci/sees/forms
...
While SEES provides dozens of services and opportunities, priority for acceptance include:

1. Be a College of Science major
2. Be a member of a group that has traditionally been underrepresented in higher education or has faced or faces social, educational, or economic barriers to careers in STEM.
3. First-year undergraduate or first-year transfer students

Please complete the SEES Program Application Form and click submit when you are finished. There are no fees associated with being part of the program.

Applications are reviewed once per year. All applications submitted by August 1 will be considered for the following school year. Any applications submitted after this deadline will be reviewed in the next cycle.

**Application submission does not guarantee acceptance into the program.**

Applications are currently closed for the 2025-26 academic year. Please check back during the Spring for the revised application.
