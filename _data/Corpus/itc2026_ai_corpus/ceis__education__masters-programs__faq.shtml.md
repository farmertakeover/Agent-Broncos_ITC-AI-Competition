**Source:** http://www.cpp.edu/ceis/education/masters-programs/faq.shtml
...
## How do I apply to the master's program? What is the admission deadline?

| **For Admission in** | | | | **Deadline** |
| --- | --- | --- | --- | --- |
| Summer | | | | Closed for MA applicants |
| Fall | | | | August 1st |
| Spring | | | | December 1st |

## What are the minimum requirements to apply to the master's program?
...
## Is there a time limit to earn the master's degree?
...
Tuition and fees vary by units taken and student status (credential or graduate). For update information, [please refer to the university’s fee schedule.](https://www.cpp.edu/student-accounting/tuition-fees/graduate.shtml)

## Can I transfer units/courses from another master's program?
...
## I’m currently in CPP’s teaching credential program. How do I apply to the master’s program?
