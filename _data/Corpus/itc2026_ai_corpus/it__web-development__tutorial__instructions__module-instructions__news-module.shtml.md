**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/news-module.shtml
...
1. A news feed from the Poly Centric.
2. A custom news feed specific to the website built internally by the department.

This tutorial will go over how to create and set up a custom news module.

## Custom News Block

### Creating News Article Page

***News Article Page View***

***![News Page Cascade View](../img/newspageview.png)*** ***Cascade View
![news page cascade view](../img/newspagecascadeview.png)***

**NOTE:** After any changes to your news pages, you need to re-publish the desired landing page for your changes to display.

### Setting Up News Listing Page

***News Listing Page View***Note: You will need to use the news-listing template for this page.
![news listing page](../img/news-listing-page.png)
![All News Page View](../img/allnewspageview.png)

***Cascade View
![news page cascade view](../img/news-list-cascade-view.png)***
