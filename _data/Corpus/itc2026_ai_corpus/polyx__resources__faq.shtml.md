**Source:** https://www.cpp.edu/polyx/resources/faq.shtml
...
### Do you get course credit for participating in a PolyX?

If your Polytechnic Experience is a course, you may earn course credit. If your PolyX is a program or a club, you may not earn course credit. By participating in a PolyX you will recieve an invaluable experience that includes all 7 PolyX elements! Go to the [PolyX Hub](https://www.cpp.edu/polyx/inventory/index.shtml) and click on a PolyX to see the description or contact the faculty/staff for confirmation.

### How do I search for a PolyX?

Searching for a PolyX is very easy! Just go to the [PolyX Hub](https://www.cpp.edu/polyx/inventory/index.shtml) and scroll through over 42 PolyX to choose from. Use our search or filter function to find the perfect PolyX for you!

### Are all PolyX offered every semester?

All PolyX might not be offered every semester. If the PolyX is a course, click the link on the PolyX Hub go to My CPP to check the [class schedule](https://schedule.cpp.edu/) by term. If the PolyX is a program or club, contact the faculty/staff for confirmation.

### Do PolyX count towards your degree progress?

Yes! If the PolyX is a course that fulfills your major or GE requirement, then you will be working towards that degree.

### How often do we update the PolyX Hub?

The [PolyX Hub](https://www.cpp.edu/polyx/inventory/index.shtml) is updated every semester after the application process in which a course, club, or program is determined to have the 7 criteria to be considered a PolyX. You can search for a PolyX using the [PolyX Hub search tool](https://www.cpp.edu/polyx/inventory/index.shtml) and start your polytechnic experience!

### How can I learn more about participating in a PolyX?

Please email us at innovationinc@cpp.edu with any questions about PolyX or visit the [Innovation Incubator](https://www.cpp.edu/ii/index.shtml) website for more information how to get started with a PolyX!

![faculty faq](../img/banners/faculty-faq.png)

## Application & Eligibility

### What is the general process for applying to be included in the PolyX Hub?

Please visit the [PolyX Hub home page](../index.shtml), under "Interested in Featuring your PolyX? Find out how by following the steps below!", click on the button, "Instructions".

### Who is eligible to apply for a PolyX?

Anyone who is a staff member, lecturer, and/or T/TT faculty member at Cal Poly Pomona.

### What kind of attachments should I include in my application as examples of how my project meets the review criteria?
...
### How many times can I apply for a PolyX Minigrant?

Faculty or staff cannot apply for a PolyX Minigrant in two consecutive years. More details coming soon!

## Criteria

### How can my project meet each PolyX criterion?

Please refer to the document below for ideas on how you can satisfy each criterion.

* [Crowdsourced Ideas for PolyX Criterion](../documents/polyx-ideas_-crowdsourcing-2021-summer-institute.pdf)

### How intense is intense mentoring?
...
### I currently do not disseminate outside of my classroom, what can I do to include that component?
...
### How do I appropriately demonstrate critical thinking and problem solving for my course/project?
...
![](../img/gallery/saddle-up.png)

![](../img/gallery/faq2.png)
