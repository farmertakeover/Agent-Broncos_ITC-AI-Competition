**Source:** http://www.cpp.edu/ehs/occupational-health/respiratory-protection-program.shtml
...
![Two construction worker guys talking in work yellow safety jackets.](../img/respiratory-protection.jpg)

## Introduction

The University [Respiratory Protection Program (pdf](../all-pdfs/aed-forms/respiratory-protection-plan.pdf)[)](../all-pdfs/aed-forms/respiratory-protection-plan.pdf) was developed to protect employees against respiratory hazards including particulates, chemicals and other materials that pose a risk to employee health. The Respiratory Protection Program outlines important responsibilities for employees including the proper use of Personal Protective Equipment which often includes the use of a proper respirator.
...
### Voluntary N-95 Respiratory Use

**During COVID-19 Pandemic:** Under the Cal/OSHA Emergency Temporary Standards (Title 8, Section 3205), N-95 respirators for voluntary use when not required by occupational duties may be requested by employees in compliance with section 5144, [Appendix D](https://www.dir.ca.gov/title8/5144d.html) of the Respiratory Protection Standard.

Employees may voluntarily use a filtering face piece respirator (i.e., N95, N99 disposable dust masks) when not required by the standard during activities that involve low-level exposures (below permissible exposure limits, threshold limit values), non-hazardous nuisance dust or another similar particulate.

**[Appendix D to Sec. 5144](https://www.dir.ca.gov/title8/5144.html) (Mandatory) Information for Employees Using Respirators When Not Required Under the Standard**

**STEP 1.** **Required Training and Documentation for N-95 Voluntary Use Request:**

Training:

1. [N-95 Voluntary Use Compliance Brief: Filtering Face piece Respirators and Masks](https://csu.sumtotal.host/Core/pillarRedirect?relyingParty=LM&url=core%2Factivitydetails%2FViewActivityDetails%3FActivityId%3D43927%26UserMode%3D0)
2. [N-95 Voluntary Use Training Handout (PDF)](../all-pdfs/environmental-programs-forms/n-95-respirator-voluntary-use-training.pdf)

Acknowledgement Form:

1. [Employee Acknowledgement of Receipt, Review and understanding of Title 8 CCR § 5144 Appendix D (English) (PDF)](../all-pdfs/aed-forms/app_d_n95_vol_use_english.pdf)
2. [Employee Acknowledgement of Receipt, Review and understanding of Title 8 CCR § 5144 Appendix D (Spanish) (PDF)](../all-pdfs/aed-forms/app_d_n95_vol_use_spanish.pdf)

**STEP 2. All of the above must be completed prior to submission:**

* Submit Voluntary Use Form to ehs@cpp.edu
...
* [Download Questionnaire (PDF)](../all-pdfs/aed-forms/medical-questionnaire.pdf)

**2026 On-Campus Medical Evaluation Dates:**

* [Monday, February 2, 2026 7am-2pm](https://cpp.az1.qualtrics.com/jfe/form/SV_6SxHmnkap0FcLXw)
* [Thursday, February 5, 2026 7am-11am](https://cpp.az1.qualtrics.com/jfe/form/SV_8GGb7RHZ7Do6mzk)
* Contact ehs@cpp.edu if you need an appointment outside of these dates
...
* [N95 Respirator](https://csu.sumtotal.host/Core/pillarRedirect?relyingParty=LM&url=core%2Factivitydetails%2FViewActivityDetails%3FActivityId%3D41886%26UserMode%3D0) (Filtering Face piece Respirators and Masks)
* [Respiratory Protection 2.0 - Cal/OSHA](https://CSU.sumtotal.host/core/pillarRedirect?relyingParty=LM&url=app%2Fmanagement%2FLMS_ActDetails.aspx%3FActivityId%3D115387%26UserMode%3D0)
...
[Los Angeles County COVID-19 Informational Website](http://publichealth.lacounty.gov/acd/respiratory.htm#kindofmask)
...
[CDC Respirators and Mask Types and Performance website](https://www.cdc.gov/niosh/ppe/php/community-respirators-masks/types-of-respirators-and-masks.html?CDC_AAref_Val=https://www.cdc.gov/niosh/topics/publicppe/community-ppe.html)

### Where Can I Get a Mask On-Campus?

*"Effective May 30, 2025, Safer Return will no longer provide PPE supplies (including gloves, surgical masks, and hand sanitizer). Moving forward, it is the responsibility of each department to procure and maintain their own PPE based on operational needs."*

*Visit the [Safer Return Personal Protection](https://www.cpp.edu/safer-return/) webpage for more information.*

Here is a Link to [PPE Resources](https://www.cpp.edu/safer-return/ppe.shtml)
...
Confined Space Entry Permit *(Coming Soon)*

Confined Space Program *(Coming Soon)*

[Voluntary Respirator Use Acknowledgement and Training (PDF)](../all-pdfs/aed-forms/cpp_respiratoryprotection_n95_voluntary_combined_v2.pdf)

[Respiratory Protection Program (PDF)](../all-pdfs/aed-forms/respiratory-protection-plan.pdf)

[Selecting a Facemask and Filter Type (PDF)](../all-pdfs/aed-forms/selecting-a-facemask-and-filter-type.pdf)

[Fit Test Filter Adaptor Compatibility (PDF)](../all-pdfs/aed-forms/fit-test-filter-adaptor-compatibility.pdf)
