**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/featured-events.shtml
...
# Featured Events Module Tutorial

## Instructions

In this Module a 25Live news feed is required to display the news list, If your department doesn't already have one, please contact the [Web Team](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=80cc3358db951c50e00f785e0f961996&sysparm_category=d571b2f26f84820025ce9e4eae3ee482) to request it.
...
![](../img/events-shtml.jpg)

## Cascade Instructions

### College Department/Division Department/Content Subpage

***Cascade View***

![](img/featured-events-cascade-view2.png)

### College Landing/Division Landing

***Cascade View***

![](img/featured-events-cascade-view1.png)
