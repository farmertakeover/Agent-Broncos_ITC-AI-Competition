**Source:** http://www.cpp.edu/financial-aid/resources/understanding-verification.shtml
...
You will be notified during the aid application filing process if you have been selected for verification via your **Student Aid Report**. We will also notify you by placing tasks and instructions in your [MyCPP Student Center](https://my.cpp.edu).

On your MyCPP Student Center, you will see a To Do item on your account (you may have multiple To Do items). When you click the details of this To Do item, you will see that it is directing you to the Cal Poly Pomona [Financial Aid Student Forms portal](https://cpp.verifymyfafsa.com).  Once you log into your Student Forms portal, you will see the tasks that are being requested of you.
...
If you have been selected for verification, you will see your requirements listed as tasks in your [Cal Poly Pomona Financial Aid Student Forms](https://cpp.verifymyfafsa.com/) portal.  Information & documents required vary by student.  Some examples of items we may be required to verify include:
...
### What you need to know about creating your Financial Aid Student Forms Account
...
**NOTE: If you completed the California Dream Act Application,** you will need to enter your California Dream ID in lieu of a social security number when creating your account. This ID# can be found on your CA Student Aid Report on [Webgrants](https://mygrantinfo.csac.ca.gov/).

### What your parent needs to know when creating their Financial Aid Student Forms Account
...
If you have been selected for verification, we will notify you through your [MyCPP Student Center](https://my.cpp.edu/) that there are items you need to review. Verification and other requirements are completed through the [Cal Poly Pomona Financial Aid Student Forms portal](http://cpp.verifymyfafsa.com/).
...
### How will I be Notified if Additional Documents are Needed?
...
* **Status of To Do Item:** On your [MyCPP Student Center](https://my.cpp.edu/), the status of the To Do item will change with 24 hours:
  ...
  + Please note that if you submit all of the requested items, the status will change to *R**eceived* within 24 hours. If additional information is needed, the status will change back to *initiated* within 24 hours.

### I submitted my documents but there is still a To Do item in my MyCPP Student Center
...
### What if I missed the Priority Deadline for Submitting Documents?
...
### Information Regarding Household Size and Number in College
...
| **Your children** | Include children that you provide more than 50% support to during the academic year, even if they don't live in your house |
...
### Information Regarding Income Verification
...
### Required Corrections Resulting from Verification
...
* **FAFSA Filers**:  The [IRS Data Retrieval Option](https://studentaid.gov/apply-for-aid/fafsa/filling-out) allows you to transfer federal income tax return data to the FAFSA. Applicants who use the IRS Data Retrieval Tool are less likely to be selected for verification.
...
* Monitor your To Do List on your [MyCPP Student Center](https://my.cpp.edu/)
