**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/templates-instructions/division-landing-page-instruction.shtml
...
# Division Landing Page Instruction

## Introduction

To start creating content for your website, go to the top left corner next to the site menu, and click on the Add Content button. Next, click on the Entity folder button and choose the Division Landing Page template.

![](../img/division-landing-page-addcontent.png)

This checklist breaks down each element of the new CPP web template for the [Division Landing Page](https://www-test.cpp.edu/green-and-gold/mockups/division-landing-page.shtml). Use this as an interactive guide to collect all the content you will need for your page and you will be set up for success during the content entry process in Cascade. If you are using this template and are not a college, you will need to adjust your page accordingly and may find some guidelines are not applicable to you. It may be helpful to have both the template, and this checklist open simultaneously. If you require assistance understanding what template to use, please submit a   [ticket](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=80cc3358db951c50e00f785e0f961996&sysparm_category=d571b2f26f84820025ce9e4eae3ee482).
...
* [Hero Landing Page](../module-instructions/hero-landing.shtml)
* [Small Cards](../module-instructions/small-cards.shtml)
* [Card Options](../module-instructions/quicklinks.shtml)
* [News Content Module (Optional)](../module-instructions/featured-news.shtml)
* [Featured Events Content Module (Optional)](../module-instructions/featured-events.shtml)
* [Social Media Feature (Optional)](../module-instructions/social-media-feature.shtml)
* [Content Option: Division Landing](division-landing-page-instruction.shtml)
* [Call to Action Cards (Optional)](../module-instructions/call-to-action-cards.shtml)

You may select any of the modules listed below for use within the **Content Option: Division Landing** section.
