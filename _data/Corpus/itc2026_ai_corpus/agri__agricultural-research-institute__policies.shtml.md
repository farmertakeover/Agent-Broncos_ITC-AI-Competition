**Source:** http://www.cpp.edu/agri/agricultural-research-institute/policies.shtml
...
* #### For 9 Month Appointments:
  ...
  1. Can be used for release time of up to 12 WTU's per semester depending on department policies (i.e., DRTP criteria).

  2. Can be used for summer salary up to ten weeks (50 days, or 400 hours).

  3. Can be used for winter break salary up to three weeks (15 days, or 120 hours).
...
* #### For 12 Month Appointments:
  ...
  1. Can be used to purchase release time up to 12 WTUs per semester depending on department policies (i.e., DRTP criteria).

  2. Cannot be used for overload compensation at anytime during the calendar year.

* #### Definitions:

  **Overload compensation (per Cal Poly Pomona Policy):** Compensation of a maximum of 10 hours per week during the academic year. An overload exists only if the faculty is teaching 12 WTU's in a given semester.
  ...
  **9 month appointment:** Contract period is the academic year (2 semesters); does not accrue vacation.
...
[ARI Proposal Evaluation Criteria](https://www.cpp.edu/agri/agricultural-research-institute/forms/fy-2023-24-ari-ppm_final.pdf) (Page 36)
