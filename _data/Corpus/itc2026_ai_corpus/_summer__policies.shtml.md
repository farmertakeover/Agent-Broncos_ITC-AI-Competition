**Source:** https://www.cpp.edu/~summer/policies.shtml
...
To support student graduation requirements, the university will offer a non state-funded, fee-based summer schedule through the College of Professional and Global Education. These fully-transferable, accredited courses meet Cal Poly Pomona degree requirements.

For academic policies such as academic standing, grade appeals, etc., see the [Registrar's Office website](https://www.cpp.edu/~registrar/academic-policies/index.shtml) on Academic Policies.
