**Source:** https://www.cpp.edu/cpge/open-university/registration
...
**CURRENT CAL POLY POMONA STUDENTS:** Are you a current & matriculated Cal Poly Pomona student? If the answer is yes, this process does not apply to you. Contact the [Bronco Advising Center](http://www.cpp.edu/~studentsuccess/bronco-advising-center/index.shtml) to answer any of your enrollment questions.

\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

To register for Open University, follow **Step 1,** then continue with **Step 2**. Read all the information in **Step 3** and make a payment.

### **Spring 2026 Account Activation is Now Closed**

### **Summer 2026 Account Activation Will Begin in May**

## Step 1: Account Activation

**Step 1: Account Activation**

**Returning Students**: Self-activation is currently unavailable until January 8. Please email us with your BID and we will manually activate your account.
...
* First, complete the **[Pre-Account Activation Form](https://cmsweb.cms.cpp.edu/psc/CPOMPRDS/EMPLOYEE/HRMS/c/CSU_SQA.CSU_SQA.GBL)**
* **[Join the Zoom queue](https://cppedu.app.qless.com/kiosk/bf149222-c21d-4a10-80d7-b85e717cf1de?locale=en)**
...
**(Type 2)**Returning students who HAVE taken classes within the last two terms (terms are spring, summer, winter, and fall) can self-activate their account in BroncoDirect. See [**step-by-step guide (PDF)**](../docs/step-by-step-guide.pdf "Step-by-Step Guide") on how to self-activate your Open University account. If you cannot access your BroncoDirect account because you forgot your username or password, please contact campus IT at 909-869-6776. When completed, continue to step two, petition submission.

**Zoom Information**

1. Please turn on the camera and have a form of ID ready, such as a passport, driver's license, or state ID. You will be asked to show your ID next to your face to confirm your identity.
2. Students will remain in the waiting room & be admitted one by one into the main room with a staff member.
3. Click the button below to join the queue for Zoom. **[Check the calendar for the Zoom schedule](zoom_verification_schedule_12.19.25.png)**. If you try to click on the Zoom link outside of the scheduled hours, the Zoom room will be closed.

### ***The Zoom queue is now closed***

## Step 2: Submit Online Petition

**Step 2: Submit Online Petition**

## ***Spring 2026 petition acceptance is now closed***

## ***Summer 2026 petition acceptance will begin in May***
...
![](../img/ou-building-icon-500px.png)**Payment is required before enrollment**
...
* Self-Calculate your fees by using the information on **[Term Tuition page.](https://www.cpp.edu/cpge/open-university/tuition/index.shtml)**
...
     B.) Make the Payment: [**Payment instructions**](../docs/payment_instructions.pdf "Payment instructions")
...
     B.) Make First Payment - **[Payment instructions](../docs/payment_instructions.pdf "Payment instructions")**
