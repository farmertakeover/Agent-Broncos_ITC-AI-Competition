**Source:** https://www.cpp.edu/studentconduct/workshops.shtml
...
Student Conduct & Integrity staff conduct trainings and workshops on an as-needed basis for campus departments, classes, student organizations and other groups on campus.

**Please Note:** Due to staffing in Spring 2026, our office may not have the capacity to fulfill all training requests.**To request a training, please fill out this form**: [https://forms.office.com/r/uB7QUXXaUb](https://forms.office.com/pages/responsepage.aspx?id=HqZLFuw5XU-J_6ofAKUhtM538KMqoPVNqJo8RsqieZpURTk3WUVZSFBQOFcyWkJJTFUzTkRPSTJSRC4u&route=shorturl)

If staff are not available to accommodate the request, then we will do our best to communicate availabilities and coordinate alternatives as needed. We also ask that all requests be submitted *at least 3 weeks* in advance. Requests will be scheduled based on staff availability. For any questions or concerns, contact us at 909-869-6985 or at studentconduct@cpp.edu.

**Maintaining Academic Integrity using Artificial Intelligence (AI): A Student Guide to Ethical and Responsible Use in the Classroom.**

Our office hosts Academic Integrity using Artificial Intelligence workshops throughout the semester. Consider attending one of our upcoming workshops! For faculty members, consider sending your students to one of our workshops.
...
Register Here](https://mybar.cpp.edu/event/12071280)

[### Tuesday, Apr. 14

Register Here](https://mybar.cpp.edu/event/12071281)
