**Source:** https://www.cpp.edu/cafe/teaching-and-learning/ai
...
# Navigating AI in the Classroom at CPP

[![face with a gear for a brain](../../img/ai/business-face.svg)

Getting Started With AI](/cafe/teaching-and-learning/ai/using-ai/getting-started.shtml)

[![lightbulb with a gear around it](../../img/ai/business-lightbulb.svg)

Faculty Samples](/cafe/teaching-and-learning/ai/faculty-samples.shtml)

[![clipboard with a questionmark](../../img/ai/business-clipboard.svg)

Frequently Asked Questions](/cafe/teaching-and-learning/ai/faq.shtml)

[![robotic brain](../../img/ai/business-brain.svg)

Upcoming AI Events](/cafe/teaching-and-learning/ai/events.shtml)
...
| --- | --- | --- |
| [Understanding Generative AI Through a Pedagogical Lens](events.shtml#ch-0) | Workshop | Apr 10, 2025 |
| [Discipline-Specific AI Tools for Enhanced Learning](events.shtml#ch-1) | Workshop | Apr 15, 2025 |
| [Crafting Prompts as Teaching Tools](events.shtml#ch-2) | Workshop | Apr 24, 2025 |
| [Enhancing Course Alignment with gAI](events.shtml#ch-3) | Workshop | May 1, 2025 |
| [Designing Assignments and Feedback with gAI](events.shtml#ch-4) | Workshop | May 8, 2025 |

![](../../img/general/divider.png)

## A note about the use of AI in this website...

Generative AI tools, such as [Google Gemini](https://gemini.google.com) and [Microsoft Copilot](https://copilot.microsoft.com), were utilized to help create and format parts of this website’s content. In our role of supporting faculty in their use of AI for courses, we are dedicated to the fair and ethical use of generative AI.
