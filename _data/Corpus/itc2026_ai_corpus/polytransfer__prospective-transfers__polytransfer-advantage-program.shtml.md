**Source:** https://www.cpp.edu/polytransfer/prospective-transfers/polytransfer-advantage-program.shtml
...
# PolyTransfer Advantage Program

## About the Program

![Students talking to each other at program](../img/pt-summer.jpg)

The PolyTransfer Advantage Program is for prospective students who have an interest in transferring to Cal Poly Pomona (CPP). Our program believes in facilitating and supporting the transfer process by creating intentional intersegmental support and infrastructure for underserved community college students as they transfer out to baccalaureate granting institutions.

![Two students posing with CPP PolyTransfer merchandise at event](../img/transfer-event.jpg)

## Program Resources

Workshops topics include the benefits of an Associate Degree for Transfer (ADT), an overview of the CSU application, how to best navigate Assist.org, types of financial aid, peer mentorship, and participating in our summer academy.

## Workshop Recording: Applying to Cal Poly Pomona 101
