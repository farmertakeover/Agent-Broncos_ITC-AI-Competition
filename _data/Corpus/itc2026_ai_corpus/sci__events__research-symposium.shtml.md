**Source:** https://www.cpp.edu/sci/events/research-symposium.shtml
...
![Two female science students discuss their research with visitors to the science research symposium.](../img-2026/website-update.jpg)
...
[Abstract Template](../documents/lastname-firstname-abstract.docx)

## Poster Presentation Guidelines

[Poster Template](../documents/lastname-firstname_poster.pptx)

* Don't download a random logo for your poster.  **Please note that there is only one CPP logo.** Please**[download the new CPP Logo in stacked](https://cpp.canto.com/v/brand/album/ICB39?viewIndex=2&display=curatedView&column=image&id=i8uj3o2hvd2avbda6fn3lb7j0v) or [primary version](https://cpp.canto.com/v/brand/album/ICB39?viewIndex=2&display=curatedView&column=image&id=9u6st9cjh51q37cgr90770dj2g) for use on your poster. The two color (green and gold) with green lettering is the preferred logo for all uses.**
* If you already have a poster that is suitable for presentation and is 41x41" or less, do not make a new one.

* If you need to print a poster, the dimensions must be set to no more than 41 inches wide by 41 inches tall. Yes, that is a hard limit.  Any size larger will not be accepted.
...
* **PowerPoint files should be saved to a pdf format** and be submitted online no later than midnight, **April 15 (for poster printing)**. **If you don't need poster printing** you may submit your abstract up until midnight, April 20 but **still need to fill out the submission form**, and upload your advisor's approval email. Specify on the submission form "No printing needed."
...
* **Your accepted submission registers you for the event.** Your submission is accepted unless you're notified otherwise. If your information is incomplete, or there is a problem with your submission you will receive an email and be asked to provide what is needed.

  ![View of people from above the 2025 science research symposium. ](../img-2026/crowd-srs.jpg)

![](https://www.cpp.edu/common//green-and-gold/assets/images/vertical-line-circle.svg)

## Submit Your Work or Register to Attend

[Submit Your Research Poster

![](../img-2026/srs-25-1.jpg)](https://forms.office.com/Pages/ResponsePage.aspx?id=HqZLFuw5XU-J_6ofAKUhtKTxV2vk_WBMuMOA7aquhllUQ09DVEVLVVFJM1lZMEU0SlpSTzM2WDNKTC4u "opens a new window")

[Register to Attend

![](../img-2026/crowd2-srs.jpg)](https://forms.office.com/Pages/ResponsePage.aspx?id=HqZLFuw5XU-J_6ofAKUhtKTxV2vk_WBMuMOA7aquhllUQkRDUkhUNTdaSkZWSUFBQlBVVFk3UzRSNy4u "opens a new window")
