**Source:** http://www.cpp.edu/fas/university-accounting-services/accounts-payable/about.shtml
...
Expand/Collapse All General Information
...
For all payment requests, please follow this [Payment Decision Tree (PDF)](../docs/Accounts%20Payable/UAS_AP_Decision_Tree_01-26-2026.pdf) to assist with determining the appropriate submission process. This is updated as of January 26, 2026 for the implementation of CSUBUY P2P.

♦ If legacy process is determined based on the Payment Decision Tree, invoice/payment requests should be submitted electronically via email to cpp-ap@cpp.edu for processing. One (1) payment request should be submitted per email, with all supporting documentation combined into one (1) PDF document.
...
♦ A Direct Pay should be prepared and accompany invoices for authorized purchases that are not required to go through the normal procurement process. Refer to the [Direct Pay Procedures webpage](direct-pay.shtml "Direct Pay Procedures") for further details.

### Employee Reimbursement Direct Deposit

To enroll or update your direct deposit for employee reimbursements (non-payroll), please use the secure online form below:

[Employee Reimbursement Direct Deposit (PolyForm)](https://polyform.cpp.edu/Loginformproc/UnityForm.aspx?d1=AYfzMY2iVQz8kkRKZIiFJMTiRkFb3CEFmdXJjEpaOqTcQ%2fVPKK0fanri8tOGExwQU736G1kbsWtzyeAGM1lfXP51vi%2b%2f%2berx28gqqYwdxR8d%2bPjIVS1yHjlVQNV2uYg1iy37bcKyC2NDy0p%2fzNDlHjUzMo5A0YplNXygj4OJwpU6eEreJ%2bX891R0F%2b6MzE%2bJFdcGR1Y41OvRE2pusn%2bPHH1zmELijQB0RCZmFH2zv836j1DZF814EIqUFfnEjbSRvQ%3d%3d "Employee Reimbursement Direct Deposit")

*Note: This direct deposit is for employee reimbursements processed through Accounts Payable. Examples include travel or mobile phone reimbursements. Payroll direct deposit is handled separately through Payroll Services.*
...
Cal Poly Pomona is located in an Unincorporated area of Los Angeles County. Therefore, the applicable Sales and Use Tax Rate for this area is **9.75%**, effective April 1, 2025.
