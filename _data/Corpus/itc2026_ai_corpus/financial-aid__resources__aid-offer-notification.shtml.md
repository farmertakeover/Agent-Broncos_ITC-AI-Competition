**Source:** http://www.cpp.edu/financial-aid/resources/aid-offer-notification.shtml
...
### Sample - CA Resident, Living On Campus

Below is a sample Aid Offer for a CA Resident student who is living on-campus.

|  |
| --- |
| ![image of aid offer](../img/aid-offer-sample-ca-res-on-campus.jpg) |

### Sample - Non Resident, Living Off Campus

Below is a sample Aid Offer for a Non-CA Resident student who is living off campus.

|  |
| --- |
| ![image of aid offer notification for non-california resident](../img/aid-offer-sample-non-ca-res-off-campus.jpg) |

### When to Expect Your Aid Offer
...
|  |
| --- |
| ![image of eligibility factors section of aid offer notification - displays the various factors used in determining aid eligibility and cost of attendance budget](../img/eligibility-factors-numbered1.jpg) |

### **Eligibility Factors**

1. **Dependency Status**:
   Your answers to questions on your aid application determine whether you are considered a dependent or independent student.
2. **Application Filing Date and Priority Filing Deadline Met**
   The date you filed your initial aid application may impact the types of aid you are considered for. The Priority Filing Date of March 2nd is used to determine eligibility for state aid, Cal Poly Pomona grant aid, and for Federal Work Study.
3. **Anticipated Fall Enrollment Status**
...
4. **Anticipated Spring Enrollment Status**Your enrollment status can impact the amount you receive from grant programs. Cal Poly Pomona initially packages financial aid on the assumption of full-time enrollment (12 units per term undergraduate & credential; 6 units graduate). If you are packaged with financial aid after the end of a semester's Add/Drop period, your offer will be based on your actual enrollment.
5. **CA Residency Status**
   Your [CA Residency Status](https://www.cpp.edu/admissions/residency/index.shtml) is based on information we receive from Admissions. Your status impacts whether or not you are charged Non-Resident tuition and your eligibility for CA State and Cal Poly Pomona grant aid.
...
7. **Number in Household and Number in College**
...
|  |
| --- |
| ![image of cost of attendance budget from aid offer notification. Displays direct costs for each term as well as indirect costs for each term](../img/cost-of-attendance-numbered.jpg) |
...
* [Undergraduate Student Costs](../undergraduate/current/costs.shtml)
* [Credential Student Costs](../credentials/current/costs.shtml)
* [Graduate Student Costs](../graduate/newly-admitted-and-current/costs.shtml)
* [CPGE Degree Program Costs](../other-programs/college-of-professional-and-global-education.shtml)
...
1. **Living Expenses** (Food & Housing)
...
|  |
| --- |
| ![image of aid offer section from aid offer. Total cost of attendance, EFC, and each type of aid is highlighted (Gift Aid, Loans, Work)](../img/aid-offer-numbered.jpg) |
...
Check our [Loan Information page](loan-information.shtml), become educated, and ***think carefully before you accept any loans.*** You are not required to accept this or any other loan to keep any free / gift aid.
...
### Options for Covering Remaining Expenses
...
|  |
| --- |
| ![image of Options for covering remaining expenses section of Aid Offer Notification communication.](../img/options-to-cover-expenses.jpg) |
...
|  |
| --- |
| ![image of Appeals section from Aid Offer notification. The three types of appeals that may display to a student are numbered - Dependency Status, Family Contribution, and Cost of Attendance.](../img/appeals-numbered.jpg) |

### Types of Appeals that May Appear

1. **Dependency Status Appeal**
...
|  |
| --- |
| ![image of Receiving your aid section of Aid Offer notification. Shows the dates aid is disbursed as well as when the remaining balance is due](../img/receiving-your-aid.jpg) |

1. **Financial Aid is Applied**:
   The dates for when financial aid is released (or disbursed) for each semestser are displayed. The earliest that financial aid can be released is 10 days prior to the start of classes for the semester. In order for most aid to be released, you must be enrolled at least half-time.  Review our [Understanding Enrollment Requirements](understanding-enrollment-requirements.shtml) page for more details on how your enrollment impacts your financial aid.
2. **Tuition Balance Due:**
...
|  |
| --- |
| ![image of Next Steps section from the aid offer notification. ](../img/next-steps.jpg) |
...
* **Understand the Aid that has been offered to you**
  ...
  + [Undergraduate Aid Programs](../undergraduate/current/aid-programs.shtml)
  + [Credential Aid Programs](../credentials/current/aid-programs.shtml)
  + [Graduate Aid Program](../graduate/newly-admitted-and-current/aid-programs.shtml)
* **BroncoDirect Student Center**Your [BroncoDirect Student Center](https://my.cpp.edu/) serves as a "home base" for your enrollment and student information (including financial aid and student account information), and provides an easy way for you to access, view, and manage your financial aid information online. Once you login to the [Single-Sign On Portal,](https://my.cpp.edu/) you will be able to do the following:
...
Review our [Using BroncoDirect – Financial Aid Information](https://www.cpp.edu/financial-aid/resources/using-broncodirect-financial-aid-information.shtml) page for instructions on how to access your financial aid information within your BroncoDirect Student Center.

* **Reporting Outside Aid not included on your Aid Offer**If you are receiving any scholarships or other aid that was not included in your aid offer, be sure to notify our office as soon as possible so that we can update your information and make any adjustments.
...
* **Understand how your enrollment can impact your financial aid**
  + [**Understanding Enrollment Requirements**](understanding-enrollment-requirements.shtml): Your financial aid offer is based on your eligibility and financial need and **is initially based on the expectation of full-time enrollment**. The number of units in which you are actually enrolled for a semester may impact the amount of financial aid you receive for various aid programs.
  + [**Satisfactory Academic Progress for Financial Aid Applicants**](understanding-sap.shtml): Satisfactory Academic Progress (SAP) standards ensure that you are successfully completing your coursework and can continue to receive financial aid.  All students receiving financial aid are required to meet SAP standards. If you fail to meet the SAP standards, you risk your eligibility to continue to receive financial aid.

## Additional Things to Know

### Revisions to Your Aid Offer
...
* **Enrollment below full-time** might result in a reduction/cancellation of some financial aid funds and billing for funds received.  Cal Poly Pomona initially offers financial aid to students assuming they will be enrolled full-time. We will automatically adjust the financial aid for students not enrolled full-time at the time aid is released, with a final review and adjustment at the end of the Add/Drop period.
  + If you drop a class or withdraw from all classes after your disbursement was received, you may need to pay back some, or all, of the money that was disbursed. Learn more on our [Understanding Enrollment Requirements](understanding-enrollment-requirements.shtml) page.
