**Source:** https://www.cpp.edu/cppmag/the-confidence-to-persist/project-spotlight.shtml
...
BLADE was founded in 2019 by **Michael Pham**, an aerospace engineering junior, and **Jacob Harbuck**, an aerospace engineering senior, thanks to the guidance and $8,000 in seed funding from the [**Projects Hatchery**](https://www.cpp.edu/learndiscovery/hatchery/index.shtml). They wanted to develop an educational program to boost hands-on experiences primarily for incoming students in STEM.
...
![Screenshot of Geiger Counter for Student Success Story PDF](../img/20cpp-mag-geigercounter-for-success.jpg)
[Download PDF](https://www.cpp.edu/cppmag/pdf/20fall-cpp-mag-geiger-counter-for-student-success.pdf)

## Projects Hatchery

To learn more or support the program, email hatchery@cpp.edu.
