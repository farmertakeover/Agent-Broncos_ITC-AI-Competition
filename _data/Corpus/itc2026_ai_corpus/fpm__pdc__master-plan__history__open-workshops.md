**Source:** https://www.cpp.edu/fpm/pdc/master-plan/history/open-workshops
...
![Master Plan Workshop BSC](/fpm/pdc/img/Master-Plan-Workshop4_web.jpg)

Open workshops aimed to engage the campus community in dialogue and fact-finding, and explore ideas about Cal Poly Pomona's past, present and future. The master planning team from Ayers Saint Gross led exercises on visioning and data gathering while compiling observations about the campus. Input from the campus community contributed to the fact-finding and observations phase.

[## Workshop Meetings](/fpm/pdc/master-plan/history/open-workshops/archives.shtml)
