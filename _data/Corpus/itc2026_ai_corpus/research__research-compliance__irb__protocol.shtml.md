**Source:** https://www.cpp.edu/research/research-compliance/irb/protocol.shtml
...
* [Home](/research/index.shtml)
* [About Us](/research/about-us/index.shtml)
* Sponsored Programs

  [Start Here for Proposals](/research/sponsored-program/index.shtml)
  [Find Funding](/research/sponsored-program/funding-search.shtml)
  [Limited Submission Opportunities](/research/sponsored-program/limited-submission-opportunities.shtml)
  [PI Requirements](/research/sponsored-program/pi-requirements.shtml)
  [Intent to Submit a Proposal](/research/sponsored-program/intent-to-submit.shtml)
  [Grant Writing Resources and Templates](/research/sponsored-program/grant-writing-resources.shtml)
  [Institutional Information for Proposals](/research/sponsored-program/proposal-information.shtml)
  [Sponsored Programs Forms and Policies](/research/sponsored-program/forms-and-policies.shtml)
  [Post-Award Services](/research/sponsored-program/post-award.shtml)
  [Resources](/research/sponsored-program/resources.shtml)
  [Gift vs. Grant](/research/sponsored-program/gift-grant.shtml)
  [Frequently Asked Questions](/research/sponsored-program/sponsored-programs-faqs.shtml)
* Internal Funding Opportunities
* [Research Compliance](/research/research-compliance/index.shtml)
* Technology Transfer

  [About Technology Transfer](/research/technology-transfer/index.shtml)
  [Education About Technology Transfer](/research/technology-transfer/education.shtml)
  [What is Patentable?](/research/technology-transfer/patentable.shtml)
  [Frequently Asked Questions](/research/technology-transfer/faq.shtml)
* [Research Centers](/research/research-centers/index.shtml)
* [Training and Workshops](/research/training/index.shtml)
* [Office of Research & Innovation](/research/index_new.shtml)

1. [CPP](https://www.cpp.edu)
2. [Office of Research and Innovation](../../index.shtml)
3. [Research Compliance](../index.shtml)
4. [IRB](/research-compliance/irb/index)
5. Protocol Application Process
...
[***Take the IRB determination Survey***](https://cpp.az1.qualtrics.com/jfe/form/SV_1S7kWiKsqOpS2ma)
...
For student research guidance- Review the [Faculty Information Sheet](docs/faculty-mentor-info-sheet102025.docx)

*Please ask questions at any stage of the process. The IRB Office is available and can help facilitate the review. You may reach us at 909-869-3713 (or 3771) or irb-office@cpp.edu**See also the [Institutional Review Board Staff Directory](https://www.cpp.edu/research/research-compliance/irb/policies.shtml#https://www.cpp.edu/research/staff.shtml) for additional contacts (IRB Chair and IRB Administrator)*

 **STEP 1**

[**Complete CITI training**](https://about.citiprogram.org/en/homepage/)
...
* Registration [Registration tutorial](../../documents/citi-registration-2023.pdf)
...
* Review the Cayuse tutorial [“Submitting a New Protocol”](docs/cayuse-how-to-submit-a-new-protocol.pptx) to learn how to navigate, complete, and submit an IRB protocol.
...
**Revise:**After your protocol has been submitted to the IRB office, it will most often be returned to the PIs with comments. [Learn how to navigate through revisions](docs/cayusereviewerscommentstutorial.pptx). [![Submission Navigation](pictures/new-submissions-box.jpg)](docs/cayuse-how-to-add-other-study-submissions.pptx)
...
[General Sample Protocol 2015 (DOC.)](docs/sample-irb-protocol-application.doc)- Investigators may use this sample protocol as a general guide to answer the questions on the protocol form. Note that every protocol is different and the format in which this protocol was written may not apply to every study but it could still be helpful.
...
> 4. Studies that use bodily materials such as cells, blood, urine, tissues, organs, hair, or nail clippings, even if the investigator did not collect these materials for the study.
> 5. Studies that reproduce generalize knowledge about categories or classes of subjects from individually identifiable information.
...
* ### Informed consent forms (ICFs):
  ...
  **Child Assent forms:**
  ...
  [Child assent form 7-10 years old](../../childassentform7-10march2021.docx)

  [Child assent form 11-14 years old](../../childassentform11-14march2021.docx)

  [Child assent form 15-17 years old](../../childassentform15-17august2025.docx)

  **Anonymous\* and non-intrusive study:**

  [Anonymous and non-intrusive study](docs/anonymous-and-non-intrusive-study-01022026.doc)

  **Confidential\* study:**

  [Confidential study](docs/confidential-study-11182024.doc)

  [SPANISH Informed Consent Form](docs/informed-consent-form-spanish11182024.docx) ( appropriate revisions must be made by the investigator)

  **Non-Disclosure Agreement- For Transcribers**

  [**NDA**](docs/nda-agreement.docx)For the CPP IRB, a non-disclosure agreement (NDA) ensures that discussions pertaining to the research are kept confidential.

        **Site- Authorization**

[Site authorization](docs/site-authorization-request-sample-11182024.docx)is a written permission from an organization to conduct research (i.e., school, private business, or medical office) at that site. This site-authorization should be included in your CP protocol application. This authorization ensures you have proper permissions and support to collect data. If the site is also your employer, ensure you provide the IRB with sufficient information about the accessing internal data.

 **Other relevant resources about ICFs:**

Example statements for CPP graduate students to use in their consenting forms, meant to avoid undue influence and coercion when recruiting subjects, is available [here in the document "Undue Influence and Coercion in Consenting"](docs/undueinfluenceandcoercioninconsenting-july2019.docx).

[Experimental subject's bill of rights for medical research](docs/medical-experimental-subject.doc)  This document is often used for biomedical/clinical procedures.

\* [Anonymous versus Confidential](docs/anonymous_confidential.doc)  Often the difference between the terms anonymous and confidential is not well understood when applied to research studies involving human participants. Yet, these concepts are very important for the protection of the subjects, and they need to be considered by researchers when designing a study and writing the ICF.  During protocol review, the level of protection described will be evaluated by the IRB.

[OHRP FAQs on informed consent](http://answers.hhs.gov/ohrp/)  This website from the federal Office for Human Research Protections (OHRP) offers information about the consent and assent processes.
...
![Hemingway readability sample](pictures/readability-hemingway.jpg)
...
Review this publication on "[Access to and Retention of Research Data: Rights and Responsibilities](https://www.cogr.edu/sites/default/files/access_to_sharing_and_retention_of_research_data-_rights_%26_responsibilities.pdf)" Council on Governmental Relations, 2012
...
[Fundamentals of Copyright and Fair Use](https://www2.calstate.edu/csu-system/administration/general-counsel/Documents/CopyrightManual.pdf)

## FAQ's

### 1. Where can I find the initial IRB protocol form on the website? How do I apply for IRB approval?

To submit a new protocol, navigate to the**"[Protocol Application](https://www.cpp.edu/research/irb/getting-started-with-a-protocol.shtml)"**tab.  The protocol is an electronic document, within the Cayuse IRB software.  After authorizing/authenticating users to gain access to Cayuse IRB, you may complete the protocol and submit it for review by the IRB.
...
For the purposes of the IRB, “human subject research” is defined in 45 CFR 46.102(e) of the [Code of Federal Regulations TITLE 45 DHHS PART 46 PROTECTION OF HUMAN SUBJECTS](https://www.ecfr.gov/cgi-bin/retrieveECFR?gp=&SID=83cd09e1c0f5c6937cd9d7513160fc3f&pitd=20180719&n=pt45.1.46&r=PART&ty=HTML#se45.1.46_1102).
...
### 3. What is CPP IRB's guideline for unaffiliated investigators (non-CPP students, non-CPP faculty, non-affiliated investigators collaborating with CPP faculty)?

Please read **Section 14 (Special topics Research at Cal Poly Pomona by Unaffiliated Investigators** in the IRB [Policy & Procedures manual](https://cascade.cpp.edu/entity/open.act?type=page&id=6537fe848647f71f54eb00dfe0e2c326&confId=ba6922d28647f71f6f3d01fdc7223161). If you wish to submit an IRB protocol to CPP as an unaffiliated investigator, please email the IRB office (irb-office@cpp.edu) the following information/attachments:
...
### 4. When and how can I expect a final decision about my protocol?
...
### 7. Where can I find information on the informed consent process?

The type of consent form varies depending on the study you will conduct.  Go to the "[protocol application](https://www.cpp.edu/research/irb/getting-started-with-a-protocol.shtml "protocol application ")" section  to view examples ( towards the end of the webpage) and guidelines to help you write your consent (adult) or assent (minor) form.

### 8. What if data collection documents (e.g., survey, recruitment flyers, questionnaires) are not yet finalized when I submit my protocol?
...
### 9. What kinds of changes to my research study require the submission of an amendment to my protocol?
...
### 10. How do I submit a change to an IRB approved protocol to the IRB?

Should there be any changes to your research plan as described in the protocol, after its approval and while still active, the investigator must log in to Cayuse IRB to complete and submit an amendment, also called a **modification**.

### 11. How often must I renew my IRB approval?

Approved protocols must be renewed (1-2 months prior to expiration) if interaction with subjects will continue.  Choose the **renewal** option within Cayuse IRB.

### 12. I received a renewal reminder from the IRB office, but my project is complete (data collection, follow-up and analysis are complete). What should I do?

At any time prior to the expiration date, the principal investigator (PI) may request closure of the protocol if research activities including data collection has stopped and only analysis of the data are taking place. The PI may close the study, by submitting a " **+ new submission**"  within Cayuse and choose the **closure** option as seen below.

### 13. Can I continue to work on my research study if I have received a notice indicating that my approval has expired?
...
### 14. What do I do if I need to withdrawal (terminate) my project for some reason, e.g., loss or lack of funding, leaving the university?

Please contact the IRB office to informed them of the completion of your project involving interaction with human subjects. You may also want to contact the funder of your study and provide them an update of the study as some funders need to be informed. If you, the PI wish to close the study, you can use the "**+ new submission**" button and choose the **closure** , where you may also add a summary of the withdrawal/closure.

### 15. I received an expiration notice from the IRB Office indicating my protocol approval has expired.  What should I do if my protocol's expiration date has passed and I intended to renew?
...
### 16. How do I report an adverse event/unanticipated problem?
...
### 17. How do I electronically sign my protocol?
...
### 18. What can I expect from an IRB review training?

The Office of Research Compliance holds periodic training sessions to address the Cayuse IRB process and the ethical issues which the IRB is looking for when reviewing a protocol.

### 19. Where can I obtain my CITI training report?

Follow this [link for instructions](http://citiprogram.desk.com/customer/portal/articles/288752-when-will-the-citi-program-mail-fax-or-e-mail-my-official-certificate-?b_id=2337 "CITI transcript") from the CITI group on how to obtain your CITI training report and determine whether your research ethics training needs to be renewed/updated.

This is the URL:  http://citiprogram.desk.com/customer/portal/articles/288752-when-will-the-citi-program-mail-fax-or-e-mail-my-official-certificate-?b\_id=2337

### 20. Can I access the Cayuse software on my IPhone or IPad?

Yes, you may access the software from other devices.

### 21. How big should my study's sample size be?

Have a look at this website in order to better understand determining an appropriate sample size for your research. A statistician or your faculty advisor should also be able to help you in defining your sample size.   [Sample Size Calculator](https://www.surveysystem.com/sscalc.htm) by Creative Research Systems

### 22. How can I test the consent form I am going to give to participants to make sure it is at an appropriate reading and comprehension level?
