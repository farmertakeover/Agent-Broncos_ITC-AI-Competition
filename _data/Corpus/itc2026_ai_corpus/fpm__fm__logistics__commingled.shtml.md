**Source:** https://www.cpp.edu/fpm/fm/logistics/commingled.shtml
...
Cal Poly Pomona has a Single Stream Recycling program that allows acceptable materials (listed below) to be placed in a single container. Separating the waste is no longer necessary. The only decision is to determine whether the trash is recyclable.
