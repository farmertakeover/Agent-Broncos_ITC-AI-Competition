**Source:** https://www.cpp.edu/~outreach/pre-admission-advising.shtml
...
Our friendly outreach counselors can answer your general questions about the Cal Poly Pomona admissions process, requirements, our majors and programs and important deadlines. Schedule your pre-admissions advising session today.

[Make an Appointment](https://engage.cpp.edu/portal/outreach_appointments%20)

![A female advisor meets with a female student](img/24env-advising5-1.jpg)

## FAQs

### What is pre-admission advising?
...
### Which students do you have pre-admissions advising with?
...
If you are an international student or have international coursework, please visit the Office of Admissions' [website for pre-admissions advising](https://www.cpp.edu/admissions/international/resources.shtml).

### What should I bring to my pre-admissions advising session?
...
### What majors do you offer at CPP? Are any of your majors impacted?

We offer many majors across different disciplines. You can find a full list of all of our current majors [by clicking here](https://www.cpp.edu/programs/index.shtml).

Some of our majors are impacted, which means that our campus has reached its enrollment capacity for instructional resources and physical support and cannot accommodate all the eligible undergraduate applications it receives. These majors tend to be more competitive in the admissions process. You can find a list of our impacted majors by [clicking here](https://www.cpp.edu/admissions/freshmen/impacted-majors.shtml).

### When can I apply to CPP?
...
Applications to CPP can be submitted on [Cal State Apply](https://www2.calstate.edu/apply).

### What are the admissions requirements for CPP?

Admissions requirements can be found on the Office of Admissions website.

**First-Time Freshmen**
[Minimum Requirements](https://www.cpp.edu/admissions/freshmen/requirements.shtml)
[Impacted Majors Requirements](https://www.cpp.edu/admissions/freshmen/impacted-majors.shtml)

[A-G Course List](https://hs-articulation.ucop.edu/agcourselist)

**Upper-Division Transfer Students**
[Minimum Requirements](https://www.cpp.edu/admissions/transfer/requirements.shtml)
[Impacted Majors Requirements](https://www.cpp.edu/admissions/transfer/impacted-majors.shtml)
...
1. [First-Time Freshmen Local Area List](https://www.cpp.edu/admissions/freshmen/local-area.shtml)
2. [Upper-Division Transfer Students Local Area List](https://www.cpp.edu/admissions/transfer/local-area.shtml)

### I am a returning student — what are my requirements, and what do I need to graduate?

If you previously attended CPP, you can find information about the steps you can take to return to CPP on our [Returning Student Website](https://www.cpp.edu/admissions/returning-students/index.shtml).

If you have specific questions for your academic college as it relates to your major of interest, please [contact them directly](https://www.cpp.edu/academics/colleges-departments/index.shtml).

### I am a graduate/credential student — what are my admissions requirements?

We can assist you with general questions you have about graduate and credential admissions requirements. [Please complete the form](https://www.cpp.edu/outreach/contact-us-form.shtml) to request to speak to an outreach counselor.
...
[Program Coordinators](https://www.cpp.edu/admissions/graduate/masters-resources.shtml)

### When will I hear back about my admission decision?

The Office of Admissions will communicate your admission status and next steps via the Bronco Applicant Portal.

### I am a transfer students — do I need to complete everything on ASSIST?

ASSIST is the official transfer and articulation system for California Community Colleges, the California State University, and the University of California: [www.assist.org](http://www.assist.org/).
...
Transfer requirements for our school can be [found here.](https://www.cpp.edu/admissions/transfer/requirements.shtml)

### I am a transfer student from a 4-year college/university — will my credits transfer?
...
[Access TES](https://www.cpp.edu/registrar/articulation/tes.shtml)

### Do you accept credits from schools that are not accredited?
...
[Regional Accreditation](https://www.cpp.edu/registrar//articulation/regional-accreditation.shtml)

### What is the max number of units I can transfer over?

Community college students can transfer in a maximum of 70 semester (105 quarter) units. Students with coursework from all other sources (i.e. 4-year colleges and universities) can transfer a maximum of 90 semester (135 quarter) units. You can find more information in our university catalog under  the [“Transfer Policies of CSU campuses” section](https://catalog.cpp.edu/content.php?catoid=53&navoid=3976#Transfer_Policies_of_CSU_Campuses).

### Does CPP accept AP scores?

Yes. Passing scores of a 3, 4, or a 5 may be equivalent to course credit. Send your official AP scores to the [Office of Admissions](https://www.cpp.edu/admissions/freshmen/admitted.shtml).

### Can I take a college level course once I graduate high school and still apply as a first-time freshman?
...
### Do you require essays on your application?

No, we do not require essays on the undergraduate CSU application. Admissions requirements can be [found here.](https://www2.calstate.edu/apply/freshman/getting_into_the_csu/pages/admission-requirements.aspx)
