**Source:** https://www.cpp.edu/cpeli/dates-fees
...
![student in field on rock looking at sun set](../img/cpeli-dates.jpg)
...
# Program Dates, Fees, Schedule & Payment

| **Term** | **Program Dates** | **Application Deadline** | **Placement Test** | **Tuition** | **Application Fee** | **Insurance Fee** |
| --- | --- | --- | --- | --- | --- | --- |
| **Spring 2026** | Jan. 20 - May 15, 2026 | Rolling Admission | Jan. 15, 2026 | $5,900 | $175 | Approx. $650 |
| **Summer 2026** | June 01 - July 24, 2026 | Rolling Admission | May 28, 2026 | $2,950 | $175 | Approx. $350 |
| **Fall 2026** | August 17 - December 11, 2026 | Rolling Admission | August 13, 2026 | $5,900 | $175 | Approx. $650 |

| **Time\Date** | **Monday** | **Tuesday** | **Wednesday** | **Thursday** | **Friday** |
| --- | --- | --- | --- | --- | --- |
| **08:00a.m.****to 09:50a.m.** | Reading & Writing | Reading & Writing | Reading & Writing | Reading & Writing | Reading & Writing |
| **09:50a.m.****to 10:00a.m.** | Break | Break | Break | Break | Break |
| **10:00a.m.****to 11:50a.m.** | Listening & Speaking | Listening & Speaking | Listening & Speaking | Listening & Speaking | Listening & Speaking |

![payment options](https://www.cpp.edu/cpge/semesteratcpp/img/560-asp-payment.jpg)

## Payment Options

[Pay Here with Flywire](https://landing-pages.flywire.com/landing/calpolypomona) - For online bank transfer and international credit card/debit card payments (Please select "**CPELI Application Fee**", or "**CPELI Program Fee**" to proceed with the payment)

[Bank Wire Instructions (PDF)](https://www.cpp.edu/cpge/semesteratcpp/docs/wire-instructions.pdf) - For payments via bank wire

Contact Program Staff - For payments to be made by personal check, or cash

To purchase the insurance plans, please click [HERE](https://www.cpp.edu/cpeli/current-students/index.shtml "CPELI Insurance puchase").

## Refund Policy

* Full tuition refund given only before the first day of class.
* 50% refund given if withdrawal occurs within the first 5 days of class.
* No refund is given after the first 5 days of class.
* Refund paid only to the person who paid the tuition.
* Application fee is nonrefundable.

![](../img/refund-policy.jpg)
