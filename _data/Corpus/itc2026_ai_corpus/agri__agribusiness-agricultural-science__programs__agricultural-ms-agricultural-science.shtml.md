**Source:** http://www.cpp.edu/agri/agribusiness-agricultural-science/programs/agricultural-ms-agricultural-science.shtml
...
# Master of Science Degree in Agriculture (Agricultural Science)

## About the Program

![Two Cal Poly Pomona students check a citrus tree for Asian citrus psyllids.](../img/2018-psyllid-bergman-1160x928.jpg)
...
1. Your degree program must include at least 45 semester units, of which at least 24 units shall be in 500- or 600-level courses. Additional coursework may be required to eliminate subject-matter deficiencies. At least 24 units must be related to agriculture.
2. You must maintain a grade point average of 3.0 (B) or better in all upper division undergraduate and all graduate courses. No course with a grade lower than "C" (2.0) may apply toward the fulfillment of degree requirements.
3. Transfer restrictions:
   * You cannot transfer more than 13 quarter units of acceptable graduate credit from another graduate institution.
   * Likewise, you cannot use more than 13 units taken through the [College of Professional & Global Education](https://www.cpp.edu/cpge/) (CPGE) on a contract.
...
5. Advancement to candidacy is required.
6. Graduate students completing a thesis must submit two final copies for binding in accordance with university regulations AND successfully complete a final oral examination covering the thesis and the candidate's area of specialization.
7. You must be enrolled at Cal Poly Pomona during the semester of graduation.
...
![](../img/cpp_bitmap_nature_both_300dpi-650x525.jpg)](/admissons/ "opens a new window")
