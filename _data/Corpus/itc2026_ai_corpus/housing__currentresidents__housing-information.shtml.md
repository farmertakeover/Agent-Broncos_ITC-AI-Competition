**Source:** http://www.cpp.edu/housing/currentresidents/housing-information.shtml
...
[University Housing Service's Housing Portal](https://cpp.starrezhousing.com/StarRezPortal/55BD3BCF/15/40/Home-Home?UrlToken=39CA1BC2) is the main hub for all UHS residents. The portal provides a seamless method for viewing, maintaining, and updating resident information.
...
Parents can also stay informed by [joining our newsletter mailing list](https://app.smartsheet.com/b/form/6b777c803a90434393d6875a7431fa6a). Additionally, a PDF copy of the UHS Weekly Newsletter is posted to the CPP Housing Portal.
...
Washers and dryers located throughout our communities on the first floor of each Residential Hall, Traditional Hall, and Residential Suite building. The cost is $1.25 to wash and $1.00 to dry.

![Wash Connection App](../img/payrange-logo.png)

All laundry purchases are made through the WASH Connect app available for Apple and Android users. Download the app, add funds, select the washer/dryer number, and you’re done! If you prefer, you can still choose to pay with coins.
...
### BRIC Fitness Membership

All UHS residents receive a complimentary membership to the BRIC (Bronco Recreation and Intramural Complex). For more information on activating your BRIC membership, visit the [BRIC’s Member Services](https://asi.cpp.edu/facilities/bric/memberships-guests/) site.

### Bronco Wellness Center

Student Health Services provides Cal Poly Pomona students with affordable, accessible and high-quality health care. Most services are covered by the mandatory student health fee already included in tuition payments.

[Bronco Wellness Center](https://www.cpp.edu/health/)

### Meal Plan Changes

Requests to change meal or point plans are accepted at specific times during the academic year via the Housing Portal. Once the semester has started, only upgrade requests to meal plans will be applied during the semester. Requests to decrease a meal or point plan will be accepted, but will not take effect until the following semester.
...
Effective September 1, 2017, Cal Poly Pomona is now a smoke free campus. For more information regarding the policy, support, and frequently asked questions, please visit the [Smoke Free Website](http://www.cpp.edu/~smokefree/).
...
Residents inquiring how to SUBMIT/REVOKE an FERPA release form, please click **[HERE](https://www.cpp.edu/registrar/ferpa.shtml)** for more information.

## Technology

### Network and Internet use

The Residence Halls, Traditional Halls, and Residential Suites are equipped with direct high-speed access to the Cal Poly Pomona network and the Internet via Ethernet ports and/or wireless. Due to the nature of wireless technology connectivity cannot be guaranteed.  These connections provide residents with a distinct advantage for research, homework assignments, or staying in touch with family, friends, and classmates.

**Wi-Fi** is also available in the Residential Halls, Traditional Halls, and Residential Suites. Wireless connectivity is primarily available in the common areas at the residential suites. Due to the nature of wireless technology connectivity cannot be guaranteed.
...
In addition, residents should be aware that the residential network has some restrictions on bandwidth, as determined by the campus. [View campus restrictions](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=310fc54e6fe8e600e020f35d5d3ee41e). Residential access to the campus network is provided primarily for the student’s educational use and is a shared resource which everyone is expected to use responsibly.
...
Please submit a [Work Order](../facilities/submit-a-housing-work-order.shtml "Submit a Work Order")from the Housing Portal for technical support.
...
Additional information can be found at [Cal Poly IT Policies, Procedures, and Guidelines](http://www.cpp.edu/~it/policies-procedures-guidelines/index.shtml).
...
![Ethernet plug](../documents/files/technology/ethernetplug1.jpg)
...
![Image of control panel](../documents/files/technology/ms-controlpanel.jpg)

**Under Network and Sharing Center, click on View Network Status and Tasks.**

![image of Network icon](../documents/files/technology/networkandinternet.jpg)

**On the left side of the window, under Tasks, click on Change adapter settings.**

![image of network share](../documents/files/technology/networksharing.jpg)

**Right-Click on Local Area Network icon and select Properties from the resulting menu.**

![image of network properties](../documents/files/technology/network-properties.jpg)

**Select Internet Protocol Version 4 (TCP/IPv4) then click Properties.**

![image of network status](../documents/files/technology/ethernet-status.jpg)

**Assure that both settings have Obtain settings automatically selected, the click OK and OK.**

![image of ip protocol](../documents/files/technology/ipprotocolprty.jpg)

**Restart your computer.**

### Download Copyright Materials
...
### Wireless Network Access / Personal Routers or Switches

Wifi is available in the Residential Halls, Traditional Halls, and Residential Suites. Wireless connectivity is primarily available in the common areas at the residential suites. Due to the nature of wireless technology connectivity cannot be guaranteed.

**Personal wired switches or wireless routers are not allowed** in the Residential Halls/Suites and Traditional Halls.

This is a policy which was agreed to when submitting your license agreement for on-campus housing, found in the [Student Housing License Agreement](https://www.cpp.edu/housing/currentresidents/license-agreement.shtml) – “Policies and Regulations” under “Computers and Technology Acceptable Use Policy,” subsections 2 and 5.17.
...
For MacBooks/MacBook Airs, adapters can be found on the [Apple Store website](http://store.apple.com/us/search/ethernet-adapter) or via the [Bronco Bookstore](https://www.broncobookstore.com/). Before purchasing, consult your products manual to determine which adapter is suited for your laptop, i.e., “USB to Ethernet” or “Thunderbolt to Ethernet”.

### Pharos Printer in Bldg 73

For residents to print to the Pharos printer in the lobby of Sicomoro (73) you will need to install a specific version of the Pharos printing system. The following links will allow you to install the printer (*choose the one that matches your machine type):*

[Pharos 32bit](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=350fc54e6fe8e600e020f35d5d3ee41c)

[Pharos 64bit](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=350fc54e6fe8e600e020f35d5d3ee41c)

## Recreation

### Basketball Court

The basketball court is located in the area behind Montecito and Alamitos Halls.

![Traditional Halls Basketball Court](../img/tradhalls-bball.jpg)
