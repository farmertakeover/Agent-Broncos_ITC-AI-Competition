**Source:** http://www.cpp.edu/eoda-hr/departments/hrpar/outside-employment-disclosure.shtml
...
State law ([Title 5 California Code of Regulations § 42740](https://govt.westlaw.com/calregs/Document/I5B7ABC134C6911EC93A8000D3A7C4BC3?viewType=FullText&originationContext=documenttoc&transitionType=CategoryPageItem&contextData=(sc.Default)&bhcp=1)) and CSU policy ([HR 2016-06](https://calstate.policystat.com/policy/6849455/latest/)) require all Executive and Management Personnel Plan (MPP) employees to disclose any outside employment they have.  Moreover, the employee’s HEERA manager is required to review the disclosure and determine whether the disclosed outside employment poses a conflict of interest or a conflict of commitment with the employee’s CSU position.  If the HEERA manager identifies a conflict, then the employee is expected to manage, reduce or eliminate the outside employment to avoid the conflict.
...
As defined by the [policy](https://calstate.policystat.com/policy/6849455/latest/#autoid-x72v7), “outside employment” is any work for which a W-2 or 1099 is issued and that is not compensated through the CSU payroll. Outside employment includes work compensated by Cal Poly Pomona Enterprises or Associated Students, Inc.  Examples of “outside employment” include, but are not limited to:
...
## Management's Review for Conflicts
...
## Annual Disclosure – Adobe Sign Filing Process
...
As part of the CSU’s renewed commitment to the California Legislature to improve transparency and accountability, the Chancellor's Office posts the outside employment activities of all vice presidents and presidents on a [public website](https://www.calstate.edu/csu-system/faculty-staff/systemwide-human-resources/outside-employment). Moreover, all Outside Employment Disclosures are public documents that are subject to disclosure upon request to any member of the public.
