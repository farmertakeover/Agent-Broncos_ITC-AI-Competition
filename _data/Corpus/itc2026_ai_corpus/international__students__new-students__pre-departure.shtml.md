**Source:** https://www.cpp.edu/international/students/new-students/pre-departure.shtml
...
Follow this checklist and complete all required steps by deadlines.

## Onboarding Checklist

### 1. Request I-20

**I-20's can be requested after students are admitted**

Financial documentation **must be issued on or after** the following dates. All financial documents must be current.

##### Complete [I-20 Request](https://www.cpp.edu/international/students/new-students/request-i-20.shtml) as soon as your admission to CPP is confirmed.

Prior to requesting an I-20, please gather the appropriate documents:

* PDF of current passport
* PDF of current bank statement (do not include investment documents)
...
* Students with an "**initial**" I-20 must pay for the SEVIS fee immediately at <https://www.fmjfee.com/i901fee/index.html>.
* Students with a "**transfer pending**" I-20 are excluded from this requirement.

### 3. Transfer SEVIS to CPP (SEVIS transfer students only)
...
It may be possible to change to another status, but there is a specific process you must complete. Learn how to [change your visa status](https://www.cpp.edu/international/students/current-students/change-status-f1.shtml).

### 4. Obtain Visa (if applicable)
...
For more information, visit the [U.S. Department of State’s travel pages](https://travel.state.gov/content/travel/en/us-visas/study.html)

### 5. Purchase Health Insurance

#### All international students are required to purchase the [CPP Student Health Insurance Plan](https://www.cpp.edu/international/students//current-students/health-insurance.shtml). **Enrollment will begin on April 7.**
...
#### If you arrive in the U.S. before the 2025-2026 coverage dates (8/15/2025-08/14/2026), please purchase a separate short-term insurance plan to cover any medical needs that may occur.

### 6. Attend the Campus Orientation

##### For more information:

* **International Student Orientation (immigration session):** All F-1 international students (new and transfer in) are required to attend the mandatory international student orientation on **Tuesday August 19 (for undergraduate students) and Wednesday, August 20 (for graduate students).** A meal will be provided at the meeting. Contact international@cpp.edu for additional information. (Note: This is in addition to the required campus orientation.)
* **Undergraduate** students: contact [the Office of New Student Programs & Family Engagement](https://www.cpp.edu/orientation/international-orientation/index.shtml) regarding the mandatory orientation requirement at orientation@cpp.edu or (909) 869-3604.
* **Graduate** students: contact your [Academic Department](https://www.cpp.edu/gradstudies/graduate-coordinators.shtml)regarding orientation requirements for your program.

### 7. Complete the Vaccination Requirements

* **CSU Immunization Requirements**
  + Contact [Student Health and Wellness Services](https://www.cpp.edu/health/immunizations/index.shtml)

* **Covid-19 Vaccination Requirements**
  + Review [the Safer Return at Cal Poly Pomona's website](https://www.cpp.edu/safer-return/vaccine.shtml)
  + Contact Student Health Services at health@cpp.edu if you have any questions.

### 8. Plan Travel to the U.S.
...
* Undergraduate students: Reach out to Bronco Advising Center at bac@cpp.edu for any assistance.
* Graduate students: Reach out to the Graduate Coordinator of your program for any assistance. For more information: <https://www.cpp.edu/gradstudies/graduate-coordinators.shtml>

### 10. Complete the Immigration Check-In
...
* Start the [Immigration Check-In](https://www.cpp.edu/international/students/new-students/arriving-cpp.shtml)
