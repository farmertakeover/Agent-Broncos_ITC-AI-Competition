**Source:** http://www.cpp.edu/eoda-hr/departments/classification-and-compensation/position-description.shtml
...
To initiate the process of revising Job Description, please log in to our new [Job Description platform](https://idp.cpp.edu/idp/profile/SAML2/Unsolicited/SSO?providerId=https://cpp.jdxpert.com "Job Description platform").

Tutorial on how to use JDXpert is available at [JDXpert Resources](jdx/resourcekits.shtml "JDXpert Resources").

[Learn More About JDXpert](jdx/index.shtml)
...
### Submission Guidelines for HEERA Manager
...
* Select “Minor Change(s)” under “TYPE OF REQUEST” for minor updates.
  ...
  + If your Position Description update involves HR/Compensation and Classification action, please refer to the appropriate process page available on our [Compensation and Classification website](index.shtml) to access detailed processes and guidelines and follow the provided steps to proceed with your update accordingly.
* To initiate the process of revising Job Description, please log in to our new Job Description platform [JDXpert](https://idp.cpp.edu/idp/profile/SAML2/Unsolicited/SSO?providerId=https://cpp.jdxpert.com "Opens in a new window"). Tutorial on how to use JDXpert is available at [JDXpert Resources](jdx/resourcekits.shtml).

### Job Description Copy Requests

You can view your current Job Description at our new Job Description platform [JDXpert](https://idp.cpp.edu/idp/profile/SAML2/Unsolicited/SSO?providerId=https://cpp.jdxpert.com "Opens in a new window").  If you need a copy of your most recent signed Job Description you can email Blake Shaw, jbshaw@cpp.edu or Julia Navar, jnavar@cpp.edu
...
If you have an urgent question regarding the Position Description, please contact Blake Shaw, ext 4528 or Julia Navar, ext 3160

### Other Resources

* [Categories Of Mandated Reporters (PDF)](docs/eo-1083-attachb_final-accessible.pdf "Opens in a new window")
* [Guidelines For Conducting Credit Checks (PDF)](docs/guidelines-for-conducting-credit-checks.pdf "Opens in a new window")
