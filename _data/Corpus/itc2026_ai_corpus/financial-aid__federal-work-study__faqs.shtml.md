**Source:** http://www.cpp.edu/financial-aid/federal-work-study/faqs.shtml
...
If you have filed a [**FAFSA**](https://studentaid.gov/h/apply-for-aid/fafsa) by the March 2 priority filing deadline, indicated that you are interested in Federal Work Study on the FAFSA application, are eligible to receive federal financial aid and have financial need, you may be eligible for Federal Work Study. Check your [BroncoDirect Student Center](https://my.cpp.edu) to review your Aid Summary.
...
Review the [Career Center](https://careercenter.cpp.edu/) for information on searching for FWS jobs.
...
Or it may have decreased because you withdrew, were dismissed, graduated (students who are not enrolled cannot continue in their work-study position), or lost your eligibility for financial aid due to not meeting the [Satisfactory Academic Progress Standards for Financial Aid Applicants](../resources/understanding-sap.shtml).
...
To be set up in payroll, you will be asked to complete your New Hire Paperwork using DocuSign, an electronic system where you will sign most of the paperwork online. You will also need to provide [**two forms of ID (PDF)**](https://www.cpp.edu/eoda-hr/student-employment/docs/sa_appt_offer_ay2324.pdf) in order to complete the Federal (I-9) Employment Eligibility Verification Form which you must do in person, after completing the paperwork. Your supervisor can assist you with questions about coordinating this and will work with Berkeley Regional Services (BRS) for these actions.

---

#### **How do I get paid and how often?**

You are paid once per month, according to the [Student Assistant Payroll Calendar.](https://www.cpp.edu/eoda-hr/departments/payroll/calendars/student-assistant-pay-schedule.shtml)
...
You can read more about distribution of the W-2 form on the Cal Poly Pomona [Payroll Services](https://www.cpp.edu/eoda-hr/departments/payroll/w-2/index.shtml) website.
...
### What are the steps for Posting a Job and Hiring a Student?

**The following steps must be taken for any new job / hires**

#### **Create a Job Posting**:

Job must be posted on [Handshake](https://support.joinhandshake.com/hc/en-us/articles/115011431228) for a minimum of three business days.
...
* You will need to select “yes” under the question asking, “Is this is a work study job?” on Handshake. This will filter your job posting to only work study eligible students. If you also want to consider non-work study eligible students, you will need to create a separate job posting and select “no” to the above question.
  + If you need additional assistance connecting to your department’s company page, please email studenthires@cpp.edu for assistance.
...
* Verify student eligibility on [Tableau](https://www.cpp.edu/data/dashboards/index.shtml).
...
When the Federal Work Study Employment Agreement form is completed, email it directly to studenthires@cpp.edu for processing.
...
Refer to the Career Center [Student Employment Resources](https://www.cpp.edu/eoda-hr/current-employees.shtml) for additional information and guides on using Handshake.

### Timesheets and Payroll

#### **How do we pay the student?**

You will need to make sure that a [Student Federal Work Study Timesheet (PDF)](../forms/fws-timesheet.pdf) and a Student Assistant Time Report, with student name and hours worked, is submitted to the Office of Financial Aid and Scholarships by the monthly due date.
...
We have provided a [form (PDF)](../forms/fws_award_balance-semester.pdf) to help you calculate and track a student’s monthly earnings. We also notify you when a student is close to earning his or her full allocation for the semester.

### Changes to a Student's FWS Offer / Rate of Pay
...
Generally, pay increases are based on time at the job, exceptional performance, or a change in job duties.  Once you have determined the student is eligible for a pay increase, you will need to submit an [Hourly Rate Change Request (PDF)](https://www.cpp.edu/eoda-hr/departments/payroll/time-keeping/students/doc/student-assistance-forms/student-hourly-rate-change-request.pdf) to Payroll Services.

Refer to the [Salary Schedule (PDF)](https://www.cpp.edu/eoda-hr/departments/payroll/time-keeping/students/doc/employer-guides/student_employment_salary_guideline.pdf) to determine if the student or position is eligible for a pay increase.

Additional resources, including a Performance Evaluation Form are available on the [Student Payroll](https://www.cpp.edu/eoda-hr/departments/payroll/time-keeping/students/index.shtml) website.

### Renewing Positions or Re-Hiring Students

#### **Do I have to renew my contract each year?**

No. You will only need to create the posting on [Handshake](https://support.joinhandshake.com/hc/en-us/articles/115011431228) and complete an **Employment Agreement** form for each student you hire.
...
The **Employment Agreement** forms are available from the [EODA and Human Resources Customer Service Center (PDF)](https://www.cpp.edu/eoda-hr/student-employment/docs/sa_appt_offer_ay2324.pdf) website.
