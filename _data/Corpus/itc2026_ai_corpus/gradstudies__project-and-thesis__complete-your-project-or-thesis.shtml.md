**Source:** http://www.cpp.edu/gradstudies/project-and-thesis/complete-your-project-or-thesis.shtml
...
Projects reports are not uploaded to Bronco ScholarWorks, so they do not require a formatting review. However, your project committee chair may still require a written project. Students need to check with their department on requirements for completing a project. All projects need to be approved/signed electronically by student’s committee members (please see step #7). Students completing a master’s project will be required to submit an abstract to Bronco Scholar Works (please read step #10 in the checklist).
