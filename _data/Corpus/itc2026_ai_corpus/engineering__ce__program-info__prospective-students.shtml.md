**Source:** http://www.cpp.edu/engineering/ce/program-info/prospective-students.shtml
...
![Concrete Canoe](/engineering/ce/img/15concrete-canoe-sand.jpg)
...
We have three programs: The undergraduate [civil engineering program](https://www.cpp.edu/engineering/ce/bsce.shtml), the undergraduate [construction engineering and management program](https://www.cpp.edu/engineering/ce/bscem.shtml) and the graduate-level [master of science in civil engineering (MSCE) program](https://www.cpp.edu/engineering/ce/msce/index.shtml) is for students who already have a BS in civil engineering or construction engineering and management, or similar degree and wish to pursue more in-depth studies.

Cal Poly Pomona is ranked very high [national and regional rankings](http://www.cpp.edu/~engineering/about/rankings.shtml). In addition, local employers have strong desires to hire our graduates. Civil engineering is especially well-regarded, and is the largest major on campus.
...
* Certain courses and other requirements as outlined in the [transfer admission requirements](https://www.cpp.edu/admissions/transfer/requirements.shtml "Transfer Admission Information")
...
The [assist.org website](http://www.assist.org/web-assist/welcome.html) is an excellent resource for checking course equivalencies. There is no need to complete an AA or AS degree.

Transfer students who complete the CSU Lower Division Transfer Pattern (LDTP) requirements for the civil engineering or construction engineering and management programs, along with the [transfer admission requirements](https://www.cpp.edu/admissions/transfer/requirements.shtml "Admission Information") are normally given first priority in admissions.

Transfer students are typically admitted every semester. The application deadlines are posted on the [Cal Poly Pomona Admissions website.](https://www.cpp.edu/admissions/index.shtml)

### Applying for Admission

The best way to apply for admission is online at the [CSU Apply website](http://www.csumentor.edu/). Additional information is available on the [Cal Poly Pomona admission and planning website.](http://www.cpp.edu/~admissions/index.shtml)

### Policies and Procedures for Change of Major to Our Civil Engineering or Construction and Management Programs

Current Cal Poly Pomona students may request a change of major to the civil engineering or construction engineering and management program. The process for doing so is described in the [Major Change Polices and Procedures](../documents/change-of-major-policies-and-procedures.pdf)document.

## MSCE Students

### General Info

Our [MSCE program](msce.shtml) is designed for both part-time and full-time students. All classes are scheduled in the late afternoon or evening in order to accommodate working professionals. This program currently offers options in construction engineering and management, environmental engineering and water resources, geotechnical engineering, structural engineering, and transportation engineering.

### Applying for Admission

Graduate students are typically admitted for fall semester only. Application deadlines and procedures are shown on the [Admissions web site](https://www.cpp.edu/admissions/index.shtml). For your information, here is the[Guidelines, Policies and Procedures for Graduate Admissions](../documents/guidelines-policies-and-procedures-for-graduate-admissions.pdf) of our MSCE program.
