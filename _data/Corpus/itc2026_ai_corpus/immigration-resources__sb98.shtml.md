**Source:** https://www.cpp.edu/immigration-resources/sb98.shtml
...
[#### Active Immigration Enforcement on Campus](#modal-0 "Active Immigration Enforcement on Campus")

### Active Immigration Enforcement on Campus

×

An active enforcement visit occurs when federal immigration authorities are on campus to engage in actions aimed at enforcing immigration laws, such as:

* Executing a federal immigration order (e.g., warrant, arrest order).
* Investigating or attempting to detain individuals for immigration violations.
* Enforcement-related questioning or attempts to remove individuals from campus property.

**What Triggers a Notification**

* Confirmation by campus officials (e.g., designated point of contact or University Police) that federal immigration personnel will be or are on campus property to engage in active immigration enforcement.
...
The University works within legal and safety constraints to verify enforcement presence before sending an alert and may issue updates as circumstances evolve.

**Immigration Enforcement Activity**

Enforcement of federal immigration laws rests with the federal government, and not with UPD. The campus police will not contact, detain, question or arrest an individual solely because of suspected undocumented immigration status or to discover the immigration status of any individual. Campus police will not undertake joint efforts with federal immigration enforcement authorities to investigate, detain or arrest individuals for violation of federal immigration law.

![](img/stratcomm_v3.png)

Close

[#### Standard Compliance Visits](#modal-1 "Standard Compliance Visits")
...
A compliance visit refers to routine or administrative activities by federal immigration officials that do not involve enforcement. Examples may include:

* Visa status reviews or check-ins that are administrative in nature.
* Outreach or informational visits (e.g., presentations, career fair participation).
* Routine verification of non-immigrant status or procedural follow-up.

**Important Points**

* These visits will not trigger an SB 98 notification from CPP because they are not active enforcement actions.
* The presence of immigration officials for compliance visits is typically known in advance and is part of routine processes.
* For transparency CPP will post scheduled or completed compliance visits on our website.

CPP will continue to support routine administrative interactions with immigration officials consistent with federal and state law. These are not considered enforcement and therefore do not require notification under SB 98.

![](img/compliance_v2.png)
...
### Does SB 98 mean the University is cooperating with immigration enforcement?
...
### What is the difference between a compliance visit and an enforcement visit?
...
### Can Cal Poly Pomona prevent federal immigration enforcement officers from coming on campus?
...
### Will I receive an SB 98 alert for a compliance visit?
...
### When will the University issue an SB 98 alert?
...
### What should I do if I see immigration officials on campus?
...
### Who should I contact if I have general questions about SB 98?

For general questions regarding SB 98, please email studentaffairs@cpp.edu.

If you are interested in having campus partners give an educational presentation on SB 98, please [complete this form](https://cpp.az1.qualtrics.com/jfe/form/SV_ag9FgMLx0yu3BwW).
