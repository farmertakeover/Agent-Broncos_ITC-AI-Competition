**Source:** https://www.cpp.edu/president/from-the-president/2025-spring/april-2025-budget-briefing-follow-up.shtml
...
For those who were unable to attend the briefing, please visit the [financial transparency website](https://www.cpp.edu/fas/financial-transparency/index.shtml "https://www.cpp.edu/fas/financial-transparency/index.shtml") to learn more about our processes and next steps. You can watch a recording of the presentation [here](https://streaming.cpp.edu/media/1_5vzt423n "https://streaming.cpp.edu/media/1_5vzt423n").

**Key Takeaways**

* CPP implemented a Voluntary Separation Incentive Program (VSIP) with 121\* participants, reducing the deficit by $13.4 million, and received enrollment growth funding that will further reduce it by $4.6 million.
...
* CSU systemwide enrollment challenges continue to put pressure on CPP to over-enroll without full state funding.

  + CPP, along with nine other campuses, has been asked to overenroll to help stabilize enrollment declines across the system.
...
Please join us for a follow-up [webinar meeting on May 15](https://cpp.zoom.us/webinar/register/WN_T-Vim3WiT6iHMN2O7LVNAg#/registration "https://cpp.zoom.us/webinar/register/WN_T-Vim3WiT6iHMN2O7LVNAg#/registration") for the next budget briefing.
