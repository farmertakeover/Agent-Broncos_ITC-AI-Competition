**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/text-image.shtml
...
***Page View (with Kicker)***

**![](img/textimgwithkicker_pageview.jpg)**

**For this section you will need:**

* Heading (H2)
* Kicker Heading (H2) and Sub Heading (H3) - optional
* Content

***Cascade View***

**![](../img/textimgcascade.png)**

**Adding Kicker Heading and Sub Heading**

**![](img/textimgwithkicker.jpg)**

**Adding Links In Content Section**

**![](../img/addlinkstep1.png)**

1. Highlight Link Text
2. Click Add Link Button
3. Follow Steps Below For External Or Internal Link

**![Internal link option form](../img/internaloption.png)**

**OR**

**![External link form option](../img/externallink.png)**
