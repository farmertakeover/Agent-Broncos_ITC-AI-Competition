**Source:** https://www.cpp.edu/programs/eng/electrical-and-computer-engineering/computer-engineering.shtml
...
![Male student in the data center](../../img/student-data-center-hernandez4.jpg)
...
Channel your passion for technology into solutions for an increasingly computerized world. Apply theories and principles of physics and mathematics to the study of circuits, electronics, software, hardware and digital system design to solve technical problems.
With over 15 electrical and computer engineering laboratories, you will gain the hands-on experience needed to achieve your dream career.
...
Design and build hardware, software and computer systems, from processors to networks. Optimize processes in manufacturing, cybersecurity and embedded system design.

### Machine Learning Engineer

Combine skills in data science, programming and engineering to build and deploy machine learning models that can learn from data, recognize patterns and make predictions and decisions autonomously.

### IT Consultant

Provide advice to organizations on how to use information technology and evaluate clients’ IT infrastructure to identify areas for improvement and implement solutions that enhance productivity and security.

### Game Developer

Create and test console, computer, mobile and virtual reality video games. Work in a variety of roles like programming, graphics and animation, sound design, testing and more.
...
[Visit Advising](https://www.cpp.edu/engineering/ece/student_resources/current-students.shtml)

![Thomas Ketseoglou](../../img/ketseoglou-thomas.jpg)
...
[Electronic Systems Engineering Technology, B.S.](https://www.cpp.edu/programs/eng/electromechanical-engineering-technology/eset.shtml)

[Computer Science, B.S.](https://www.cpp.edu/programs/sci/computer-science/computer-science.shtml)

[Computer Science Minor](https://www.cpp.edu/sci/computer-science/undergraduate-program/minor-in-cs.shtml)

[Mathematics - Applied Mathematics and Statistics, B.S.](https://www.cpp.edu/programs/sci/mathematics-and-statistics/applied-mathematics-and-statistics.shtml)

[Mathematics Minor](https://www.cpp.edu/sci/mathematics-statistics/undergraduate-students/index.shtml)

[Physics, B.S.](https://www.cpp.edu/programs/sci/physics/physics.shtml)

[Physics Minor](https://www.cpp.edu/sci/physics-astronomy/academic-programs/physics-minor.shtml)

[Business Administration – Computer Information Systems, B.S.](https://www.cpp.edu/programs/cba/cis/computer-information-systems.shtml)
