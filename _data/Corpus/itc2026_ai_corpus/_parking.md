**Source:** http://www.cpp.edu/~parking
...
![Samples of the Fall Parking Permits](img/fallpermits.jpg)

### Purchase a Parking Permit

Spring Semester parking permits will be available for sale

**January 11, 2026**

[**Purchase Now**](https://csupomona.t2hosted.com/Account/Portal)

Use **PayByPhone** to purchase daily digital permit.

-Select parking location, enter vehicle info & method of payment

*(must be purchased on the same day).*

[**PayByPhone**](https://m.paybyphone.com)

**\*\*Permits are required on campus, there is no grace period.\*\***

![](img/portal.jpg)

### Pay or Appeal a Citation Online

Parking Services has an easy online portal to view, pay and/or appeal your current parking citations. [Access a dedicated FAQ's](https://www.cpp.edu/parking/citations/academic-holds-faqs.shtml) regarding academic holds related to unpaid citations here. Click the button below to access the portal.

[**Access Portal**](https://csupomona.t2hosted.com/Account/Portal)

![](event_services.png)

### Request Event Services

PTS offers a variety of services. For more information on each of the different services, [click here for deadlines, prices, and services](services/events.shtml).  To request a specific service, click on the button below.

## **[Parking for 10 guests or less](https://app.smartsheet.com/b/form/68ebfbb5623b4b059a0e1057364efd4d "Event Services Request From")**

**[Parking for more than 11 guests](https://app.smartsheet.com/b/form/0195ab5c37107a438c29c19d13092474 "Event Services Request From")**

[**More Services: Shuttles, directional signs, traffic control, space reservation**](https://app.smartsheet.com/b/form/0195ab5c37107a438c29c19d13092474 "Event Services Request From")
...
##### [**JAPA Parking App**](https://apps.apple.com/us/app/japa-smart-parking/id1237326914)

##### to view LIVE parking space availability for major parking locations at CPP. Save time by driving directly to the available parking spaces.

#####

![](img/img_8839.jpg)

## Employee Parking Action Forms

* Employees who wish to purchase a $3 daily permit can use the [Employee Daily Parking Request Form](https://app.smartsheet.com/b/form/36fe913414624e458da3923c94086672) to register each semester.
* New Employees can visit the Student Accounting Services Office in Building 121 to setup Payroll Deduction Parking.
* Employees who were once on payroll deduction can opt-in using the [Online Payroll Deduction Reinstatement Form](https://polyform.cpp.edu/Loginformproc/UnityForm.aspx?d1=AYq6HBGRxIbdGc0sD9WuJPqlA0LyfNM5xn2LFAVLL1Jmsdx3y1J6NdGxT4wHWHeexnY3Hn5bzVVNW5bwOxCfVgpTtyix4jqScPx%2bLEVemJ9E225yM06cmVPn%2fclER9%2fztyFjZpNkNmPs8Nmu%2f8Wy34b0pkcGblOIdZ7zyJpazs1c9AjVB1Af%2fBUVMXMZj8Yq%2bOHueh9iHUU0saLklYRENXXrDQISnp30jPohmzuVCeGm).
