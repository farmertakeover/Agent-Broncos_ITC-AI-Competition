**Source:** https://www.cpp.edu/sci/biological-sciences/graduate-studies/graduate-contract.shtml
...
* Fill out the GS101 form for the year you entered the Master’s program (see below for detailed instructions). Once the form is complete, submit the form through [PolyDoc](https://www.cpp.edu/gradstudies/forms-and-procedures/graduate-forms.shtml) (under Program of Study – Master’s Contract) and include your major professor’s information as the Advisor.
* Download the form and instructions for the term that you began the program:
  + [Graduate contract instructions – Fall 2019 through Spring 2022](../docs/gradprog/graduate-contract-instructions-fall-2019.pdf)
  + [Graduate contract form – Fall 2019 through Spring 2022](../docs/gradprog/bio-gs101-2021-22.pdf)
  + [Graduate contract instructions – Fall 2018 or Spring 2019](../docs/gradprog/graduate-contract-instructions-fall-2018-spring-2019.pdf)
  + [Graduate contract form – Fall 2018 or Spring 2019](https://www.cpp.edu/sci/biological-sciences/docs/grad-forms/semester_contract.xls)
  + For prior semesters contact the Graduate Coordinator.
  + If there are any issues downloading/completing the form, contact the [Graduate Coordinator](https://www.cpp.edu/sci/biological-sciences/graduate-studies/contact.shtml).
...
* **If you wish to amend your current contract, you must submit a Graduate Academic Petition (see [forms](https://www.cpp.edu/sci/biological-sciences/graduate-studies/forms.shtml) page).** Do **NOT** file a new GS101 to make changes to your contract. The Graduate Academic Petition is specifically designed to allow deletion and addition of courses to your GS101. If your additions/deletions change the total number of units in your program, be sure to indicate the change in the total units in the "Statement of Action other than Course Substitution" section.
