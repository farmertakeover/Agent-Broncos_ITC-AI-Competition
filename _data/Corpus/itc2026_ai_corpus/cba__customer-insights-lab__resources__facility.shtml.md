**Source:** https://www.cpp.edu/cba/customer-insights-lab/resources/facility.shtml
...
# Resources Available at the Center for Customer Insights and Digital Marketing
...
![Inside the Center for Customer Insights and Digital Marketing](../img/resources/bl-clac610-small.jpg)

Inside the Center for Customer Insights and Digital Marketing

The Center for Customer Insights and Digital Marketing shows the interior of the lab with computers and personnel.

![Workshop on Medialab](../img/resources/bl-workshop2.jpg)

Workshop on Medialab

Dr. Jung is giving a workshop on Medialab

![SmartPLS - Model Testing](../img/resources/smartpls_model_hypo.png)

SmartPLS - Model Testing

Illustrating the results of PLS-SEM model testing using SmartPLS

![Business Research Panel (aka, business sona-systems)](../img/resources/bl-business-research-panel.jpg)

Business Research Panel

Business Research Panel consists of students taking classes in the College of Business Administration. We use sona-systems to manage the subject pool.

![Medialab's Research Software Empirisoft](../img/resources/bl-medialab.jpg)

![Medialab-based study](../img/resources/bl-medialab-studyppt.jpg)

![Medialab question item](../img/resources/bl-medialab-question-item.jpg)

Medialab question item

A typical question item in a medialab software

![Medialab experiment editor](../img/resources/bl-medialab-experiment_editor.jpg)

Medialab experiment editor

Medialab experiment editor puts together questionnaire items.

![Qualtrics Survey - Cover Page](../img/resources/bl-qualtrics-survey-sample.jpg)

Qualtrics Survey - Cover Page

A sample of Qualtrics Survey showing the cover page.

![Data Visualization using Qualtrics](../img/resources/bl-qualtrics-graph.jpg)

Data Visualization using Qualtrics

Qualtrics allows not only data collection but also data analysis, even in the middle of data collection.

![Qualtrics usage statistics](../img/resources/bl-qualtrics_cba_stat.jpg)

Qualtrics usage statistics

Qualtrics usage statistics for the College of Business Administration shows an increasing trend of usage among CBA members.

![SmartPLS - Common Method Bias](../img/resources/smartpls_cmb.png)

SmartPLS - Common Method Bias

Illustrating how to assess Common Method Bias using SmartPLS.
...
* Qualtrics
* Media Lab
* Sona-systems subject pool management system
* Research panel with Generation Z
* Databases for secondary research
* Statistical software (SPSS, R, SAS, AMOS, and SmartPLS)
* The Analytics and Marketing Insights Club, the only student market research club in CA.
