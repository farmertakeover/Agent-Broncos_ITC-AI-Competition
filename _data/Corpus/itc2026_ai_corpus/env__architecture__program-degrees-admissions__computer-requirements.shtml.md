**Source:** http://www.cpp.edu/env/architecture/program-degrees-admissions/computer-requirements.shtml
...
Cost for undergraduate program tuition, can be found at the university [Student Accounting & Cashiering Services](https://www.cpp.edu/student-accounting/tuition-fees/undergraduate.shtml) website. Financial aid calculators are found [here](https://www.cpp.edu/financial-aid/undergraduate/current/costs.shtml).
Cost for graduate program tuition are redirected [here](https://www.cpp.edu/student-accounting/tuition-fees/graduate.shtml), financial aid availability [here](https://www.cpp.edu/financial-aid/graduate/course-eligibility.shtml).
Housing and meal costs are located at the CalPoly Pomona [Housing website](https://www.cpp.edu/housing/futureresidents/housing-costs.shtml).
Study abroad information can be found [here](https://www.cpp.edu/international/study-abroad/index.shtml).

**Bachelor Of Architecture Estimated Supply cost 2024-25**
One-time purchases:
Tools for model making (cutting mat, tools, rulers, etc.) $300
Computer & peripheral hardware (printer, external monitor, Harddrive, etc.) $3500
...
Total 5-year estimate: $12,800

**Master Of Architecture Estimated Supply cost 2024-25**
One-time purchases:
...
Tuition and fees are paid directly to Cal Poly Pomona but are only a part of a student’s education costs.  The overall [Cost of Attendance](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.collegedata.com%2Fresources%2Fpay-your-way%2Fhow-colleges-figure-cost-of-attendance&data=05%7C01%7Crdeponte%40cpp.edu%7C77420f2d465a4418645f08db6120fe51%7C164ba61e39ec4f5d89ffaa1f00a521b4%7C0%7C0%7C638210566582582833%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&sdata=Wdhk%2Bbg8y8bHO5m4sIHUyrMZIAWSdUK0ZErrzLLeSsQ%3D&reserved=0) is broadly defined as the average cost to attend Cal Poly Pomona for one academic year, (which consists of the Fall and Spring semesters) and includes additional expenses ranging from transportation to books and course materials.
...
* Rhino 3d **–** $195 for academic license
  + <https://www.rhino3d.com/store?audience=Educational>
* Discount Software and Hardware can be purchased through the Cal Poly Pomona campus bookstore.
  *See the Bronco Bookstore for pricing (Adobe, Dell and Apple have special pricing for Cal Poly).*
  + <https://www.broncobookstore.com/Technology.asp>?
