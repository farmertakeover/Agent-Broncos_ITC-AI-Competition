**Source:** http://www.cpp.edu/registrar/evaluation-transfer-credit/degree-progress-report.shtml
...
**View the [Degree Progress Report User Guide for *Students*](https://www.youtube.com/watch?v=zXpEbJ3rApg)**

##

## **Obtain the Degree Progress Report (DPR):**

Current CPP students with transfer courses and entering Undergraduate Students attending [Orientation](https://www.cpp.edu/~orientation/index.shtml) can retrieve their Transfer Credit Report (TCR)from their Advisee Student Center within PeopleSoft after logging in via [MyCPP Portal](https://my.cpp.edu/).
...
![DPR guide ](../img/how-to-read-the-dpr.jpg)

## **Questions regarding your Degree Progress Report:**

For questions about major requirements, contact your [**assigned academic advisor**](https://www.cpp.edu/studentsuccess/directories/advising-directory.shtml) or college advising center.

For general questions about your degree requirements, contact the [**Bronco Advising Center**](https://www.cpp.edu/studentsuccess/bronco-advising-center/index.shtml).

For questions regarding graduate program requirements, master's students should contact their [Graduate Coordinator](https://www.cpp.edu/gradstudies/prospective-students/explore-our-grad-programs.shtml "Graduate Studies Office") or the [Graduate Studies Office](https://www.cpp.edu/gradstudies/index.shtml "Graduate Studies Office") for assistance.
...
If students are admitted into a program of study that does **not** correspond to one of the approved ADT pathways at CPP, **or** if a student changes their program of study after admission, the AA-T/AS-T guarantee and its associated benefits will no longer apply. As a result, certain degree requirements that were previously satisfied under the ADT guarantee may now be **incomplete** under the new program.

For questions or clarification, please contact your [academic advisor](https://www.cpp.edu/studentsuccess/directories/advising-directory.shtml) or email to **ADT@cpp.edu**.

* [ADT 2-year roadmaps](https://www.cpp.edu/academic-programs/academic-advising/tools/sheets-roadmaps/index.shtml "ADT 2-year roadmaps")
* [ADT accepted by Cal Poly Pomona](https://www.cpp.edu/admissions/transfer/associate-degree-for-transfer.shtml "ADT accepted by Cal Poly Pomona")
* [ADT Major & Campus Search](https://www.calstate.edu/apply/transfer/Pages/associate-degree-for-transfer-major-and-campus-search.aspx "ADT Major & Campus Search")

### Graduate Students

*The following unit limitations on transfer courses apply to graduate students*:
A maximum of 9 semester units from an accredited institution or from the [College of Professional and Global Education (CPGE)](https://www.cpp.edu/cpge/index.shtml) may be applied to the Master's Degree requirements with departmental and college approval. Time limits apply to the acceptance of transfer courses.

### Additional Resources

[The ACE Military Guide](https://www.acenet.edu/news-room/Pages/Military-Guide-Online.aspx "American Council on Education (ACE) Guide")

[American Institutions Requirement: CA Component](https://www.cpp.edu/~class/political-science/undergraduate/california-government-test.shtml)

[AP/IB/CLEP Scores (Credits)](https://catalog.cpp.edu/content.php?catoid=57&navoid=4363&hl=%22advanced+placement+examinations%22&returnto=search#Advanced_Placement_Examinations)

[College of Professional and Global Education (CPGE)](https://www.cpp.edu/cpge/index.shtml)

[Transfer Students and GE Certification](https://catalog.cpp.edu/index.php)

[Regional Accrediting Agencies](regional-accreditation1.shtml)

Including:

* [Current University Catalog](https://catalog.cpp.edu/)
* [Curriculum Sheets/Roadmaps by College](http://www.cpp.edu/~academic-programs/academic-advising/tools/sheets-roadmaps/index.shtml)
* [Guided Registration - Stretch Sequence](https://www.cpp.edu/studentsuccess/new-students/category-placement.shtml)
...
### I need assistance in understanding the DPR. Where do I go for assistance?

Watch [Viewing Your DPR & Academic Information](https://youtu.be/zXpEbJ3rApg) for a quick guide through the DPR. If you still need assistance after watching, please see your academic advisor in your major department.

### Does the notification of my ADT pathway show on my Degree Progress Report?

Yes, in the header of the DPR under “Current Academic Summary” there is a line note saying, “ADT Pathway”. This line will identify the program associated with your Associate Degree for Transfer (ADT).

Note, under the “General Degree Requirements” section of the DPR there will be general information regarding the ADT program within the “Message: Curriculum Requirements” section of the general degree requirements. For more information, please visit the [ADT Requirements](https://www.calstate.edu/apply/transfer/Pages/ccc-associate-degree-for-transfer.aspx) page.

### Why don’t the total units and GPA on my Degree Progress Report (DPR) match my transcript?
...
### I completed a requirement but it’s not showing as Completed on my DPR?
...
1. Processing Time: If you recently completed the course, your DPR may not have updated yet. Allow some time for processing.
2. Transfer Credits: If the requirement was met with transfer coursework, it may still be under review or need manual adjustment.
3. Course Substitutions or Exceptions: If you receive approval for a course substitution or exception, it may need to be officially recorded.
4. Minimum Grade Requirement: Some requirements have specific grade requirements. If the grade does not meet the minimum, the requirement may still show as incomplete.
5. Placement in the DPR: The system may not have automatically applied the course to the correct requirement, and an adjustment may be needed.
...
### I repeated a course with a better grade, but the requirement is showing “In Progress,” why?
...
### Some of my transfer courses have the course names and numbers, but others have different code names like TRN-LD, what are these courses?
...
### What do Ineligible Courses mean?
