**Source:** http://www.cpp.edu/cafe/teaching-and-learning/getting-started.shtml
...
Here's a very [brief video summary of the backwards design concept](https://youtu.be/QbKx_tG99ho)
...
5. **[Build an alignment table (docx)](../documents/3-column-table-blank-form.docx)**[:](../documents/3-column-table-blank-form.docx)Check how well Steps 1-3 match up.  Make sure that every outcome has an assessment and every assessment has an activity - and that the outcomes, assessments, and activities all work together.  You can also make sure that the course is balanced, without one area being unintentionally over- or under-emphasized.
...
7. **Decide on course policies and practices:**  At Cal Poly Pomona, faculty are responsible for determining their own policies regarding late work and responses to academic integrity, so at the very least include these policies. See [CPP's Syllabus policy (pdf)](https://www.cpp.edu/academic-manual/1200-1299-research-and-instructional-support/1200-1299/policy_1200_university_course_syllabus.pdf).
...
## Top Five Course Design Resources

* [California State University Quality Learning & Teaching (QLT) Rubric](https://ocs.calstate.edu/rubrics/qlt). This rubric, first developed in 2011, is designed to help support and identify exemplary practices for the design and delivery of online and blended courses. It is relevant for face to face courses as well.
* [Self-Directed Guide for Designing Courses for Significant Learning](../documents/teaching-learning/self-directed-guide-to-course-design-sept-10.pdf) (pdf). Based on the outstanding book [Creating Significant Learning Experiences](https://www.amazon.com/Creating-Significant-Learning-Experiences-Integrated/dp/1118124251/ref%3Dsr_1_1?ie=UTF8&qid=1530909526&sr=8-1&keywords=dee+fink&dpID=51A8i2f9IFL&preST=_SX218_BO1,204,203,200_QL40_&dpSrc=srch) (Fink, L.D., 2013), this 37-page workbook walks you through an interesting, rewarding process of course creation.
* Creating Courses for Adults: Design for Learning (book).  St. Clair, R. (2015).  This practical book from Jossey-Bass provides a systematic approach to lesson and course design based on research into adult learning.  Our students are, of course, very close to adulthood if not well into it.
* [Grading for Equity: What It Is, Why It Matters, and How It Can Transform Schools and Classrooms](https://gradingforequity.org/) (book).  Feldman, J. (2019). This book offers specific ways to help students become intrinsically motivated to learn, by creating grading systems that accurately measure where they are in the learning process.
* [Universal Design for Learning](https://www.cast.org/impact/universal-design-for-learning-udl).  The UDL framework guides the design of instructional goals, assessments, methods, and materials so that all students' needs are met.  The heart of UDL is multiple means of engagement, action & expression, and representation.
