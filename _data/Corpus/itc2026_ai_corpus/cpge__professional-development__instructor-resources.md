**Source:** https://www.cpp.edu/cpge/professional-development/instructor-resources
...
For professional development courses, instructors are welcome to log in by clicking on the button below.

[Login Here](https://cpge.cpp.edu/portal/logonInstructor.do?method=load)

## How to Set Up Password

Instructors, please follow the **[directions on setting up instructor passwords (PDF)](directions-on-setting-up-instructor-password-final-accessible.pdf)**.
