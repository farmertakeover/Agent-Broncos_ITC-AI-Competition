**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/form-embed.shtml
...
# Form Embed Module Tutorial

## Instructions

***Page View***

![](../img/form-embed-page-view.png)

 **For this section you will need:**

* 1 Form URL or embed script

***Cascade View***

There are three types of form embeds available to choose from: Microsoft Forms, BlackBaud Forms, and other (custom embed script).

![](../img/form-embed-cascade-view.png)
