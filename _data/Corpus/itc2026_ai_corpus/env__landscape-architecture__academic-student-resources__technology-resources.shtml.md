**Source:** http://www.cpp.edu/env/landscape-architecture/academic-student-resources/technology-resources.shtml
...
## Information System and Techical Equipment
...
### Cal Poly Pomona's Learning-Centered Technology Initiative
...
* anti-virus programs, e.g., McAfee and Norton,
* database programs, e.g., Oracle,
* graphic media programs, e.g., Adobe Suite,
* office products, e.g., Microsoft Office Professional,
* SFTP software, e.g., Fugu and PuTTY,
* statistical programs, e.g., Mathematica, SAS and SPSS,
* utility programs, e.g., Winzip, Eraser, Ghost, Retrospective.

Most of these applications are also installed in the open access computer labs on campus. However, multimedia applications such as Adobe Suite are only available in the Computing Commons, and the 24-hour computer lab in the University Library.

### The Center for Geographic Information Science Research (CGISR)
...
### CED's Central Media Service Bureau and Computer Labs
...
### The Landscape Architecture Department's Studio Technical Equipment
