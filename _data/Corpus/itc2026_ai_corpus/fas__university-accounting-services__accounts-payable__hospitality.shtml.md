**Source:** http://www.cpp.edu/fas/university-accounting-services/accounts-payable/hospitality.shtml
...
![campus panorama with the CLA in the middle](https://www.cpp.edu/fas/img/hospitality-banner.jpg)
...
## P2P Hospitality Request Form (Non-Travel Vendor Payments)
...
Departments must complete the [**Hospitality Request (Non-Travel)**](https://solutions.sciquest.com/apps/Router/FavoritesFormsBrowse?tmstmp=1769214797447) form in CSUBUY P2P for pre-approval and appropriate routing.
...
For more information or assistance regarding the CSUBUY P2P implementation, please visit the [P2P resource center webpage](https://www.cpp.edu/procurement/marketplace/resource_center.shtml).

## Legacy Hospitality Authorization Form & Process

Please follow this process for hospitality provided:

* While on travel status;
* To be paid via university travel card or p-card;
* Paid out-of-pocket and to be reimbursed; OR
* If hospitality is provided prior to January 26, 2026, and paid directly from the university to a vendor, including university auxiliary organizations.

### Step 1: Determine Allowability

Review the CSU and campus hospitality policy to confirm the proposed expense is allowable.
...
* [CPP Hospitality Policy (PDF)](../docs/hospitality/CPP%20Hospitality%20Policy.pdf)
* [Appendix A - Hospitality FAQs (PDF)](../docs/hospitality/Appendix%20A_Hospitality%20FAQs.pdf)
* [Hospitality Expenditure Grid (PDF)](../docs/hospitality/Hospitality%20Expenditure%20Grid.pdf)
* [Hospitality Per-Person Meal Rates (PDF)](../docs/hospitality/Hospitality%20Per-Person%20Meal%20Rates_March%202022-Final.pdf)
* [Hospitality Authorization Form (PDF)](../docs/hospitality/Hospitality%20Authorization%20Form.pdf)
