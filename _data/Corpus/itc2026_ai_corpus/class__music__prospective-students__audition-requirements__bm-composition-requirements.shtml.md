**Source:** http://www.cpp.edu/class/music/prospective-students/audition-requirements/bm-composition-requirements.shtml
...
* You are **required** to audition in order to qualify for the Bachelor of Music, Composition program.
...
* You must submit scores and recordings of 2-3 pieces of music with varying instrumentation.
  + Electronic submission of scores and recordings is preferred.
* All styles of music are welcome, including electronic/electroacoustic works, but evidence of skill in written musical notation is a necessary component of the application.
...
* You will provide sheet music for the accompanist in the correct key for in-person auditions, or a background track for each song
  + All sheet music and background tracks must be emailed to dpuentes@cpp.edu by Friday, 1/15/26.
...
You should also consider additional works comparable to:
...
You should also perform a two-octave major scale of your choice, and a brief sight-reading example
