**Source:** http://www.cpp.edu/broncoscarecenter/health-topics/physical-activity.shtml
...
[### Strength Training](#modal-1 "Strength Training")
...
* Exercises with [resistance bands](https://www.acefitness.org/education-and-resources/lifestyle/blog/3624/workout-wednesday-15-minute-resistance-band-workout "resistance bands")
* [Body weight exercises](https://www.cpp.edu/health/health-topics/body-weight-exercises.shtml)
* Weight lifting

Close

[### Flexibility and Training](#modal-2 "Stretching 101 ")
...
* [Abdominal](https://www-test.cpp.edu/~health/docs/abdominal_stretches.pdf "Abdominal")
* [Arms & Chest](https://www-test.cpp.edu/~health/docs/arms-chest_stretches.pdf "Arms & Chest")
* [Back & Sides](https://www-test.cpp.edu/~health/docs/back-sides_stretches.pdf "Back & Sides")
* [Hips & Butt](https://www-test.cpp.edu/~health/docs/hips-butt_stretches.pdf "Hips & Butt")
* [Neck & Shoulders](https://www-test.cpp.edu/~health/docs/neck-shoulders_stretches.pdf "Neck & Shoulders")
* [Upper & Lower Legs](https://www-test.cpp.edu/~health/docs/upper-lower-leg_stretches.pdf "Upper & Lower Legs")
...
[### Get Moving With Others](#modal-3 "Get Moving")

### Get Moving

×

Sometimes, being active with others can help you stay motivated and add to the fun. Here are some ideas to get started:

* Go shopping
* Walk the dog
* Play an active video game like Wii
* Go dancing
* Hike or walk
* Head to the beach and swim, jump in the waves, walk on the sand
* Go to a lake and paddle boat, canoe, kayak, or paddle board
* Volunteer with a community group to pick up trash, plant trees, or start a community garden
* Go to the park and play on the playground
* Play tag or hide and seek

The possibilities are endless! If you want more information or help making a plan to move more, call the Bronco Wellness Center at (909) 869-5272 and make an appointment with a Peer Health Educator.

Close

[### Body Weight Exercises](#modal-4 "Body Weight Exercises")

### Body Weight Exercises

×

![lower body](https://www.cpp.edu/health/img/legs1.jpg)

[Lower Body](https://www.cpp.edu/health/docs/legs.pdf)

![chest & biceps](https://www.cpp.edu/health/img/chest_biceps.jpg)

[Chest & Biceps](https://www.cpp.edu/health/docs/chest-biceps.pdf)

![abdominals](https://www.cpp.edu/health/img/abs.jpg)

[Core](https://www.cpp.edu/health/docs/abdominals.pdf)

![](https://www.cpp.edu/health/img/back1.jpg)

[Back, Shoulders & Triceps](https://www.cpp.edu/health/docs/back-triceps-deltoids.pdf)

## Additional Resources

* [30 Day Workout](https://www.cpp.edu/health/docs/30-day-workout)
