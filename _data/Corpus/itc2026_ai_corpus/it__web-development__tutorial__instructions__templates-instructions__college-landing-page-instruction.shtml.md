**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/templates-instructions/college-landing-page-instruction.shtml
...
# College Landing Page Instruction

## Introduction

To start creating content for your website, go to the top left corner next to the site menu, and click on the Add Content button. Next, click on the Entity folder button and choose the College Landing Page template.

![](../img/col-landing-page-addcontent.png)

This checklist breaks down each element of the new CPP web template for the [College Landing Page](https://www-test.cpp.edu/green-and-gold/mockups/college-landing-page.shtml).
...
* [Carousel Cards](../module-instructions/carousel-cards.shtml)
* [Carousel Cards (Optional)](../module-instructions/carousel-cards.shtml)
* [Featurettes](../module-instructions/featurette.shtml)
* [Bronco Highlights](../module-instructions/bronco-highlights.shtml)
* [Featurettes (Optional)](../module-instructions/featurette.shtml)
* [News Feed](../module-instructions/news-feed.shtml)
* [Featured Events Content](../module-instructions/featured-events.shtml)
* Module (Optional)
* [Call to Action](../module-instructions/call-to-action-cards.shtml)
