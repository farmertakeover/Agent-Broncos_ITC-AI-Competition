**Source:** http://www.cpp.edu/cafe/teaching-and-learning/course-formats.shtml
...
1. **Determine your course mode designation:** [Cal Poly Pomona Instruction Modes](https://www.cpp.edu/studentsuccess/guides/instruction-modes.shtml) explains the differences between Face-to-Face, Synchronous, Asynchronous, Hybrid (synchronous or asynchronous), and HyFlex course formats at Cal Poly Pomona.
2. **Write or update course learning objectives:** Learning objectives communicate to students what they are expected to learn, and also provide guidance for you, the instructor, for measuring and describing students' mastery of course content. Clear learning objectives contribute to transparency and fairness in a course.  Use the [Revised Bloom’s Taxonomy of Measurable Verbs](blooms-taxonomy.shtml) to help build clear and measurable learning objectives.
3. **Write an Aligned Course Plan:** Ensure that your course activities and assessments really reflect what you want your students to learn by using this [Course Plan Worksheet template](../documents/alignment-worksheet.doc) (doc).
4. **Plan Out the Interactions Your Students Will Experience:** Include a combination of all [three types of interaction](https://canvas.ucdavis.edu/courses/34528/pages/types-of-interaction?module_item_id=4974) (Student-Content, Student-Instructor, and Student-Student) in your course for an impactful learning experience.
5. **Consider Flipping Your Class:** By having students review lecture material before coming to class you free up valuable in-class time for interaction, active learning, and problem-solving.  Learn more at the [Flipped Learning Network](https://flippedlearning.org/definition-of-flipped-learning/)

### Build

1. **Use Canvas to Conduct Your Course:** Canvas is Cal Poly Pomona’s official Learning Management System. Canvas helps students to stay connected with their instructors and classmates, and can be used to support any course format. At a bare minimum, instructors should use Canvas to share the [course syllabus](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-use-the-Syllabus-as-an-instructor/ta-p/638), communicate with students regularly via announcements or the Canvas in-box, and to keep [student grades](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-use-the-Gradebook/ta-p/701) updated.
2. **Use the QLT Course Template to Effectively Structure Your Canvas Course:** Add the Quality Learning and Teaching (QLT) Course Template to your courses from the Canvas Commons by logging-in to [Canvas](https://canvas.cpp.edu/) and select the Commons button from the left menu, then search for “CPP QLT Template.” You can import the QLT template from there.  Contact canvas@cpp.edu for help if needed.
3. **Use the Canvas Rich Content Editor to Build Rich Learning Experiences:** The [Rich Content Editor](https://community.canvaslms.com/t5/Canvas-Basics-Guide/What-is-the-Rich-Content-Editor/ta-p/12) in Canvas makes it easy to share text, images, videos, documents, and more with your students.
4. **Use Kaltura and Kaltura Capture to Share and Create Video Content:** Kaltura is the official video streaming service for Cal Poly Pomona.  View CAFE’s [Kaltura, Technology Tutorial](https://streaming.cpp.edu/media/1_k1ovs5d6/) video to learn more.
5. **Ensure Your Course Materials Are Accessible:** Visit CAFE’s [Creating Accessible Instructional Materials](accessible-instructional-materials.shtml) page to learn more about making accessible Word documents, Powerpoints, PDFs, and websites.

### Teach

1. **Introduce Yourself and Your Course:** Personalizing your online presence helps to build a relationship with your students, especially in remote courses.  One great way to do this is by providing an intro video.  View MediaVision’s [Video Quality - Tips and Tricks](https://streaming.cpp.edu/media/0_m72xsjtl) to get started.
...
3. **Use Active Learning Techniques:** This document of [101 Interactive Techniques](https://www.csulb.edu/sites/default/files/document/content_fcpd_101_tips_teaching_strategies.pdf) gives a lot of options for getting students engaged.  Pick a maximum of 3 techniques and try integrating them into your course.
4. **Use Authentic Assessments:** At CPP we pride ourselves on “learn by doing,” so ensure that your assessments ask students to actually *do* something. Indiana University’s [Authentic Assessment](https://citl.indiana.edu/teaching-resources/assessing-student-learning/authentic-assessment/index.html) page gives a good primer on how to create assignments that match our polytechnic credo.
5. **Consider Best Practices:** Check out UNLV’s [Teach Online: Best Practices and Research](https://www.unlv.edu/teach-online/best-practices) for more strategies and techniques to improve your course.

![](../img/general/divider.png)

## Top Hybrid Course Resources

* [California State University Quality Learning & Teaching (QLT) Rubric](https://ocs.calstate.edu/rubrics/qlt). This rubric supports and identify exemplary practices for online and blended courses. It is relevant for face to face courses as well.  See also the [Quality Matters Course Design Rubric](https://ocs.calstate.edu/rubrics/qm), the inspiration for QLT.
* [CSU Flexible Course Experience Institute](https://canvas.cpp.edu/courses/28454).  Created by Dr. Kevin Kelly for the CSU, housed in Canvas.  Requires CPP log-in.
* Books at Cal Poly Pomona: Online access, log into [MyCPP](https://my.cpp.edu/) to access.
* [Small Teaching Online: Applying Learning Science in Online Classes](https://ebookcentral.proquest.com/lib/csupomona/detail.action?docID=5780349).  Darby, F., & Lang, J. (2019).  Jossey-Bass.
* [Conquering the Content: A Blueprint for Online Course Design and Development](https://ebookcentral.proquest.com/lib/csupomona/detail.action?docID=1794063).  Smith, R. (2014).  John Wiley & Sons.
...
![illustration with woman on laptop holding a start button with a rocket launching off of it](../img/teaching-learning/design.svg)

### Design

[Basics of Course Design](../teaching-and-learning/getting-started.shtml)
[Inclusive & Equitable Teaching](../teaching-and-learning/inclusive-teaching.shtml)
[Teaching in Different Formats](../teaching-and-learning/course-formats.shtml)
[Creating Accessible Courses](../teaching-and-learning/accessible-instructional-materials.shtml)
[Bloom's Taxonomy](../teaching-and-learning/blooms-taxonomy.shtml)

---

![illustration of woman using a laptop](../img/teaching-learning/build.svg)

### Build

[Teaching in Different Formats](../teaching-and-learning/course-formats.shtml)
[Creating Accessible Courses](../teaching-and-learning/accessible-instructional-materials.shtml)
[Flexible Teaching for Emergencies](../teaching-and-learning/teaching-for-emergencies.shtml)

---

![Illustration of a network of people around the world](../img/teaching-learning/teach.svg)
...
![Illustration of a woman using a cellphone with chat icons around her](../img/teaching-learning/improve.svg)

### Improve

[Inclusive & Equitable Teaching](../teaching-and-learning/inclusive-teaching.shtml)
[Reflective Teaching](../teaching-and-learning/reflective-teaching.shtml)
