**Source:** https://www.cpp.edu/sci/cemast/students/how-to-become-a-teacher.shtml
...
![](../img/banners/bannerhowtoteacher.png)
...
Candidates must submit their university application as a graduate student seeking a teaching credential online at [Cal State Apply](https://www.calstate.edu/apply).

[Tuition and Fees Schedule](https://www.cpp.edu/student-accounting/tuition-fees/credential.shtml)

[Credential Cost Overview](https://www.cpp.edu/financial-aid/credentials/prospective/costs.shtml)

## STEP 2:  Credential Program Admission Forms and Requirements

**[Credential Program Application](https://www.cpp.edu/ceis/credential-program/admission/program-application.shtml "Application"):** Complete the online credential program application form by the established deadline. There is a $25 application processing fee.  Payments can be made to the Cashier’s Office or via BroncoDirect.

**Program Application Checklist:** Applicants must use the [Program Application Checklist (PDF)](../doc/program_application_checklist.pdf) to ensure all requirements are met.

**Certificate of Clearance (Application and Fingerprints):** A copy of a Certificate of Clearance document granted by the California Commissions on Teacher Credentialing (CTC) must be submitted as part of the program admissions process.  A California Teaching Credential or Emergency Permit may be submitted in lieu of the Certificate of Clearance.  The issuance date must not exceed 5 years.  A copy of your document can be downloaded and printed from the [CTC website](https://www.ctc.ca.gov/credentials/submit-online "CTC") within 60 days of your application submission.

**Subject Matter Competence:**  **Subject matter competency is required of all students**  **prior to program admission.** All candidates must verify subject matter competency through 1) completion of an academic major in the subject area of the credential being sought 2) completion of coursework addressing each of the Commission-adopted subject matter domains 3) completion of CSET exam(s) or 4) completion of a combination of coursework and examination(s) that meets or exceeds the subject matter domains.  Submit the [Subject Matter Competency Requirement Verification Request](https://engage.cpp.edu/register/?id=a6281279-9b73-428a-92b5-76039a63a4ba) form for a review of your options.   Please refer to [Commission on Teacher Credentialing](https://www.ctc.ca.gov/credentials/leaflets/Single-Multiple-Subject-Credentials-%28CL-560C%29) website for more information.

We know this can be confusing so please contact your [Faculty Advisor](https://www.cpp.edu/ceis/credential-program/faculty-advisors.shtml) to set up an advising appointment.  In addition, you can contact the [Single Subject Credential Analyst](https://www.cpp.edu/ceis/credential-program/contact-us.shtml "Credential Analyst") in the College of Education with further questions.

For FREE CSET prep resources go to [Resources for Prospective STEM Teachers](../resources/resources.shtml "Resources") page  .

**Waivers:**

* [Chemistry (PDF)](../doc/chemistry-waiver.pdf)
* [Earth Science (PDF)](../doc/earthscience.pdf)
* [Foundational Science (PDF)](../doc/flgs-waiver.pdf)
* [Life Science (PDF)](../doc/lifescience.pdf)
* [Mathematics (PDF)](../doc/math-waiver.pdf)
* [Physics (PDF)](../doc/physics-waiver.pdf)

**Mix & Match Waivers:**

* [Chemistry Mix & Match (PDF)](how-to-become-a-teacher1/chemistrymixandmatch.pdf)
* [Earth Science Mix & Match (PDF)](how-to-become-a-teacher1/earthandspacesciencemixandmatch.pdf)
* [Physics Mix & Match (PDF)](how-to-become-a-teacher1/physicsmixandmatch.pdf)
* [Foundational Science Mix & Match (PDF)](how-to-become-a-teacher1/foundationalmixandmatch.pdf)
* [Life Science Mix & Match (PDF)](how-to-become-a-teacher1/lifesciencemixandmatch.pdf)

**Early Field Experience (EFE):**  Prior to admission into the Credential Program, each credential candidate must have participated in supervised Early Field Experience (EFE) with children at or close to the age range that students intend to teach. This experience must have taken place within the last four years and must consist of at least 45 clock hours of paid or volunteer experience. Submit the [Early Field Experience Verification form (PDF)](../doc/early-field-verification-form-rev8-21.pdf) with credential program application.
...
**Student Program Plan:**  Contact your [Faculty Advisor](https://www.cpp.edu/ceis/credential-program/faculty-advisors.shtml) to complete a Student Program Plan.
...
**Orientation:** All teacher candidates must attend an orientation online or view a pre-recorded orientation video.  Visit the [Orientation page](https://www.cpp.edu/ceis/credential-program/orientation.shtml) to view dates and times.
...
## STEP 3:  Complete Credential Coursework
...
**Complete and submit the [Clinical Practice application form](https://engage.cpp.edu/register/?id=575e3e5e-d084-4dff-b820-2ab0a2f14781) by the established deadline.**

## STEP 4:  Complete Directed Teaching Coursework
...
Complete and submit the [Credential Recommendation Form](https://engage.cpp.edu/register/credential_recommendation).

Complete the [CSU Exit Survey](https://www.csuexitsurvey.org/).
...
                                      pmbeardsley@cpp.edu                              ccrunnalls@cpp.edu

[Basic Credential Orientations](https://www.cpp.edu/ceis/credential-program/orientation.shtml)

[Commission on Teacher Credentialing - Roadmap to Teaching](https://www.ctc.ca.gov/credentials/roadmap-to-teaching)

![teacher and students](../img/mtf.png)

## Click below to learn more about how to become a math or science teacher.

[YouTube Video](https://www.youtube.com/watch?v=REhP4KUeVy4)

[PowerPoint (PDF)](../how_to_become_a_math_or_science_teacher_11.6.24.pdf)

## Transfer Students

CEMaST works closely with community colleges to assure a clear pathway to the teaching pipeline.  CEMaST and PolyTransfer will support students by working one-on-one in developing an efficient transfer process for student success.  CEMaST advisors will develop a program plan for the teaching credential and provide support and resources including recommending scholarship and fellowship opportunities.  Contact cemast@cpp.edu to setup an advising appointment.

Click on the link to learn how CEMaST works with transfer students.

[PowerPoint (PDF)](how-to-become-a-teacher1/transferstudents1.pdf)

## Costs/Additional Financial Assistance

[Tuition and Fees Schedule](https://www.cpp.edu/student-accounting/tuition-fees/credential.shtml)

[Credential Cost Overview](https://www.cpp.edu/financial-aid/credentials/prospective/costs.shtml)

[Aid Programs for Credential Students](https://www.cpp.edu/financial-aid/credentials/prospective/aid-programs.shtml)
