**Source:** http://www.cpp.edu/studentsuccess/bronco-advising-center/undeclared/faqs.shtml
...
### Can I graduate in 4 years by starting as Undeclared?
...
### How do I contact the major I'm interested in?

Contact the [department chair](https://https://www.cpp.edu/faculty-affairs/about-us/dept-chairs-deans-dir.shtml) or an [academic advisor](../../directories/advising-directory.shtml) in the major you're interested in.

### How do I declare a major?

In collaboration with your advisor, you'll follow the [Major Declaration Guide](major-declaration/index.shtml) to meet the major declaration requirements and submit your Change of Major petition.
...
### When can I declare a major? Is there a deadline?
...
All undeclared students are required to meet with the Undeclared advisor at least once per semester before registering for the following term. You will get a hold on your account every semester to remind you to meet with the undeclared advisor. You can make an appointment through [CPP Connect](../../cppconnect/index.shtml). The Undeclared Advisor is located in the Student Services Building (first floor, blue counter). You will check in with the Bronco Advising Center.

## Frequently Asked Questions For Exploratory Students

### As an Exploratory student, where do I go for advising?

First, you will need to meet with your [current academic advisor](../../directories/advising-directory.shtml) and share your interest in changing majors. You will then meet with the Undeclared, Exploratory and Pre-Health Professional Advising Coordinator for further advising on the requirements to change your major.

### What if I choose a major and realize that I have made the wrong decision?
