**Source:** http://www.cpp.edu/veterans/interruptions.shtml
...
If you are called to active duty, you should notify the Veterans Resource Center that you have been deployed. This does not apply in situations where notice is precluded by military necessity or would compromise national security.
...
To resume studies, you must notify the Veterans Resource Center at vetquestions@cpp.edu. Then, you should schedule a meeting with your advisor and establish an academic plan for the completion of your degree.
...
A leave of absence, for reasons other than military, is also permitted after at least one semester of enrollment.  As with other leaves, you should discuss such a request with the Veterans Resource Center.

More information about [military leave of absence](https://catalog.cpp.edu/content.php?catoid=57&navoid=4363) is available on the University Catalog page. To submit a Leave of Absence visit the  [Registrar's Office](https://www.cpp.edu/registrar/forms/forms.shtml) website.

For military leave that is less than 30 days, review the [Accommodations of Military Student Service Obligations (Less than 30 Days) policy](https://catalog.cpp.edu/content.php?catoid=57&navoid=4363#military_leave_of_absence) on the university catalog for more information.
