**Source:** http://www.cpp.edu/research/internal-funding-opportunities/sirg.shtml
...
Priority consideration will be given to proposals with strong potential to secure major interdisciplinary contracts or grants consistent with Cal Poly Pomona's [Mission and Vision](https://www.cpp.edu/strategicplan/).

### **Proposals Submission**

Applications must be submitted through [InfoReady](https://cpp.infoready4.com/).
...
4. **Project Narrative (a maximum of five pages)**  The narrative should be written for an **educated general audience** and must include the sections using the headings below:.
   ...
   * **Alignment with Cal Poly Pomona’s Mission and Vision**  Briefly describe how the proposed activity relates to one or more core values of CPP's [Mission and Vision](https://www.cpp.edu/strategicplan/).
...
* Relevance of the proposed project to the core values of Cal Poly Pomona [Mission and Vision](https://www.cpp.edu/strategicplan/);
