**Source:** http://www.cpp.edu/registrar/student-records/ferpa.shtml
...
Students have the following rights and guarantees under FERPA, except where pertinent laws apply. The forms for requests to access these rights are located on the Registrar’s Office website, under the [Academic Forms](../forms/forms.shtml).
...
[**\***FERPA Student Privacy Rights Annual Notification (PDF)](../forms/ferpa-student-privacy-rights-annual-notification.pdf)

CPP students may grant their parents and/or other individuals' access to their education records by completing the *FERPA Authorize to Release* via their BroncoDirect Student Center and indicating the type of records that may be released to them within the indicated ed timeframe.  Click here to view the [How to Complete a FERPA Authorize to Release (PDF)](https://www.cpp.edu/registrar//forms/how-to-complete-a-ferpa-student.pdf) for instructions.
...
For more information on FERPA, please view  the [Family Educational Rights and Privacy Act](https://catalog.cpp.edu/content.php?catoid=57&navoid=4363#ferpa) policy on the catalog, contact the Registrar’s office at registrar@cpp.edu or call us at (909) 869-3000.
...
### What Access Do Parents Have to Student Information?
...
**Question 1: Can a parent who is not listed as a FERPA-authorized individual be part of a conversation with a student?**
...
**Question 2: Is it a FERPA violation to use candid student photos on social media?**
...
**Question 3: What kinds of third parties might receive a student’s 'directory information' without consent?**
...
**Question 4: Why is a student's name and email considered 'directory information' if it could be used to identify or locate someone?**
