**Source:** https://www.cpp.edu/agriscapes/childrens-garden/bugs.shtml
...
![flower with butterflies, wasp, lady bug, fly, and praying mantis around it](../img/bugs.jpg)

## Good Bugs and Bad Bugs Know the difference between beneficial and pest species

When it comes to bugs, we almost always think of them as being scary and harmful. But not all bugs are bad. In fact, there are many beneficial bugs that play an important role in the health of your garden. These bugs can limit pests by eating them, they can work to pollinate flowers, and they can help fertilize the soil by breaking down dead material.

![fun fact](../img/lightbulb.png)

Insects are the most diverse group of organisms in the world.

Learn and have fun while doing the activities below:

[![student in front of good bug or bad bug sign](../img/bugs-video.png)

## Good & Bad Bugs Video](https://vimeo.com/407022878)

[![different bugs on the lawn](../img/sort-bugs-game.png)

## Sort the Bugs Ge](https://www.pestworldforkids.org/games/sortthebug/index.html)

[![word search game](../img/insect-wordsearch.png)

## Insect Word Search](/agriscapes/docs/wordsearch-insects.pdf)

[![crafting person](../img/craftinsect-video.png)

## Craft an Insect Video](https://www.youtube.com/watch?v=2O7RV-4zYRs&list=PLw2cuKNQvZ2d9b3Wqhu32dkjX28qokaiA&index=73)
