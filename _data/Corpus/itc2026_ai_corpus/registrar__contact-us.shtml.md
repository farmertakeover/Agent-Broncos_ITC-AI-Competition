**Source:** http://www.cpp.edu/registrar/contact-us.shtml
...
[Join the Registrar's Office Queue!](https://cppedu.app.qless.com/kiosk/6e7db6e0-0f75-4418-b09e-0702b3d28503?locale=en)
...
* **N****OTE****:** If you are requesting a Zoom drop-in, you must use the link below (Join the Queue). The text option is only for in person drop-ins.
* I**f** **you don’t receive a Zoom link via text after checking in: Call** (**909) 869–3000** or Email  registrar@cpp.edu for assistance.

Join our queue

| ![Virtual drop in Zoom or In-Person](img/ro_virtual_drop_in.jpg) |
| --- |

### Live Chat through Chatot
...
![Billy bronco chatbot](img/bronco-billy_chatbot.jpg)
...
### Student & General Inquiries via Email
...
Also, we offer a variety of [**online resources**](https://my.cpp.edu/uPortal/f/home/normal/render.uP)and **[forms](https://www.cpp.edu/registrar/forms/forms.shtml)** to support you in your academic journey at CPP.
...
![bld-121-map.png](img/bldg-121-map.png)

## How Are We Doing?

If you have any feedback regarding the quality of our service, click the link: [let us know](https://forms.office.com/Pages/ResponsePage.aspx?id=HqZLFuw5XU-J_6ofAKUhtALfAHtQJlFIq-EkKDpEQDFUQlc4OFBPVkhSMkMyMzJPUzcwT0xHNFRSUiQlQCN0PWcu).
