**Source:** https://www.cpp.edu/sci/biological-sciences/students/declare_faq.shtml
...
## How to Declare/Change my Major?
...
**Step One:** Complete a Department Advising Worksheet: **[MSWord format](https://www.cpp.edu/~sci/biological-sciences/docs/advising/ac_adv_worksheet_20051024.doc)**; **[pdf format](https://www.cpp.edu/~sci/biological-sciences/docs/advising/ac_adv_worksheet_20051024.pdf)**
...
Please read the University **[Double Majors Policy (pdf)](https://www.cpp.edu/academic-manual/1400-1499-academic-standards-regulations/policy_1444_change_of_major_and_double_majors-2022.july.pdf)**. Basically, you are allowed to request a second major if you could complete both majors **within 48 units** above the units required for your primary major.
...
Click **[here](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml)** to access a list of the all of the Cal Poly Pomona minors with links to the Catalog with more information about course requirements.

**How to Declare a Minor**

**Step One:** Click [here](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml) or search the University Catalog to review the minor course requirements. Email or make an appointment to meet with the [designated faculty advisor](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml) for the minor program if you have any questions about the minor course requirements.

**Step Two:** To declare a minor please review the video explaining the **[Steps to Declaring a Minor](https://www.cpp.edu/studentsuccess/directories/declaring-a-minor.shtml)** or read the **[Guide to Add or Change a Minor (pdf)](https://www.cpp.edu/registrar/forms/change-of-minor-in-broncodirect-bpg-for-students_june-2023.pdf)**

**Step Three:** Request to add, change or drop a minor in your [BroncoDirect Student Center](https://my.cpp.edu). Beginning June 2023, you can also use [BroncoDirect](https://my.cpp.edu) to change your elective selections and/or submit minor course substitutions.
