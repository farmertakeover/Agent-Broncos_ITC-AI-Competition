**Source:** https://www.cpp.edu/tree/pride/resources/lbtq-terminology.shtml
...
## *For a more in depth, comprehensive guide, please refer to [The A - Z of Gender and Sexuality: From Ace to Ze](https://https//drive.google.com/file/d/19rHDkCHVFUcVIBbd21U8IQGBlXDlSndF/view?usp=sharing)by Morgan Lev Edward Holleb. The definitions on this page are from, or informed by, this work.*
...
Furthermore, note that no identity has one singular, concrete defintion. Identities and language are fluid, and they continue to develop, shift, and evolve with the time. The knowledge presented here is simply our most educated and informed knowledge at the present time of writing.
