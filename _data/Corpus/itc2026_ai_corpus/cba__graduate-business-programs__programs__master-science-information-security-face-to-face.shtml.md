**Source:** https://www.cpp.edu/cba/graduate-business-programs/programs/master-science-information-security-face-to-face.shtml
...
# Information Security (Face-to-Face Program)

## Master of Science - MSIS | Graduate

![Student programming server in Mitchell C Hill data center](../img/msis-hybrid-24.jpg)

## Quicklinks

[Home](https://www.cpp.edu/cba/)
[CIS Department](https://www.cpp.edu/cba/computer-information-systems/index.shtml)
[Faculty](https://www.cpp.edu/cba/graduate-business-programs/programs/msis-faculty.shtml)
...
Cal Poly Pomona has long been at the forefront of InfoSec education since the 1970s. Our program has been designated as a National Center of Academic Excellence in Cyber Defense (ACE-CD) by the National Security Agency. Combined with our STEM designation (CIP Code: 11.0103), AACSB accreditation, continuously updated and industry-relevant curriculum, Cal Poly Pomona stands as a premier institution for cybersecurity education.
In this face-to-face MSIS program, classes are offered in hybrid mode with both face-to-face and online components. International students can stay in the U.S. while pursuing this program.

$120,360

Median salary for Information Security Analyst

2023 U.S. News Best Jobs Report
...
[Sign Up](https://www.cpp.edu/cba/graduate-business-programs/forms/msis-rfi.shtml)
...
[See Course Catalog](https://www.cpp.edu/cba/graduate-business-programs/programs/msis-curriculum-face.shtml)
[Visit Advising](https://www.cpp.edu/cba/faculty/msis-faculty.shtml)
[Info Session](https://www.cpp.edu/cba/graduate-business-programs/schedule.shtml)
[Tuition / Fees](https://www.cpp.edu/cba/graduate-business-programs/costs/msis-costs.shtml)

![-- Insert Alt Text --](../img/srusthi-ghotikar.jpg)

> “The MSIS program was aligned well with industry requirements and we often had opportunities to pursue professional certificates as part of the course. Today, I work full-time as a cybersecurity analyst, and the opportunities, mentorship, and inclusive...
...
* Prerequisites
  ...
  |  |  |
  | --- | --- |
  | **Area** | **Sample Course (similar course is acceptable)** |
...
* English Proficiency Test (only for Applicants with prior degrees conducted not in English)
  ...
  TOEFL (if required) 213 Computer Based, 550 Paper Based, 80 Internet Based, or IELTS 6.5, or Duolingo Score: 105, or CPELI level 6 Details can be found at [https://www.cpp.edu/cpeli/](https://www.cpp.edu/cpeli/ "https://www.cpp.edu/cpeli/").
* For a complete list, visit our [Admission Requirements page](https://www.cpp.edu/cba/graduate-business-programs/programs/msis-requirement.shtml).
...
* [SWIFT](https://www.calpolyswift.org/): focuses on cybersecurity, networking, and system administration.
* [FAST](https://www.cppfast.org/): focuses on digital forensics, cyber crime, and cybersecurity.
* [MISSA](https://www.calpolymissa.org/): focuses on information auditing and data analytics.
...
[Request Information](https://www.cpp.edu/cba/graduate-business-programs/forms/msis-rfi.shtml)
