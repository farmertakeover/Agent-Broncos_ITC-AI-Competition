**Source:** http://www.cpp.edu/env/landscape-architecture/degrees-admissions/minor.shtml
...
![Landscape architecture first-year site design for Spring 2018 finals review](../img/minor-landscape-architecture-jumbotron.jpg)
...
[Three general education (GE) courses offered by the department](http://www.cpp.edu/~env/programs/ge-courses.shtml "General Education Courses (opens in new window)")  count towards the 24-unit requirement to achieve the Landscape Architecture Minor Award. The program is a mix of applied skill-building and theory that involve forays into geographic information systems (GIS), plant science, visual communication, and design history.
...
**Barry Lehrman**
Professor and LA Minor Advisor
Department of Landscape Architecture
blehrman@cpp.edu

## Curriculum

![](../img/la-aqueduct-field-trip.jpg)
