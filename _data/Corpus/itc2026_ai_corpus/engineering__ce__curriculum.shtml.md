**Source:** http://www.cpp.edu/engineering/ce/curriculum.shtml
...
# BSCE & BSCEM Curricula

![Steel Bridge](/engineering/ce/img/img_97931.jpg)

## Curriculum Sheets and Course Descriptions

Flow Charts and [Curriculum Sheets](https://www.cpp.edu/~academic-programs/academic-advising/tools/sheets-roadmaps/index.shtml) show the specific course requirements for each degree and are available on the Current Students page of the CPP website.

Detailed course descriptions are available in the [University Catalog](https://catalog.cpp.edu/).
...
### Which curriculum sheet and flow chart should I use?

Normally, you should use the one that was in effect during your first semester as a civil engineering student at Cal Poly Pomona. If you change options, the curriculum year does not change (i.e., if you are on the 2019-20 general option curriclum sheet and change to the environmental option, then you will be on the 2019-20 environmental option curriculum sheet). However, the curriculum year does change when you change majors (i.e. if you started at Cal Poly Pomona in Fall 2018 and changed major to civil engineeing in Fall 2019, then you would be on the 2019-20 curriculum sheet.

### May I change to a different curriculum sheet?

Upon request, any student can change to any of the following curriculum sheets: 1) The one that was in effect at the the time the student began continuous attendance at any CSU campus or California Community College; or 2) The one that was in effect during the student's first semester at Cal Poly Pomona; or 3) The one in effect at the time of graduation. See the [Request for Curriculum Year Change](http://www.cpp.edu/~registrar/forms-services/index.shtml) form for more details, and submit this form to change your curriculum year.

### What is the difference between a prerequisite and a corequisite?

A prerequiste is a course that must be completed before taking the next course. A corequisite is a course that can either be taken before or concurrent with a certain course. Some classes are mutual corequesites for one another and must be taken concurrently. For example, lecture and lab courses are typically mutual corequisites.

### Are all prerequisites and corequisites shown on the flow charts?

No. Please check the course descriptions in the univesity catalog for a complete list of prerequisites and corequisites. In some cases, a minimum grade is required in a prerequisite.

### Can I take two courses concurrently, one of which is a prerequisite for the other?

No.

### Can I substitute work experience or co-op for a certain course?
