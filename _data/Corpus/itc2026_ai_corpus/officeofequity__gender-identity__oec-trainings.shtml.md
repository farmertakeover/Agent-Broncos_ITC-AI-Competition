**Source:** http://www.cpp.edu/officeofequity/gender-identity/oec-trainings.shtml
...
* [Training and Education Request - Online Form](https://forms.office.com/Pages/ResponsePage.aspx?id=HqZLFuw5XU-J_6ofAKUhtBHm2tUotExClj1V9MKlj7tUREJXODNCWFdCTkVWSDdKTFVGTk1GUDVXNi4u)

## Pure Praxis training at Cal Poly Pomona

Pure Praxis is a social theater group that creates cultural change through interactive, scenario-based training. Pure Praxis replaces lectures with engaging performances that spark conversation, invite audience participation, and allow participants to practice real-world intervention strategies. Since 2015, Pure Praxis has helped transform mandatory trainings into memorable experiences that inspire meaningful change.

![pure praxis brochures on table](../img/pure-praxis-brochures-on-table.jpg)

![pure praxis actors on stage](../img/pure-praxis-show-1.jpg)

![pure praxis actor engaging with cpp students](../img/pure-praxis-show-2.jpg)

![pure practice actors on stage](../img/pure-praxis-show-3.jpg)
