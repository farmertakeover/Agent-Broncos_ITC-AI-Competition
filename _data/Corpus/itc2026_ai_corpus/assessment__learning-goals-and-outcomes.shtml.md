**Source:** http://www.cpp.edu/assessment/learning-goals-and-outcomes.shtml
...
### Institutional Learning Goals (ILGs)](#modal-0 "Institutional Learning Goals (ILGs) ")
...
### GE Student Learning Outcomes (GE SLOs)](#modal-1 "GE Student Learning Outcomes (GE SLOs)")

### GE Student Learning Outcomes (GE SLOs)

×

**GE Meaning and Purpose Statement (GEMPS)**
...
*Adopted by the Academic Senate, Fall 2019*
...
*Adopted by the Academic Senate, Spring 2023*

[*Learn How GE Student Learning Outcomes are Assessed*](institutional-assessment-results.shtml)

Close

[![cpp architecture student building model ](img/env-design.png)

### Curriculum Matrices](#modal-2 "Curriculum Matrices ")

### Curriculum Matrices

×

**Curriculum matrices** are tables that map the alignment between specific courses in a program’s curriculum with desired program learning outcomes.

To view a program's Curriculum Matrix, please click [here](https://livecsupomona.sharepoint.com/%3Au%3A/r/sites/aprstaff/SitePages/OAPR%20Assessment%20Plans%20%26%20Curriculum%20Matrices.aspx?csf=1&web=1&e=dguvRf).

If you are having trouble locating your program's Curriculum Matrix, please email us at apr@cpp.edu.
