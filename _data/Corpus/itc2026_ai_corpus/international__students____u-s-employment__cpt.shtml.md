**Source:** https://www.cpp.edu/international/students//u-s-employment/cpt.shtml
...
*CPT workshops will resume August 14.*

## Application Overview

### **Apply**

1. **Student submits the**[**CPT Clearance form**](https://www.cpp.edu/international/students/isso-forms/index.shtml)**.**

[View](https://www.cpp.edu/international/students/img/cpt-guidlines.pdf) Curricular Practical Training (CPT) Clearance form Application Guidelines

(Please note that I will attach an updated version of the CPT clearance form application guidelines for “view”.)

2. **Academic Advisor reviews the submission**
3. **International Student Advisor reviews the submission.**

**Allow 3-5 business days.**

4. **Student receives a decision via email**
...
##### Please not that the ISSO is unable to provide tax related advising. See [U.S. Taxes](https://www-test.cpp.edu/international/students/living-pomona/taxes.shtml) for more information.
...
If an employer has questions about documentation required for I-9 purposes, please refer them to U.S. Citizenship and Immigration Services’ [“I-9 Central” webpage](https://www.uscis.gov/i-9-central), including the section about [international students with training authorization](https://www.uscis.gov/i-9-central/acceptable-documents/additional-documentation-requirements/additional-documentation-requirements).
