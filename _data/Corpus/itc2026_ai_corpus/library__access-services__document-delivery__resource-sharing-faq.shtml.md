**Source:** http://www.cpp.edu/library/access-services/document-delivery/resource-sharing-faq.shtml
...
* [What is Interlibrary Loan?](#what)
* [Who can use Interlibrary Loan services?](#who)
* [What is the difference between CSU+ and Interlibrary Loan (ILLiad)?](#difference)
* [Which service is right for me?](#which-one)
* [Does it cost anything?](#cost)
* [What if I lose or damage the materials?](#lose)
* [Is there a limit of requests I can make?](#limit)
* [How long do the services take?](#how-long)
* [How will I be notified?](#notified)
* [What is the duration of the loans?](#duration)
* [Can I renew my requests?](#renew)
* [How do I check the status of my request?](#status)
* [What does the status of my request mean?](#request-status)
* [What else should I know about Interlibrary Loan?](#what-else)
* [How do I return materials?](#return)
* [Is security a problem if I use a public workstation?](#security)
* [Why don't I see all my older Interlibrary Loan requests when I look at my request history?](#history)
* [What is Electronic Delivery?](#e-delivery)
* [Who can assist me with further questions?](#assist)

---

## What is Interlibrary Loan?

Interlibrary Loan is a process by which a library borrows material from or supplies material to another library. The CPP University Library offers two services: CSU+ and [Interlibrary Loan (ILLiad)](https://illiad-library-cpp-edu.proxy.library.cpp.edu/illiad/illiad.dll).

[Back to top](#top)

## Who can use Interlibrary Loan services?

Interlibrary Loan services are available to all **currently enrolled Cal Poly Pomona students, staff, faculty, and emeriti**. Interlibrary Loan requests will not be processed for patrons with a delinquent status with the library.

[Back to top](#top)

## What is the difference between CSU+ and Interlibrary Loan?

**CSU+** is an interlibrary loan consortium program that allows all 23 CSU libraries, as well as libraries outside the CSU, to exchange library resources. The patron uses [OneSearch](https://csu-cpp.primo.exlibrisgroup.com/discovery/search?vid=01CALS_PUP:01CALS_PUP&tab=Everything&lang=en&query=any,contains,&primoQueryTemp=) to request physical and digital copies.

**Interlibrary Loan** is a service that allows the patron to obtain library material not available in the CPP collection or CSU+. This service will automatically search for availability in other public and academic libraries located within the United States or internationally. The user is allowed to request books, articles, material in microform format, dissertations, theses, book chapters, etc. using the databases, OneSearch, or submitting a request manually through [ILLiad](https://www.cpp.edu/library/access-services/document-delivery/resource-sharing-faq.shtml).

[Back to top](#top)

## Which service is right for me?

Since CSU+ typically responds to requests more quickly, we advise using it first. [Interlibrary Loan (ILLiad)](https://illiad-library-cpp-edu.proxy.library.cpp.edu/illiad/illiad.dll) requests should be used as a backup for the items that cannot be supplied through CSU+.
...
## What if I lose or damage the materials?
...
## Is there a limit of requests I can make?

Cal Poly Pomona faculty, staff, and students are encouraged to be judicious in making requests via interlibrary loan.

Patrons are limited in the number of "active" requests that they may have at any one time.  An "active" request—whether physical or digital—includes any request that has a status of:  Request sent, Customer notified via e-mail, Checked out to customer, In transit, and/or Delivered to web. Your 'active' requests can be seen through your ILLiad account. The limits on active requests at any one time are as follows:

| **Service** | **Request Limits** |
| --- | --- |
| CSU+ | 10 items |
| Interlibrary Loan (ILLiad) | * Faculty - 20 active requests * Staff - 15 active requests * Graduate - 15 active requests * Undergraduates - 10 active requests |
...
| --- | --- | --- |
| CSU+ | Books, and audio/visual material  Digital chapters and articles | 3 days - 2 weeks  24 hours M-F |
| Interlibrary Loan (ILLiad) | Any material  Digital chapters and articles | 3 days - 2 weeks  24 hours - 3 days |
...
1. Logon to the [Interlibrary Loan](https://proxy.library.cpp.edu/login?url=https://illiad.library.cpp.edu/illiad/illiad.aspx) system. The link will prompt you to Cal Poly Pomona's single-sign-on.
...
**CSU+**requests can be checked on [My Library Account](https://cpp-primo.hosted.exlibrisgroup.com/primo-explore/account?vid=01CALS_PUP). The link will prompt you to sign in with Cal Poly's single-sign-on. CSU+ requests will be found under the Requests tab.

**Interlibrary Loan** request can be checked by following the following steps:

1. Log on to the [Interlibrary Loan](https://proxy.library.cpp.edu/login?url=https://illiad.library.cpp.edu/illiad/illiad.aspx) system. The link will prompt you to Cal Poly Pomona's single-sign-on.
...
Please do not remove the identification strap from the book cover. You may return items inside the library at the 2nd Floor Circulation Desk during [Library Open Hours](https://cpp.libcal.com/hours/).  There are [two book drops](https://www.cpp.edu/library/access-services/borrowing/returning-materials-after-hours.shtml) on campus where you are welcome to return library materials while the library is closed. Please note, it takes longer to retrieve and process items in the book drops. If your item is close to the due date, we recommend returning it at the 2nd Floor Circulation Desk.
...
## Why don't I see all my older Interlibrary Loan requests when I look at my request history?
...
Many libraries ship photocopies of articles to us in electronic format. In the past, we printed these articles before delivering them to you. Now, through the Interlibrary Loan System, we are able to offer you the option of electronic delivery of these articles in PDF format (Adobe's Portable Document Format).

[Back to top](#top)

## Who can assist me with further questions?

For further assistance, please contact us at libldrs@cpp.edu, or (909)869-3111, between 8:00AM - 5:00PM, M-F. Alternatively, you can visit us at the University Library's Circulation Desk during the library's [hours of operation](https://cpp.libcal.com/hours/). If you need further assistance with your research, please contact a [Subject Librarian](https://www.cpp.edu/library/reference-instruction/contact-subject-librarian.shtml).
