**Source:** http://www.cpp.edu/class/history/research/finding-sources.shtml
...
![Research Guide Image](../img/research-guide-image.png)

## Doing Research

This research guide contains links to over 300 different digital collections, and is intended to help Cal Poly Pomona history students locate primary and secondary resources for their research, particularly for Theory and Practice of History (HST 3300) and Senior Thesis (HST 4620). It will also be helpful for any class that requires outside research. Please e-mail Dr. Rob...

[Research Guide (Word document)](https://www.cpp.edu/class/history/docs/research-guide-7-29-25.docx%20 "opens a new window")
