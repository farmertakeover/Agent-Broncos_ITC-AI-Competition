**Source:** https://www.cpp.edu/cce/faculty/cel-attribute-initiative.shtml
...
![](../img/faculty/faq-faculty.jpg)

[Faculty FAQs Guide](https://www.cpp.edu/cce/img/faculty/csu-cel-initiative-faculty-faqs.pdf "Faculty FAQs Guide. ")

![](../img/faculty/definition-faculty.jpg)

[Taxonomy & Definitions](https://www.cpp.edu/cce/img/faculty/csu-cel-taxonomy-and-definitions.pdf "Taxonomy & Definitions. ")

![](../img/faculty/sampleicon.png)

[Preview of CEL Tool Survey](https://acrobat.adobe.com/link/track?uri=urn:aaid:scds:US:de88a12e-ae4a-366e-9aa5-2a498c887ca1 "Preview of CEL Tool Survey. ")
...
1. Watch the instructional video aboveon how to complete the CEL Attribute Survey or reference the [PDF of the survey](https://documentcloud.adobe.com/link/track?uri=urn:aaid:scds:US:9d97b4a5-51bb-4ec9-835c-587806f2ee89).
2. The form captures information for one course at a time.
3. Complete the form based on how you are currently teaching the CEL course.
4. Review the [CEL Taxonomy](https://documentcloud.adobe.com/link/track?uri=urn%3Aaaid%3Ascds%3AUS%3Ae80d0d0a-5063-47a9-9f42-82d3b73511fa#pageNum=1).
5. Be prepared to spend approximately 15 minutes to complete the form.
6. Have course materials available; you may need to refer to it as you complete the survey.

## CEL Survey Tool

---

Please help us do our part in the systemwide attribute implementation pilot and complete the online survey below.

[CSU COMMUNITY-ENGAGED LEARNING TOOL SURVEY](https://app.calstates4.com/cpp/node/370326)
