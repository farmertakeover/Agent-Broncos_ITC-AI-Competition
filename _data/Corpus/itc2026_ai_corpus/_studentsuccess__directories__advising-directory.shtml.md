**Source:** http://www.cpp.edu/~studentsuccess/directories/advising-directory.shtml
...
## Where to Find Your Assigned College Advisor:

![Screenshot of Advisor box from Student Center with Billy Bronco info](../img/directories/advising-directory/advisor-box.png)

### Your BroncoDirect Student Center's Advisor Box in MyCPP

![Screenshot of Success Team box from CPP Connect with Billy Bronco info](../img/directories/advising-directory/cpp-connect-box.png)

### Your CPP Connect Homepage's Success Team Box

![Screenshot of Billy Chat text with Billy Bronco info](../img/directories/advising-directory/billy-chat.png)
...
You can view your assigned advisor's appointment or drop-in availability in [CPP Connect](https://www.cpp.edu/studentsuccess/cppconnect/index.shtml). Advisors are available in person and in virtual formats throughout the year.
...
Your College Advising Center has regular drop-in hours for quick questions.

### What can I expect from an advising session?
...
* Review your Degree Progress Report (DPR) and Curriculum Sheet to identify classes you need.
* Prepare a list of questions to bring with you and have some way to take notes.
* Always use and check your CPP email.

### How will I know if my advisor has reached out for a meeting?
...
We are confident you will get the opportunity to build a supportive and productive relationship with your advisor. If you have additional questions or concerns, email cppconnect@cpp.edu.

## Your College Advising Centers

[![Two students pick avocados](../img/directories/advising-directory/ag.png)

### Agriculture

Building 2, rooms 219 and 125](https://www.cpp.edu/agri/student-success-center/index.shtml%20 "opens a new window")

[![Two students present on a project](../img/directories/advising-directory/cba.png)

### Business Administration

Building 164, room 1060](https://www.cpp.edu/~cba/student-success-center/index.shtml%20 "opens a new window")

[![A teacher works with two children](../img/directories/advising-directory/ceis.png)

### Education and Integrative Studies

Building 94, room 275](https://www.cpp.edu/ceis/student-success-center/index.shtml%20 "opens a new window")

[![Three students work together with a surveying machine](../img/directories/advising-directory/egr.png)

### Engineering

Building 17, room 2257](https://www.cpp.edu/engineering/advising/index.shtml%20 "opens a new window")

[![A student stands with his sculpture](../img/directories/advising-directory/env.png)

### Environmental Design

Building 7, room 104A](https://www.cpp.edu/env/student-success-advising-center/index.shtml%20 "opens a new window")

[![A student puts dressing on a salad](../img/directories/advising-directory/hrt.png)

### Hospitality Management

Building 80, room 121](https://www.cpp.edu/collins/student-success-center/%20 "opens a new window")

[![A pair of students, with more students in the background, playing saxophones](../img/directories/advising-directory/class.png)

### Letters, Arts, and Social Sciences

Building 5, room 228](https://www.cpp.edu/class/student-success-center/index.shtml%20 "opens a new window")

[![A student looks at a flame](../img/directories/advising-directory/sci.png)

### Science

Building 8, room 306](https://www.cpp.edu/~sci/advising-center/index.shtml%20 "opens a new window")

[![A group of students walk together in University Quad](../img/directories/advising-directory/undc.png)

### Undeclared

Building 121, first floor (blue counter)](../bronco-advising-center/undeclared-advising.shtml "opens a new window")
...
[EOP](https://www.cpp.edu/~ssep/eop/)

[Graduate Studies Coordinators](https://www.cpp.edu/gradstudies/prospective-students/explore-our-grad-programs.shtml)

[Kellogg Honors College Advising](https://www.cpp.edu/honorscollege/index.shtml)

[International Student Advising](https://www.cpp.edu/international/students/index.shtml)

[Library Resources](https://libguides.library.cpp.edu/major)

[Pre-Medicine Advising](https://www.cpp.edu/preprofessional/index.shtml)

[Retention & Graduation Specialists](https://www.cpp.edu/studentsuccess/oss/retention-graduation-specialists.shtml)

[Student Athlete Advising](https://broncoathletics.com/sports/2012/8/13/GEN_0813124831.aspx)
