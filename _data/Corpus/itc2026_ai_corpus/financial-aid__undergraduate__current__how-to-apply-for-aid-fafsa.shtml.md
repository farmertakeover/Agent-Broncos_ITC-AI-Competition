**Source:** http://www.cpp.edu/financial-aid/undergraduate/current/how-to-apply-for-aid-fafsa.shtml
...
Your FAFSA is used to determine your eligibiliity for Federal, California State, and Cal Poly Pomona aid, and some scholarship providers may use your FAFSA information to determine whether you qualify for their awards.

When you [fill out the FAFSA](https://studentaid.gov/h/apply-for-aid/fafsa), you are applying for aid for a specific year. In order to receive aid the next year, you’ll need to submit that next year’s FAFSA. Luckily, [Federal Student Aid](https://studentaid.gov/h/apply-for-aid/fafsa) makes it easy for you by allowing you to submit a Renewal FAFSA that remembers certain information you reported the year before and places it in your new FAFSA.

The FAFSA Application becomes available every October 1st – and the priority deadline for applying is April 2 (for the 2025 – 2026 academic year, the application became available November 19, 2024 and the priority filing deadline is April 2, 2025).

Be sure to file before the priority filing deadline in order to be considered for the maximum types of aid.

***If you*** ***miss the Priority******Filing******Deadline, you will not be eligible for any CA State or Cal Poly Pomona Institutional Grants for the academic year.*** *Y**ou will**still be considered for**the Federal Pell Grants and F**ederal**Direct L**oans.*

[Apply Now - FAFSA!](https://studentaid.gov/h/apply-for-aid/fafsa)

![](../../img/fafsa-banner-final-20241.png)
...
* You must be an [eligible non-citizen](https://studentaid.gov/understand-aid/eligibility/requirements/non-us-citizens) (i.e., Permanent Resident)
...
Dependent students are required to include information about their parents on the application. By answering a few questions, you can get a good idea of which category you fit into.  Visit [Federal Student Aid’s page](https://studentaid.gov/apply-for-aid/fafsa/filling-out#dependency) on Dependency Status for information on the difference between a dependent and an independent student, and to determine your dependency status for financial aid purposes.

## **Fact Sheets**:

* English Language:  [Am I Dependent or Independent? (PDF)](https://studentaid.gov/sites/default/files/fafsa-dependency.pdf)
* Spanish Language:  [Soy alumno/adependiente o independiente (PDF)](https://studentaid.gov/sites/default/files/fafsa-dependency-spanish.pdf)?

### Reporting Parent Information

If you’re a dependent student, you’ll need to report parent information on your FAFSA. Visit Federal Student Aid’s page on [reporting parent information](https://studentaid.gov/apply-for-aid/fafsa/filling-out#parent-info) to find out who counts as your parent, what to do if you don’t live with your parents, and what to do if you don’t have access to your parents’ financial information.
...
* English Language: [Who is My Parent When I Fill out the FAFSA?  (PDF)](https://studentaid.gov/sites/default/files/fafsa-parent.pdf)
* Spanish Language: [A quiénes se les considera mis “padres” para efectos de la FAFSA? (PDF)](https://studentaid.gov/sites/default/files/fafsa-parent-spanish.pdf)
...
In order to electronically sign your FAFSA, your parent(s) will need a valid Social Security Number in order to apply for an FSA ID. If your parent is not able to apply for an FSA ID, you can print a signature page by selecting **Print Signature Page** on the “My FAFSA” or “Signature Status” page. Visit [Federal Student Aid](https://studentaid.gov/help/signing-without-fsa-id) for more details.

### What if I am unable to provide parent information due to special circumstances?
...
* [Federal Student Aid and Homeless Youth (PDF)](https://studentaid.gov/sites/default/files/homeless-youth.pdf)
* [Wards of Court, Foster Youth, Single Parents and More (PDF)](https://www.nasfaa.org/uploads/documents/2021-22_FAFSA_UniqueSituations.pdf)

### Taking the Next Steps / After the FAFSA: What Happens Next?

Completing the FAFSA is not the last step; your FAFSA has to be processed, and then you get an *Expected Family Contribution (EFC)*, which Cal Poly Pomona uses to figure out how much aid you can get. Find out more about [what happens after you fill out the FAFSA](https://studentaid.gov/apply-for-aid/fafsa/filling-out#next-steps), how to review your Student Aid Report and how to correct any errors.
...
Cal Poly Pomona Current Student Status and GPA verification

| **C****al Poly Pomona****Current Student Status** | GPA Verified by: |
| --- | --- |
| **First Year Transfer Student** | Your Former College |
| **Current Cal Poly Pomona Student with fewer than 24 total earned college units (cumulative) earned as of March 1st** | Your Former High School |
| **Current Cal Poly Pomona Student with at least 24 total college units earned - with at least one unit earned at Cal Poly Pomona as of March 1st** | Cal Poly Pomona (electronic submission to CSAC) |
| **Current Cal Poly Pomona Student with at least 24 total college units earned - with NO units earned at Cal Poly Pomona as of March 1st** | Cal Poly Pomona ([Paper GPA Verification Form](https://www.csac.ca.gov/sites/main/files/file-attachments/g4_gpa_verification_form_march_2nd_deadline_fully_ready.pdf?1603306186) required) |

Be sure you contact the appropriate school to have your GPA Verification sent to CSAC by the **March 2****nd****deadline**.  More information is available on the [CSAC Cal Grant page](https://www.csac.ca.gov/cal-grant-faq).

## **CSAC and Your WebGrants Account**

Are you wondering if your Cal Grant GPA has been received by CSAC? After you have filed a FAFSA, you can go on-line and check the status of your Cal Grant application by logging on to [WebGrants for Students](https://mygrantinfo.csac.ca.gov/) and creating an account. This secure site provides you with resources, information and tools to assist you with the college financial aid process. It will also let you view the status of your Cal Grant or Chafee Grant application, update your address, submit corrections, view your payment history, update your college of attendance, or satisfy outstanding requirements.
...
[CSAC Webgrants Information Guides](https://www.csac.ca.gov/post/accessing-and-navigating-webgrants-4-students)

### Missed the Priority Filing Deadline?

If you missed the Priority Filing Deadline (April 1st for the 2022-2023 year only), you should still complete the FAFSA Application.  Although you have missed the opportunity to be considered for Cal Poly Pomona and California State Grant funds for the year, there are other aid programs available to you.
