**Source:** http://www.cpp.edu/research/sponsored-program/sponsored-programs-faqs.shtml
...
## When and how do I contact ORSP if I'm interested in submitting a proposal to an external sponsor?
...
[Intent to Submit Form](intent-to-submit.shtml)

## When are proposals due in ORSP?
...
* [PHS 398 Facepage](../documents/phs-398-facepage.docx)
...
## The agency I am applying to limits indirect costs to 10%. What do I need to do for ORSP to accept this rate?
...
Cost-share commitments should be indicated on the [Cost Share form](https://www.cpp.edu/research/sponsored-program/docs/cost-share-form-rev-05-23-2022.pdf), and the form should indicate a valid account number (with sufficient funds) with signatures indicating approval.

## I am working with my ORSP grant administrator on a multi-year budget. How much should salaries and benefits increase each year?
...
## Now that my grant is over, what happens to the equipment and project supplies purchased from the grant?
