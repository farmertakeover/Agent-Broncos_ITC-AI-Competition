**Source:** https://www.cpp.edu/polysec/projects.shtml
...
![clear human skull model](img/neuro.jpg)

Neurophysiology & CyberSecurity

![graphic of brainwaves](img/brainwave.jpg)

Brainwave (EEG) Workbench

![white vertical lines of light](img/phishing.jpg)

Socio-technical Approach to Address Spear Phishing Attack

![cyber physical system](img/iot.jpg)
...
![Raspberry Pi on a computer screen](img/raspberrypihome.jpg)

Raspberry Pi 3 Home Network Monitoring Tool

![paper money on Android phone](img/secureanalysis.jpg)

Security Analysis of Mobile Money Applications on Android

![graphic with locks and numbers](img/inapppurchase.jpg)

Securing In-App Purchase Vulnerability in Mobile Applications

![smartphone with a chain around it](img/mobilecyber.jpg)

Experimental Support for Smartphone Security Education

![computer network with cables](img/pgv.jpg)

Preserving Data Integrity and Confidentiality in the Cloud

![graphic of a lock](img/bypassverified.jpg)

Vulnerabilities of Lightweight Operating Systems such as Chromium and Android OS

![smartphone displaying Twitter welcome](img/covertbotnet.jpg)

Covert Botnet Command and Control Using Twitter

![computer screen displaying file listing](img/studydropbox.jpg)

Implementation Vulnerability Associated with OAuth 2.0:. A Case Study on Dropbox

![smartphone displaying Facebook login screen](img/facebookprivacy.jpg)
...
## Neuro Cyber Projects

* [Neurophysiology & CyberSecurity](project/neurocyber/index.shtml)
* [Brainwave (EEG) Workbench](project/brainwave/index.shtml)
* [Socio-technical Approach to Address Spear Phishing Attack](project/phishing/index.shtml)

## CPS & IOT Projects

* [Threat Modelling of Cyber Physical Systems](project/cpsiot/index.shtml)
* [Securing the Communication of Unmanned Aerial Vehicle (UAV)](project/uav/index.shtml)
* [Raspberry Pi 3 Home Network Monitoring Tool](project/network/index.shtml)

## Android Projects

* [Security Analysis of Mobile Money Applications on Android](project/mobilemoney/index.shtml)
* [Securing In-App Purchase Vulnerability in Mobile Applications](project/iap/index.shtml)
* [Experimental Support for Smartphone Security Education](project/smartphone/index.shtml)

## Cloud Computing Projects

* [Preserving Data Integrity and Confidentiality in the Cloud](project/cloud/index.shtml)
* [Vulnerabilities of lightweight Operating Systems such as Chromium and Android OS](project/vulnchrom/index.shtml)
* [Covert Botnet Command and Control Using Twitter](project/twitterbot/index.shtml)
* [Implementation Vulnerability Associated with OAuth 2.0:. A Case Study on Dropbox](project/dropbox/index.shtml)
* [Facebook Privacy Management Simplified](project/facebook/index.shtml)
