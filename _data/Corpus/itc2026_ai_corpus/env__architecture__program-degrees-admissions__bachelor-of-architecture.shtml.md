**Source:** http://www.cpp.edu/env/architecture/program-degrees-admissions/bachelor-of-architecture.shtml
...
![Franco Mellone speaking](../img/franco-mellone.jpg)
...
[Undergraduate B.Arch Flow Chart (PDF)](../img/barch-flowchart-updated-spring25.pdf "Undergraduate B.Arch Flow Chart (opens in new window)")
...
For further information about University requirements for "impacted" majors, please refer to the Undergraduate Admissions for freshmen and for transfer student requirements:   [Office of Admissions - Impacted Majors](https://www.cpp.edu/admissions/freshmen/impacted-majors.shtml "Office of Admissions - Impacted Majors (opens in new window)").
...
For additional information on Transfer Admissions, please refer to:
 [https://www.cpp.edu/admissions/transfer/app-checklist.shtml](https://www.cpp.edu/admissions/transfer/app-checklist.shtml "https://www.cpp.edu/admissions/transfer/app-checklist.shtml (opens in window)").
...
View the [CPP/ARC Rubric](../docs/rubrics-sp2023.pdf) used to assess transfer student portfolios for placement.
...
For additional information on Incoming International Students and requirements, please refer to:
 [Apply as an International Student](https://www.cpp.edu/admissions/international/apply.shtml "Apply as an International Student (opens in new window)")
...
[Undergraduate B.Arch Flow Chart (PDF)](../docs/barc-flowchart24.pdf "Undergraduate B.Arch Flow Chart (opens in new window)")

[B.Arch Curriculum sheets can be found here](https://www.cpp.edu/academic-programs/academic-advising/tools/sheets-roadmaps/2022-2023/env.shtml "B.Arch Curriculum sheets can be found here (opens in new window)").
...
Students should consult the [Academic Programs](https://www.cpp.edu/academic-programs/ "Academic Programs (opens in new window)") website for current information regarding this requirement. Unless specific courses are required, please refer to the list of approved courses under General Education Requirements, Areas A through E.
