**Source:** https://www.cpp.edu/cafe/learning-objects
...
***Example shown:** [Thin Layer Chromatography](https://elearning.cpp.edu/learning-objects/organic-chemistry/tlc) by Dr. Laurie Starkey, College of Science*

### Colleges and Departments

Select discipline to browse:

[Agriculture](../learning-objects/agriculture.shtml)
[Business](../learning-objects/business.shtml)
[Education](../learning-objects/education.shtml)
[Engineering](../learning-objects/engineering.shtml)
[Environmental Design](../learning-objects/env.shtml)
[Hospitality Management](../learning-objects/collins.shtml)
[Letters, Arts, & Social Sciences](../learning-objects/class.shtml)
[Science](../learning-objects/science.shtml)
[Library/Other](../learning-objects/library.shtml)

### About CAFE's Multimedia Learning Objects Repository website

This website is a collection of interactive multimedia and animations that can be used to enhance a course and bring abstractions to life, as demonstrated in the example above which simulates an actual *Thin Layer Chromatography* experiment traditionally done in class. The learning objects have been developed in collaboration with faculty on campus and can be shared across multiple disciplines and other institutions. Use this website to browse and preview all the learning objects that are publicly available in our collection.

### How to Use the Learning Objects

Preview an object by clicking the **view details** button and then clicking the**link** on the pop-up window. Share this link with your students or use the embed code *(when available)* to embed it directly to your web or course page. Some objects may not have the same options or may need to be downloaded.

### Interested in Creating Something?

If you are faculty at Cal Poly Pomona who would like to request multimedia development, contact us through our multimedia development request form.

[Request Multimedia Development](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=0547f5e66fe18b007996073aea3ee499)

### License Information

Beginning 2023, all multimedia learning objects (MLOs) are licensed under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0) by [California State Polytechnic University, Pomona](https://www.cpp.edu/). Any other license information appearing on an MLO is superceded by this license.
[![creativ commons](https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1)![atribution](https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1)![non-commercial](https://mirrors.creativecommons.org/presskit/icons/nc.svg?ref=chooser-v1)![no derivatives](https://mirrors.creativecommons.org/presskit/icons/nd.svg?ref=chooser-v1)](https://creativecommons.org/licenses/by-nc-nd/4.0)
