**Source:** http://www.cpp.edu/class/psychology/graduate-program/graduate-how-to-apply.shtml
...
[![Become by doing](../img/re-25become-by-doing1.jpg)

### Admission Requirements](#modal-0 "Admission Requirement")
...
* A completed [**online application**](https://www.calstate.edu/Apply). This online application will instruct you to upload the other application materials (e.g., personal statement, letters of recommendation, unofficial transcripts)
...
Other factors such as bilingual skills, and relevant professional and life experiences will also be considered.

**Please note that we DO NOT require the GRE for admission.**

Close

[![Billy Bronco Superhero](../img/re-billy-bronco-superhero2.jpg)

### Application Materials & Deadline](#modal-1 "Letters of Recommendation")
...
Applicants who wish to be considered for Fall 2026 admission should have completed files by February 1, 2026. Please note that students from international universities must submit their application one month earlier, by January 15, 2026. Applications open on October 1, 2025.

If you want to check on the status of your application, go to [Broncodirect](https://www.cpp.edu/~broncodirect) or call the Admissions Office at (909) 869-4555. The website will give you three types of information:
...
You can also obtain more information about this program by contacting:
