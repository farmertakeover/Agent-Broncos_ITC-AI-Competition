**Source:** http://www.cpp.edu/agri/dietetic-internship-program/program-descriptions.shtml
...
Program Level:  Post-Baccalaureate Certificate
 ...
 The DI program follows a normal academic year, beginning in August and ending in June. The program consists of one week of orientation, followed by 1,010 hours of supervised practice and approximately 160 didactic hours. These hours are distributed as follows:

* 35 weeks of supervised practice, approximately 29 hours each week
...
Clinical services rotations cover conditions such as general medical/surgical, diabetes, cardiac care, nutrition support, clinical management, and clinical staff relief, and are completed at the assigned hospital. You can complete rotations in pediatrics and outpatient/counseling at another facility.
...
You will complete public health, school food service, budget, and elective rotations at non-hospital facilities.

Required Rotations include:

* Clinical 1, 2, and 3 (total of 10 to 11 weeks)
...
Elective Rotations (6 to 8 weeks total):  Interns can choose up to three rotations from the following options to meet their personal goals:
...
The dietetic internship runs from August to June each year. The internship does not strictly follow the university academic calendar. Internship winter break and spring break may be at different times than the university. Also, interns may be scheduled to work on academic holidays.

Each intern has a unique schedule and will complete their rotations in a different order. Interns will be given their schedule at orientation.  The program is designed to build on prior learning and practice experiences to progress to more advanced learning activities in rotations.

The 2025-26 internship class will start with orientation on August 13, 2025, and is due to end no later than June 5, 2026.
...
| **Date** | **Description** |
| --- | --- |
| August 14-16 | Orientation |
| Sept 3 | Start Supervised Practice |
| November 28-29 | Thanksgiving Holiday |
| December 21-January 6 | Winter Break |
| March 29-April 6 | Spring Break |
| May 23 | End of Supervised Practice |
| May 24 | Pinning Ceremony |
| May 28-29 | Submission of paperwork |
...
These hospitals are located up to 60 miles from the Cal Poly Pomona campus. The use of a car is mandatory to travel to assigned rotations. Non-hospital rotations such as public health, school food service, community college, and Head Start, will be completed in Los Angeles, Orange, San Bernardino, and/or Riverside counties.

Interns are responsible for their own living arrangements.

**GLADIC Classes**

In addition to supervised practice hours, interns are required to attend Monday classes at a variety of sites in the Greater Los Angeles area. These hours are in addition to the 1,000+ practice hours in the assigned rotations.

Topics covered in these classes may include but are not limited to:
...
* Academy of Nutrition and Dietetics/California Academy structure and activities
* introduction to community agencies.

**Program Completion Requirements**

Interns are expected to complete the program in 10 months. Interns who are unable to meet completion requirements within 15 months of the start date will be placed on probation. Interns who do not complete requirements within two years of the start date may be terminated from the program unless there are extenuating circumstances.
...
* Complete a minimum 1,010 hours of supervised practice (NTR 5600 and NTR 5610)
...
* Official transcript showing master’s degree from granting institution
