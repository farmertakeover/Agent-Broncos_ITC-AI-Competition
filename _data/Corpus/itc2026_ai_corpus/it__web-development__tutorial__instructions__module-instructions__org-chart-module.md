**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/org-chart-module
...
## Options for Adding Org Chart to site

[### Adding Band new Org Chart

If your site does not currently have an organizational chart and you would like to add one, please click here.](create-new-org-chart.shtml)

[### Migrate Org Chart

If your previous site (group.yoursite) has an existing organizational chart that you would like to migrate to your new site instead of rebuilding it from scratch, please click here.](migrate-org-chart.shtml)
