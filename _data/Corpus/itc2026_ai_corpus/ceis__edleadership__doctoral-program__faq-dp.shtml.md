**Source:** http://www.cpp.edu/ceis/edleadership/doctoral-program/faq-dp.shtml
...
**Step 1a****:** Applicants must first apply to the university online through <https://www2.calstate.edu/apply>  Please select the **Summer 2026** term from the dropdown menu as your application term.
...
**Step 2****:** The second part of the process requires that pertinent supporting documents be sent via email in PDF format to Betty Alford at btalford@cpp.edu. This is a comprehensive process that includescompletion of a doctoral program supplemental application, a formal written statement in response to a series of questions, and an admission interview Further information is available in the doctoral program brochure and the Doctoral Studies Website:  <https://www.cpp.edu/financial-aid/index.shtml>

### What are the requirements?

* **Prior Education:** You must already have earned a baccalaureate degree and a master’s degree from an accredited institution of higher education with a cumulative GPA of 3.0 or higher in upper division (junior/senior year) and graduate studies.

* **Recommendation Letters:** Cal State Apply will prompt you to enter contact information for three professional references who can provide letters of recommendation attesting to your leadership ability and scholarship potential. It is recommended that you contact your references and request a letter of recommendation prior to submitting their contact information.
...
### What constitutes eligibility to the program?
...
The GRE is no longer required for the doctoral program admission process.
...
We are currently accepting applications for Cohort XV to begin May 2026. Applications will be screened during the winter and spring months. Selected applicants will be invited for an interview.
...
### How do I track my progress in the application process?

Admissions have a student-specific “to do list” that applicants can view on the web through Bronco Direct to follow their progress. You are strongly encouraged to monitor your progress in order to help facilitatecompletion of your file. If you encounter special difficulties, you may call the Doctoral Studies Co-Director for assistance at 936-554-5240, Betty Alford’s cell phone. Please do not call regarding your status as an applicant, however, since you will be notified as soon as decisions are made.

### When will I know if I have been accepted?

We anticipate notifying candidates who meet both university and doctoral program eligibility requirements on an ongoing basis after successful paper screening and an interview.  Following the personal interview session, an email and formal letter will notify candidates if they have been accepted into the doctoral program.

### Cost Comparison

| **Institution** | **CPP** | **Chapman\*** | **USC** |
| --- | --- | --- | --- |
| **Total Program Cost** | $60,903.99 | $79,515.00 | $89,404.00 |

 \*Based on cost/unit, does not include fees
...
### When are where are classes held?
...
You may review the doctoral studies website <https://www.cpp.edu/~ceis/edleadership/doctoral-program/index.shtml> or attend a program information session, dates and times are available on the website.  Further information is also available by contacting the program director, Betty Alford at btalford@cpp.edu or 936-554-5240.
...
Jose Aguilar-Hernandez, Ph.D.

jhernandez@cpp.edu

## Download FAQs

* [FAQs Download](../for-inquiries-doctoral-program-q-and-a-26-27-1.docx)
