**Source:** http://www.cpp.edu/ceis/edleadership/doctoral-program/application-admission-doctoral-program.shtml
...
[https://cpp.zoom.us/j/86011880901](https://cpp.zoom.us/j/86011880901%C2%A0)
...
[https://cpp.zoom.us/j/83380447770](https://cpp.zoom.us/j/83380447770%C2%A0)
...
1. **University Application:** To begin the application process, you must apply through the CSU system application website: [Cal State Apply](https://www.calstate.edu/apply). Please be sure to complete all application sections marked REQUIRED.
...
4. **Supplementary Application**:  The [supplementary application (doc)](application-admission-doctoral-program.shtml) requires responses to the following writing prompts as well as the submission of a current vita or resume.
...
5. **Interview**: You will be contacted to schedule an interview with the program admissions committee. The interview will be 30 minutes in length with a 15 minute open-ended written response that will be used as a writing sample. No preparation is needed.
