**Source:** https://www.cpp.edu/fpm/fm/planners-and-estimating-services.shtml
...
# Planners & Estimating Services

This unit is responsible for reviewing construction requests for additions or remodeling. Requests are analyzed, then a scope of work and cost estimate is determined. After a request becomes a work order, the various shops and trades within Facilities Management are called in to remodel offices and classrooms.

**[Space Policy (PDF)](docs/suam-space-standards.pdf)**

**[Space and Facilities Database (PDF)](docs/space-and-facilities-database.pdf)**
