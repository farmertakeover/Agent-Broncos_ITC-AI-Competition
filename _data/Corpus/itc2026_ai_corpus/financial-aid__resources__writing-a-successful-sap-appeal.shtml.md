**Source:** http://www.cpp.edu/financial-aid/resources/writing-a-successful-sap-appeal.shtml
...
* Review our [Understanding Unit Maximums page](understanding-unit-maximums.shtml) for a listing of the SAP Attempted Unit Maximum for each program at Cal Poly Pomona.

### How are the SAP Standards Applied?
...
### Reasons for Appealing Your Status
...
*Please note that this is not an exhaustive list of circumstances or obstacles that could justify submitting an appeal - as there could be other valid reasons to appeal.*
...
For additional information on SAP appeals and procedures please refer to our [Understanding SAP](understanding-sap.shtml)

### #2: Log in to Student Forms Portal to access your Appeal

All SAP Appeal forms are accessed through our [**Student Forms Portal**](https://cpp.studentforms.com). Any forms required as part of your SAP Appeal will be pre-assigned to your task list within the Portal.

### #3: Complete all SAP Appeal Forms Assigned to You
...
### #4: Meet with a Member of the Financial Aid & Scholarships Team
...
### #5: Upload Your Appeal and Supporting Documents to the Financial Aid Student Forms Portal

Once you have completed all required items for your SAP Appeal, you must submit the forms through the **[Financial Aid Student Forms Portal](https://cpp.studentforms.com).**
