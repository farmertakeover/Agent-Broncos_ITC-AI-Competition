**Source:** https://www.cpp.edu/ceis/news/articles/cpp-wins-schoolsfirst-grant-to-prepare-computer-science-teachers.shtml
...
![students in front of computer](../img/cpp-wins-schools-first-grant.jpg)The Center for Excellence in Math and Science Teaching (CEMaST), in partnership with the College of Education and Integrative Studies (CEIS), has received a $105,000 grant from SchoolsFirst Credit Union. The funds will support students and local teachers in their pathway to teaching and obtaining a supplemental authorization in computer science (CS).
