**Source:** http://www.cpp.edu/cce/faculty/funding-opportunities.shtml
...
![service learning course](../img/students/servicelearning-project2.jpg)

## SERVICE-LEARNING/COMMUNITY-ENGAGED LEARNING FACULTY FELLOWS
...
For more information regarding this program, please contact the Center for Community Engagement at (909) 869-4269 or cce@cpp.edu.

Expand/Collapse All for faq number 1

## Requirements

·       Attend a minimum of 6 meetings/workshops on service-learning from **June 2025 to June 2026**.
·       Create a service-learning course syllabus for a new course.
·       Consult with CCE staff for course learning outcome development.
·       Apply for the official service-learning designation for Spring Semester 2026 by **September 1, 2025.**
·       Implement service-learning course (at least pilot) by **Spring Semester 2026.**
...
·       $1,500 honorarium/stipend to be given to faculty member upon completion of program requirements. Applicable taxes will be taken out and payments will be made throughout the 2025-2026 academic year.
...
## CCE Impact Grants 2025-2026 - Now Open!

**The Center for Community Engagement is excited to announce funding for the 2025-2026 CCE Impact Grant.** The Impact Grant is designed to assist faculty with integrating curricular engaged learning (service-learning and community-engaged learning) into their Spring 2026 S/CEL courses. Projects must be curricular, related to course academic learning objectives, reflective of CPP's university values, and address a community-identified need. Tenured, tenure-track faculty, and lecturers are eligible to apply.

### The CCE Impact Grant promotes:

* The growth of community-engaged learning and diversity/global learning as high-impact pedagogy
* Collaboration and co-education between the community and faculty

CCE Impact Grants of up to $1,500 per grant will be awarded to engaged faculty and student/community teams working to address critical social issues in Pomona or the Greater Los Angeles area. This includes direct service and/or community-based research in support of the [United Nations Sustainable Development Goals](https://sdgs.un.org/goals).

**The application is open now until Friday, November 14!** Existing engaged faculty members are encouraged to apply. To provide an opportunity for various engaged faculty to be awarded an Impact Grant, new applicants will have first consideration. Faculty must be logged into MyCPP/BroncoSERV to access application.

For more information regarding this program, please contact the Center for Community Engagement at (909) 869-4269 or cce@cpp.edu.

[Apply Now](https://app.calstates4.com/cpp/node/533518)

Expand/Collapse All for faq number 1

## Faculty Eligibility

All CPP faculty are invited to participate. Projects addressing the [United Nations, 2030 Sustainable Development Goals](https://www.un.org/sustainabledevelopment/sustainable-development-goals/) will be given priority.

## Guidelines

Projects MUST have a curricular component (i.e., service-learning course, community-engaged learning). The CCE Impact Grant is designed to increase the number and quality of high-impact (PolyX) teaching practices on campus and respond to critical needs in Pomona and the Greater Los Angeles area through meaningful engagement. For more information, see [High Impact Practices](https://www.aacu.org/node/4084).
...
Click to view the [Engaged Faculty sample budget and grant guidelines](https://documentcloud.adobe.com/link/track?uri=urn:aaid:scds:US:e4e9c715-0e16-496b-ad3b-461fb34ac5a8) form.
