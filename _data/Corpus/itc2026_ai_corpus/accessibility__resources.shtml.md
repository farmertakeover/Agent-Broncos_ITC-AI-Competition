**Source:** https://www.cpp.edu/accessibility/resources.shtml
...
[CSU PDF Remediation Tool](https://csu.d2ljzoawo09xv6.amplifyapp.com/home/)
...
### Request a Website or Mobile Application Accessibility Review
...
To request a review, submit an [Accessibility/ATI Test Request ticket at eHelp (CPP login required)](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=c70d670f0f489f007a6046ace1050eac)

Contact us at accessibility@cpp.edu for any questions.

### Submit a Procurement ATI/IT Review Request
...
To submit an ATI/IT Review, click [ATI/IT Procurement Review (CPP login required)](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=bc4674596f0d43007996073aea3ee428) or search "ATI" on [eHelp](https://cpp.service-now.com/ehelp) after you have logged into eHelp.

See [CPP ATI/IT Procurement Review Process](procurement.shtml) for more information.
...
### Submit a Video for Captioning or Audio Description
...
For additional information, please refer to [MediaVision’s Captioning Services page](https://www.cpp.edu/mediavision/services/captioning.shtml).

[Submit video(s) for captioning or audio description through eHelp (CPP login required).](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=ce5441846fcdce0025ce9e4eae3ee4db)

### Learn more about Accessibility Support Services for Faculty
...
See [CAFE | Working With Accessibility](https://www.cpp.edu/cafe/teaching-and-learning/accessible-instructional-materials.shtml) for more information.
...
For more information or to schedule an appointment, visit [Studio 6](https://www.cpp.edu/cafe/about-us/studio-6.shtml).

### Assistive Technology Installations for Campus and Non-Campus Hardware
...
To request assistive technology installation on campus-managed devices, [submit an Application Access Request ticket at eHelp (CPP login required).](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=2c412ac6db8d9050e00f785e0f9619b2&sysparm_category=b298635b6f1161000a149e4eae3ee405&catalog_id=-1)
...
[CAFE | Faculty Accessibility Guide](/cafe/teaching-and-learning/accessible-instructional-materials.shtml)
