**Source:** http://www.cpp.edu/procurement/campus/asset-management.shtml
...
![](img/asset-management-bar-code.500x500.jpg)

Asset Management (AM) ensures that all assets acquired by the University have been appropriately accounted for and are reconciled to the general ledger as well as perform a Physical Inventory of all state-owned equipment, including computers.

Due to the pandemic and our remote work environment, in lieu of an onsite physical inventory, we request your cooperation, as staff and faculty, to complete a brief five-question mandatory survey for each computer (desktop, laptop, tablet only) used at home or in a remote location.

Employees have an obligation to safeguard CSU equipment and property, as outlined in Section 3.1 of the [CO CSU Administration of University Property - Equipment Procedures. (PDF)](https://www.csustan.edu/sites/default/files/FinancialServices/Travel/documents/3150-01-procedure_csu_property_administration.pdf)

**Please use the following link to complete the survey:**

[Asset Inventory Survey](https://app.smartsheet.com/b/form/c5af338afb974af489956ed7a9d34a0c "Asset Inventory Survey Link")

**Campus credential is require for log-in to complete the survey. For further instructions on the log-in, [please visit the link.](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=33c11c20dbc720d0ae3a567b4b9619ff)**

The onsite Physical Inventory process for equipment located on campus will resume once staff and faculty return to work on campus.

Thank you for your cooperation.

Asset Management

## Understanding Property Tags and Serial Numbers Made Simple

**Understanding Property Tags and Serial Numbers Made Simple**

**What is a Property Tag?**

A property tag is a small silver and black sticker that identifies equipment or assets owned by Cal Poly Pomona. These tags are also called:

* CPKs
* ID labels
* Asset tags or labels

**Where to Find Property Tags on Computer Equipment:**

* **Laptops (Dell, MS Surface, MacBook, iPad):** Check the bottom of the device.
* **All-In-One Computers:** Look on the back, upper-right corner.
* **Desktop Computers:** Check the upper-right corner.

---

**What is a Serial Number?**

A serial number is a unique code of letters and numbers used to identify a product.

**Where to Find Serial Numbers on Computer Equipment:**

* **Dell Laptops:** Look for the "service tag" sticker on the bottom of the device. Alternatively, use the command prompt to locate it.
* **MS Surface:** Find the serial number beneath the word Surface, under the kickstand on the back.
* **MacBooks and iPads:** The serial number is printed on the bottom of the device, near regulatory markings.
* **Dell All-In-One Computers:** Look for a black-and-white sticker on the back or on the stand. It may say "service tag."

By following these simple steps, you can easily locate the property tags and serial numbers on your equipment!

                                                                                                                         \*R Luna, CPPA 12/16/2024
...
Auction Website:  [Publicsurplus.com](http://www.publicsurplus.com/sms/csupomona%2Cca/list/current?orgid=428785)
...
Upon receipt through Distribution Services/Receiving, all property is tagged with a barcoded identification number (CPK#); it is then the responsibility of Asset Management to update and maintain the PeopleSoft database. If equipment does not come through the proper receiving process or if equipment is purchased with the Procurement Credit Card, please notify Asset Management at extension 3394 to make arrangements for on-site tagging or stamping. Asset Management is also responsible for the removal of equipment from the property database. This is accomplished when a department completes and forwards a "[Request for Property Survey Report (PDF)](docs/f315.pdf)."

## Transfers & Loans

**Transfers of State Property**: To initiate a transfer of property between two departments, a "Transfer of Equipment Form," (F-178-03), must be completed by both departments. Once completed, the form is forwarded to Asset Management, Procurement and Support Services, Building 75 for final processing.

## Loans of State Property
...
* If stolen, a police report should be attached to the above correspondence. It is the borrower’s responsibility to obtain a police report.
