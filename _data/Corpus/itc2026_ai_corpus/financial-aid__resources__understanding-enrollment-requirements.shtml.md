**Source:** http://www.cpp.edu/financial-aid/resources/understanding-enrollment-requirements.shtml
...
For federal student aid purposes, full-time enrollment is 12 credit hours. I**f you are enrolled in less than 12 credit hours (units), your Pell Grant will be reduced** based on your enrollment intensity.

Below is a chart of enrolment intensity relative to full-time enrollment. Note that enrollment intensity cannot exceed 100% for purposes of Pell Grant proration.
...
* Although 12 units is considered full-time, in order to graduate in four years you must complete 15 units per semester (30 units per academic year).
...
| Financial Aid Type | Impact of Enrollment Status on Offered Amount |
| --- | --- |
| **Federal Pell Grant\*** | **Grant Reduced** based on enrollment intensity. Refer to Federal Pell Grant information above. |
| **Supplemental Education Opportunity Grant (SEOG)** | **No Impact** - Eligible for full amount offered |
...
* If you are **enrolled in 6 units**, the amount of the State University Grant is adjusted to reflect the half-time Tuition Fee ($1,764 per semester for Fall 2024, Spring 2025)
...
| Financial Aid Type | Impact of Enrollment Status on Offered Amount |
| --- | --- |
| **Federal Pell Grant\*** | **Grant Reduced** based on enrollment intensity. Refer to the Federal Pell Grant information above. |
| **Supplemental Education Opportunity Grant (SEOG)** | **No Impact** - Eligible for full amount offered |
...
## Credential Student Enrollment Requirements

### Federal Pell Grant Enrollment Requirements

Beginning with the 2024-2025 aid year, the Pell grant will no longer be based on enrollment status. Instead Pell Grant disbursement amounts will now be calculated using Enrollment Intensity - which is a percentage value based on the number of credits a student is enrolled for during a term.

For federal student aid purposes, full-time enrollment is 12 credit hours. For federal student aid purposes, full-time enrollment is 12 credit hours. **If you are enrolled in less than 12 credit hours (units), your Pell Grant will be reduced** based on your enrollment intensity.
...
| **7** | **Half-Time** | **58%** |
| **6** | **Half-Time** | **50%** |
| **Less than 6** | **Less than Half-Time** | **N/A - Grant Canceled** |

**NOTE:** Credential Student aid eligibility is restricted to only that coursework that is required by the State of California to receive a professional certification or licensing credential.  Any units taken outside of the required credential coursework cannot be used when determining your enrollment status.

The Federal Pell Grant requires you to be enrolled at least half-time (in required coursework) in order to be eligible to receive funds. **If you enroll in less than 6 units of required coursework for a semester, you will lose eligibility for the Pell Grant for that semester**.
...
| Financial Aid Type | Impact of Enrollment Status on Offered Amount |
| --- | --- |
| **Federal Pell Grant\*** | **Grant Reduced** **Grant Reduced** based on enrollment intensity. Refer to the Federal Pell Grant information above. |
| **Cal Grant Tuition Grant** | **Grant Reduced** to 75% of offered amount |
| **Cal Grant Access** | **Grant Reduced** to 75% of offered amount |
| **State University Grant** | **No Impact** - Eligible for full amount offered |
...
* If you are **enrolled in 7 or more units**, there is no change to the State University Grant, since the Tuition Fee remains the same.
* If you are **enrolled in 6 units**, the amount of the State University Grant is adjusted to reflect the half-time Tuition Fee ($2,049 per semester for Fall 2024, Spring 2025)
...
Credential Students are required to be enrolled at least half-time in required coursework in order to be eligible to receive **any** federal or state funds, including the Federal Pell Grant.

If you are enrolled in only 1 - 5 units of required credential coursework, your federal Pell Grant  will be canceled and you will be required to repay any funds that had already been released.
...
* If you are **enrolled in 7 or more units**, there is no change to the State University Grant, since the Tuition Fee remains the same.
* If you are **enrolled in 6 units**, the amount of the State University Grant is **adjusted to reflect the 6 unit Tuition Fee** ($2,208 per semester Fall 2024, Spring 2025)
...
The State University Grant is a tuition fee designated grant and can only be applied to a student's Tuition Fee. If you are enrolled in 4.5 - 5 units, the amount of the State University Grant is adjusted to reflect the lower Tuition Fee ($2,208 per semester Fall 2024, Spring 2025)
...
The State University Grant is a tuition fee designated grant and can only be applied to a student's Tuition Fee. If you are enrolled in 3 - 4 units, the amount of the State University Grant is adjusted to reflect the lower Tuition Fee ($2,208 per semester Fall 2024, Spring 2025)
