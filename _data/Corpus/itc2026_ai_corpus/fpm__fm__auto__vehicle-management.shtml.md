**Source:** https://www.cpp.edu/fpm/fm/auto/vehicle-management.shtml
...
This document sets forth the responsibilities, guidelines and procedures required for compliance with the directives set forth in [Executive Order 691](http://www.calstate.edu/eo/EO-691.pdf)for a Campus Motor Vehicle Inspection Program, and with applicable policies found in the CSU’s[Use of University and Private Vehicles Policy Guidelines](http://www.calstate.edu/HRAdm/Policies/csumv__policy_guideline.pdf) and the [State Administrative Manual](http://sam.dgs.ca.gov/default.htm). Full compliance with this program will increase the overall safety, efficiency and economic well being of the campus motor vehicle fleet.
...
For copies of this program and related links and delegations, visit Facilities Planning and Management’s Website (see [What’s New](https://www.cpp.edu/fpm/whats-new.shtml)) and the [University Administrative Manual](http://www.cpp.edu/~policies/)online (see Policies / Executive Orders / No. 691).
...
**Prior to Acquisitio**n: Prior to submitting requisitions for new vehicles to Procurement & Support Services:

* Vehicle specifications must be reviewed and signed off by the MVI, and must meet the alternative fuel standards set forth in the Department of General Services’ SAM [Management Memo No. MM 04-20, Vehicle Purchase and Lease Policy](http://www.documents.dgs.ca.gov/osp/sam/mmemos/MM04_20.pdf), issued July 6, 2004.
...
Problems and any new damage to the vehicle noticed by the driver should be noted on the Vehicle [Operator Checklist](https://www.cpp.edu/fpm/docs/forms/vehicle_inspection_checklist.pdf) or the [Operator Checklist for Gas/Electric Carts and Micro-Vehicles](https://www.cpp.edu/fpm/docs/forms/vehicle_inspection_checklist-electric.pdf) that is kept in the vehicle. The completed checklist is to be faxed to Facilities Customer Service at x4363 at the driver’s earliest opportunity. Drivers are to immediately report such problems to the appropriate person in their department, that person to be determined by the department. Problems affecting safe operation of the vehicle should be taken care of immediately.
...
## Repairs, Estimates and Invoices

To comply with current CSU policies and guidelines set forth in the "[Use of University and Private Vehicles Policy Guidelines](http://www.calstate.edu/HRAdm/Policies/csumv__policy_guideline.pdf)," the following procedures must be followed:
...
## Replacement, Reutilization, and Disposition of Vehicles
...
**Disposition of Surplus Vehicles:** The campus will follow the current CSU Procurement Policy and liquidate surplus vehicles through competitive bidding or auction at the maximum price attainable in the open market. Provisions within the [California Vehicle Code](http://www.leginfo.ca.gov/cgi-bin/calawquery?codesection=veh&codebody=&hits=20) govern sales of all publicly owned vehicles, including any owned by the CSU.

**Request for Property Survey Report:** A [Request for Property Survey Report](http://www.cpp.edu/~fas/forms/procurement/f315.pdf) is required for all vehicles being disposed of. This form may be obtained from the Forms section of Procurement and Support Services’ website. The campus department disposing of a vehicle completes and sends the signed form to the Procurement department.
...
* [Procurement & Support Services, CPP](http://www.cpp.edu/~procurement/)
* [University Administrative Manual, CPP](http://www.cpp.edu/~policies/) (see Policies/Executive Orders)
* [State Administrative Manual, DGS](http://sam.dgs.ca.gov/default.htm)
* [Use of University and Private Vehicles Policy Guidelines, CSU](http://www.calstate.edu/HRAdm/Policies/csumv__policy_guideline.pdf)
* [Policy Manual for Contracting and Procurement, § 603, Disposal of Vehicles, CSU](http://www.calstate.edu/CSP/crl/policy/Policy.shtml#603)
* [California Vehicle Code](http://www.leginfo.ca.gov/cgi-bin/calawquery?codesection=veh&codebody=&hits=20)
