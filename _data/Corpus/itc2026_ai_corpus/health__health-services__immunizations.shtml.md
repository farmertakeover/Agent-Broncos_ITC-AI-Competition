**Source:** https://www.cpp.edu/health/health-services/immunizations.shtml
...
## Incoming Students: Required Immunizations for all CPP Students
...
Beginning Fall 2023, all incoming students must comply with the California State University systemwide [Executive Order 803](https://calstate.policystat.com/policy/13152298/latest/?showchanges=true)to ensure they are educated about and receive immunizations to prevent potentially serious and contagious diseases.
...
* Student Health Services (SHS) participates in the California Immunization Registry (CAIR), whereby immunization information can be verified for all CPP students immunized in the State of California.

* If SHS is unable to verify in CAIR database, students must submit proof of vaccine through an upload to MyHealthPortal. Documents will **ONLY** be accepted if submitted through the health portal. Do not mail in, bring in person or email documents to Student Health Services.

* Log in to MyHealthPortal, click on the “Medical Clearances” section to begin:
  + Enter dates each immunization was administered **OR** date blood test was done.
  + Complete/submit TB Screen Risk Form and other digital documents.

* Upload a copy of your immunization record(s), chest x ray or lab results.

* If SHS is unable to verify using CAIR **and** student cannot produce required documentation, a titer test may be used to prove immunity to disease for MMR, Varicella and Hepatitis B. A blood sample is taken and tested. If the test is positive, the individual has immunity.

* When it is not possible to test for immunity levels, a student may receive the vaccines from Student Health Services.

**Resources**

[CSU Immunization Requirements](https://calstate.policystat.com/policy/13152298/latest/)
