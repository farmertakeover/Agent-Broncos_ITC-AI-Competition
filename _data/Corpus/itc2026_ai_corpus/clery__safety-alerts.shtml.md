**Source:** https://www.cpp.edu/clery/safety-alerts.shtml
...
Emergency notifications are sent through CPP's [Safety Alert System](https://www.cpp.edu/em/emergency-communication/safety-alert-system.shtml) when there is confirmation of an imminent or immediate threat to the health and safety of the campus community. Examples include, but are not limited to:
...
The systemwide [Emergency Notification Policy](https://calstate.policystat.com/policy/16562624/latest/#autoid-9ygnv) outlines the procedures that the University Police Department (UPD) follows when sending emergency notifications.

All faculty, staff, and students are automatically enrolled to receive emergency notifications. The Safety Alert System uses contact information from the BroncoDirect database. Employees and students are encouraged to log into [BroncoDirect](http://www.cpp.edu/broncodirect/) and update their personal contact information as needed.
...
The systemwide [Timely Warning Policy](https://calstate.policystat.com/policy/16562624/latest/#autoid-vxw5g) outlines the procedures that UPD and the Clery Director follow in reviewing incidents and sending timely warnings. The Chief of Police has the ultimate authority and responsibility for determining whether to issue a timely warning.
...
To ensure you receive emergency notifications, log into BroncoDirect and review your provided contact information for accuracy. If you want to receive text messages, make sure that your cell phone number is in the “cellular” or “mobile" field.](http://www.cpp.edu/broncodirect/ "opens a new window")

[### View Past Timely Warnings

Review UPD's archive of timely warnings.](https://www.cpp.edu/police/timely-warnings.shtml "opens a new window")
