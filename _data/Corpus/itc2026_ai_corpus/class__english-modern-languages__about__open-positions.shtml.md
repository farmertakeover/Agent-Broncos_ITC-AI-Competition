**Source:** http://www.cpp.edu/class/english-modern-languages/about/open-positions.shtml
...
We have no searches running at this time.

### Lecturer Positions

While we are not currently hiring, we welcome applications to our pool for part-time, temporary faculty in the following areas: first-year composition, first-year composition for multilingual writers, French, German, Chinese (Mandarin), and Spanish.

* [Lecturer Position Announcement (PDF)](../docs/lect-announcement_fa25.pdf)
* Updated Application for Academic Employment coming soon
