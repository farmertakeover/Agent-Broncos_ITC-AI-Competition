**Source:** http://www.cpp.edu/class/cgisr
...
![Building 5 rear entrance](img/index/hero_small.jpg)

# Center for Geographic Information Science Research (CGISR)

![CGISR computer lab](img/index/hero_large.jpg)

## Our Center

The Center for Geographic Information Science Research (CGISR) is the hub for spatial and geospatial scholarly and creative activities at Cal Poly Pomona. CGISR facilities support the study of an array of topics from pressing societal issues to environmental phenomena to GIScience education by offering solutions in Geographic Information Science (GIS), Remote Sensing (RS), Artificial Intelligence (AI), Big Data, Machine Learning (ML) with spatial analysis and visualization, and cartography. The Center is housed in the College of Letters, Arts, and Social Sciences, at Cal Poly Pomona.

$134.23 Billion

The projected GIS market by 2030 according to an Emergen Research report.

## Check Out More

[![usb drive inserted into laptop](img/index/card_usb.jpg)

### Access Software](software.shtml "opens a new window")

[![AI generated newspaper page](img/index/card_news_events.jpg)

### News and Events](news-events.shtml "opens a new window")

[![image of front of CPP library](img/index/card_library.jpg)

### Library GIS](https://libguides.library.cpp.edu/geography/gis%20 "opens a new window")
