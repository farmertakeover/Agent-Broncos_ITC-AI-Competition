**Source:** https://www.cpp.edu/our-cpp/students/stars/application.shtml
...
![STARS Program Banner](../../img/image_headers/program-banners/stars-banner.jpg)

# Application

---

## STARS & Engage Summer Research Experience For Undergraduates (REU) Application

---

The STARS & [Engage](../engage/index.shtml) REU allows students to participate in high-level faculty-mentored research projects over an eight-week program. Students that participate in REU have the opportunity to present their culminating research projects at our annual Cal Poly Pomona Creative Activities & Research Symposium ([CPP CARS](../../events-workshops/cars/index.shtml)). Students who participate in the REU during the 8-weeks can expect the following:
...
The STARS & Engage REU program can only fund a smaller number of scholars during the summer REU vs. the academic year (fall and spring). Although space is not guaranteed, priority will be given to current STARS Scholars.

The STARS & Engage REU is expected to start on **June 16, 2026** and end on **August 7, 2026.**

---

## STARS & Engage Summer REU Application Now Open

[Apply Here](https://cpp.az1.qualtrics.com/jfe/form/SV_4YDUSbDQY6On53w)
...
4. **Be a current student (at CPP, Mt.SAC, or Citrus College)**
5. Must be a US citizen or permanent resident of the US.
6. **OPTIONAL:** Positive recommendation form(s).
...
Application must be submitted using the Online Application Form and supporting documents must be emailed. Questions regarding the application process can be directed to the program email:stars@cpp.edu.  A complete application package will include:

1. The application form can be accessed [HERE](https://cpp.az1.qualtrics.com/jfe/form/SV_4YDUSbDQY6On53w).
...
5. All the documents must be converted to pdf files and saved as the document name\_last name.pdf (*Example*: Transcript\_Smith.pdf and Financial\_Aid\_Smith.pdf)
...
* Recommenders should include the applicant's name and field of study, and a ranking or evaluation of the applicant relative to their peer group.  Recommendation form can be downloaded [HERE (PDF)](stars-files/stars_engage_recommendation_form-2025.pdf).
* The recommendation form must be downloaded and saved to access all the application fields including the digital signature field. Forms must be saved as Recommendation\_Last name of the applicant.pdf (*Example*: Recommendation\_Smith.pdf).
...
* Recommenders must submit all completed forms here: Qualtrics Submission Link (TBA)
  + **Recommendation Due Date**: TBA
...
Selection to the STARS & Engage Program will be based on many factors including but not limited to:

* Commitment to complete a Bachelor's degree program.
...
* Under-served students such as low-income, first-generation, students with disabilities, and disconnected students are strongly encouraged to apply.

## Navigation

[Home](index.shtml) [Projects](projects.shtml)  [Student Application](application.shtml) [Faculty](faculty.shtml)  [STARS Profiles](../../about/profiles/stars-student-profiles.shtml) [Contact](contact.shtml)
