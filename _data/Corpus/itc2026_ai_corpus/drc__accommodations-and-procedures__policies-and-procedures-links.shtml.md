**Source:** http://www.cpp.edu/drc/accommodations-and-procedures/policies-and-procedures-links.shtml
...
* [Home](/drc/index.shtml)
* Apply for DRC Services

  + [Application Process](/drc/applying-for-services/applying-for-services.shtml)
  + [Disability Documentation](/drc/applying-for-services/disability-documentation.shtml)
  + [Differences Between K12 & Higher Ed](/drc/applying-for-services/difference-k12-highered.shtml)
* Accommodations and Procedures

  + [Information for Students](/drc/accommodations-and-procedures/accommodations-services.shtml)
  + [Information for Faculty](/drc/accommodations-and-procedures/accommodations-faculty-info.shtml)
  + [DRC Policies and Procedures](/drc/accommodations-and-procedures/policies-and-procedures-links.shtml)
* Additional Services & Resources

  + [Student Resources](/drc/additional-resources1/student-resources.shtml)
  + [Faculty Resources](/drc/accommodations-and-procedures/accommodations-faculty-info.shtml)
  + [Bronco Access Mentors](/drc/additional-resources1/mentors.shtml)
  + [Events](/drc/additional-resources1/events.shtml)
  + [Newsletter](/drc/additional-resources1/drc-newsletter.shtml)
* Contact Us

  + [Contact Us](/drc/contact-us/contact-us.shtml)
  + [Meet Our Staff](/drc/contact-us/meet-our-staff.shtml)
...
To meet the legal requirements of these laws, the CSU system established the Policy for Provision of Accommodations and Support Services to Students with Disabilities [(Coded Memorandum AA-2014-08 PDF)](https://www.calstate.edu/attend/student-services/Documents/aa-2014-08.pdf) and the California State University Policy on Disability Support and Accommodations [(Executive Order 1111).](https://calstate.policystat.com/policy/8436999/latest/)
...
1. Students have option of making an informal complaint by:
   ...
   * Submitting [Service Delivery Compliant Form (PDF)](../documents/service-delivery-complaint-form.pdf).
...
Students who have been denied their requested accommodation(s) may request reconsideration of the decision by completing the [Accommodation Reconsideration Form (PDF)](../documents/accommodation-reconsideration-form-may17.pdf). Students will be asked to provide additional information that supports their request and may attach additional documentation that addresses the reasons given by the DRC for the denial.
...
Students who believe they have experienced discrimination on the basis of disability may pursue the University's formal grievance procedures by contacting the Office of Equity and Compliance (OEC) at 909-869-4646 or file an [online incident report](https://cm.maxient.com/reportingform.php?CalPolyPomona&layout_id=8) with OEC.
...
As defined by the [CSU Policy for Provision of Accommodations and Support Services to Student with Disabilities (PDF)](https://www2.calstate.edu/attend/student-services/Documents/aa-2014-08.pdf), a disability is a physical or mental impairment of an individual that limits one or more of the major life activities and requires either a record of such an impairment, or documentation of having been regarded as having such an impairment.
...
Please review the [DRC General Guidelines for Disability Documentation (DOCX)](../documents/general-documentation-guidelines-may20.docx)

### Additional Accommodation Requests

**Active DRC students**seeking additional accommodations submit an Additional Accommodation/Documentation request through myDRC portal. Additional accommodation requests are subject to the evaluation criteria detailed above.

**Temporary/Inactive students** seeking to continue their temporary eligibility or reinstate expired eligibility must submit an Additional Accommodation/Documentation request through myDRC portal.

The student’s DRC Access Specialist will provide written notification of the decision to approve and/or deny the request, including the reason for denial, within 5 business days. If the request for an additional accommodation is denied, the student will be provided information about how to request reconsideration using the [Accommodation Reconsideration Form (PDF)](../documents/accommodation-reconsideration-form-may17.pdf).
...
1. At the student’s DRC initial Intake Meeting appointment, the Access Specialist will establish eligibility for accommodations and/or services based on an interactive process.
2. Notice of eligible accommodations is available at the conclusion of the Intake Meeting appointment in the “My Eligibility” tab of myDRC.
3. DRC Access Specialist will document the denied accommodation(s) and the basis for the denial in the department’s data management software.
...
1. The student’s DRC Access Specialist will provide written notification of the decision to approve and/or deny the request, including the reason for denial, within 5 business days.
2. If the request for an additional accommodation is denied, the student is provided information about how to request reconsideration using the [Accommodation Reconsideration Form (PDF)](../documents/accommodation-reconsideration-form-may17.pdf).
...
Students interested in connecting with DRC should submit an application and available disability documentation using [myDRC](https://cascade.accessiblelearning.com/CPP). Students experiencing difficulty accessing the online system should contact the DRC office (909.869.3333 or drc@cpp.edu).
...
Accessible furniture is provided on a case-by-case basis to meet the needs of students with
disability-related physical limitations. The available options include:

* Adjustable Tables
* Specialty Chairs (e.g., padded, padded with arms, high swivel)

Accessible furniture provided by the DRC is not prescriptive in nature and should only be
considered as an improvement to classroom access.

#### FAQ:

##### How are students eligible for accessible furniture?

1. New students must register with DRC and may need to provide appropriate documentation.
2. Current DRC students already approved for furniture accommodations, must submit accommodation request(s) via myDRC for furniture as soon as course registration is completed for the following term.

#### How long does it take for furniture to be placed?

All requests are submitted via myDRC. When students log into myDRC to request their accommodations they will notice the E-agreements may require (re)signing. Once the e-agreements are read and confirmed registered courses will be viewable. On step 1 students select the courses and on step 2 of the requesting process, there will be a check box next to the furniture, i.e., adjustable table or chair. Select the furniture needed for specific classrooms and click submit.

#### How long does it take for furniture to be placed?

The DRC partners with Facilities Planning & Management for furniture placement. Furniture requests received at least 2 weeks prior to the start of the term will be in place by the first day of instructions. Requests received thereafter are submitted to Facilities for movement in the order received; placement can take 7-10 days

#### What happens if the furniture is not available?

If it is necessary to purchase furniture for the student, there will be an additional delay. Due to University purchasing procedures, furniture is ordered through specific vendors; the DRC will work diligently to help ensure prompt fulfillment of the request.

#### What happens if there are issues with the furniture?

If there are any issues with the furniture (the furniture is missing from the room, it is constantly being moved, broken, or damaged), then it is the student’s responsibility to notify the DRC immediately by emailing drc@cpp.edu.
...
#### Process for Use of Alternative Format

1. Student registers for classes during Priority Registration. Students approved for Alternative Format are also approved for Priority Registration to allow DRC to accommodate the request in a timely manner.
2. Student submits an **Accommodation Request** through myDRC, selecting the specific Alternative Format accommodation for each class in which alternate formats for course materials are needed. Requests should be made within 1 week of registering for classes.
3. Student must submit a **Book Request** to receive alternative format of a textbook. This is done on the Alternative Format page of myDRC. Requests are processed on a first-come, first-served basis.
4. DRC emails a Notification of Accommodation to each instructor.
5. Students are required to provide proof of possession before DRC can provide alternative formats for textbooks.
6. DRC will email the student when Alt Media materials are ready to be downloaded.

#### Student Responsibilities

* Monitor CPP email for status updates or questions from DRC Alternative Media Services
* Submit accommodation requests for alternative media within 1 week of registering for classes
* Submit specific book requests as far in advance as possible
* Notify Alternative Media of any changes to the class schedule related to materials being converted
...
2. Student submits an Accommodation Request through myDRC, selecting the appropriate DHH service for each class. Requests should be made within 1 week of registering for classes.
...
6. (Realtime Captioning only) Transcripts will be available through myDRC before the next class.
...
1. Student submits an Accommodation Request through myDRC, selecting Assistive Listening Device for each class in which it’s needed.
...
**The student must initiate the process of creating an agreement on the myDRC portal for how the accommodation will be provided in the class.** This accommodation agreement should be in place at the beginning of each semester, or as soon as possible after the student requests the accommodation for the class. The agreement is NOT active until the agreement has been completed by both the student and instructor. The agreement should address specific adjustments that can be made to the class policy on accepting late work and/or assignment due dates.
...
The Disability Resource Center (DRC) works in collaboration with University Housing Services (UHS) and Cal Poly Pomona Enterprises (CPPE) Student Housing to coordinate appropriate accommodations for students with documented disabilities or health conditions. Please note, the DRC reviews housing requests and approves accommodations as needed. DRC Housing accommodations are considered on a case-by-case basis and are determined by the nature of the student’s disability and the functional impact it has within the campus living environment. The DRC does not have the authority to prioritize students on housing waitlists. Approval of housing accommodations does not guarantee housing placement and is contingent upon a student’s standing with University Housing Services and/or CPPE Student Housing.

Students requesting housing accommodations must:

* Follow standard housing application and contracting procedures,
* Submit appropriate documentation to the DRC,
* Be approved by the DRC for a specific housing accommodation.

Because on-campus housing is in high demand, the DRC strongly encourages students to submit their housing applications as early as possible.

If you are unable to secure on-campus housing, you may consider nearby CPPE Student Housing options such as [University Village](https://cppvillage.com/) or [The Current in Pomona](https://thecurrentpomona.com/). We encourage you to explore these communities early, as availability may be limited closer to the start of the semester/academic year. Please note the [Bronco Express Shuttle](https://www.cpp.edu/transportation/commuting-to-campus/bronco-shuttle.shtml) does stop at both of these CPPE Student Housing locations.

For details about housing applications and procedures, please visit the [University Housing Services](https://www.cpp.edu/housing/), [University Village](https://cppvillage.com/)  and [The Current](https://thecurrentpomona.com/) websites.
...
Once approved, riders will receive an email from the approving office that includes a link to Microsoft Bookings to make appointments for rides. Current Service Hours and more information is available in our [How-To: Mobility Assistance](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fsway.office.com%2FVZ6oHYqD7RzM8nbK%3Floc%3Dswsp&data=05%7C01%7Csahatten%40cpp.edu%7C9748322e3c424eba924708db728e1c5f%7C164ba61e39ec4f5d89ffaa1f00a521b4%7C0%7C0%7C638229726908987221%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&sdata=ham0t5s6u49Zdjp8mnbDeSGNIGnc9ytMebRsBQZX3G4%3D&reserved=0) tutorial.
...
* Evening rides must be requested a minimum of one business day in advance.
...
Students with extended absences or those who have missed too many class meetings and/or scheduled tests might find that a make-up plan is not workable. Instructors are not obligated to provide individualized instruction or to re-teach material that was missed. If absences become excessive, it may be necessary to petition for a [Course Withdrawal](https://www.cpp.edu/studentsuccess/oss/academic-advising/university-policy-information/withdrawals.shtml) or to ask the instructor for an [Incomplete Grade.](https://catalog.cpp.edu/content.php?catoid=53&navoid=4006#Grading_System__See_also__Graduate_Studies__section_)
...
DRC student **must request the Modified Attendance Accommodation for the class through their** [myDRC](https://cascade.accessiblelearning.com/CPP/Login.aspx) portal.
...
##### Step 2: Establish a Modified Attendance Agreement with Instructor on myDRC portal

**The student must initiate the process of creating an agreement on myDRC for how the accommodation will be provided in the class.** This accommodation agreement should be in place at the beginning of each semester, or as soon as possible after the student requests the accommodation for the class. The agreement is NOT active until the agreement has been completed by both the student and instructor. The agreement should address specific adjustments that can be made to the class policy on attendance. The agreement should also address make-up exam details. As needed, the student schedules the exam through their myDRC portal in accordance with these specifications.
...
In the event of a change in animal, individuals are required to submit a new ESA request to the DRC for approval.
...
### Notetaking Technology-Genio (formerly Glean)
...
\*As part of this accommodation, the student is authorized to audio record lectures and will be required to fill out the Audio Recording Agreement in [myDRC Portal](https://cascade.accessiblelearning.com/CPP/Login.aspx) every year. A copy of the agreement is available on this page under [Notetaking Support-Audio Recording](https://sway.office.com/C9jSt1IBGnIy1UBD?ref=Link).

**How to Use Genio**

1. DRC student submits an Accommodation Request through [myDRC](https://cascade.accessiblelearning.com/CPP/Login.aspx), selecting Notetaking Technology for each class in which its needed
2. DRC will invite the student to Genio.
3. Student will receive an introduction email from Genio with a link to sign-in.
4. DRC will send student an email with additional information about how to use Genio.
5. DRC recommends practicing recording ahead of time using their preferred method of [audio recording](https://sway.office.com/C9jSt1IBGnIy1UBD?ref=Link).
6. During class, student takes their own notes and records the lecture.
   1. Record lecture, and
   2. Take their own notes and write down what is on the board
   3. After class, audio notes will be transcribed within the hour
7. Once your audio notes are transcribed you will be able to import lecture slides, add definitions, highlight important information, and create assignments.
...
* Student who are eligible for and have requested Notetaking Technology accommodations and will be recording lectures with Genio.
...
To utilize Notetaking Support-Audio Recording accommodations, the student submits an Accommodation Request through [myDRC](https://cascade.accessiblelearning.com/CPP/Login.aspx), selecting Audio Recording for each class in which it's needed. Their instructor will then be notified that the student has permission to utilize the requested accommodation.

Please visit [Audio Recording Accommodation](https://sway.office.com/C9jSt1IBGnIy1UBD?ref=Link) for recording instructions and other resources. **Students who have any questions or concerns about audio recording should contact DRC immediately for technical assistance or to explore other options available.**
...
To utilize this accommodation, the student submits an Accommodation Request through [myDRC](https://cascade.accessiblelearning.com/CPP/Login.aspx), selecting Laptop Use for each class in which it's needed. Their instructor will then be notified that the student has permission to use their laptop in class.
...
### Overview of Testing Accommodations
...
1. DRC student submits an Accommodation Request through myDRC, selects Test Accommodations for each class in which they’re needed. This will request all test accommodations for which the student is eligible.
2. DRC emails a Notification of Accommodation to each instructor about two weeks prior to the term, or within one business day for subsequent requests.
3. DRC student confirms with instructor that they will provide test accommodations.
4. If instructor is unable to provide test accommodations, student must submit a test request through myDRC.
...
1. DRC Student schedules test through myDRC. For more information on scheduling guidelines read the Scheduling Tests and Scheduling Final Exams sections below.
2. DRC reviews the request and approves the scheduled test or sends the student a request to reschedule.
3. When approved, notification is sent to the student and instructor. The notification will include date and time.
4. DRC emails the instructor to obtain instructions and a copy of the test.
5. Upon completion, DRC facilitates the return of the test to the instructor if applicable.
...
If one of the exceptions applies, students must schedule their test as reasonably close to when the class is taking the test as possible and indicate the reason for the schedule adjustment in "Additional Notes” box of the test request. Upon reviewing the exam request, DRC staff may contact the student to confirm that the test request complies with the above guidelines, and/or send the student a reschedule notification so that it complies with the above guidelines. Students are responsible for replying to inquiries and reschedule notices within a reasonable amount of time to allow for coordination of accommodations with the instructor.
...
1. Students checks in for their test.
2. The student reads the test instructions from the instructor, including time and materials allowed (i.e. note card, calculator). The student will be responsible for following the test instructions at all times. DRC can provide clarification if there are specific questions.
3. Students will be assigned a test space prior to entering the testing area. Students are not permitted to choose or change their test space once it has been designated.
4. Lockers are provided for storage of personal belongings. The only items allowed in the testing room are approved testing materials.
5. Once a test has begun a student may not return to the locker, unless accompanied by DRC staff.
6. Students are not permitted to leave the test area once the test has begun. Use of the restroom is permitted; however, the test time-clock does not stop unless the student has breaks as an approved accommodation. The student must bring their test to the front desk and tell DRC staff before leaving the testing area. If students are gone for longer than five minutes, DRC will notify the instructor for test security purposes.
7. The student must inform DRC staff immediately if they are unclear about test instructions or have concerns about the test environment/conditions. DRC staff will attempt to contact the instructor for clarification about specific questions.
8. When the test time is up, the student will stop and return the test materials to DRC staff.
...
Instructors will need to use the myDRC [Instructor Portal](https://cascade.accessiblelearning.com/CPP/instructor). While email reminders and notifications will continue to be sent, the instructor portal provides similar information in a centralized location. The portal allows instructors to:
...
Instructors may review this [myDRC Instructor Portal Tutorial](https://sway.cloud.microsoft/0oPN5ikvC48UU7Uc?ref=Link) for further information or contact DRC for assistance.

### Instructor Role - Test Format
...
Instructions for how to extend time in Canvas can be found in [Faculty Accommodation Resources](faculty-testing.shtml).
...
### Instructor Role - DRC Proctored Test
