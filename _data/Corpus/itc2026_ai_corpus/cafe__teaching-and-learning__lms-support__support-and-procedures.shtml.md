**Source:** http://www.cpp.edu/cafe/teaching-and-learning/lms-support/support-and-procedures.shtml
...
Material uploaded by Cal Poly Pomona faculty and staff is expected to fall within [Section 508 compliance](https://www.cpp.edu/accessibility.shtml).

Learn about making common file types accessible at CAFE’s [Creating Accessible Materials](../accessible-instructional-materials.shtml) page.

### Canvas Accessibility Resources

[Canvas’s Accessibility Resources](https://community.canvaslms.com/t5/Canvas-Basics-Guide/What-are-the-Canvas-accessibility-standards/ta-p/1564) provides best practices, usage guidelines, and system features regarding accessible compliance.
...
View the [sponsored affiliate eHelp article](https://cpp.service-now.com/ehelp?id=kb_article&sys_id=360fc54e6fe8e600e020f35d5d3ee436) to learn more about the process and to request a sponsored affiliate account. Once a Sponsored Affiliate is approved, the Sponsor must submit a separate request for Canvas access using the [Application Access/Removal Request form](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=2c412ac6db8d9050e00f785e0f9619b2) on eHelp.
...
Learn more about [Section Start and End Dates](https://community.canvaslms.com/t5/Canvas-Basics-Guide/How-do-term-dates-course-dates-and-section-dates-work-in-Canvas/ta-p/37).
...
Instructors may manually enroll a user with a CPP email address by following the [instructions to manually enroll a user](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-add-users-to-a-course/ta-p/1119).

**Note:** Users with the “Student’ course role cannot be manually added or removed in official Canvas teaching courses. Students must add or drop through BroncoDirect to be added/removed in Canvas courses. Teachers may manually add other Teachers, TAs, Designers, Observers, or [DRC staff](https://cpp.service-now.com/ehelp?id=sc_cat_item&sys_id=dcefbcec1b0ee5d08e3ca602b24bcb39) to their official Canvas teaching courses. Teachers may choose to add waitlisted students as Observers to allow them to view the Canvas course while their official enrollment is pending, but they are not required to do so.
...
Course combinations can be requested through our [Canvas Requests](../../about-us/request-services.shtml) page.
...
Material uploaded by Cal Poly Pomona faculty, staff, and students is expected to fall within [copyright guidelines](https://www.cpp.edu/copyright/).
...
Instructors can also [recover Canvas content they deleted in error](https://community.canvaslms.com/t5/Canvas-Question-Forum/Can-I-restore-deleted-data-from-a-course/m-p/605325) by adding “/undelete” to the web address for the course home page (e.g., [https://canvas.cpp.edu/courses/#####/undelete](https://canvas.cpp.edu/courses/#/undelete)). Instructors may contact canvas@cpp.edu for help retrieving deleted content.
...
[Canvas Accounts and Access](#canvas-accounts-and-access)

[Course Creation Services](#course-creation-services)

[Course Enrollment Services](#course-enrollment-services)

[BroncoDirect Daily Sync and Annual Maintenance](#broncodirect-daily-sync-and-annual-maintenance)

[Combining Courses in Canvas](#combining-courses-in-canvas)

[Course Content Services](#course-content-services)

[Course Retention and Restoration Services](#course-retention-and-restoration-services)
