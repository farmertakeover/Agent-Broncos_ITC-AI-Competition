**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/small-cards.shtml
...
# Small Cards Module Tutorial

## Instructions

***Page View***

![](../img/small_cards_div_landing_page.jpg)

**For this section, you will need:**

* Heading text
* (3) images
* (3) title texts and headlines
* (3) links for cards

**Note: You will be required to edit three cards.**

***Cascade View***

![](../img/small_cards_div_landing_cascade.jpg)

**Expand each section and provide content as following:**
