**Source:** http://www.cpp.edu/financial-aid/resources/financial-aid-policies.shtml
...
The [Family Educational Rights and Privacy Act (FERPA)](https://studentprivacy.ed.gov/ferpa) exists to protect your right to confidentiality and places limitations on student record information that may be released to third parties (***which includes parents, guardians, spouse, and/or caregivers***) without the student’s written permission unless it is considered directory information.  Protected information includes grades, billing, tuition and fee assessments, financial aid, and other student record information.

We want you to know that we strictly adhere to FERPA. Although it does limit what we can share, it protects you.  You can authorize the release of your information via [BroncoDirect](https://my.cpp.edu). For more information regarding FERPA, please see the [Registrar’s Office website](https://www.cpp.edu/registrar/student-records/ferpa.shtml).

Students may grant the Office of Financial Aid & Scholarships permission to release information about their financial aid to a third party (including parents, step-parents, spouse, etc.) by submitting a [***Confidentiality Release / FERPA Authorization (PDF)***](https://www.cpp.edu/registrar/forms/how-to-complete-a-ferpa-student.pdf), through BroncoDirect.

### Coordination of Aid and Resources
...
If you have any questions about the coordination of outside resources with your financial aid, please [connect with us](contact.shtml) during regular business hours.

### Financial Aid and Deferment of Tuition and Fees Payment

Payment of Tuition and Fees is due each semester, typically before financial aid is able to be released. Information on [Payment Dates & Deadlines](https://www.cpp.edu/student-accounting/dates/) is available from Student Accounting and Cashiering Services.
...
If you file your aid application (FAFSA or California Dream) after the Priority Filing Deadline, you will still be considered for financial aid; however, you may not have your eligibility determined in time to receive a deferment of payment for the Fall semester.  You will need to plan to pay your registration fees by the [published Cal Poly Pomona Fall payment deadline](https://www.cpp.edu/student-accounting/dates/) (release of any financial aid may then result in a refund of your payment) in the event you have not been packaged with financial aid by the fee payment deadline.

### **Impact of Missing Document Submission Deadline**

If you fail to complete your file by the document submission deadline, you run the risk of not having your file reviewed and aid eligibility finalized prior to the fee payment deadline.  As such, you will be responsible for paying your fees by the [published Cal Poly Pomona fee payment deadlines](https://www.cpp.edu/student-accounting/dates/).

If you turn in your documents after the document submission deadline, you will still be considered for financial aid; however you may not have your eligibility determined in time to receive a deferment of payment for the Fall semester.  You will need to pay your registration fees by the [published Cal Poly Pomona Fall payment deadline](https://www.cpp.edu/student-accounting/dates/) (release of any financial aid may then result in a refund of your payment).

### Release (Disbursement) of Financial Aid
...
Students are encouraged to enroll in Direct Deposit for faster delivery of refunds. Information on how to sign-up is found on the Student Accounting and Cashiering Services website, under [Direct Deposit](https://www.cpp.edu/student-accounting/direct_deposit.shtml).  You may also contact Student Accounting and Cashiering Services for more information.
...
**Students enrolled and NOT ATTENDING CLASSES** must return aid received to the Student Accounting & Cashiering Services and officially withdraw from those classes.

### Financial Aid Proration and Grant Recalculation
...
Aid Adjustments Based on Enrollment

| **Financial Aid Program** | **Eligibility at   Full Time Status** | **Eligibility at   3/4 Time Status** | **Eligibility at   1/2 Time Status** | **Eligibility at Less than ½ Time Status** |
| --- | --- | --- | --- | --- |
...
### **Canceling a Federal TEACH Grant or Federal Direct Loan**
...
* Have an [Expected Family Contribution (EFC)](https://studentaid.gov/complete-aid-process/how-calculated#efc) that falls within the grant eligible range (**For 2023 – 2024 the eligible EFC range is $0 - $6,656).**
...
* **The amount of SUG awarded is:**
  ...
  + Canceled if the student does not meet the [Cal Poly Pomona SAP (Satisfactory Academic Progress) Standards for Financial Aid Applicants](understanding-sap.shtml).
...
Please note that the SUG Unit Maximum is based upon earned units while the [Satisfactory Academic Progress Standards for the Receipt of Financial Aid](understanding-sap.shtml) is based upon attempted units.
...
### Satisfactory Academic Progress Standards for Financial Aid Applicants
...
The Academic Senate Policy on Repetition of Coursework and the Financial Aid Policy differ in application. The Cal Poly Pomona [Repetition of Courses Policy](https://catalog.cpp.edu/content.php?catoid=36&navoid=2926#Repetition_of_Courses) and [Grade Forgiveness Policy](https://catalog.cpp.edu/content.php?catoid=36&navoid=2926#Grade_Forgiveness) do not apply when determining if the repeat coursework is eligible for financial aid.  The financial aid Repeat Coursework and Federal Financial Aid Eligibility policy is generally more restrictive, allowing less course repetition than the academic policy does.
...
1. The U.S. Department of Education (or California Student Aid Commission) will notify the student on their Student Aid Report if the student was selected by the governing agency. With this notification, the student is informed that the school will follow up with them for necessary documents.
2. Cal Poly Pomona will provide email notification to the student that additional documents are required before their aid eligibility can be determined and their aid package finalized; the email contains information regarding the document submission deadline and the ramifications of missing the deadline. The student is prompted to refer to their MyCPP Self-Service To-Do List. The email notification to the student is generally sent within three business days from the time that notification is received from the application processor or selection is determined *(the timeframe may be longer at the beginning of the processing cycle, October-December).*
3. Cal Poly Pomona also provides secure 24/7 access to information showing verification documents requested for each student on the [Financial Aid Student Forms Portal](https://cpp.verifymyfafsa.com).
4. As a courtesy, Cal Poly Pomona may contact students by email with an additional request for any outstanding documentation thirty days after the initial request.
...
Review the full Cal Poly Pomona policy regarding [**Refund of Tuition and Mandatory Fees, Including Nonresident Tuition**](https://catalog.cpp.edu/content.php?catoid=61&navoid=4880#Refund_Mandatory_Fees_Incl_Nonresident_Tuition#Refund_Mandatory_Fees_Incl_Nonresident_Tuition).
...
Aid received from private sources external to the University will not be subject to this policy. Also see [Student Accounting & Cashiering Services](https://www.cpp.edu/student-accounting/home/policy.shtml) for additional information on refunds.
...
* Register with [Selective Service](https://www.sss.gov/) when required to do so.
* Complete [Loan Entrance Counseling](https://studentaid.gov/)and an [electronic Master Promissory Note](https://studentaid.gov/) if you are a first-time borrower of a Federal Direct Student Loan at Cal Poly Pomona.
* Complete the Annual Student Loan Acknowledgement each year you wish to borrow a federal student loan.
* Complete on–line [Loan Exit Counseling](https://studentaid.gov/)before you graduate, transfer, or withdraw from Cal Poly Pomona, if you have borrowed a Federal Direct Student Loan.

### **When you accept Federal Work-Study (FWS), it is your responsibility to**

* Find a Work-Study job with assistance from the [Cal Poly Pomona Career Center.](https://www.cpp.edu/career/index.shtml)
...
### Office of Financial Aid:  NASFAA Code of Ethics

The Cal Poly Pomona Office of Financial Aid & Scholarships is a member of the [National Association of Student Financial Aid Administrators](https://www.nasfaa.org/) (NASFAA).  Additionally, members of our staff belong to the [Western Association of Student Financial Aid Administrators (WASFAA)](https://www.wasfaa.org) and the [California Associated of Student Financial Aid Administrators (CASFAA)](https://www.casfaa.org).

Staff in the Office of Financial Aid & Scholarships have always attempted to act in the best interest of our students and their families. In response to mandates outlined in the [Higher Education Opportunity Act of 2008](https://www.ed.gov/laws-and-policy/higher-education-laws-and-policy/higher-education-opportunity-act-of-2008), we have adopted the [CSU Code of Conduct (PDF)](https://www.calstate.edu/apply/paying-for-college/financial-aid/Documents/CSU_CodeofConduct_StudentLending.pdf)to define our relationship with student loan providers.  Additionally, all of our actions are bound by NASFAA's [Statement of Ethical Principles and Code of Conduct for Institutional Financial Aid Professionals:](https://www.nasfaa.org/Statement_of_Ethical_Principles)
...
Refer to NASFAA's [Code of Conduct](https://www.nasfaa.org/Code_of_Conduct), [Enforcement Procedures](https://www.nasfaa.org/uploads/documents/ektron/b3845e64-e020-406c-a002-20d8133f46c3/ef5b71839b3c4eb191a6bf60b5d6a0527.pdf), as well as the [Ethical Principles, Code of Conduct and Enforcement Procedures Q&A](https://www.nasfaa.org/Ethics_Q_A) for more information about NASFAA's ethical guidelines and how they are enforced.

*NASFAA Publication Date: 11/21/2017*
