**Source:** http://www.cpp.edu/class/english-modern-languages/majors/eng-ed.shtml
...
# EML Bachelor Degrees: English – Education

* [CPP](https://www.cpp.edu)
* [English & Modern Languages](../index.shtml)
* [Academics](/majors/index)
* English Education
* [...](../index.shtml)
...
[English – Education curriculum for 2025-2026](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19676&returnto=6720)
...
* Dr. Alison Baker: abaker@cpp.edu or (909) 869-2738

#### Additional English Education faculty advisors

* tba

## Pursuing a Teaching Credential

A teaching credential is required to be a full-time teacher in California. You can stay at CPP for your credential, or you can pursue one elsewhere. Information about CPP's credential program is provided here to help you better understand credential programs.
...
### How do I apply for CPP’s credential program?

Application to the Single Subject Credential program is through the Education department, and the most up-to-date information is [on its website](https://www.cpp.edu/ceis/credential-program/admission/admission-information.shtml). There are two key steps:
...
2. File a complete application with the Education department, [following these steps to complete the admissions packet](https://www.cpp.edu/ceis/credential-program/admission/program-application.shtml). We recommend spending 4-6 weeks to compile all documents. For assistance, contact [Jennifer Garcia, Credential Analyst](https://www.cpp.edu/ceis/credential-program/contact-us.shtml).

### Which state-level requirements must be met for the credential application?

[See the full application here](https://www.cpp.edu/ceis/credential-program/admission/admission-information.shtml). There are several important requirements you need to be aware of as a potential credential applicant.

1. **Meet the Basic Skills requirement.**There are a [variety of ways of doing this](https://www.ctc.ca.gov/credentials/leaflets/basic-skills-requirement-%28cl-667%29), including taking and passing the [CBEST Exam](https://www.ctcexams.nesinc.com/), qualifying ACT and SAT scores, or getting a B- or higher on qualifying coursework. In AB 130, the state defines this coursework as:
...
2. **Meet the Subject Matter Competency requirement**. There are [several ways to do this](https://www.ctc.ca.gov/educator-prep/subject-matter-requirements), including the [CSET Exam](https://www.ctcexams.nesinc.com/). With the passing of AB 130, all students graduating with a degree in English will meet the requirement for a single subject credential program in English, as the degree name matches the credential name. This includes students in all three options of the English degree at Cal Poly Pomona.
3. **Meet the Early Field Experience (EFE) requirement.** Complete 45 hours of relevant field experience within four years of your application. Examples of relevant experiences include volunteering in a classroom, conducting field observations for a course, substitute teaching, working as an after school program aide, working with scouts, and coaching. For more information, [review the form on the application website](https://www.cpp.edu/ceis/credential-program/admission/program-application.shtml). Your EFE hours should be as directly relevant to your future classroom age and focus as possible.
4. **Get screened for TB**. This can be done anywhere, but we recommend going to [Student Health Services](https://www.cpp.edu/health/about-us/fee-schedule.shtml), as it is convenient and inexpensive.

### When can I apply to the credential program?
...
You can view an [orientation session here](https://www.cpp.edu/ceis/credential-program/admission/admission-information.shtml) for more information.
...
The English Education coordinator is your point person for moving through the degree and advising. Currently, this is Dr. Alison Baker (abaker@cpp.edu). You can also meet with any [English Education advisor](../student-resources/advising.shtml). Once you move into the credential application process, you should contact [relevant support in the Education department](https://www.cpp.edu/ceis/credential-program/contact-us.shtml).
...
Up to nine hours (3 courses) can be petitioned to count toward your credential program's hours. All four courses will be counted toward curriculum requirements, however. Use the “Request by an Undergraduate for Graduate Credit” petition linked on the [Graduate Studies website](https://www.cpp.edu/gradstudies/current-students/forms.shtml).
...
There are two master's degrees you might be considering.[A master's degree in English](../academics/graduate-programs.shtml) qualifies you to do many things, one of which is teach freshman and sophomore-level courses in English. These could include composition, rhetoric, literature, TESOL, or creative writing, depending on your program and interests. You could work at a community college, four-year university, or at a high school doing dual enrollment courses (you would likely also need a credential). [A master's degree in Education](https://www.cpp.edu/ceis/education/masters-programs/index.shtml) prepares you for educational leadership and administration positions. This degree is different from subject-matter master's degrees that would qualify you to teach English at a collegiate level. [CPP has a program](https://www.cpp.edu/ceis/education/masters-programs/combined-credential-and-masters-program.shtml) that allows you to get your credential and master's in Education at the same time.

K-12 teachers often get their master's degrees at some point in their careers as part of their professional development. It is not required, but it can mean more opportunities for teaching dual enrollment, moving into administration or leadership, or a pay raise. If you are not sure what degree you want to pursue, we recommend talking [with an advisor](../student-resources/advising.shtml).

## Our Students in Action

![Young woman presenting at a lectern.](../img/elizabeth-ibarra-2-1400x754.jpg)

![Sorting hat resting on a desk while students work in groups.](../img/sorting-hat-1400x750.jpg)

![3 students with Bronco branded clothing interacting.](../img/eml-students-interacting.jpg)
