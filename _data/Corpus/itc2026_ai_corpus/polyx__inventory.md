**Source:** https://www.cpp.edu/polyx/inventory
...
![PolyX Hub](../img/banners/polyx.png)

# PolyX Hub

**All PolyX are not ​offered every semester. Please [click here](https://schedule.cpp.edu/ "University Catalog") to check for availability.**

Search:

[Filters](#polyx-filters)
...
Total entries: **{{(polyXList.entries | class : standing | curr : curricular\_type | college\_division:division\_option | polyx\_name:polyx\_name\_option | polyx\_contact:contact\_option | filter:searchQuery).length}}**

## {{entry['q1']}}

**Length of PolyX:** {{entry['q10']}}
 **Curricular or Co-curricular:** {{entry['q9']}}
 **Is GPA Required:** {{entry['q14']}}
  **GPA:** {{entry['q14b']}}
  **Class Level:** {{entry['q12']}}
 **How can students apply or what pre-requisite(s) is required:** {{entry['q13b']}}

### Description

{{entry['q2']}}

**[Visit the website](%7B%7Bentry%5B%27q3%27%5D%7D%7D "{{entry['q1']}} (opens in new window)")**

### Contact Information

![{{entry['q6']}} {{entry['q5']}}](/polyx/inventory/img/contacts/{{entry['q4'].replace('@cpp.edu','').toLowerCase()}}.jpg)

**Faculty Instructor(s):** {{entry['q6']}} {{entry['q5']}} ( Email)
 **College/Division:** {{entry['q7']}}
 **Department:** {{entry['q8']}}
