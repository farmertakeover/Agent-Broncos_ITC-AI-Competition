**Source:** https://www.cpp.edu/library/computers-in-library.shtml
...
## Applications Available on Library Desktop Computers
...
* MiKTeX 2.9
* Mozilla Firefox 68.7.0 ESR (x64 en-US)
* NetBeans IDE 8.0.1
* Notepad++ (64-bit x64)
* Pharos
...
* SAS Studio 3.1 Single-User Edition (64-bit)
* Sassafras K2 Client
* TypeScript SDK
* Visual Studio Professional 2017
* VLC media player
* Windows Software Development Kit - Windows 10.0.17763.132
* Wolfram Mathematica 12 (M-WIN-P 12.0.0 6207018)
* Zotero Standalone 4.0.29.10 (x86 en-US)

## Applications Available on Short-term Library Laptop Loaner
...
## Applications Available on Long-term Library Laptop Loaner

* VPN
* Office 365
* Software Available in Software Center
  + Camtasia
  + Chrome
  + Firefox
  + EquatIO
...
Table shows the floor location and type of computer available

| # | Location | Number of Computers (Total) | Number of iMacs |
| --- | --- | --- | --- |
| 1 | Bronco Computer Lab | 70 | 10 |
| 2 | 2nd Floor | 112 | 7 |
| 3 | 4th Floor | 23 | 4 |
| 4 | 5th Floor | 15 | 4 |
| 5 | 6th Floor | 23 | 4 |
