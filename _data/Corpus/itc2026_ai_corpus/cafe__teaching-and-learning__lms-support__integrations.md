**Source:** http://www.cpp.edu/cafe/teaching-and-learning/lms-support/integrations
...
## Canvas integrations and procedures

Learn about Canvas integrations and the evaluation and adoption procedures for getting an integration implemented at Cal Poly Pomona.

[About Canvas Integrations](about.shtml)

---

## View existing Canvas integrations

Visit our Canvas integrations page to see what integrations have been implemented including any integrations policies, EEAP documents, and support materials available for each integration.

[Existing Canvas Integrations](existing.shtml)
