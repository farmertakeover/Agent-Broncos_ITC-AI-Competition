**Source:** https://www.cpp.edu/accessibility/regulations-and-standards.shtml
...
[Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/TR/WCAG21/)is developed through the [W3C Process](http://www.w3.org/WAI/intro/w3c-process.php) in cooperation with individuals and organizations around the world with a goal of providing a single shared standard for web content accessibility that meets the needs of individuals, organizations, and governments internationally. These guidelines not only make pages more accessible to people with disabilities, but also have the benefit of improving the quality of the overall user experience for all users on different browsers and devices.
...
* [WCAG Easy Checks](https://www.w3.org/WAI/test-evaluate/easy-checks/)
...
On April 24, 2024, the Federal Register published the Department of Justice’s final rule updating its regulations for [Title II of the Americans with Disabilities Act (ADA)](https://www.ada.gov/law-and-regs/regulations/title-ii-2010-regulations/). Cal Poly Pomona must make all web and mobile services meet WCAG 2.1 Level AA standards by **April 24, 2026.**

The requirements do not apply to the following:

* **Archived web content**. Archived web content as defined in [Title II Section § 35.104](https://www.ada.gov/law-and-regs/regulations/title-ii-2010-regulations/#:~:text=associated%20with%20them.-,Section%2035.104%20Definitions.,-For%20purposes%20of).
...
In 1998, Congress amended the Rehabilitation Act of 1973 to require Federal agencies to make their electronic and information technology (EIT) accessible to people with disabilities. The [29 U.S.C § 794 (d)](https://www.govinfo.gov/content/pkg/USCODE-2011-title29/html/USCODE-2011-title29-chap16-subchapV-sec794d.htm) law applies to all Federal agencies when they develop, procure, maintain, or use electronic and information technology.

The [U.S. Access Board](https://www.access-board.gov/) is responsible for developing Information and Communication Technology (ICT) accessibility standards. On January 18, 2017, the U.S. Access Board updated accessibility requirements covered by Section 508, and refreshed guidelines for telecommunications equipment subject to Section 255 of the Communications Act. The final rule went into effect on January 18, 2018.
...
* [Section 508 Homepage](https://www.section508.gov/)
* [United States Access Board - Information and Communication Technology (ICT)](https://www.access-board.gov/ict.html)
...
* [Free & Appropriate Education (FAPE)/Section 504 - Department of Education](https://www.ed.gov/laws-and-policy/civil-rights-laws/disability-discrimination/disability-discrimination-key-issues/disability-discrimination-providing-free-appropriate-public-education-fape)

### Telecommunications Act of 1996 (Section 255)

Section 255 of the Act requires telecommunications products and services to be accessible to people with disabilities. This is required to the extent access is "'designed, developed, and fabricated to be accessible to and usable by individuals with disabilities' when it is readily achievable to do so." ([U.S. Access Board Telecommunications Act Section 255 Guidelines](https://www.access-board.gov/ict/guide/2555_guide.md.html))

See [Overview of the Telecommunications Act of 1996](https://www.access-board.gov/about/law/ta.html) for more information.
