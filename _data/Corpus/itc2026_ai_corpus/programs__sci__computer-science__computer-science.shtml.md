**Source:** https://www.cpp.edu/programs/sci/computer-science/computer-science.shtml
...
![students presenting in front of a class](../img/24cybersecurity-fair-truong3.jpg)

## Quicklinks

[Computer Science Department](https://www.cpp.edu/sci/computer-science/index.shtml)
[Student Clubs](https://www.cpp.edu/sci/computer-science/student-clubs/index.shtml)
[Student Resources](https://www.cpp.edu/sci/computer-science/undergraduate-program/student-resources.shtml)
...
[Student Projects](https://www.cpp.edu/news/content/2024/07/robotic-dog-spot-helps-computer-science-students-navigate-code/index.shtml)
[Contact Us](https://www.cpp.edu/sci/computer-science/contact-information.shtml)
...
Design, develop and maintain software applications that meet user needs. Collaborate with cross-functional teams to determine requirements, create efficient algorithms, and ensure software functionality through rigorous testing.

### Data Scientist

Collect, analyze and interpret large datasets to extract meaningful insights. Utilize statistical methods and machine learning techniques to inform business decisions and solve complex problems.

### Artificial Intelligence Engineer

Develop, program and train AI models and algorithms to automate processes and enhance decision-making. Work on integrating AI capabilities into applications, ensuring they function effectively and align with business objectives.

### Computer Forensic Analyst

Investigate cybercrimes and data breaches by analyzing digital evidence. Collaborate with law enforcement agencies to support criminal investigations involving computer systems and ensure the integrity of digital information.
...
[See Course Catalog](https://catalog.cpp.edu/preview_program.php?catoid=68&poid=18690)
[Advising Center](https://www.cpp.edu/sci/advising-center/)
[Internships](https://www.cpp.edu/sci/computer-science/undergraduate-program/internship.shtml)

![Fatemeh Jamshidi ](../img/24new-faculty-jamshidi.jpg)
...
[Faculty and Staff](https://www.cpp.edu/sci/computer-science/faculty-and-staff/index.shtml%20%20%20%20%20%20)
...
[Watch Alex's Story](https://www.cpp.edu/wearecpp/stories/alex_cheng.shtml%20%20%20%20%20%20)

![Alex Cheng](../img/18distinguished-alumni-cheng.jpg)

## Accreditation

### ABET Accreditation

The Department of Computer Science’s Bachelor of Science program has been fully accredited by the Computing Accreditation Commission of ABET since 1994. For further information visit the [Program Accreditation & Assessment](https://www.cpp.edu/sci/computer-science/program-evaluation/accreditation-and-assessment.shtml) page.

## Related Programs

[Cyber Security Minor](https://catalog.cpp.edu/preview_program.php?catoid=68&amp;poid=19545&amp;returnto=5683)

[Data Science Minor](https://www.cpp.edu/sci/ds/minor-in-data-science.shtml)

[Computer Science Minor](https://www.cpp.edu/sci/computer-science/undergraduate-program/minor-in-cs.shtml)

[Mathematics, B.S. - Applied Mathematics/Statistics](https://www.cpp.edu/programs/sci/mathematics-and-statistics/applied-mathematics-and-statistics.shtml)

[Computer Engineering](https://www.cpp.edu/programs/eng/electrical-and-computer-engineering/computer-engineering.shtml)
