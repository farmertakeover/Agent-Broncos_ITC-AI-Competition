**Source:** https://www.cpp.edu/it/web-development/tutorial/instructions/module-instructions/hero-program.shtml
...
Note: **Program Type** is a breadcrumb that allows users to navigate back to the selected page of programs.

***Page View***

![](img/green-and-gold-tutorial-img/program-hero-program-page.png)
...
![](img/green-and-gold-tutorial-img/program-hero-program-tutorial.png)
