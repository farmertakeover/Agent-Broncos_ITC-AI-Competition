**Source:** https://www.cpp.edu/fpm/pdc/master-plan/faq.shtml
...
## 1. What is the 2040 Campus Master Plan Update?

The [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf) builds on Cal Poly Pomona’s [previous Campus Master Plan (PDF)](../docs/master_plan.pdf) and will guide the long-term physical development of the campus, in support of the university’s mission, strategic vision, and values. It provides a framework for future facility renovations and replacement, recreational facilities, open space, mobility/circulation, infrastructure updates, and sustainability.

## 2. Why do we need a Campus Master Plan Update?
...
## 5. What is the current status of the 2040 Campus Master Plan Update?

The planning process and development of the [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf) is complete. After conducting extensive outreach with the campus community and external stakeholders to define the priorities in the [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf), and with the resumption of most in-person learning and teaching activities in 2024, the University advanced the environmental review process for the 2040 Campus Master Plan Update, as required under the California Environmental Quality Act (CEQA). Past [meetings](https://www.cpp.edu/fpm/pdc/master-plan/history/committee/index.shtml) and [focused studies](history/studies.shtml) to the 2040 Campus Master Plan Update can be found on the project website at [www.cpp.edu/masterplan](https://www.cpp.edu/masterplan). The Campus Master Plan and Final EIR were presented to the CSU Board of Trustees in July 2025 for consideration for approval and certification. See the [Environmental Impact Report](https://www.cpp.edu/fpm/pdc/master-plan/environmental-impact-reports.shtml) page for a copy of the [Notice of Determination (PDF)](https://www.cpp.edu/fpm/pdc/master-plan/cpp-master-plan-nod-07.23.2025.pdf) from the meeting and for more information on the environmental process.

## 6. Why was the 2040 Campus Master Plan Update paused?

The [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf) was paused in late 2021 during the COVID-19 pandemic. This allowed the University to re-evaluate its on-campus physical capacity needs in light of remote instruction and its telecommuting program, among other considerations. In the Spring of 2023, the University began re-socializing the [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf) with the campus community, prior to formally commencing the environmental review process.

## 7. Has the 2040 Campus Master Plan Update changed since the pause?
...
## 8. What is the timeline for approval of the 2040 Campus Master Plan Update?

The Campus Master Plan and Final EIR were presented to the CSU Board of Trustees in July 2025 for consideration for certification and approval. See the [Environmental Impact Report](https://www.cpp.edu/fpm/pdc/master-plan/environmental-impact-reports.shtml) page for a copy of the [Notice of Determination (PDF)](cpp-master-plan-nod-07.23.2025.pdf) from the meeting and for more information on the environmental process.

## 9. What opportunities are there for public input in the process?

The planning process and development of the [2040 Campus Master Plan Update (PDF)](full-report.v7.2.1_r2.pdf) is complete. Past [meetings](https://www.cpp.edu/fpm/pdc/master-plan/history/committee/index.shtml) and [focused studies](history/studies.shtml) to the 2040 Campus Master Plan Update can be found on the project website. Past meetings and notices on the [Environmental Impact Report](https://www.cpp.edu/fpm/pdc/master-plan/environmental-impact-reports.shtml) process can also be found on the project website at [www.cpp.edu/masterplan](http://www.cpp.edu/masterplan).

## 10. Who can I contact for additional information or questions?

You can contact Carmen Chan, Planning Manager, at carmenchan@cpp.edu.
