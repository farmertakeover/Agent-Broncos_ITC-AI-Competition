**Source:** https://www.cpp.edu/cba/customer-insights-lab/resources/virtual-workshops/effective_web_development.shtml
...
Jarrod Griffin, Web Design & Media Analytics Specialist, gives an introduction to web design and development. He covers fundamentals of the web, areas of web design, content management systems, domains, web hosts, web tools, web standards, content strategies, and how to create your own website for cheap!

![](../../img/training-images/cropped-flyers/web_design_thumb.png)

### Relevant Links and Code:

Relevant Links:
CSS Peeper: <https://chrome.google.com/webstore/detail/css-peeper/mbnbehikldjhnfehhnaidhjhoofhpehk/related?hl=en>
Wappalyzer:
<https://chrome.google.com/webstore/detail/wappalyzer/gppongmhjkpfnbhagpmjfkannfbllamg/related?hl=en>
Ditto:
<https://ditto-cp.sourceforge.io/>
Reddit Link with more:
<https://old.reddit.com/r/learnprogramming/comments/h10ooq/tools_i_wish_i_had_known_about_when_i_started/>
