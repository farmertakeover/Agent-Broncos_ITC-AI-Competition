**Source:** https://www.cpp.edu/our-cpp/students/irb.shtml
...
![](../img/assets/banners/irb-banner.png)

# IRB

[![](../img/assets/icons/irb-what.png)](#irb-what)

[![](../img/assets/icons/irb-how.png)](#irb-how)

[![](../img/assets/icons/irb-resources.png)](#irb-resources)

[![](../img/assets/icons/irb-tips.png)](#irb-tips)

![What is the Institutional Review Board?](../img/assets/banners/irb-what-header.png)
...
![](../img/assets/illustrations/irb-levels-of-review.png)

### View the Image

×

![IRB Levels of Review](../img/assets/illustrations/irb-levels-of-review.png)

Close

![](../img/assets/illustrations/irb-review-category-decision-chart.png)

### View the Image

×

![IRB Review Category Decision Chart](../img/assets/illustrations/irb-review-category-decision-chart.png)

Close

![How to Acquire IRB](../img/assets/banners/irb-how-header.png)

1. Confirm that your project is "Human Subject Research"
   1. Verify with your faculty advisor OR you can always contact the IRB office if you need help assessing this.
      1. Email the IRB staff for drop-in hours, Monday and Wednesday at 10:00 - 11:00 am.
   2. For more guidance see the [IRB’s Policies and Guidelines](https://www.cpp.edu/research/irb-guidelines-and-procedures2020).
2. Complete your required Human Subject Research Education training
   1. See Step 1 in [Getting Started with a New or Existing Protocol](https://www.cpp.edu/research/research-compliance/irb/protocol.shtml)
3. Create a Cayuse IRB account. Once created, you will be notified and then have access to the Cayuse IRB platform.
4. Select the most appropriate IRB review category (exempt, expedited or full board) based on your study's risk level.
5. Complete your Cayuse IRB application: Include surveys, informed consent forms, external approvals and ensure your faculty advisor has reviewed and approved your proposed study.
   1. An IRB protocol application has 10 sections. You may already have most of the required information in the research proposal you and your faculty advisor have developed.
6. The image below shows the step-by step process your IRB application goes through.

![Life Cycle of an IRB Protocol](../img/assets/illustrations/life-cycle-of-an-irb-protocol.png)

![IRB Resources](../img/assets/banners/irb-resources-header.png)
...
![](../img/getting-started/irb-cpp.png)

##### CPP IRB Website

[View the Site](https://www.cpp.edu/research/research-compliance/irb/protocol.shtml "View the Site. ")

![](../img/getting-started/studying-student.png)

##### Links to Resources

[View the Resources](https://www.hhs.gov/ohrp/regulations-and-policy/regulations/45-cfr-46/revised-common-rule-regulatory-text/index.html "View the Resources. ")

![](../img/events/workshops/cayuse-tutorial.png)

##### Cayuse Tutorial - Navigating the IRB Site

[View the Video](https://streaming.cpp.edu/media/Cayuse%2Bover-OUR%2Band%2BIRB/1_qych794b "View the Video. ")

![](../img/getting-started/studentslibrary.jpg)

##### IRB Guidelines & Procedures

[View the Guidelines](https://www.cpp.edu/research/irb-guidelines-and-procedures2020 "View the Guidelines. ")

![IRB Tips from Students](../img/assets/banners/irb-tips-header.png)

![](../img/contact/diana-pic.jpg)

## Tips From Diana Fellow Researcher and CPP Alumna
