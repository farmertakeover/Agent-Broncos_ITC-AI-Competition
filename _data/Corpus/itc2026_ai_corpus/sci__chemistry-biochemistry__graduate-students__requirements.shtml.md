**Source:** http://www.cpp.edu/sci/chemistry-biochemistry/graduate-students/requirements.shtml
...
1. The degree program must include a minimum of 30 semester units. At least 16 units must be taken in 5000-6000 level courses.
...
3. The student must complete their program based upon the curriculum outlined below.
...
8. The candidate must be enrolled in the university during the term of graduation.

## Graduate Courses Required

|  |  |  |
| --- | --- | --- |
| MS Chemistry Total Units = 30 | | |
| Course Number | Course Title | Units |
| *Major Core Courses= 7 units* | | |
| *CHM 5500* | Advanced Chemical Communication | 1 |
| *CHM 5500* | Advanced Chemical Communication | 1 |
| CHM 5510L | Advanced Instrumental Analysis | 2 |
| CHM 5520 | Advanced Chemical Equilibria | 3 |
| *Major Elective Courses= 17 units*  *A minimum of 17 units selected from 5000-6000 level CHM Electives; 4000 level CHM Electives (limit to 7 units) and CHM 6910 (limit to 3 units)* | | |
| *Major Thesis/Culminating Experience= 6 units* |  |  |
| *CHM 6940* | Thesis Research | 4 |
| *CHM 6960* | Thesis | 2 |

[Chemistry Graduate Form](../docs/chem-graduate-contract.pdf "Chem Graduate Contract") (PDF)

[Signature Approval Form](../docs/signature-approval-contract.doc "Signature approval contract") (DOC)
