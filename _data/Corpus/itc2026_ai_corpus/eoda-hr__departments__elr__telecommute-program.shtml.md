**Source:** http://www.cpp.edu/eoda-hr/departments/elr/telecommute-program.shtml
...
[Non-Represented Staff Telecommuting Program (PDF)](docs/cpp-telecommuting-program.pdf)

[California State University Employees Union (CSUEU) - Units 2,5,7,9 Telecommuting Program (PDF)](docs/csueu-cpp-mou_systemwide-telecommuting-program.pdf)

[Academic Professionals of California (APC) - Unit 4 Telecommuting Program (PDF)](docs/apc-cpp-mou_systemwide-telecommuting-program.pdf)
...
To view your completed or pending Telecommuting Agreement, log into [MyCPP](https://my.cpp.edu/ "MyCPP"). Click on the Employee Center tab and under the Telecommuting Program section, click on My Telecommuting Agreement.

**Tools**

* [Telecommuting Home Safety Checklist and Agreement (PDF)](docs/telecommuting-home-safety-checklist-and-agreement.pdf "Telecommuting Home Safety Checklist and Agreement (PDF)") For Reference Only. To submit a Telecommuting Agreement, initiate the PeopleSoft process.
* [Telecommuting Checklist for Staff (PDF)](docs/telecommuting-checklist-for-staff_07.31.2023.pdf "Telecommuting Checklist for Staff (PDF)")
* [PeopleSoft Telecommuting Agreement Process - Employees Tutorial (PDF)](docs/peoplesoft-telecommuting-agreement-process-employees-tutorial-08.26.2024-final.pdf "PeopleSoft Telecommuting Agreement Process - Employees Tutorial (PDF)")
* [Ergonomic Resources](https://www.cpp.edu/ehs/occupational-health/ergonomics.shtml)

## Staff Frequently Asked Questions

### Which staff employee categories are eligible to request to telecommute?
...
### Is telecommuting a guaranteed benefit?
...
### I have been approved to telecommute, but I do not have the proper equipment. What can I do?
...
### How do I ensure my Telecommuting Site meets safety standards?
...
### Can staff telecommute from out of state?
...
### What if my position description is not up to date?
...
### How long can staff's telecommuting schedule be effective?
...
### Can staff telecommute if they have work performance deficiencies?
...
### How do staff submit their request to telecommute?

Staff may submit their written request to telecommute to their HEERA Manager via email.

### How do staff submit their Telecommuting Agreement?
...
### Do telecommuting staff have to work during the university’s standard operating hours of Monday through Friday from 8 a.m. to 5 p.m.?
...
### What if I need to telecommute due to a disability or medically related reason?
...
### What if my manager does not approve my request to telecommute?
...
### What if I believe my request to telecommute was denied due to discrimination, harassment or retaliation based on protected status?

The Interim CSU Policy Prohibiting Discrimination, Harassment, Sexual Misconduct, Sexual Exploitation, Dating Violence, Domestic Violence, Stalking, and Retaliation prohibits discrimination, harassment and retaliation based on protected status. Staff, including student staff, who feel they have experienced discrimination, harassment or retaliation based on protected status may contact the [Office of Equity and Compliance (OEC)](https://www.cpp.edu/officeofequity/index.shtml "Opens in a new window").

### If I have been instructed by the university or my health care provider to temporarily isolate/quarantine due to COVID-19 related reasons (e.g. sick, waiting for COVID-19 test or COVID-19 test results), may I telecommute during my isolation period?
...
### If I have child care, dependent care, or personal medical care needs, may I request to telework on a regularly scheduled in-person workday?
...
### Who do I contact if I have questions about the CPP Telecommuting Program?
...
* [PeopleSoft Telecommuting Agreement Process - AVPs' & VPs' Tutorial (PDF)](docs/avp-vps-tutorial-08.10.2023-docx.pdf)
...
* To initiate a Telecommuting Agreement for your staff: Go to [MyCPP](https://my.cpp.edu/ "MyCPP") and log in. At the top of the screen, click on the Employee Center tab. Under the Telecommuting Program – Managers section, click on Manager-initiated Telecommuting Agreement.
...
* [Telecommuting Home Safety Checklist and Agreement (PDF)](docs/telecommuting-home-safety-checklist-and-agreement.pdf "Telecommuting Home Safety Checklist and Agreement (PDF)") For Reference Only. To submit a Telecommuting Agreement, initiate the PeopleSoft process.
* [Telecommuting Checklist for HEERA Managers (PDF)](docs/telecommuting-checklist-for-heera-managers_07.31.2023.pdf "Telecommuting Checklist for HEERA Managers (PDF)")
* [Operational Assessment and Position Evaluation Guide For Telecommuting (PDF)](docs/operational-assessment-and-position-evaluation-guide-for-telecommuting_07.31.2023.pdf "Operational Assessment and Position Evaluation Guide For Telecommuting (PDF)")
* [PeopleSoft Telecommuting Agreement Process - HEERA Managers' Tutorial (PDF)](docs/managers-tutorial-08.10.2023.pdf)
* [Ergonomic Resources](https://www.cpp.edu/ehs/occupational-health/ergonomics.shtml)

## HEERA Manager Frequently Asked Questions

### Which positions are suitable for telecommuting?
...
### What are appropriate reasons to deny staff participation in the CPP Telecommuting Program?
...
### Can staff appeal the HEERA Manager’s decision to deny the request for participation in the CPP Telecommuting Program?

No. The HEERA Manager’s decision to deny staff’s request to telecommute is not subject to appeal.

### What are the characteristics of positions that DO lend themselves to telecommuting?
...
### What are the characteristics of positions that DO NOT lend themselves to telecommuting?
...
### What should be considered when determining whether staff is eligible for telecommuting?
...
### If staff were on a Temporary Remote Work Agreement (TRWA), are they automatically eligible to participate in the CPP Telecommuting Program?
...
### If I need to end a staff’s Temporary Remote Work Agreement (TRWA) and the staff is not eligible to participate in the CPP Telecommuting Program, how much advanced notice do I need to provide my staff?
...
### What do I communicate to staff who have requested to participate in the CPP Telecommuting Program, but do not meet the eligibility requirements?
...
### How do I end a staff’s CPP Telecommuting Agreement?
...
### How can I obtain a copy of a position description?
...
To update a staff’s position description, please review the [Compensation/Classification website](../classification-and-compensation/index.shtml) for instructions and resources. We highly recommend becoming familiar with your staff’s classification and qualification standards that can be found at the [CSU Classification Standards page](https://csyou.calstate.edu/Divisions-Orgs/HR/hrm/Compensation/Classification%20Standards/Forms/AllItems.aspx "Opens in a new window").

For consultations and questions regarding position description updates, please contact a Compensation & Classification Analyst.

### How do I respond to staff who calls in sick on a day they are supposed to work in-person, but the staff states they can still work by telecommuting?
...
### What do I do if a staff member requests furniture or IT equipment for their telecommuting site?
...
### What if there is an event/meeting on campus that staff need to attend that falls on their established telecommuting workday?
...
### How much notice must I provide to staff if I alter a Telecommuting Agreement?
...
### If I allow my staff to telecommute, how do I ensure that we have staff presence in the office?
...
### What do I do if staff request to work outside the state?
...
### What do I do if my non-exempt staff are working outside of their established work schedule?
...
### What if my staff are not meeting work expectations while telecommuting?
...
### How do I ensure equity considerations when determining eligibility for telecommuting?
...
### What other options are available for staff not eligible to participate in the CPP Telecommuting Program?
...
Staff or their dependents, who have a medical condition that causes the staff to need time off from work either intermittently or long-term, may be eligible for Family Medical Leave (FMLA). Please immediately refer staff to the Leaves of Absence Coordinator, leaves@cpp.edu or (909) 869-6839 to obtain more information. [CPP's FMLA Website](../benefits/leaves/leave-programs/fml.shtml)

HEERA Managers should not solicit medical information from their staff.

### What if staff has been instructed by the Safer Return Task Force to isolate/quarantine due to COVID-19 related reasons (e.g. sick, waiting for COVID-19 test or COVID-19 test results), and the staff requests to telework during the isolation period?
...
### What if staff requests to telework on a regularly scheduled in-person workday due to child care, dependent care, or personal medical care needs?
