**Source:** http://www.cpp.edu/class/english-modern-languages/academics/minors.shtml
...
A minor or certificate is a great way to enhance your degree, whether you use it to follow a passion or to further develop key professional skills in communication, cultural knowledge, and critical thinking. Minors are usually comprised of 6 classes (18 units), while a certificate is 5 classes (15 units).
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19757&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)

If you are not sure which class to take to start or continue learning Chinese, see our [Language Placement information](https://www-test.cpp.edu/class/english-modern-languages/academics/language-placement.shtml).
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19682&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19683&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)

If you are not sure which class to take to start or continue learning French, see our [Language Placement information](https://www-test.cpp.edu/class/english-modern-languages/academics/language-placement.shtml).

Contact the French Minor Coordinator, Dr. Claudia Salazar Jimenez, at claudias@cpp.edu or (909) 869-3825.

**Please note: at present the EML Department is unable to accept new students into the French minor program**
...
To see a full listing of the courses we offer in the certificate, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19768&returnto=6726#acalog_template_course_filter). (Not all courses are offered every semester.)

If you are not sure which class to take to start or continue learning German, see our [Language Placement information](https://www-test.cpp.edu/class/english-modern-languages/academics/language-placement.shtml).
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19684&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)

If you are not sure which class to take to start or continue learning Spanish, see our [Language Placement information](https://www-test.cpp.edu/class/english-modern-languages/academics/language-placement.shtml).
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19685&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)
...
To see a full listing of the courses we offer in the minor, see the [CPP Catalog](https://catalog.cpp.edu/preview_program.php?catoid=69&poid=19766&returnto=6724#acalog_template_course_filter). (Not all courses are offered every semester.)
