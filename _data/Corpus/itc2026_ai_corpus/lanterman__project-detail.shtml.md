**Source:** http://www.cpp.edu/lanterman/project-detail.shtml
...
Cal Poly Pomona’s decision to develop the Lanterman property comes after a deliberative process that spanned several years, as the project timeline shows. The information in this section — the maps, reports and studies —document that process and underscore the university’s commitment to be transparent with campus and community constituents.

## Resources

[### Project Timeline](timeline.shtml)

[### History](reports-studies-and-documents.shtml)

[### Financials (PDF)](https://www.cpp.edu/lanterman/pdfs/lanterman_cppe-state-side-pl_june-30-2025.pdf)

## Maps

![Labels of Lanterman Map](img/lanterman-specific-plans-slide1.jpg)

![Lanterman Usable Lot Area](img/lanterman-lot-slide2.jpg)

![Map of Zones A-D](img/lanterman-zones-slide3.jpg)

![Closeup of Zone A and B](img/lanterman-zones2-slide4.jpg)

![Closeup Zones C and D](img/lanterman-zones3-slide5.jpg)
