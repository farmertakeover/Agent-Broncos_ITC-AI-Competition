**Source:** http://www.cpp.edu/academic-resources/tableau.shtml
...
Access via [Institutional Research, Planning, and Analytics](https://www.cpp.edu/data/dashboards/index.shtml) (IRPA)

## Tableau Tutorial Videos

* [Download Data to Excel](https://www.youtube.com/watch?v=2sY4BeJYFak?cc_load_policy=1)
* [Download Data as PDF](https://youtu.be/qo3rKsZTk-4)
* [Add a Header and Footer to the PDF Tableau File](https://www.youtube.com/watch?v=MnCquvR1I2E&feature=youtu.be)
* [Sharing Tableau Views](https://youtu.be/wYq8m8JMR6I)
* Saving Views/Defaults (Coming Soon!)

**Dashboard Hint**: For a snappy performance, use "Pause" while setting filters, then "Resume"

## Tableau Handouts

* [Discover the Tableau Navigation Toolbar (PDF)](budget-and-finance/docs/tableau-navigation-toolbar-explained.pdf)
* [Discover the Right Hand Navigation Menu (PDF)](budget-and-finance/docs/tableau-right-hand-side-navigation-guide.pdf)
* [Navigate and Download Finance Dashboard Data (PDF)](budget-and-finance/docs/academic-affairs-finance-workshop-tableau-dashboards.pdf)
* [Navigate and Download Sequence Courses Dashboard Data (PDF)](budget-and-finance/docs/tableau-sequence-courses-db-scheduler-guide.pdf)
