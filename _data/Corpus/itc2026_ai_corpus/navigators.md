**Source:** https://www.cpp.edu/navigators
...
* [Home](/navigators/index.shtml)
* [Find a Mentor](https://cpp.mentorcollective.org/register/bronconavigators/mentee)
* [Become a Mentor](https://cpp.mentorcollective.org/register/bronconavigators/mentor)
* [LinkedIn Badge for Mentors](/navigators/linkedin.shtml)
...
![Two students walk across the Rose Garden](img/small-image.png)

# Bronco Navigators

![Three students walk in the Japanese Garden](img/hero.png)

## About the Program

The Bronco Navigators program enhances the college experience by linking students one-on-one with a peer mentor. First-year students are paired with experienced peers invested in their success -- someone ready to listen, inspire, and recognize opportunities. We partner with Mentor Collective to make this program possible.

As a mentee, you will learn what to expect at CPP, how to approach challenges, and gain career advice. At the same time, mentors will build their networks while developing professional and leadership skills. You can discuss common questions that arise for a college student, including:
...
Incoming students will be matched with a peer mentor (an experienced CPP student) based on common interests, background, academics, and professional aspirations. To get started, students and mentors register and complete an online survey to put together a picture of interests and experiences. Check out the videos below for more info:

## Get Connected with Bronco Navigators

[### Find a Mentor

It's easy to sign up and get connected with a mentor for free. Click on the card to get started. Complete a survey about yourself and your background, and we'll match you with a mentor.](https://cpp.mentorcollective.org/register/bronconavigators/mentee "opens a new window")

[### Be a Mentor

It's easy to sign up and help other students set and achieve their goals while learning valuable leadership skills for your future career. Click on the card to get started. Complete a survey about yourself and your background, and we'll match you with mentees.](https://cpp.mentorcollective.org/register/bronconavigators/mentor "opens a new window")
