**Source:** https://www.cpp.edu/rms/insurance/fine-arts.shtml
...
![Kellogg Art Gallery](../img/kellogg-gallery.jpg)
...
Insurance is available for works of art that are publicly displayed on campus. University Risk Management will arrange for coverage.

Requests should be forwarded to University Risk management and should include the following:

* Beginning and ending dates of the exhibit.
* Location of exhibit.
* Identification of each item to be displayed and its value.

For more information, please contact Strategic Enterprise Risk Management at 909-869-2495.
