**Source:** http://www.cpp.edu/financial-aid/resources/understanding-repeat-coursework-and-aid-eligibility.shtml
...
Federal regulations require that financial aid may only be awarded to an undergraduate, graduate, or a professional student once for a previously passed course (i.e., one repetition per class).  The Cal Poly Pomona [Repetition of Courses Policy](https://catalog.cpp.edu/content.php?catoid=53&navoid=4006#course_repetition) and [Grade Forgivenesss Policy](https://catalog.cpp.edu/content.php?catoid=53&navoid=4006#Grade_Forgiveness) do not apply when determining if the  coursework is eligible for financial aid.
...
* All repeated courses are counted as attempted units for [Satisfactory Academic Progress for Financial Aid Applicants.](understanding-sap.shtml)
...
* **Passing gra****des** are: “A (+/-)”, “B (+/-)”, “C (+/-)”, “D (+/-)”, “CR” (Credit) or “Pass”
* **Not passing gr****ades** are: “NC” (No Credit), “I,” “W,” “WU,” “WX," "F”

### Example Scenarios of Repeat Courses and Aid Eligibility
...
Academic Policies surrounding course repetition can be found in the [University Catalog](https://catalog.cpp.edu/content.php?catoid=53&navoid=4006) and through the [Office of the Registrar](https://www.cpp.edu/registrar/student-records/course-repetition.shtml).

Example Scenario of Repeat Courses and Aid Eligibility

| **Course Examples** | **1****st****Class Attempt** | **2****nd****Class Attempt** | **3****rd****Class Attempt** | ****Would 3****rd****Attempt be Eligible for Federal Financial Aid?**** |
| --- | --- | --- | --- | --- |
