**Source:** http://www.cpp.edu/financial-aid/resources/question-of-the-month.shtml
...
Despite difficulties with the U.S. Department of Education's soft launch of the [2024-2025 FAFSA](https://studentaid.gov/h/apply-for-aid/fafsa), students and families should persist and if necessary, seek help getting it filed.

Need assistance with completing your 2024-2025 FAFSA?  Check out our [FAFSA Simplification webpage](fafsa-simplification/students-and-families.shtml) or attend one of our [upcoming workshops](fafsa-dream-workshops.shtml).

### December 2023: On what date is a student's FAFSA considered submitted?
...
### October 2023: Will an FSA ID be required to file an online FAFSA starting with the 2024-2025 aid year?

Yes. In its [FAFSA Changes: An Overview webinar](https://www.youtube.com/watch?v=kSHQmtSQFvo), the U.S. Department of Education (ED) stated, beginning with the 2024-25 FAFSA, all students and FAFSA contributors **must** create a ***Federal Student Aid ID*** (FSA username and password).
...
**Student Eligibility:** Under [34 CFR 668.32(d)](https://www.nasfaa.org/Part_668_General_Provisions#subc66832d) and [668.33](https://www.nasfaa.org/Part_668_General_Provisions#subc66833), a student must still be a U.S. citizen or eligible noncitizen to be eligible for federal student aid. Also, under [668.32(i)](https://www.nasfaa.org/Part_668_General_Provisions#subc66832i), except for students from the Freely Associated States, all students must have an SSN to be eligible for Title IV aid. Students from the Freely Associated States (Marshall Islands, Micronesia, and Palau) are assigned pseudo-SSNs.
...
Review this [video](https://cpp.financialaidtv.com/play/1766-applying-financial-aid/38872-fafsa-creating-fsa-id) for help in creating an FSA ID now (for those with an SSN).

### August 2023: When is the CA priority filing date for the 2024-2025 FAFSA & Dream Applications?
...
### July 2023: Can Financial Aid pay for a course that does not count toward a student's degree completion requirements?
...
To be eligible for federal (and state) funds, a student must be a regular student as defined in [34 CFR 600.2](https://www.nasfaa.org/Part_600_Institutional_Eligibility#suba6002) of the Institutional Eligibility regulations. A regular student is defined as: “A person who is enrolled or accepted for enrollment at an institution for the purpose of obtaining a degree, certificate, or other recognized educational credential offered by that institution.” Therefore, the school cannot award federal or state aid for course work that will not count towards the completion of that student's degree program requirements (or otherwise result in a degree, certificate, or credential).
...
### June 2023: Is Academic Standing the same as Satisfactory Academic Progress (SAP) for Financial Aid?
...
### May 2023: Why is full-time for the summer term considered 12 units (for undergraduate students)?

For **undergraduate programs**, the definition of a full-time student, [34 CFR 668.2(b)](https://www.nasfaa.org/Part_668_General_Provisions#suba6682b) requires a program that measures progress in credit hours and uses standard terms to establish **12 hours per academic term as the minimum definition of full-time**.
...
### April 2023: Since Orientation is Mandatory, Can the Orientation Fee be Paid with Financial Aid?

No.

Financial Aid funds can only be applied towards institutional charges under [34 CFR 668.164(d)(1)](https://www.nasfaa.org/Part_668_General_Provisions#subk668164d1) if the charges are:
...
Additionally, Orientation as a standalone activity cannot be considered instructional time.  Per [34 CFFR 668.8(b)(3)(ii)](https://www.nasfaa.org/Part_668_General_Provisions#suba6688b): "Instructional time does not include any vacation periods, homework, or periods of orientation or counseling."
...
### February 2023: Why does the Financial Aid Office require some students to submit additional documents?
...
* Students are required to submit the required documents by the **priority document submission deadline** in order to have their file reviewed and aid packaged prior to the fee payment deadline.
* Students are encouraged to contact the Financial Aid Office with questions about the verification process.
* Data is checked against the [Internal Revenue Service](https://www.irs.gov/), [Social Security Administration](https://www.ssa.gov/), [Immigration and Naturalization Service](https://www.uscis.gov/portal/site/uscis), [Veterans Administration](https://www.va.gov/), [Selective Service System](https://www.sss.gov) and [National Student Loan Data Base](https://nsldsfap.ed.gov/nslds_FAP/) to ensure that individual status and benefits are being reported correctly.
...
Review our [Understanding Verification](understanding-verification.shtml) page for more details on the verification process at Cal Poly Pomona.

### January 2023: Can the Financial Aid Office share student FAFSA Data with other offices on campus?
...
Even if a disclosure meets the HEA criteria noted above, other conditions must also be met under FERPA—[34 CFR 99](https://www.ecfr.gov/cgi-bin/text-idx?c=ecfr&SID=9aa00c41516c32b7edc9fdd8b3b57d4e&tpl=/ecfrbrowse/Title34/34cfr99_main_02.tpl).

### December 2022: When is the Student Loan Payment Pause ending?

The [student loan payment pause](https://studentaid.gov/announcements-events/covid-19) was set to expire on Dec. 31, 2022, but has now been extended up to **June 30, 2023** - with President Biden saying that borrowers should not have to pay monthly student loans bills until the courts reach a decision on the legality of student debt forgiveness. The extension allows the Supreme Court time to hear the case in its current term.
...
### November 2022: What is happening with the Student Debt Relief Program?
...
In the meantime, the Biden administration has encouraged borrowers to [sign up for updates](https://www.ed.gov/subscriptions) from the Department of Education regarding the program so borrowers can know when any updates are available.

### October 2022: Will the new California Ban on Private Scholarship Displacement (AB 288) change how finanical aid is processed at Cal Poly Pomona?
...
Our long-standing approach at Cal Poly Pomona is consistent with the newly signed [Assembly Bill 288](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202120220AB288) (AB 288), which enacts the **California Ban on Scholarship Displacement Act of 2021.**

### **Assembly Bill 288 - California Ban on Scholarship Displacement Act of 2021**

[Assembly Bill 288](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202120220AB288) (AB 288), signed into law on September 30, 2022, enacts the **California Ban on Scholarship Displacement Act of 2021**, which is intended to ensure that ***private scholarships*** for students supplement, and do not supplant, gift aid, grants, scholarships, tuition waivers, and fellowship stipends provided by institutions of higher education to California students who have financial need.
...
Even with the ban on Private Scholarship Displacement, there are times when a reduction of grant or other aid may be required in order to remain compliant with federal or other financial aid regulations, (including provisions surrounding the [treatment of estimated financial assistance](https://www.nasfaa.org/Part_685_Federal_Direct_Loan_Program#suba685102)):
...
### September 2022: Is a Scholarship or Fellowship considered Estimated Financial Assistance if it is awarded for a period of nonattendance?
...
The definition of estimated financial assistance in [34 CFR 685.102(b)](https://www.nasfaa.org/Part_685_Federal_Direct_Loan_Program#suba685102), specifically, clause (1)(iii), states: "*Estimated financial assistance*:
...
The assumption for this part of the definition is that the student would not be receiving the assistance if he or she was not enrolled at a postsecondary institution. [685.102(b)] See also [673.5(c) *Estimated financial assistance*](https://www.nasfaa.org/part_673_campus-based_common_provisions#subb6735).

Under [Section 471 of the Higher Education Act of 1965 (HEA)](https://uscode.house.gov/view.xhtml?req=(title:%20section:1087kk%20edition:prelim)%20OR%20(granuleid:USC-prelim-title-section1087kk)&f=treesort&edition=prelim&num=0&jumpTo=true), as amended, [20 USC 1087kk], the amount of need for a student for Title IV assistance during a period of enrollment is equal to the cost of attendance (COA) for the student, minus his or her expected family contribution (EFC), and minus his or her estimated financial assistance (EFA).
...
### August 2022: Is there a limit to how long a student can receive financial aid?
...
You can read more about the various limits for specific aid programs on our [Understanding Aid Program Limits](https://www.cpp.edu/financial-aid/resources/understanding-aid-program-limits.shtml) page.  Also be sure to visit our [Understanding Unit Maximums](https://www.cpp.edu/financial-aid/resources/understanding-unit-maximums.shtml) page for details on unit limits associated with the SAP Maximum Timeframe and State University Grant eligibility.

Also, be sure to check out the following video from our 24/7 Get Answers video channel on the [Pell Grant Limit.](https://cpp.financialaidtv.com/play/1003-grant-programs-including-ccpg/10004-what-lifetime-eligibility-used-leu-pell-grants)

### July 2022: Beginning with Fall 2022, the Grant Recalculation Date for Fall & Spring semesters will be the day after the Add / Drop Period ends (the 10th day of classes). Why the change?
...
### June 2022: Can a school review Satisfactory Academic Progress (SAP) for Fall and Spring Terms but not for the Summer Term?
...
### May 2022: How is eligibility for Summer Federal Work Study determined? Are students who are not enrolled in summer courses eligible?
...
### April 2022: Are Graduation Prizes or Post-Enrollment Awards Considered Estimated Financial Assistance (EFA) for the Prior Year?
...
Answer: Yes, according to guidance from the U.S. Department of Education (ED), the funds would be considered to be estimated financial assistance (EFA) and must be reported to the Office of Financial Aid & Scholarships. [34 CFR 673.5(c)](https://www.nasfaa.org/part_673_campus-based_common_provisions#subb6735) and [685.102(b)](https://www.nasfaa.org/Part_685_Federal_Direct_Loan_Program#suba685102) specify the definition of EFA as:
...
### March 2022: Can the Orientation fee be paid with a student's financial aid?
...
Federal (Title IV) financial aid funds can be applied towards institutional charges under [34 CFR 668.164(d)(1)](https://www.nasfaa.org/Part_668_General_Provisions#subk668164d1) **if the charges are** current and allowable.
...
**Additionally**, under [34 CFR 668.32](https://www.nasfaa.org/Part_668_General_Provisions#subc66832) a student is considered a **regular student** if they have been accepted into an eligible program of study. At Cal Poly Pomona, students are considered accepted for admission **effective** with the **Fall term (or Spring** – for Spring admits). As such, the Orientation Activity is taking place prior to when the students meet the definition of a **regular student**. The student's financial aid cannot be applied to charges for an activity that occurs prior to when they meet the definition of a regular student.
...
### February 2022: Are Emergency Grants or Gift Cards from a department required to be coordinated with the Office of Financial Aid & Scholarships in all cases?
...
* The definition of **estimated financial assistance** is in [34 CFR 685.102(b)](https://www.nasfaa.org/Part_685_Federal_Direct_Loan_Program#suba685102b). Generally speaking, assistance provided to a student because of his or her enrollment in a postsecondary education program is EFA. Funds from the institution **are not excluded** from the definition of EFA. Neither are funds awarded on the basis of an emergency experienced by the student. The school **must treat the funds as EFA**.
* Section 668.16(b)(3) of the administrative capability regulations requires all campus offices to report to the financial aid office any information which may have bearing on a student's receipt of Title IV federal student aid. [34 CFR [668.16(b)(3)](https://www.nasfaa.org/Part_668_General_Provisions#subb66816); [673.5](https://www.nasfaa.org/part_673_campus-based_common_provisions#subb6735); [685.201](https://www.nasfaa.org/Part_685_Federal_Direct_Loan_Program#subb685201)]
* [**CSU Academic Affairs Coded Memo AA-2004-15 (PDF)**](https://www.calstate.edu/csu-system/administration/codedmemos/Academic%20Affairs%20Coded%20Memos/AA-2004-15.pdf) issued May 2004, in response to audit findings, reminded campuses of the need to coordinate information and resources related to student financial aid eligibility.

* [**CSU Academic Affairs Coded Memo ASA 2016-28 (PDF)**](https://www.calstate.edu/csu-system/administration/codedmemos/Academic%20Affairs%20Coded%20Memos/ASA-2016-28.pdf) issued November 2016 (and revised December 2021) reiterated that if a student receives awards that would cause their total aid ***from all sources*** to exceed the COA, then adjustments must be made. The Memo specified that, “in general, unless the award is considered wages, it is other financial assistance and must be factored in.”
...
### January 2022: How does pursuit of a Double-Major impact an undergraduate student’s financial aid?
...
Students with more than one major must also adhere to the Cal Poly Pomona [Satisfactory Academic Progress Standards for Aid Recipients](https://www.cpp.edu/financial-aid/resources/understanding-sap.shtml) (including the Maximum Time Frame Standard) and are limited by [Aggregate Loan Limits](https://studentaid.gov/understand-aid/types/loans/subsidized-unsubsidized) for Federal Direct Loans.
