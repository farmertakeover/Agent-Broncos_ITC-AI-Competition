**Source:** https://www.cpp.edu/~fas/university-accounting-services/travel/submitting-claim.shtml
...
The [Missing Receipt Affidavit Form. PDF](../docs/travel/missing-receipt-affidavit_accessible_2025.pdf "Missing Receipt Affidavit") may be used to support a receipt that is not provided, and can be attached to the Expense Report as support of the purchase.
...
The [Travel Procedures Exception Request Form (PDF)](../docs/travel/travel-procedures-exception-request_accessible_2025.pdf "Travel Procedures Exception Request Form") should be completed and submitted with the Expense Report to support the approval or denial of the request. *Note: Exceptions to the nightly lodging cap will be approved through the submission of the Travel Request.*
