**Source:** https://www.cpp.edu/events?type=featured
...
Notifications are not provided to users when a date is selected and page is updated.  Some links open a new window without providing advanced warning to users.  If you need assistance, contact calendar@cpp.edu

## Related Links

* [Public Schedule of Classes](https://schedule.cpp.edu/ "Public Schedule of Classes (opens in new window)")
* [Final Exam Schedules](https://www.cpp.edu/studentsuccess/academic-calendar/finals-week.shtml "Final Exam Schedules (opens in new window)")
* [25Live Training Guides](https://livecsupomona.sharepoint.com/%3Af%3A/s/sem1/EqNNb22E_aFLrduW5rA-XAkBbzB8mEA5BFfvZHLticVLWw?e=dK4wuT "25Live Training Guides (opens in new window)")

## Submit an Event

Faculty, Staff, and Student e-Board Schedulers: If you like to submit an event, please login to 25Live.

* [Log into 25live](https://25live.collegenet.com/pro/cpp#!/home/dash)
